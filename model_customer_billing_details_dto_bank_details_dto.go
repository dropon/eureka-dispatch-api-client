...
// checks if the CustomerBillingDetailsDtoBankDetailsDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerBillingDetailsDtoBankDetailsDto{}

// CustomerBillingDetailsDtoBankDetailsDto struct for CustomerBillingDetailsDtoBankDetailsDto
type CustomerBillingDetailsDtoBankDetailsDto struct {
...
func NewCustomerBillingDetailsDtoBankDetailsDto() *CustomerBillingDetailsDtoBankDetailsDto {
	this := CustomerBillingDetailsDtoBankDetailsDto{}
	return &this
}
...
func (o CustomerBillingDetailsDtoBankDetailsDto) MarshalJSON() ([]byte, error) {
...
func (o CustomerBillingDetailsDtoBankDetailsDto) ToMap() (map[string]interface{}, error) {
...
type NullableCustomerBillingDetailsDtoBankDetailsDto struct {
	value *CustomerBillingDetailsDtoBankDetailsDto
	isSet bool
}

func (v NullableCustomerBillingDetailsDtoBankDetailsDto) Get() *CustomerBillingDetailsDtoBankDetailsDto {
	return v.value
}

func (v *NullableCustomerBillingDetailsDtoBankDetailsDto) Set(val *CustomerBillingDetailsDtoBankDetailsDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerBillingDetailsDtoBankDetailsDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerBillingDetailsDtoBankDetailsDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerBillingDetailsDtoBankDetailsDto(val *CustomerBillingDetailsDtoBankDetailsDto) *NullableCustomerBillingDetailsDtoBankDetailsDto {
	return &NullableCustomerBillingDetailsDtoBankDetailsDto{value: val, isSet: true}
}

func (v NullableCustomerBillingDetailsDtoBankDetailsDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerBillingDetailsDtoBankDetailsDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
