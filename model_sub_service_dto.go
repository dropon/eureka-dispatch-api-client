...
// checks if the SubServiceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubServiceDto{}

// SubServiceDto struct for SubServiceDto
type SubServiceDto struct {
	...
	QuantityMustBeSelected *bool `json:"quantityMustBeSelected,omitempty"`
	SubServiceQuantities *CappedCollectionDtoSubServiceQuantityDto `json:"subServiceQuantities,omitempty"`
}
...
// GetQuantityMustBeSelected returns the QuantityMustBeSelected field value if set, zero value otherwise.
func (o *SubServiceDto) GetQuantityMustBeSelected() bool {
	if o == nil || IsNil(o.QuantityMustBeSelected) {
		var ret bool
		return ret
	}
	return *o.QuantityMustBeSelected
}

// GetQuantityMustBeSelectedOk returns a tuple with the QuantityMustBeSelected field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SubServiceDto) GetQuantityMustBeSelectedOk() (*bool, bool) {
	if o == nil || IsNil(o.QuantityMustBeSelected) {
		return nil, false
	}
	return o.QuantityMustBeSelected, true
}
...
// SetQuantityMustBeSelected gets a reference to the given bool and assigns it to the QuantityMustBeSelected field.
func (o *SubServiceDto) SetQuantityMustBeSelected(v bool) {
	o.QuantityMustBeSelected = &v
}

// GetSubServiceQuantities returns the SubServiceQuantities field value if set, zero value otherwise.
func (o *SubServiceDto) GetSubServiceQuantities() CappedCollectionDtoSubServiceQuantityDto {
	if o == nil || IsNil(o.SubServiceQuantities) {
		var ret CappedCollectionDtoSubServiceQuantityDto
		return ret
	}
	return *o.SubServiceQuantities
}

// GetSubServiceQuantitiesOk returns a tuple with the SubServiceQuantities field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SubServiceDto) GetSubServiceQuantitiesOk() (*CappedCollectionDtoSubServiceQuantityDto, bool) {
	if o == nil || IsNil(o.SubServiceQuantities) {
		return nil, false
	}
	return o.SubServiceQuantities, true
}
...
// SetSubServiceQuantities gets a reference to the given CappedCollectionDtoSubServiceQuantityDto and assigns it to the SubServiceQuantities field.
func (o *SubServiceDto) SetSubServiceQuantities(v CappedCollectionDtoSubServiceQuantityDto) {
	o.SubServiceQuantities = &v
}

func (o SubServiceDto) MarshalJSON() ([]byte, error) {
...
func (o SubServiceDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QuantityMustBeSelected) {
		toSerialize["quantityMustBeSelected"] = o.QuantityMustBeSelected
	}
	if !IsNil(o.SubServiceQuantities) {
		toSerialize["subServiceQuantities"] = o.SubServiceQuantities
	}
	return toSerialize, nil
}

type NullableSubServiceDto struct {
	value *SubServiceDto
	isSet bool
}

func (v NullableSubServiceDto) Get() *SubServiceDto {
	return v.value
}

func (v *NullableSubServiceDto) Set(val *SubServiceDto) {
	v.value = val
	v.isSet = true
}

func (v NullableSubServiceDto) IsSet() bool {
	return v.isSet
}

func (v *NullableSubServiceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubServiceDto(val *SubServiceDto) *NullableSubServiceDto {
	return &NullableSubServiceDto{value: val, isSet: true}
}

func (v NullableSubServiceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubServiceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
