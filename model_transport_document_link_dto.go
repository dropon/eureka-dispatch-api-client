...
var _ MappedNullable = &TransportDocumentLinkDto{}

// TransportDocumentLinkDto struct for TransportDocumentLinkDto
type TransportDocumentLinkDto struct {
...
func NewTransportDocumentLinkDto() *TransportDocumentLinkDto {
	this := TransportDocumentLinkDto{}
	return &this
}

// NewTransportDocumentLinkDtoWithDefaults instantiates a new TransportDocumentLinkDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTransportDocumentLinkDtoWithDefaults() *TransportDocumentLinkDto {
	this := TransportDocumentLinkDto{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *TransportDocumentLinkDto) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *TransportDocumentLinkDto) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *TransportDocumentLinkDto) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *TransportDocumentLinkDto) SetId(v int32) {
	o.Id = &v
}

// GetFileCategoryCode returns the FileCategoryCode field value if set, zero value otherwise.
func (o *TransportDocumentLinkDto) GetFileCategoryCode() string {
...
// and a boolean to check if the value has been set.
func (o *TransportDocumentLinkDto) GetFileCategoryCodeOk() (*string, bool) {
	if o == nil || IsNil(o.FileCategoryCode) {
		return nil, false
	}
...
func (o *TransportDocumentLinkDto) HasFileCategoryCode() bool {
	if o != nil && !IsNil(o.FileCategoryCode) {
		return true
	}
...
func (o *TransportDocumentLinkDto) SetFileCategoryCode(v string) {
	o.FileCategoryCode = &v
}

// GetFileCategoryLabel returns the FileCategoryLabel field value if set, zero value otherwise.
func (o *TransportDocumentLinkDto) GetFileCategoryLabel() string {
...
// and a boolean to check if the value has been set.
func (o *TransportDocumentLinkDto) GetFileCategoryLabelOk() (*string, bool) {
	if o == nil || IsNil(o.FileCategoryLabel) {
		return nil, false
	}
...
func (o *TransportDocumentLinkDto) HasFileCategoryLabel() bool {
	if o != nil && !IsNil(o.FileCategoryLabel) {
		return true
	}
...
func (o *TransportDocumentLinkDto) SetFileCategoryLabel(v string) {
	o.FileCategoryLabel = &v
}

// GetLabel returns the Label field value if set, zero value otherwise.
func (o *TransportDocumentLinkDto) GetLabel() string {
...
// and a boolean to check if the value has been set.
func (o *TransportDocumentLinkDto) GetLabelOk() (*string, bool) {
	if o == nil || IsNil(o.Label) {
		return nil, false
	}
	return o.Label, true
...
func (o *TransportDocumentLinkDto) HasLabel() bool {
	if o != nil && !IsNil(o.Label) {
		return true
	}
...
func (o *TransportDocumentLinkDto) SetLabel(v string) {
	o.Label = &v
}

// GetLink returns the Link field value if set, zero value otherwise.
func (o *TransportDocumentLinkDto) GetLink() string {
...
// and a boolean to check if the value has been set.
func (o *TransportDocumentLinkDto) GetLinkOk() (*string, bool) {
	if o == nil || IsNil(o.Link) {
		return nil, false
	}
	return o.Link, true
...
func (o *TransportDocumentLinkDto) HasLink() bool {
	if o != nil && !IsNil(o.Link) {
		return true
	}
...
func (o *TransportDocumentLinkDto) SetLink(v string) {
	o.Link = &v
}
...
func (o *TransportDocumentLinkDto) HasCreationDateTime() bool {
	if o != nil && !IsNil(o.CreationDateTime) {
		return true
	}
...
func (o TransportDocumentLinkDto) MarshalJSON() ([]byte, error) {
...
func (o TransportDocumentLinkDto) ToMap() (map[string]interface{}, error) {
...
type NullableTransportDocumentLinkDto struct {
	value *TransportDocumentLinkDto
	isSet bool
}

func (v NullableTransportDocumentLinkDto) Get() *TransportDocumentLinkDto {
	return v.value
}

func (v *NullableTransportDocumentLinkDto) Set(val *TransportDocumentLinkDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportDocumentLinkDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportDocumentLinkDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportDocumentLinkDto(val *TransportDocumentLinkDto) *NullableTransportDocumentLinkDto {
	return &NullableTransportDocumentLinkDto{value: val, isSet: true}
}

func (v NullableTransportDocumentLinkDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportDocumentLinkDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
