...
// checks if the UpdateAddressDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAddressDto{}

// UpdateAddressDto struct for UpdateAddressDto
type UpdateAddressDto struct {
	...
	AddressCategoryCode *string `json:"addressCategoryCode,omitempty"`
	ExternalAddressCode *string `json:"externalAddressCode,omitempty"`
	Notes *string `json:"notes,omitempty"`
	StopDurationInSeconds *int32 `json:"stopDurationInSeconds,omitempty"`
	CircuitAddressSetId *int32 `json:"circuitAddressSetId,omitempty"`
	AddressComplement1 *string `json:"addressComplement1,omitempty"`
	AddressComplement2 *string `json:"addressComplement2,omitempty"`
	AddressComplement3 *string `json:"addressComplement3,omitempty"`
	AddressComplement4 *string `json:"addressComplement4,omitempty"`
	IsHeightRestrictedAccess *bool `json:"isHeightRestrictedAccess,omitempty"`
	HeightLimitation *int32 `json:"heightLimitation,omitempty"`
	IsHatchBackMandatory *bool `json:"isHatchBackMandatory,omitempty"`
	IsWarehousemanMandatory *bool `json:"isWarehousemanMandatory,omitempty"`
	IsHandlingEquipmentMandatory *bool `json:"isHandlingEquipmentMandatory,omitempty"`
	IsSecuritySuitcaseMandatory *bool `json:"isSecuritySuitcaseMandatory,omitempty"`
	IsSideUnloading *bool `json:"isSideUnloading,omitempty"`
	IsCraneUnloading *bool `json:"isCraneUnloading,omitempty"`
	Geocoding *AddressGeocodingEditionDto `json:"geocoding,omitempty"`
	CityId *int32 `json:"cityId,omitempty"`
	// The emails are replaced when provided in the update. When not provided, the existing emails are kept unchanged.
	Emails []string `json:"emails,omitempty"`
	AdditionalContacts []UpdateAddressDtoUpdateAddressAdditionalContactDto `json:"additionalContacts,omitempty"`
	// Address openings are replaced when provided in the update. When not provided, the existing address openings are kept unchanged.
	AddressOpenings []UpdateAddressDtoUpdateAddressOpeningDto `json:"addressOpenings,omitempty"`
	// Forbidden vehicle type codes are replaced when provided in the update. When not provided, the existing forbidden vehicle types are kept unchanged.
	ForbiddenVehicleTypeCodes []string `json:"forbiddenVehicleTypeCodes,omitempty"`
}
...
// GetAlternativePhone returns the AlternativePhone field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetAlternativePhone() string {
	if o == nil || IsNil(o.AlternativePhone) {
		var ret string
		return ret
	}
	return *o.AlternativePhone
}

// GetAlternativePhoneOk returns a tuple with the AlternativePhone field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetAlternativePhoneOk() (*string, bool) {
	if o == nil || IsNil(o.AlternativePhone) {
		return nil, false
	}
	return o.AlternativePhone, true
}
...
// SetAlternativePhone gets a reference to the given string and assigns it to the AlternativePhone field.
func (o *UpdateAddressDto) SetAlternativePhone(v string) {
	o.AlternativePhone = &v
}
...
// GetAddressCategoryCode returns the AddressCategoryCode field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetAddressCategoryCode() string {
	if o == nil || IsNil(o.AddressCategoryCode) {
		var ret string
		return ret
	}
	return *o.AddressCategoryCode
}

// GetAddressCategoryCodeOk returns a tuple with the AddressCategoryCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetAddressCategoryCodeOk() (*string, bool) {
	if o == nil || IsNil(o.AddressCategoryCode) {
		return nil, false
	}
	return o.AddressCategoryCode, true
}
...
// SetAddressCategoryCode gets a reference to the given string and assigns it to the AddressCategoryCode field.
func (o *UpdateAddressDto) SetAddressCategoryCode(v string) {
	o.AddressCategoryCode = &v
}

// GetExternalAddressCode returns the ExternalAddressCode field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetExternalAddressCode() string {
	if o == nil || IsNil(o.ExternalAddressCode) {
		var ret string
		return ret
	}
	return *o.ExternalAddressCode
}

// GetExternalAddressCodeOk returns a tuple with the ExternalAddressCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetExternalAddressCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalAddressCode) {
		return nil, false
	}
	return o.ExternalAddressCode, true
}
...
// SetExternalAddressCode gets a reference to the given string and assigns it to the ExternalAddressCode field.
func (o *UpdateAddressDto) SetExternalAddressCode(v string) {
	o.ExternalAddressCode = &v
}
...
// GetStopDurationInSeconds returns the StopDurationInSeconds field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetStopDurationInSeconds() int32 {
	if o == nil || IsNil(o.StopDurationInSeconds) {
		var ret int32
		return ret
	}
	return *o.StopDurationInSeconds
}

// GetStopDurationInSecondsOk returns a tuple with the StopDurationInSeconds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetStopDurationInSecondsOk() (*int32, bool) {
	if o == nil || IsNil(o.StopDurationInSeconds) {
		return nil, false
	}
	return o.StopDurationInSeconds, true
}
...
// SetStopDurationInSeconds gets a reference to the given int32 and assigns it to the StopDurationInSeconds field.
func (o *UpdateAddressDto) SetStopDurationInSeconds(v int32) {
	o.StopDurationInSeconds = &v
}

// GetCircuitAddressSetId returns the CircuitAddressSetId field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetCircuitAddressSetId() int32 {
	if o == nil || IsNil(o.CircuitAddressSetId) {
		var ret int32
		return ret
	}
	return *o.CircuitAddressSetId
}

// GetCircuitAddressSetIdOk returns a tuple with the CircuitAddressSetId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetCircuitAddressSetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.CircuitAddressSetId) {
		return nil, false
	}
	return o.CircuitAddressSetId, true
}
...
// SetCircuitAddressSetId gets a reference to the given int32 and assigns it to the CircuitAddressSetId field.
func (o *UpdateAddressDto) SetCircuitAddressSetId(v int32) {
	o.CircuitAddressSetId = &v
}

// GetAddressComplement1 returns the AddressComplement1 field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetAddressComplement1() string {
	if o == nil || IsNil(o.AddressComplement1) {
		var ret string
		return ret
	}
	return *o.AddressComplement1
}

// GetAddressComplement1Ok returns a tuple with the AddressComplement1 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetAddressComplement1Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement1) {
		return nil, false
	}
	return o.AddressComplement1, true
}
...
// SetAddressComplement1 gets a reference to the given string and assigns it to the AddressComplement1 field.
func (o *UpdateAddressDto) SetAddressComplement1(v string) {
	o.AddressComplement1 = &v
}

// GetAddressComplement2 returns the AddressComplement2 field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetAddressComplement2() string {
	if o == nil || IsNil(o.AddressComplement2) {
		var ret string
		return ret
	}
	return *o.AddressComplement2
}

// GetAddressComplement2Ok returns a tuple with the AddressComplement2 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetAddressComplement2Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement2) {
		return nil, false
	}
	return o.AddressComplement2, true
}
...
// SetAddressComplement2 gets a reference to the given string and assigns it to the AddressComplement2 field.
func (o *UpdateAddressDto) SetAddressComplement2(v string) {
	o.AddressComplement2 = &v
}

// GetAddressComplement3 returns the AddressComplement3 field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetAddressComplement3() string {
	if o == nil || IsNil(o.AddressComplement3) {
		var ret string
		return ret
	}
	return *o.AddressComplement3
}

// GetAddressComplement3Ok returns a tuple with the AddressComplement3 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetAddressComplement3Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement3) {
		return nil, false
	}
	return o.AddressComplement3, true
}
...
// SetAddressComplement3 gets a reference to the given string and assigns it to the AddressComplement3 field.
func (o *UpdateAddressDto) SetAddressComplement3(v string) {
	o.AddressComplement3 = &v
}

// GetAddressComplement4 returns the AddressComplement4 field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetAddressComplement4() string {
	if o == nil || IsNil(o.AddressComplement4) {
		var ret string
		return ret
	}
	return *o.AddressComplement4
}

// GetAddressComplement4Ok returns a tuple with the AddressComplement4 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetAddressComplement4Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement4) {
		return nil, false
	}
	return o.AddressComplement4, true
}
...
// SetAddressComplement4 gets a reference to the given string and assigns it to the AddressComplement4 field.
func (o *UpdateAddressDto) SetAddressComplement4(v string) {
	o.AddressComplement4 = &v
}

// GetIsHeightRestrictedAccess returns the IsHeightRestrictedAccess field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetIsHeightRestrictedAccess() bool {
	if o == nil || IsNil(o.IsHeightRestrictedAccess) {
		var ret bool
		return ret
	}
	return *o.IsHeightRestrictedAccess
}

// GetIsHeightRestrictedAccessOk returns a tuple with the IsHeightRestrictedAccess field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetIsHeightRestrictedAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.IsHeightRestrictedAccess) {
		return nil, false
	}
	return o.IsHeightRestrictedAccess, true
}
...
// SetIsHeightRestrictedAccess gets a reference to the given bool and assigns it to the IsHeightRestrictedAccess field.
func (o *UpdateAddressDto) SetIsHeightRestrictedAccess(v bool) {
	o.IsHeightRestrictedAccess = &v
}

// GetHeightLimitation returns the HeightLimitation field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetHeightLimitation() int32 {
	if o == nil || IsNil(o.HeightLimitation) {
		var ret int32
		return ret
	}
	return *o.HeightLimitation
}

// GetHeightLimitationOk returns a tuple with the HeightLimitation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetHeightLimitationOk() (*int32, bool) {
	if o == nil || IsNil(o.HeightLimitation) {
		return nil, false
	}
	return o.HeightLimitation, true
}
...
// SetHeightLimitation gets a reference to the given int32 and assigns it to the HeightLimitation field.
func (o *UpdateAddressDto) SetHeightLimitation(v int32) {
	o.HeightLimitation = &v
}

// GetIsHatchBackMandatory returns the IsHatchBackMandatory field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetIsHatchBackMandatory() bool {
	if o == nil || IsNil(o.IsHatchBackMandatory) {
		var ret bool
		return ret
	}
	return *o.IsHatchBackMandatory
}

// GetIsHatchBackMandatoryOk returns a tuple with the IsHatchBackMandatory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetIsHatchBackMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsHatchBackMandatory) {
		return nil, false
	}
	return o.IsHatchBackMandatory, true
}
...
// SetIsHatchBackMandatory gets a reference to the given bool and assigns it to the IsHatchBackMandatory field.
func (o *UpdateAddressDto) SetIsHatchBackMandatory(v bool) {
	o.IsHatchBackMandatory = &v
}

// GetIsWarehousemanMandatory returns the IsWarehousemanMandatory field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetIsWarehousemanMandatory() bool {
	if o == nil || IsNil(o.IsWarehousemanMandatory) {
		var ret bool
		return ret
	}
	return *o.IsWarehousemanMandatory
}

// GetIsWarehousemanMandatoryOk returns a tuple with the IsWarehousemanMandatory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetIsWarehousemanMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsWarehousemanMandatory) {
		return nil, false
	}
	return o.IsWarehousemanMandatory, true
}
...
// SetIsWarehousemanMandatory gets a reference to the given bool and assigns it to the IsWarehousemanMandatory field.
func (o *UpdateAddressDto) SetIsWarehousemanMandatory(v bool) {
	o.IsWarehousemanMandatory = &v
}

// GetIsHandlingEquipmentMandatory returns the IsHandlingEquipmentMandatory field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetIsHandlingEquipmentMandatory() bool {
	if o == nil || IsNil(o.IsHandlingEquipmentMandatory) {
		var ret bool
		return ret
	}
	return *o.IsHandlingEquipmentMandatory
}

// GetIsHandlingEquipmentMandatoryOk returns a tuple with the IsHandlingEquipmentMandatory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetIsHandlingEquipmentMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsHandlingEquipmentMandatory) {
		return nil, false
	}
	return o.IsHandlingEquipmentMandatory, true
}
...
// SetIsHandlingEquipmentMandatory gets a reference to the given bool and assigns it to the IsHandlingEquipmentMandatory field.
func (o *UpdateAddressDto) SetIsHandlingEquipmentMandatory(v bool) {
	o.IsHandlingEquipmentMandatory = &v
}

// GetIsSecuritySuitcaseMandatory returns the IsSecuritySuitcaseMandatory field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetIsSecuritySuitcaseMandatory() bool {
	if o == nil || IsNil(o.IsSecuritySuitcaseMandatory) {
		var ret bool
		return ret
	}
	return *o.IsSecuritySuitcaseMandatory
}

// GetIsSecuritySuitcaseMandatoryOk returns a tuple with the IsSecuritySuitcaseMandatory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetIsSecuritySuitcaseMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSecuritySuitcaseMandatory) {
		return nil, false
	}
	return o.IsSecuritySuitcaseMandatory, true
}
...
// SetIsSecuritySuitcaseMandatory gets a reference to the given bool and assigns it to the IsSecuritySuitcaseMandatory field.
func (o *UpdateAddressDto) SetIsSecuritySuitcaseMandatory(v bool) {
	o.IsSecuritySuitcaseMandatory = &v
}

// GetIsSideUnloading returns the IsSideUnloading field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetIsSideUnloading() bool {
	if o == nil || IsNil(o.IsSideUnloading) {
		var ret bool
		return ret
	}
	return *o.IsSideUnloading
}

// GetIsSideUnloadingOk returns a tuple with the IsSideUnloading field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetIsSideUnloadingOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSideUnloading) {
		return nil, false
	}
	return o.IsSideUnloading, true
}
...
// SetIsSideUnloading gets a reference to the given bool and assigns it to the IsSideUnloading field.
func (o *UpdateAddressDto) SetIsSideUnloading(v bool) {
	o.IsSideUnloading = &v
}

// GetIsCraneUnloading returns the IsCraneUnloading field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetIsCraneUnloading() bool {
	if o == nil || IsNil(o.IsCraneUnloading) {
		var ret bool
		return ret
	}
	return *o.IsCraneUnloading
}

// GetIsCraneUnloadingOk returns a tuple with the IsCraneUnloading field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetIsCraneUnloadingOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCraneUnloading) {
		return nil, false
	}
	return o.IsCraneUnloading, true
}
...
// SetIsCraneUnloading gets a reference to the given bool and assigns it to the IsCraneUnloading field.
func (o *UpdateAddressDto) SetIsCraneUnloading(v bool) {
	o.IsCraneUnloading = &v
}

// GetGeocoding returns the Geocoding field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetGeocoding() AddressGeocodingEditionDto {
	if o == nil || IsNil(o.Geocoding) {
		var ret AddressGeocodingEditionDto
		return ret
	}
	return *o.Geocoding
}

// GetGeocodingOk returns a tuple with the Geocoding field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetGeocodingOk() (*AddressGeocodingEditionDto, bool) {
	if o == nil || IsNil(o.Geocoding) {
		return nil, false
	}
	return o.Geocoding, true
}
...
// SetGeocoding gets a reference to the given AddressGeocodingEditionDto and assigns it to the Geocoding field.
...
func (o *UpdateAddressDto) GetAdditionalContacts() []UpdateAddressDtoUpdateAddressAdditionalContactDto {
	if o == nil || IsNil(o.AdditionalContacts) {
		var ret []UpdateAddressDtoUpdateAddressAdditionalContactDto
		return ret
	}
...
// SetAdditionalContacts gets a reference to the given []UpdateAddressDtoUpdateAddressAdditionalContactDto and assigns it to the AdditionalContacts field.
func (o *UpdateAddressDto) SetAdditionalContacts(v []UpdateAddressDtoUpdateAddressAdditionalContactDto) {
	o.AdditionalContacts = v
}

// GetAddressOpenings returns the AddressOpenings field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetAddressOpenings() []UpdateAddressDtoUpdateAddressOpeningDto {
	if o == nil || IsNil(o.AddressOpenings) {
		var ret []UpdateAddressDtoUpdateAddressOpeningDto
		return ret
	}
	return o.AddressOpenings
}

// GetAddressOpeningsOk returns a tuple with the AddressOpenings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetAddressOpeningsOk() ([]UpdateAddressDtoUpdateAddressOpeningDto, bool) {
	if o == nil || IsNil(o.AddressOpenings) {
		return nil, false
	}
	return o.AddressOpenings, true
}
...
// SetAddressOpenings gets a reference to the given []UpdateAddressDtoUpdateAddressOpeningDto and assigns it to the AddressOpenings field.
func (o *UpdateAddressDto) SetAddressOpenings(v []UpdateAddressDtoUpdateAddressOpeningDto) {
	o.AddressOpenings = v
}

// GetForbiddenVehicleTypeCodes returns the ForbiddenVehicleTypeCodes field value if set, zero value otherwise.
func (o *UpdateAddressDto) GetForbiddenVehicleTypeCodes() []string {
	if o == nil || IsNil(o.ForbiddenVehicleTypeCodes) {
		var ret []string
		return ret
	}
	return o.ForbiddenVehicleTypeCodes
}

// GetForbiddenVehicleTypeCodesOk returns a tuple with the ForbiddenVehicleTypeCodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateAddressDto) GetForbiddenVehicleTypeCodesOk() ([]string, bool) {
	if o == nil || IsNil(o.ForbiddenVehicleTypeCodes) {
		return nil, false
	}
	return o.ForbiddenVehicleTypeCodes, true
}
...
// SetForbiddenVehicleTypeCodes gets a reference to the given []string and assigns it to the ForbiddenVehicleTypeCodes field.
func (o *UpdateAddressDto) SetForbiddenVehicleTypeCodes(v []string) {
	o.ForbiddenVehicleTypeCodes = v
}

func (o UpdateAddressDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateAddressDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AlternativePhone) {
		toSerialize["alternativePhone"] = o.AlternativePhone
	}
	...
	if !IsNil(o.AddressCategoryCode) {
		toSerialize["addressCategoryCode"] = o.AddressCategoryCode
	}
	if !IsNil(o.ExternalAddressCode) {
		toSerialize["externalAddressCode"] = o.ExternalAddressCode
	}
	if !IsNil(o.Notes) {
		toSerialize["notes"] = o.Notes
	}
	if !IsNil(o.StopDurationInSeconds) {
		toSerialize["stopDurationInSeconds"] = o.StopDurationInSeconds
	}
	if !IsNil(o.CircuitAddressSetId) {
		toSerialize["circuitAddressSetId"] = o.CircuitAddressSetId
	}
	if !IsNil(o.AddressComplement1) {
		toSerialize["addressComplement1"] = o.AddressComplement1
	}
	if !IsNil(o.AddressComplement2) {
		toSerialize["addressComplement2"] = o.AddressComplement2
	}
	if !IsNil(o.AddressComplement3) {
		toSerialize["addressComplement3"] = o.AddressComplement3
	}
	if !IsNil(o.AddressComplement4) {
		toSerialize["addressComplement4"] = o.AddressComplement4
	}
	if !IsNil(o.IsHeightRestrictedAccess) {
		toSerialize["isHeightRestrictedAccess"] = o.IsHeightRestrictedAccess
	}
	if !IsNil(o.HeightLimitation) {
		toSerialize["heightLimitation"] = o.HeightLimitation
	}
	if !IsNil(o.IsHatchBackMandatory) {
		toSerialize["isHatchBackMandatory"] = o.IsHatchBackMandatory
	}
	if !IsNil(o.IsWarehousemanMandatory) {
		toSerialize["isWarehousemanMandatory"] = o.IsWarehousemanMandatory
	}
	if !IsNil(o.IsHandlingEquipmentMandatory) {
		toSerialize["isHandlingEquipmentMandatory"] = o.IsHandlingEquipmentMandatory
	}
	if !IsNil(o.IsSecuritySuitcaseMandatory) {
		toSerialize["isSecuritySuitcaseMandatory"] = o.IsSecuritySuitcaseMandatory
	}
	if !IsNil(o.IsSideUnloading) {
		toSerialize["isSideUnloading"] = o.IsSideUnloading
	}
	if !IsNil(o.IsCraneUnloading) {
		toSerialize["isCraneUnloading"] = o.IsCraneUnloading
	}
	if !IsNil(o.Geocoding) {
		toSerialize["geocoding"] = o.Geocoding
	}
	if !IsNil(o.CityId) {
	...
	if !IsNil(o.AddressOpenings) {
		toSerialize["addressOpenings"] = o.AddressOpenings
	}
	if !IsNil(o.ForbiddenVehicleTypeCodes) {
		toSerialize["forbiddenVehicleTypeCodes"] = o.ForbiddenVehicleTypeCodes
	}
	return toSerialize, nil
}

type NullableUpdateAddressDto struct {
	value *UpdateAddressDto
	isSet bool
}

func (v NullableUpdateAddressDto) Get() *UpdateAddressDto {
	return v.value
}

func (v *NullableUpdateAddressDto) Set(val *UpdateAddressDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateAddressDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAddressDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAddressDto(val *UpdateAddressDto) *NullableUpdateAddressDto {
	return &NullableUpdateAddressDto{value: val, isSet: true}
}

func (v NullableUpdateAddressDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateAddressDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
