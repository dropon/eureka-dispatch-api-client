...
type ApiGetMyAccountInformationRequest struct {
	ctx context.Context
	ApiService *MeAPIService
}

func (r ApiGetMyAccountInformationRequest) Execute() (*MyAccountInfoDto, *http.Response, error) {
	return r.ApiService.GetMyAccountInformationExecute(r)
}

/*
GetMyAccountInformation Get my account information

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMyAccountInformationRequest
*/
func (a *MeAPIService) GetMyAccountInformation(ctx context.Context) ApiGetMyAccountInformationRequest {
	return ApiGetMyAccountInformationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MeAPIService) GetMyAccountInformationExecute(r ApiGetMyAccountInformationRequest) (*MyAccountInfoDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MyAccountInfoDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MeAPIService.GetMyAccountInformation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/me"
...
type ApiGetOauthAuthorizationUrlRequest struct {
	ctx context.Context
	ApiService *MeAPIService
	redirectUri *string
	ssoCode *string
...
func (r ApiGetOauthAuthorizationUrlRequest) RedirectUri(redirectUri string) ApiGetOauthAuthorizationUrlRequest {
	r.redirectUri = &redirectUri
	return r
}

func (r ApiGetOauthAuthorizationUrlRequest) SsoCode(ssoCode string) ApiGetOauthAuthorizationUrlRequest {
	r.ssoCode = &ssoCode
	return r
}

func (r ApiGetOauthAuthorizationUrlRequest) State(state string) ApiGetOauthAuthorizationUrlRequest {
	r.state = &state
	return r
}

func (r ApiGetOauthAuthorizationUrlRequest) Scope(scope string) ApiGetOauthAuthorizationUrlRequest {
	r.scope = &scope
	return r
}

func (r ApiGetOauthAuthorizationUrlRequest) Execute() (*GetSsoAuthorizationUrlResultDto, *http.Response, error) {
	return r.ApiService.GetOauthAuthorizationUrlExecute(r)
}

/*
GetOauthAuthorizationUrl Get oauth authorization url

Get the SSO authorization url to be called to get authorization code for oauth protocol.  
This operation is allowed for the following role: Application.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetOauthAuthorizationUrlRequest
*/
func (a *MeAPIService) GetOauthAuthorizationUrl(ctx context.Context) ApiGetOauthAuthorizationUrlRequest {
	return ApiGetOauthAuthorizationUrlRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetSsoAuthorizationUrlResultDto
func (a *MeAPIService) GetOauthAuthorizationUrlExecute(r ApiGetOauthAuthorizationUrlRequest) (*GetSsoAuthorizationUrlResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSsoAuthorizationUrlResultDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MeAPIService.GetOauthAuthorizationUrl")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/sso/oauth-authorization-url"
	...
	if r.ssoCode == nil {
		return localVarReturnValue, nil, reportError("ssoCode is required and must be specified")
	}
	if r.state == nil {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "ssoCode", r.ssoCode, "", "")
...
type ApiGetSAMLAuthorizationUrlRequest struct {
	ctx context.Context
	ApiService *MeAPIService
	ssoCode *string
	relayState *string
...
func (r ApiGetSAMLAuthorizationUrlRequest) SsoCode(ssoCode string) ApiGetSAMLAuthorizationUrlRequest {
	r.ssoCode = &ssoCode
	return r
}

func (r ApiGetSAMLAuthorizationUrlRequest) RelayState(relayState string) ApiGetSAMLAuthorizationUrlRequest {
	r.relayState = &relayState
	return r
}

func (r ApiGetSAMLAuthorizationUrlRequest) AssertionConsumerServiceUrl(assertionConsumerServiceUrl string) ApiGetSAMLAuthorizationUrlRequest {
	r.assertionConsumerServiceUrl = &assertionConsumerServiceUrl
	return r
}

func (r ApiGetSAMLAuthorizationUrlRequest) Execute() (*GetSsoAuthorizationUrlResultDto, *http.Response, error) {
	return r.ApiService.GetSAMLAuthorizationUrlExecute(r)
}

/*
GetSAMLAuthorizationUrl Get SAML authorization url

Get the SSO authorization url to be called to authenticate using SAML protocol.  
This operation is allowed for the following role: Application.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSAMLAuthorizationUrlRequest
*/
func (a *MeAPIService) GetSAMLAuthorizationUrl(ctx context.Context) ApiGetSAMLAuthorizationUrlRequest {
	return ApiGetSAMLAuthorizationUrlRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetSsoAuthorizationUrlResultDto
func (a *MeAPIService) GetSAMLAuthorizationUrlExecute(r ApiGetSAMLAuthorizationUrlRequest) (*GetSsoAuthorizationUrlResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MeAPIService.GetSAMLAuthorizationUrl")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/sso/saml-authorization-url"
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "ssoCode", r.ssoCode, "", "")
	if r.relayState != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "relayState", r.relayState, "", "")
	}
	if r.assertionConsumerServiceUrl != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "assertionConsumerServiceUrl", r.assertionConsumerServiceUrl, "", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
