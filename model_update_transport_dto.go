...
// checks if the UpdateTransportDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTransportDto{}

// UpdateTransportDto struct for UpdateTransportDto
type UpdateTransportDto struct {
	ApiBehavior *UpdateTransportDtoApiBehaviorDto `json:"apiBehavior,omitempty"`
	...
	PickupStep *UpdateTransportBaseDtoStepDto `json:"pickupStep,omitempty"`
	DeliveryStep *UpdateTransportBaseDtoStepDto `json:"deliveryStep,omitempty"`
	ServiceCode *string `json:"serviceCode,omitempty"`
	// When the service is updated, this collection must be filled like for the creation :  Keep the collection empty to use service's default sub services,  or provide the full collection of sub services with merge action 'add'.
	SubServices []UpdateTransportBaseDtoSubServiceDto `json:"subServices,omitempty"`
	Packing *UpdateTransportBaseDtoPackingDto `json:"packing,omitempty"`
	CustomerCustomParameters []UpdateTransportBaseDtoCustomParameterDto `json:"customerCustomParameters,omitempty"`
	ServiceCustomParameters []UpdateTransportBaseDtoCustomParameterDto `json:"serviceCustomParameters,omitempty"`
	DangerousGoods []UpdateTransportBaseDtoDangerousGoodDto `json:"dangerousGoods,omitempty"`
	...
	// Gas emission is updated only if is gas emission forced is set
	...
	Comment *UpdateTransportBaseDtoCommentDto `json:"comment,omitempty"`
	TransportBillAddress *UpdateTransportBaseDtoTransportBillAddressDto `json:"transportBillAddress,omitempty"`
	CashOnDelivery *UpdateTransportBaseDtoCashOnDeliveryDto `json:"cashOnDelivery,omitempty"`
...
// GetApiBehavior returns the ApiBehavior field value if set, zero value otherwise.
func (o *UpdateTransportDto) GetApiBehavior() UpdateTransportDtoApiBehaviorDto {
	if o == nil || IsNil(o.ApiBehavior) {
		var ret UpdateTransportDtoApiBehaviorDto
		return ret
	}
	return *o.ApiBehavior
}

// GetApiBehaviorOk returns a tuple with the ApiBehavior field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportDto) GetApiBehaviorOk() (*UpdateTransportDtoApiBehaviorDto, bool) {
	if o == nil || IsNil(o.ApiBehavior) {
		return nil, false
	}
	return o.ApiBehavior, true
}
...
// SetApiBehavior gets a reference to the given UpdateTransportDtoApiBehaviorDto and assigns it to the ApiBehavior field.
...
func (o *UpdateTransportDto) GetPickupStep() UpdateTransportBaseDtoStepDto {
	if o == nil || IsNil(o.PickupStep) {
		var ret UpdateTransportBaseDtoStepDto
		return ret
	}
	return *o.PickupStep
}
...
// SetPickupStep gets a reference to the given UpdateTransportBaseDtoStepDto and assigns it to the PickupStep field.
...
// SetDeliveryStep gets a reference to the given UpdateTransportBaseDtoStepDto and assigns it to the DeliveryStep field.
...
func (o *UpdateTransportDto) GetSubServices() []UpdateTransportBaseDtoSubServiceDto {
	if o == nil || IsNil(o.SubServices) {
		var ret []UpdateTransportBaseDtoSubServiceDto
		return ret
	}
...
// SetSubServices gets a reference to the given []UpdateTransportBaseDtoSubServiceDto and assigns it to the SubServices field.
...
func (o *UpdateTransportDto) GetPacking() UpdateTransportBaseDtoPackingDto {
	if o == nil || IsNil(o.Packing) {
		var ret UpdateTransportBaseDtoPackingDto
		return ret
	}
	return *o.Packing
}
...
// SetPacking gets a reference to the given UpdateTransportBaseDtoPackingDto and assigns it to the Packing field.
...
func (o *UpdateTransportDto) GetCustomerCustomParameters() []UpdateTransportBaseDtoCustomParameterDto {
	if o == nil || IsNil(o.CustomerCustomParameters) {
		var ret []UpdateTransportBaseDtoCustomParameterDto
		return ret
	}
...
// SetCustomerCustomParameters gets a reference to the given []UpdateTransportBaseDtoCustomParameterDto and assigns it to the CustomerCustomParameters field.
...
// SetServiceCustomParameters gets a reference to the given []UpdateTransportBaseDtoCustomParameterDto and assigns it to the ServiceCustomParameters field.
...
func (o *UpdateTransportDto) GetDangerousGoods() []UpdateTransportBaseDtoDangerousGoodDto {
	if o == nil || IsNil(o.DangerousGoods) {
		var ret []UpdateTransportBaseDtoDangerousGoodDto
		return ret
	}
...
// SetDangerousGoods gets a reference to the given []UpdateTransportBaseDtoDangerousGoodDto and assigns it to the DangerousGoods field.
...
func (o *UpdateTransportDto) GetComment() UpdateTransportBaseDtoCommentDto {
	if o == nil || IsNil(o.Comment) {
		var ret UpdateTransportBaseDtoCommentDto
		return ret
	}
	return *o.Comment
}
...
// SetComment gets a reference to the given UpdateTransportBaseDtoCommentDto and assigns it to the Comment field.
...
func (o *UpdateTransportDto) GetTransportBillAddress() UpdateTransportBaseDtoTransportBillAddressDto {
	if o == nil || IsNil(o.TransportBillAddress) {
		var ret UpdateTransportBaseDtoTransportBillAddressDto
		return ret
	}
...
// SetTransportBillAddress gets a reference to the given UpdateTransportBaseDtoTransportBillAddressDto and assigns it to the TransportBillAddress field.
...
func (o *UpdateTransportDto) GetCashOnDelivery() UpdateTransportBaseDtoCashOnDeliveryDto {
	if o == nil || IsNil(o.CashOnDelivery) {
		var ret UpdateTransportBaseDtoCashOnDeliveryDto
		return ret
	}
...
// SetCashOnDelivery gets a reference to the given UpdateTransportBaseDtoCashOnDeliveryDto and assigns it to the CashOnDelivery field.
...
func (o UpdateTransportDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateTransportDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ApiBehavior) {
		toSerialize["apiBehavior"] = o.ApiBehavior
	}
...
type NullableUpdateTransportDto struct {
	value *UpdateTransportDto
	isSet bool
}

func (v NullableUpdateTransportDto) Get() *UpdateTransportDto {
	return v.value
}

func (v *NullableUpdateTransportDto) Set(val *UpdateTransportDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateTransportDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateTransportDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateTransportDto(val *UpdateTransportDto) *NullableUpdateTransportDto {
	return &NullableUpdateTransportDto{value: val, isSet: true}
}

func (v NullableUpdateTransportDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateTransportDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
