...
type AddressDto struct {
	...
	Geocoding *GeocodingDto `json:"geocoding,omitempty"`
	City *CityDto `json:"city,omitempty"`
	Emails []string `json:"emails,omitempty"`
	Included *AddressIncludedDto `json:"included,omitempty"`
	AdditionalContacts *CappedCollectionDtoAddressContactDto `json:"additionalContacts,omitempty"`
	AddressOpenings *CollectionDtoAddressOpeningDto `json:"addressOpenings,omitempty"`
	ForbiddenVehicleTypes *CappedCollectionDtoAddressVehicleTypeDto `json:"forbiddenVehicleTypes,omitempty"`
}
...
// SetGeocoding gets a reference to the given GeocodingDto and assigns it to the Geocoding field.
...
// SetCity gets a reference to the given CityDto and assigns it to the City field.
...
// SetIncluded gets a reference to the given AddressIncludedDto and assigns it to the Included field.
...
func (o *AddressDto) GetAdditionalContacts() CappedCollectionDtoAddressContactDto {
	if o == nil || IsNil(o.AdditionalContacts) {
		var ret CappedCollectionDtoAddressContactDto
		return ret
	}
...
// SetAdditionalContacts gets a reference to the given CappedCollectionDtoAddressContactDto and assigns it to the AdditionalContacts field.
...
func (o *AddressDto) GetAddressOpenings() CollectionDtoAddressOpeningDto {
	if o == nil || IsNil(o.AddressOpenings) {
		var ret CollectionDtoAddressOpeningDto
		return ret
	}
...
// SetAddressOpenings gets a reference to the given CollectionDtoAddressOpeningDto and assigns it to the AddressOpenings field.
func (o *AddressDto) SetAddressOpenings(v CollectionDtoAddressOpeningDto) {
	o.AddressOpenings = &v
}

// GetForbiddenVehicleTypes returns the ForbiddenVehicleTypes field value if set, zero value otherwise.
func (o *AddressDto) GetForbiddenVehicleTypes() CappedCollectionDtoAddressVehicleTypeDto {
	if o == nil || IsNil(o.ForbiddenVehicleTypes) {
		var ret CappedCollectionDtoAddressVehicleTypeDto
		return ret
	}
	return *o.ForbiddenVehicleTypes
}

// GetForbiddenVehicleTypesOk returns a tuple with the ForbiddenVehicleTypes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AddressDto) GetForbiddenVehicleTypesOk() (*CappedCollectionDtoAddressVehicleTypeDto, bool) {
	if o == nil || IsNil(o.ForbiddenVehicleTypes) {
		return nil, false
	}
	return o.ForbiddenVehicleTypes, true
}
...
// SetForbiddenVehicleTypes gets a reference to the given CappedCollectionDtoAddressVehicleTypeDto and assigns it to the ForbiddenVehicleTypes field.
func (o *AddressDto) SetForbiddenVehicleTypes(v CappedCollectionDtoAddressVehicleTypeDto) {
	o.ForbiddenVehicleTypes = &v
}
...
func (o AddressDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ForbiddenVehicleTypes) {
		toSerialize["forbiddenVehicleTypes"] = o.ForbiddenVehicleTypes
	}
