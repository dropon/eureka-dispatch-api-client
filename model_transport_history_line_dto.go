...
var _ MappedNullable = &TransportHistoryLineDto{}
...
// GetTransportHistoryLineId returns the TransportHistoryLineId field value if set, zero value otherwise.
func (o *TransportHistoryLineDto) GetTransportHistoryLineId() int32 {
	if o == nil || IsNil(o.TransportHistoryLineId) {
		var ret int32
		return ret
	}
	return *o.TransportHistoryLineId
}

// GetTransportHistoryLineIdOk returns a tuple with the TransportHistoryLineId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportHistoryLineDto) GetTransportHistoryLineIdOk() (*int32, bool) {
	if o == nil || IsNil(o.TransportHistoryLineId) {
		return nil, false
	}
	return o.TransportHistoryLineId, true
}
...
// SetTransportHistoryLineId gets a reference to the given int32 and assigns it to the TransportHistoryLineId field.
func (o *TransportHistoryLineDto) SetTransportHistoryLineId(v int32) {
	o.TransportHistoryLineId = &v
}
...
func (o *TransportHistoryLineDto) GetInsertionDateTimeOk() (*Time, bool) {
	...
	return o.InsertionDateTime, true
}
...
// GetTransportState returns the TransportState field value if set, zero value otherwise.
func (o *TransportHistoryLineDto) GetTransportState() string {
	if o == nil || IsNil(o.TransportState) {
		var ret string
		return ret
	}
	return *o.TransportState
}

// GetTransportStateOk returns a tuple with the TransportState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportHistoryLineDto) GetTransportStateOk() (*string, bool) {
	if o == nil || IsNil(o.TransportState) {
		return nil, false
	}
	return o.TransportState, true
}
...
// SetTransportState gets a reference to the given string and assigns it to the TransportState field.
...
// GetLatitudeLocation returns the LatitudeLocation field value if set, zero value otherwise.
func (o *TransportHistoryLineDto) GetLatitudeLocation() float64 {
	if o == nil || IsNil(o.LatitudeLocation) {
		var ret float64
		return ret
	}
	return *o.LatitudeLocation
}

// GetLatitudeLocationOk returns a tuple with the LatitudeLocation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportHistoryLineDto) GetLatitudeLocationOk() (*float64, bool) {
	if o == nil || IsNil(o.LatitudeLocation) {
		return nil, false
	}
	return o.LatitudeLocation, true
}
...
// SetLatitudeLocation gets a reference to the given float64 and assigns it to the LatitudeLocation field.
func (o *TransportHistoryLineDto) SetLatitudeLocation(v float64) {
	o.LatitudeLocation = &v
}

// GetLongitudeLocation returns the LongitudeLocation field value if set, zero value otherwise.
func (o *TransportHistoryLineDto) GetLongitudeLocation() float64 {
	if o == nil || IsNil(o.LongitudeLocation) {
		var ret float64
		return ret
	}
	return *o.LongitudeLocation
}

// GetLongitudeLocationOk returns a tuple with the LongitudeLocation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportHistoryLineDto) GetLongitudeLocationOk() (*float64, bool) {
	if o == nil || IsNil(o.LongitudeLocation) {
		return nil, false
	}
	return o.LongitudeLocation, true
}
...
// SetLongitudeLocation gets a reference to the given float64 and assigns it to the LongitudeLocation field.
func (o *TransportHistoryLineDto) SetLongitudeLocation(v float64) {
	o.LongitudeLocation = &v
}
...
func (o *TransportHistoryLineDto) GetLocationDateTimeOk() (*Time, bool) {
	...
	return o.LocationDateTime, true
}
...
func (o *TransportHistoryLineDto) GetAnomalies() CappedCollectionDtoTransportHistoryAnomalyDto {
	if o == nil || IsNil(o.Anomalies) {
		var ret CappedCollectionDtoTransportHistoryAnomalyDto
		return ret
	}
	return *o.Anomalies
}
...
// SetAnomalies gets a reference to the given CappedCollectionDtoTransportHistoryAnomalyDto and assigns it to the Anomalies field.
func (o *TransportHistoryLineDto) SetAnomalies(v CappedCollectionDtoTransportHistoryAnomalyDto) {
	o.Anomalies = &v
}

func (o TransportHistoryLineDto) MarshalJSON() ([]byte, error) {
...
func (o TransportHistoryLineDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TransportHistoryLineId) {
		toSerialize["transportHistoryLineId"] = o.TransportHistoryLineId
	}
	if !IsNil(o.InsertionDateTime) {
		toSerialize["insertionDateTime"] = o.InsertionDateTime
	}
	if !IsNil(o.ActionDateTime) {
		toSerialize["actionDateTime"] = o.ActionDateTime
	}
	if !IsNil(o.TransportState) {
		toSerialize["transportState"] = o.TransportState
	}
	...
	if !IsNil(o.LatitudeLocation) {
		toSerialize["latitudeLocation"] = o.LatitudeLocation
	}
	if !IsNil(o.LongitudeLocation) {
		toSerialize["longitudeLocation"] = o.LongitudeLocation
	}
	if !IsNil(o.LocationDateTime) {
		toSerialize["locationDateTime"] = o.LocationDateTime
	}
...
type NullableTransportHistoryLineDto struct {
	value *TransportHistoryLineDto
	isSet bool
}

func (v NullableTransportHistoryLineDto) Get() *TransportHistoryLineDto {
	return v.value
}

func (v *NullableTransportHistoryLineDto) Set(val *TransportHistoryLineDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportHistoryLineDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportHistoryLineDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportHistoryLineDto(val *TransportHistoryLineDto) *NullableTransportHistoryLineDto {
	return &NullableTransportHistoryLineDto{value: val, isSet: true}
}

func (v NullableTransportHistoryLineDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportHistoryLineDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
