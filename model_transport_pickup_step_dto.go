...
// checks if the TransportPickupStepDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportPickupStepDto{}

// TransportPickupStepDto struct for TransportPickupStepDto
type TransportPickupStepDto struct {
	StepDate *TransportPickupDateTimeSlotDto `json:"stepDate,omitempty"`
...
func (o *TransportPickupStepDto) GetStepDate() TransportPickupDateTimeSlotDto {
	if o == nil || IsNil(o.StepDate) {
		var ret TransportPickupDateTimeSlotDto
		return ret
	}
	return *o.StepDate
}
...
// SetStepDate gets a reference to the given TransportPickupDateTimeSlotDto and assigns it to the StepDate field.
...
func (o TransportPickupStepDto) MarshalJSON() ([]byte, error) {
...
func (o TransportPickupStepDto) ToMap() (map[string]interface{}, error) {
...
type NullableTransportPickupStepDto struct {
	value *TransportPickupStepDto
	isSet bool
}

func (v NullableTransportPickupStepDto) Get() *TransportPickupStepDto {
	return v.value
}

func (v *NullableTransportPickupStepDto) Set(val *TransportPickupStepDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportPickupStepDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportPickupStepDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportPickupStepDto(val *TransportPickupStepDto) *NullableTransportPickupStepDto {
	return &NullableTransportPickupStepDto{value: val, isSet: true}
}

func (v NullableTransportPickupStepDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportPickupStepDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
