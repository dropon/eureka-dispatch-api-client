...
// checks if the UpdateTransportBaseDtoDangerousGoodDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTransportBaseDtoDangerousGoodDto{}

// UpdateTransportBaseDtoDangerousGoodDto struct for UpdateTransportBaseDtoDangerousGoodDto
type UpdateTransportBaseDtoDangerousGoodDto struct {
	// Merge action to perform : add, update, remove.
	MergeAction *string `json:"mergeAction,omitempty"`
	// This property is an entity identifier.
	Uid *string `json:"uid,omitempty"`
	UnNumber *string `json:"unNumber,omitempty"`
	Designation *string `json:"designation,omitempty"`
	IataDesignation *string `json:"iataDesignation,omitempty"`
	PackagingQuantity *int32 `json:"packagingQuantity,omitempty"`
	PackageNumber *int32 `json:"packageNumber,omitempty"`
	PackagingDescription *string `json:"packagingDescription,omitempty"`
	PackagingGroup *string `json:"packagingGroup,omitempty"`
	Class *string `json:"class,omitempty"`
	Label1 *string `json:"label1,omitempty"`
	Label2 *string `json:"label2,omitempty"`
	Label3 *string `json:"label3,omitempty"`
	NetWeightKg *float64 `json:"netWeightKg,omitempty"`
	NetVolumeL *float64 `json:"netVolumeL,omitempty"`
	GrossWeightKg *int32 `json:"grossWeightKg,omitempty"`
	TunnelCode *string `json:"tunnelCode,omitempty"`
}

// NewUpdateTransportBaseDtoDangerousGoodDto instantiates a new UpdateTransportBaseDtoDangerousGoodDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateTransportBaseDtoDangerousGoodDto() *UpdateTransportBaseDtoDangerousGoodDto {
	this := UpdateTransportBaseDtoDangerousGoodDto{}
	return &this
}

// NewUpdateTransportBaseDtoDangerousGoodDtoWithDefaults instantiates a new UpdateTransportBaseDtoDangerousGoodDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdateTransportBaseDtoDangerousGoodDtoWithDefaults() *UpdateTransportBaseDtoDangerousGoodDto {
	this := UpdateTransportBaseDtoDangerousGoodDto{}
	return &this
}

// GetMergeAction returns the MergeAction field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetMergeAction() string {
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetMergeActionOk() (*string, bool) {
	if o == nil || IsNil(o.MergeAction) {
		return nil, false
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasMergeAction() bool {
	if o != nil && !IsNil(o.MergeAction) {
		return true
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetMergeAction(v string) {
	o.MergeAction = &v
}

// GetUid returns the Uid field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetUid() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetUidOk() (*string, bool) {
	if o == nil || IsNil(o.Uid) {
		return nil, false
	}
	return o.Uid, true
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasUid() bool {
	if o != nil && !IsNil(o.Uid) {
		return true
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetUid(v string) {
	o.Uid = &v
}

// GetUnNumber returns the UnNumber field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetUnNumber() string {
	if o == nil || IsNil(o.UnNumber) {
		var ret string
		return ret
	}
	return *o.UnNumber
...
// GetUnNumberOk returns a tuple with the UnNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetUnNumberOk() (*string, bool) {
	if o == nil || IsNil(o.UnNumber) {
		return nil, false
	}
	return o.UnNumber, true
}

// HasUnNumber returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasUnNumber() bool {
	if o != nil && !IsNil(o.UnNumber) {
		return true
	}
...
// SetUnNumber gets a reference to the given string and assigns it to the UnNumber field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetUnNumber(v string) {
	o.UnNumber = &v
}

// GetDesignation returns the Designation field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetDesignation() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetDesignationOk() (*string, bool) {
	if o == nil || IsNil(o.Designation) {
		return nil, false
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasDesignation() bool {
	if o != nil && !IsNil(o.Designation) {
		return true
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetDesignation(v string) {
	o.Designation = &v
}

// GetIataDesignation returns the IataDesignation field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetIataDesignation() string {
	if o == nil || IsNil(o.IataDesignation) {
		var ret string
		return ret
	}
	return *o.IataDesignation
}

// GetIataDesignationOk returns a tuple with the IataDesignation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetIataDesignationOk() (*string, bool) {
	if o == nil || IsNil(o.IataDesignation) {
		return nil, false
	}
	return o.IataDesignation, true
}

// HasIataDesignation returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasIataDesignation() bool {
	if o != nil && !IsNil(o.IataDesignation) {
		return true
	}
...
// SetIataDesignation gets a reference to the given string and assigns it to the IataDesignation field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetIataDesignation(v string) {
	o.IataDesignation = &v
}

// GetPackagingQuantity returns the PackagingQuantity field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackagingQuantity() int32 {
	if o == nil || IsNil(o.PackagingQuantity) {
		var ret int32
		return ret
	}
	return *o.PackagingQuantity
}

// GetPackagingQuantityOk returns a tuple with the PackagingQuantity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackagingQuantityOk() (*int32, bool) {
	if o == nil || IsNil(o.PackagingQuantity) {
		return nil, false
	}
	return o.PackagingQuantity, true
}

// HasPackagingQuantity returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasPackagingQuantity() bool {
	if o != nil && !IsNil(o.PackagingQuantity) {
		return true
	}
...
// SetPackagingQuantity gets a reference to the given int32 and assigns it to the PackagingQuantity field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetPackagingQuantity(v int32) {
	o.PackagingQuantity = &v
}

// GetPackageNumber returns the PackageNumber field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackageNumber() int32 {
...
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackageNumberOk() (*int32, bool) {
	if o == nil || IsNil(o.PackageNumber) {
		return nil, false
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasPackageNumber() bool {
	if o != nil && !IsNil(o.PackageNumber) {
		return true
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetPackageNumber(v int32) {
	o.PackageNumber = &v
}

// GetPackagingDescription returns the PackagingDescription field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackagingDescription() string {
	if o == nil || IsNil(o.PackagingDescription) {
		var ret string
		return ret
	}
	return *o.PackagingDescription
}

// GetPackagingDescriptionOk returns a tuple with the PackagingDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackagingDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.PackagingDescription) {
		return nil, false
	}
	return o.PackagingDescription, true
}

// HasPackagingDescription returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasPackagingDescription() bool {
	if o != nil && !IsNil(o.PackagingDescription) {
		return true
	}
...
// SetPackagingDescription gets a reference to the given string and assigns it to the PackagingDescription field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetPackagingDescription(v string) {
	o.PackagingDescription = &v
}

// GetPackagingGroup returns the PackagingGroup field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackagingGroup() string {
	if o == nil || IsNil(o.PackagingGroup) {
		var ret string
		return ret
	}
	return *o.PackagingGroup
}

// GetPackagingGroupOk returns a tuple with the PackagingGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetPackagingGroupOk() (*string, bool) {
	if o == nil || IsNil(o.PackagingGroup) {
		return nil, false
	}
	return o.PackagingGroup, true
}

// HasPackagingGroup returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasPackagingGroup() bool {
	if o != nil && !IsNil(o.PackagingGroup) {
		return true
	}
...
// SetPackagingGroup gets a reference to the given string and assigns it to the PackagingGroup field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetPackagingGroup(v string) {
	o.PackagingGroup = &v
}

// GetClass returns the Class field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetClass() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetClassOk() (*string, bool) {
	if o == nil || IsNil(o.Class) {
		return nil, false
	}
	return o.Class, true
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasClass() bool {
	if o != nil && !IsNil(o.Class) {
		return true
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetClass(v string) {
	o.Class = &v
}

// GetLabel1 returns the Label1 field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetLabel1() string {
	if o == nil || IsNil(o.Label1) {
		var ret string
		return ret
	}
	return *o.Label1
...
// GetLabel1Ok returns a tuple with the Label1 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetLabel1Ok() (*string, bool) {
	if o == nil || IsNil(o.Label1) {
		return nil, false
	}
	return o.Label1, true
}

// HasLabel1 returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasLabel1() bool {
	if o != nil && !IsNil(o.Label1) {
		return true
	}
...
// SetLabel1 gets a reference to the given string and assigns it to the Label1 field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetLabel1(v string) {
	o.Label1 = &v
}

// GetLabel2 returns the Label2 field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetLabel2() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetLabel2Ok() (*string, bool) {
	if o == nil || IsNil(o.Label2) {
		return nil, false
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasLabel2() bool {
	if o != nil && !IsNil(o.Label2) {
		return true
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetLabel2(v string) {
	o.Label2 = &v
}

// GetLabel3 returns the Label3 field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetLabel3() string {
	if o == nil || IsNil(o.Label3) {
		var ret string
		return ret
	}
	return *o.Label3
...
// GetLabel3Ok returns a tuple with the Label3 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetLabel3Ok() (*string, bool) {
	if o == nil || IsNil(o.Label3) {
		return nil, false
	}
	return o.Label3, true
}

// HasLabel3 returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasLabel3() bool {
	if o != nil && !IsNil(o.Label3) {
		return true
	}
...
// SetLabel3 gets a reference to the given string and assigns it to the Label3 field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetLabel3(v string) {
	o.Label3 = &v
}

// GetNetWeightKg returns the NetWeightKg field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetNetWeightKg() float64 {
...
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetNetWeightKgOk() (*float64, bool) {
	if o == nil || IsNil(o.NetWeightKg) {
		return nil, false
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasNetWeightKg() bool {
	if o != nil && !IsNil(o.NetWeightKg) {
		return true
	}
...
// SetNetWeightKg gets a reference to the given float64 and assigns it to the NetWeightKg field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetNetWeightKg(v float64) {
	o.NetWeightKg = &v
}

// GetNetVolumeL returns the NetVolumeL field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetNetVolumeL() float64 {
	if o == nil || IsNil(o.NetVolumeL) {
		var ret float64
		return ret
	}
	return *o.NetVolumeL
...
// GetNetVolumeLOk returns a tuple with the NetVolumeL field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetNetVolumeLOk() (*float64, bool) {
	if o == nil || IsNil(o.NetVolumeL) {
		return nil, false
	}
	return o.NetVolumeL, true
}

// HasNetVolumeL returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasNetVolumeL() bool {
	if o != nil && !IsNil(o.NetVolumeL) {
		return true
	}
...
// SetNetVolumeL gets a reference to the given float64 and assigns it to the NetVolumeL field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetNetVolumeL(v float64) {
	o.NetVolumeL = &v
}

// GetGrossWeightKg returns the GrossWeightKg field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetGrossWeightKg() int32 {
...
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetGrossWeightKgOk() (*int32, bool) {
	if o == nil || IsNil(o.GrossWeightKg) {
		return nil, false
	}
...
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasGrossWeightKg() bool {
	if o != nil && !IsNil(o.GrossWeightKg) {
		return true
	}
...
// SetGrossWeightKg gets a reference to the given int32 and assigns it to the GrossWeightKg field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetGrossWeightKg(v int32) {
	o.GrossWeightKg = &v
}

// GetTunnelCode returns the TunnelCode field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetTunnelCode() string {
	if o == nil || IsNil(o.TunnelCode) {
		var ret string
		return ret
	}
	return *o.TunnelCode
...
// GetTunnelCodeOk returns a tuple with the TunnelCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) GetTunnelCodeOk() (*string, bool) {
	if o == nil || IsNil(o.TunnelCode) {
		return nil, false
	}
	return o.TunnelCode, true
}

// HasTunnelCode returns a boolean if a field has been set.
func (o *UpdateTransportBaseDtoDangerousGoodDto) HasTunnelCode() bool {
	if o != nil && !IsNil(o.TunnelCode) {
		return true
	}
...
// SetTunnelCode gets a reference to the given string and assigns it to the TunnelCode field.
func (o *UpdateTransportBaseDtoDangerousGoodDto) SetTunnelCode(v string) {
	o.TunnelCode = &v
}

func (o UpdateTransportBaseDtoDangerousGoodDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateTransportBaseDtoDangerousGoodDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UnNumber) {
		toSerialize["unNumber"] = o.UnNumber
	}
	if !IsNil(o.Designation) {
		toSerialize["designation"] = o.Designation
	}
	if !IsNil(o.IataDesignation) {
		toSerialize["iataDesignation"] = o.IataDesignation
	}
	if !IsNil(o.PackagingQuantity) {
		toSerialize["packagingQuantity"] = o.PackagingQuantity
	}
	if !IsNil(o.PackageNumber) {
		toSerialize["packageNumber"] = o.PackageNumber
	}
	if !IsNil(o.PackagingDescription) {
		toSerialize["packagingDescription"] = o.PackagingDescription
	}
	if !IsNil(o.PackagingGroup) {
		toSerialize["packagingGroup"] = o.PackagingGroup
	}
	if !IsNil(o.Class) {
		toSerialize["class"] = o.Class
	}
	if !IsNil(o.Label1) {
		toSerialize["label1"] = o.Label1
	}
	if !IsNil(o.Label2) {
		toSerialize["label2"] = o.Label2
	}
	if !IsNil(o.Label3) {
		toSerialize["label3"] = o.Label3
	}
	if !IsNil(o.NetWeightKg) {
		toSerialize["netWeightKg"] = o.NetWeightKg
	}
	if !IsNil(o.NetVolumeL) {
		toSerialize["netVolumeL"] = o.NetVolumeL
	}
	if !IsNil(o.GrossWeightKg) {
		toSerialize["grossWeightKg"] = o.GrossWeightKg
	}
	if !IsNil(o.TunnelCode) {
		toSerialize["tunnelCode"] = o.TunnelCode
	}
	return toSerialize, nil
}

type NullableUpdateTransportBaseDtoDangerousGoodDto struct {
	value *UpdateTransportBaseDtoDangerousGoodDto
	isSet bool
}

func (v NullableUpdateTransportBaseDtoDangerousGoodDto) Get() *UpdateTransportBaseDtoDangerousGoodDto {
	return v.value
}

func (v *NullableUpdateTransportBaseDtoDangerousGoodDto) Set(val *UpdateTransportBaseDtoDangerousGoodDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateTransportBaseDtoDangerousGoodDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateTransportBaseDtoDangerousGoodDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateTransportBaseDtoDangerousGoodDto(val *UpdateTransportBaseDtoDangerousGoodDto) *NullableUpdateTransportBaseDtoDangerousGoodDto {
	return &NullableUpdateTransportBaseDtoDangerousGoodDto{value: val, isSet: true}
}

func (v NullableUpdateTransportBaseDtoDangerousGoodDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateTransportBaseDtoDangerousGoodDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
