...
type FileCategoriesAPIGetFileCategoriesRequest struct {
	ctx context.Context
	...
	codes *[]string
	labels *[]string
	isVisibleForOrderers *bool
	isVisibleForDrivers *bool
	isBillingReceipt *bool
	serviceUids *[]string
	pattern *string
...
// Search by file category code
func (r FileCategoriesAPIGetFileCategoriesRequest) Code(code string) FileCategoriesAPIGetFileCategoriesRequest {
	r.code = &code
	return r
}

// Search by file category label
func (r FileCategoriesAPIGetFileCategoriesRequest) Label(label string) FileCategoriesAPIGetFileCategoriesRequest {
	r.label = &label
	return r
}

// Search by file category codes
func (r FileCategoriesAPIGetFileCategoriesRequest) Codes(codes []string) FileCategoriesAPIGetFileCategoriesRequest {
	r.codes = &codes
	return r
}

// Search by file category labels
func (r FileCategoriesAPIGetFileCategoriesRequest) Labels(labels []string) FileCategoriesAPIGetFileCategoriesRequest {
	r.labels = &labels
	return r
}

// Search by file category orderer visibility
func (r FileCategoriesAPIGetFileCategoriesRequest) IsVisibleForOrderers(isVisibleForOrderers bool) FileCategoriesAPIGetFileCategoriesRequest {
	r.isVisibleForOrderers = &isVisibleForOrderers
	return r
}

// Search by file category driver visibility
func (r FileCategoriesAPIGetFileCategoriesRequest) IsVisibleForDrivers(isVisibleForDrivers bool) FileCategoriesAPIGetFileCategoriesRequest {
	r.isVisibleForDrivers = &isVisibleForDrivers
	return r
}

// Search by file category being billing receipt
func (r FileCategoriesAPIGetFileCategoriesRequest) IsBillingReceipt(isBillingReceipt bool) FileCategoriesAPIGetFileCategoriesRequest {
	r.isBillingReceipt = &isBillingReceipt
	return r
}

// Search by file category service uids
func (r FileCategoriesAPIGetFileCategoriesRequest) ServiceUids(serviceUids []string) FileCategoriesAPIGetFileCategoriesRequest {
	r.serviceUids = &serviceUids
	return r
}

// A pattern to look for in fields specified by PatternFields.
func (r FileCategoriesAPIGetFileCategoriesRequest) Pattern(pattern string) FileCategoriesAPIGetFileCategoriesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r FileCategoriesAPIGetFileCategoriesRequest) PatternFields(patternFields []string) FileCategoriesAPIGetFileCategoriesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r FileCategoriesAPIGetFileCategoriesRequest) StartIndex(startIndex int32) FileCategoriesAPIGetFileCategoriesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r FileCategoriesAPIGetFileCategoriesRequest) Count(count int32) FileCategoriesAPIGetFileCategoriesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r FileCategoriesAPIGetFileCategoriesRequest) Sort(sort []string) FileCategoriesAPIGetFileCategoriesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r FileCategoriesAPIGetFileCategoriesRequest) Desc(desc []string) FileCategoriesAPIGetFileCategoriesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r FileCategoriesAPIGetFileCategoriesRequest) Fields(fields string) FileCategoriesAPIGetFileCategoriesRequest {
	r.fields = &fields
	return r
}

func (r FileCategoriesAPIGetFileCategoriesRequest) Execute() (*IPagedResourceListFileCategoryDto, *http.Response, error) {
	return r.ApiService.GetFileCategoriesExecute(r)
}

/*
GetFileCategories Get file categories

Get a paginated list of file category

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return FileCategoriesAPIGetFileCategoriesRequest
*/
func (a *FileCategoriesAPIService) GetFileCategories(ctx context.Context) FileCategoriesAPIGetFileCategoriesRequest {
	return FileCategoriesAPIGetFileCategoriesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return IPagedResourceListFileCategoryDto
func (a *FileCategoriesAPIService) GetFileCategoriesExecute(r FileCategoriesAPIGetFileCategoriesRequest) (*IPagedResourceListFileCategoryDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListFileCategoryDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FileCategoriesAPIService.GetFileCategories")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/file-categories"
	...
	if r.isVisibleForOrderers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isVisibleForOrderers", r.isVisibleForOrderers, "", "")
	}
	if r.isVisibleForDrivers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isVisibleForDrivers", r.isVisibleForDrivers, "", "")
	}
	if r.isBillingReceipt != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isBillingReceipt", r.isBillingReceipt, "", "")
	}
	if r.serviceUids != nil {
		t := *r.serviceUids
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "serviceUids", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "serviceUids", t, "form", "multi")
		}
	}
	if r.pattern != nil {
