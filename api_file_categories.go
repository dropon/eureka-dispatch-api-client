...
type ApiGetFileCategoriesRequest struct {
	ctx context.Context
...
func (r ApiGetFileCategoriesRequest) Code(code string) ApiGetFileCategoriesRequest {
	r.code = &code
	return r
}

// Search by file category label
func (r ApiGetFileCategoriesRequest) Label(label string) ApiGetFileCategoriesRequest {
	r.label = &label
	return r
}

// Search by file category codes
func (r ApiGetFileCategoriesRequest) Codes(codes []string) ApiGetFileCategoriesRequest {
	r.codes = &codes
	return r
}

// Search by file category labels
func (r ApiGetFileCategoriesRequest) Labels(labels []string) ApiGetFileCategoriesRequest {
	r.labels = &labels
	return r
}

// Search by file category orderer visibility
func (r ApiGetFileCategoriesRequest) IsVisibleForOrderers(isVisibleForOrderers bool) ApiGetFileCategoriesRequest {
	r.isVisibleForOrderers = &isVisibleForOrderers
	return r
}

// Search by file category driver visibility
func (r ApiGetFileCategoriesRequest) IsVisibleForDrivers(isVisibleForDrivers bool) ApiGetFileCategoriesRequest {
	r.isVisibleForDrivers = &isVisibleForDrivers
	return r
}

// Search by file category being billing receipt
func (r ApiGetFileCategoriesRequest) IsBillingReceipt(isBillingReceipt bool) ApiGetFileCategoriesRequest {
	r.isBillingReceipt = &isBillingReceipt
	return r
}

// Search by file category service uids
func (r ApiGetFileCategoriesRequest) ServiceUids(serviceUids []string) ApiGetFileCategoriesRequest {
	r.serviceUids = &serviceUids
	return r
}

// A pattern to look for in fields specified by PatternFields.
func (r ApiGetFileCategoriesRequest) Pattern(pattern string) ApiGetFileCategoriesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetFileCategoriesRequest) PatternFields(patternFields []string) ApiGetFileCategoriesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetFileCategoriesRequest) StartIndex(startIndex int32) ApiGetFileCategoriesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetFileCategoriesRequest) Count(count int32) ApiGetFileCategoriesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetFileCategoriesRequest) Sort(sort []string) ApiGetFileCategoriesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetFileCategoriesRequest) Desc(desc []string) ApiGetFileCategoriesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetFileCategoriesRequest) Fields(fields string) ApiGetFileCategoriesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetFileCategoriesRequest) Execute() (*IPagedResourceListFileCategoryDto, *http.Response, error) {
...
Get a paginated list of file category
 ...
 @return ApiGetFileCategoriesRequest
*/
func (a *FileCategoriesAPIService) GetFileCategories(ctx context.Context) ApiGetFileCategoriesRequest {
	return ApiGetFileCategoriesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *FileCategoriesAPIService) GetFileCategoriesExecute(r ApiGetFileCategoriesRequest) (*IPagedResourceListFileCategoryDto, *http.Response, error) {
	var (
