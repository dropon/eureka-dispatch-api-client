...
// checks if the UpdateCountryDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCountryDto{}

// UpdateCountryDto struct for UpdateCountryDto
type UpdateCountryDto struct {
	...
	// Country label localizations.  When this property is set, the full collection is replaced with the provided value.
...
func (o UpdateCountryDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateCountryDto) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateCountryDto struct {
	value *UpdateCountryDto
	isSet bool
}

func (v NullableUpdateCountryDto) Get() *UpdateCountryDto {
	return v.value
}

func (v *NullableUpdateCountryDto) Set(val *UpdateCountryDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCountryDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCountryDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCountryDto(val *UpdateCountryDto) *NullableUpdateCountryDto {
	return &NullableUpdateCountryDto{value: val, isSet: true}
}

func (v NullableUpdateCountryDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCountryDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
