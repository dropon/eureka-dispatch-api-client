...
// checks if the ApplyDeliveredStatusCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyDeliveredStatusCommand{}

// ApplyDeliveredStatusCommand struct for ApplyDeliveredStatusCommand
type ApplyDeliveredStatusCommand struct {
	// Mandatory. Transport's unique identifier
	TransportUid string `json:"transportUid"`
	// Transport receipt
	TransportReceipt *string `json:"transportReceipt,omitempty"`
	// Transport delivery sign
	DeliverySign *string `json:"deliverySign,omitempty"`
	// Transport delivery comment
	DeliveryComment *string `json:"deliveryComment,omitempty"`
	// Transport delivery realized date time
...
type _ApplyDeliveredStatusCommand ApplyDeliveredStatusCommand
...
func NewApplyDeliveredStatusCommand(transportUid string) *ApplyDeliveredStatusCommand {
	this := ApplyDeliveredStatusCommand{}
...
// GetTransportUid returns the TransportUid field value
func (o *ApplyDeliveredStatusCommand) GetTransportUid() string {
	...
	return o.TransportUid
}

// GetTransportUidOk returns a tuple with the TransportUid field value
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetTransportUidOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TransportUid, true
}

// SetTransportUid sets field value
func (o *ApplyDeliveredStatusCommand) SetTransportUid(v string) {
	o.TransportUid = v
}

// GetTransportReceipt returns the TransportReceipt field value if set, zero value otherwise.
func (o *ApplyDeliveredStatusCommand) GetTransportReceipt() string {
	if o == nil || IsNil(o.TransportReceipt) {
		var ret string
		return ret
	}
	return *o.TransportReceipt
}

// GetTransportReceiptOk returns a tuple with the TransportReceipt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetTransportReceiptOk() (*string, bool) {
	if o == nil || IsNil(o.TransportReceipt) {
		return nil, false
	}
	return o.TransportReceipt, true
}
...
// SetTransportReceipt gets a reference to the given string and assigns it to the TransportReceipt field.
func (o *ApplyDeliveredStatusCommand) SetTransportReceipt(v string) {
	o.TransportReceipt = &v
}

// GetDeliverySign returns the DeliverySign field value if set, zero value otherwise.
func (o *ApplyDeliveredStatusCommand) GetDeliverySign() string {
	if o == nil || IsNil(o.DeliverySign) {
		var ret string
		return ret
	}
	return *o.DeliverySign
}

// GetDeliverySignOk returns a tuple with the DeliverySign field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetDeliverySignOk() (*string, bool) {
	if o == nil || IsNil(o.DeliverySign) {
		return nil, false
	}
	return o.DeliverySign, true
}
...
// SetDeliverySign gets a reference to the given string and assigns it to the DeliverySign field.
func (o *ApplyDeliveredStatusCommand) SetDeliverySign(v string) {
	o.DeliverySign = &v
}

// GetDeliveryComment returns the DeliveryComment field value if set, zero value otherwise.
func (o *ApplyDeliveredStatusCommand) GetDeliveryComment() string {
	if o == nil || IsNil(o.DeliveryComment) {
		var ret string
		return ret
	}
	return *o.DeliveryComment
}

// GetDeliveryCommentOk returns a tuple with the DeliveryComment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetDeliveryCommentOk() (*string, bool) {
	if o == nil || IsNil(o.DeliveryComment) {
		return nil, false
	}
	return o.DeliveryComment, true
}
...
// SetDeliveryComment gets a reference to the given string and assigns it to the DeliveryComment field.
...
func (o *ApplyDeliveredStatusCommand) GetRealizedDateTime() Time {
...
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetRealizedDateTimeOk() (*Time, bool) {
	if o == nil || IsNil(o.RealizedDateTime) {
		return nil, false
	}
	return o.RealizedDateTime, true
}
...
func (o *ApplyDeliveredStatusCommand) SetRealizedDateTime(v Time) {
...
func (o *ApplyDeliveredStatusCommand) GetRealizedArrivalOnSiteDateTime() Time {
...
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetRealizedArrivalOnSiteDateTimeOk() (*Time, bool) {
	if o == nil || IsNil(o.RealizedArrivalOnSiteDateTime) {
		return nil, false
	}
	return o.RealizedArrivalOnSiteDateTime, true
}
...
func (o *ApplyDeliveredStatusCommand) SetRealizedArrivalOnSiteDateTime(v Time) {
...
func (o *ApplyDeliveredStatusCommand) GetRealizedUnloadingStartDateTime() Time {
...
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetRealizedUnloadingStartDateTimeOk() (*Time, bool) {
	if o == nil || IsNil(o.RealizedUnloadingStartDateTime) {
		return nil, false
	}
	return o.RealizedUnloadingStartDateTime, true
}
...
func (o *ApplyDeliveredStatusCommand) SetRealizedUnloadingStartDateTime(v Time) {
...
func (o *ApplyDeliveredStatusCommand) GetRealizedUnloadingEndDateTime() Time {
...
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetRealizedUnloadingEndDateTimeOk() (*Time, bool) {
	if o == nil || IsNil(o.RealizedUnloadingEndDateTime) {
		return nil, false
	}
	return o.RealizedUnloadingEndDateTime, true
}
...
func (o *ApplyDeliveredStatusCommand) SetRealizedUnloadingEndDateTime(v Time) {
	o.RealizedUnloadingEndDateTime = &v
}

// GetPickupData returns the PickupData field value if set, zero value otherwise.
func (o *ApplyDeliveredStatusCommand) GetPickupData() PickupDataOnStatusAppliedDto {
	if o == nil || IsNil(o.PickupData) {
		var ret PickupDataOnStatusAppliedDto
		return ret
	}
	return *o.PickupData
}

// GetPickupDataOk returns a tuple with the PickupData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplyDeliveredStatusCommand) GetPickupDataOk() (*PickupDataOnStatusAppliedDto, bool) {
	if o == nil || IsNil(o.PickupData) {
		return nil, false
	}
	return o.PickupData, true
}
...
// SetPickupData gets a reference to the given PickupDataOnStatusAppliedDto and assigns it to the PickupData field.
func (o *ApplyDeliveredStatusCommand) SetPickupData(v PickupDataOnStatusAppliedDto) {
	o.PickupData = &v
}

func (o ApplyDeliveredStatusCommand) MarshalJSON() ([]byte, error) {
...
func (o ApplyDeliveredStatusCommand) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["transportUid"] = o.TransportUid
	if !IsNil(o.TransportReceipt) {
		toSerialize["transportReceipt"] = o.TransportReceipt
	}
	if !IsNil(o.DeliverySign) {
		toSerialize["deliverySign"] = o.DeliverySign
	}
	if !IsNil(o.DeliveryComment) {
		toSerialize["deliveryComment"] = o.DeliveryComment
	}
	if !IsNil(o.RealizedDateTime) {
		toSerialize["realizedDateTime"] = o.RealizedDateTime
	}
	if !IsNil(o.RealizedArrivalOnSiteDateTime) {
		toSerialize["realizedArrivalOnSiteDateTime"] = o.RealizedArrivalOnSiteDateTime
	}
	if !IsNil(o.RealizedUnloadingStartDateTime) {
		toSerialize["realizedUnloadingStartDateTime"] = o.RealizedUnloadingStartDateTime
	}
	if !IsNil(o.RealizedUnloadingEndDateTime) {
		toSerialize["realizedUnloadingEndDateTime"] = o.RealizedUnloadingEndDateTime
	}
	if !IsNil(o.PickupData) {
		toSerialize["pickupData"] = o.PickupData
	}
	return toSerialize, nil
}

func (o *ApplyDeliveredStatusCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varApplyDeliveredStatusCommand := _ApplyDeliveredStatusCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplyDeliveredStatusCommand)
	if err != nil {
		return err
	}

	*o = ApplyDeliveredStatusCommand(varApplyDeliveredStatusCommand)

	return err
}

type NullableApplyDeliveredStatusCommand struct {
	value *ApplyDeliveredStatusCommand
	isSet bool
}

func (v NullableApplyDeliveredStatusCommand) Get() *ApplyDeliveredStatusCommand {
	return v.value
}

func (v *NullableApplyDeliveredStatusCommand) Set(val *ApplyDeliveredStatusCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyDeliveredStatusCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyDeliveredStatusCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyDeliveredStatusCommand(val *ApplyDeliveredStatusCommand) *NullableApplyDeliveredStatusCommand {
	return &NullableApplyDeliveredStatusCommand{value: val, isSet: true}
}

func (v NullableApplyDeliveredStatusCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyDeliveredStatusCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
