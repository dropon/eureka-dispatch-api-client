...
var _ MappedNullable = &TransportPickupDateTimeSlotDto{}
...
func NewTransportPickupDateTimeSlotDto() *TransportPickupDateTimeSlotDto {
	this := TransportPickupDateTimeSlotDto{}
	return &this
}
...
func (o TransportPickupDateTimeSlotDto) MarshalJSON() ([]byte, error) {
...
func (o TransportPickupDateTimeSlotDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.LoadingStart) {
		toSerialize["loadingStart"] = o.LoadingStart
	}
	if !IsNil(o.LoadingEnd) {
		toSerialize["loadingEnd"] = o.LoadingEnd
	}
...
type NullableTransportPickupDateTimeSlotDto struct {
	value *TransportPickupDateTimeSlotDto
	isSet bool
}

func (v NullableTransportPickupDateTimeSlotDto) Get() *TransportPickupDateTimeSlotDto {
	return v.value
}

func (v *NullableTransportPickupDateTimeSlotDto) Set(val *TransportPickupDateTimeSlotDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportPickupDateTimeSlotDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportPickupDateTimeSlotDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportPickupDateTimeSlotDto(val *TransportPickupDateTimeSlotDto) *NullableTransportPickupDateTimeSlotDto {
	return &NullableTransportPickupDateTimeSlotDto{value: val, isSet: true}
}

func (v NullableTransportPickupDateTimeSlotDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportPickupDateTimeSlotDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
