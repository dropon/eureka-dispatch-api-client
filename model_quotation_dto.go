...
// checks if the QuotationDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotationDto{}

// QuotationDto struct for QuotationDto
type QuotationDto struct {
	...
	IsUniqueOrder *bool `json:"isUniqueOrder,omitempty"`
	IsArchived *bool `json:"isArchived,omitempty"`
	IsFinalized *bool `json:"isFinalized,omitempty"`
	Transports *CappedCollectionDtoTransportDto `json:"transports,omitempty"`
}
...
// GetIsUniqueOrder returns the IsUniqueOrder field value if set, zero value otherwise.
func (o *QuotationDto) GetIsUniqueOrder() bool {
	if o == nil || IsNil(o.IsUniqueOrder) {
		var ret bool
		return ret
	}
	return *o.IsUniqueOrder
}

// GetIsUniqueOrderOk returns a tuple with the IsUniqueOrder field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuotationDto) GetIsUniqueOrderOk() (*bool, bool) {
	if o == nil || IsNil(o.IsUniqueOrder) {
		return nil, false
	}
	return o.IsUniqueOrder, true
}
...
// SetIsUniqueOrder gets a reference to the given bool and assigns it to the IsUniqueOrder field.
...
func (o *QuotationDto) GetTransports() CappedCollectionDtoTransportDto {
	if o == nil || IsNil(o.Transports) {
		var ret CappedCollectionDtoTransportDto
		return ret
	}
	return *o.Transports
}
...
// SetTransports gets a reference to the given CappedCollectionDtoTransportDto and assigns it to the Transports field.
func (o *QuotationDto) SetTransports(v CappedCollectionDtoTransportDto) {
	o.Transports = &v
}

func (o QuotationDto) MarshalJSON() ([]byte, error) {
...
func (o QuotationDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsUniqueOrder) {
		toSerialize["isUniqueOrder"] = o.IsUniqueOrder
	}
	if !IsNil(o.IsArchived) {
		toSerialize["isArchived"] = o.IsArchived
	}
	if !IsNil(o.IsFinalized) {
		toSerialize["isFinalized"] = o.IsFinalized
	}
...
type NullableQuotationDto struct {
	value *QuotationDto
	isSet bool
}

func (v NullableQuotationDto) Get() *QuotationDto {
	return v.value
}

func (v *NullableQuotationDto) Set(val *QuotationDto) {
	v.value = val
	v.isSet = true
}

func (v NullableQuotationDto) IsSet() bool {
	return v.isSet
}

func (v *NullableQuotationDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuotationDto(val *QuotationDto) *NullableQuotationDto {
	return &NullableQuotationDto{value: val, isSet: true}
}

func (v NullableQuotationDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuotationDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
