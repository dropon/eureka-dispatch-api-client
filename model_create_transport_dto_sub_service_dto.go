...
// checks if the CreateTransportDtoSubServiceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransportDtoSubServiceDto{}

// CreateTransportDtoSubServiceDto struct for CreateTransportDtoSubServiceDto
type CreateTransportDtoSubServiceDto struct {
	// Mandatory. Sub service's unique code.
	Code string `json:"code"`
	// This number can have up to 2 decimals.
	ForcedSellQuantity *float64 `json:"forcedSellQuantity,omitempty"`
	// If sell unit price is forced, sell global pricing will be disabled.    Forced sell unit price and forced sell price must not be both specified.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedSellUnitPrice *float64 `json:"forcedSellUnitPrice,omitempty"`
	// If sell price is forced, sell global pricing will be disabled.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedSellPrice *float64 `json:"forcedSellPrice,omitempty"`
	// Forced sell price can be specified in reference currency when it is different from customer's currency    and when this option is available in general settings.    Forced sell price and forced sell price in reference currency must not be both set.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	...
	// If buy unit price is forced, buy global pricing will be disabled.  Forced buy unit price and forced buy price must not be both specified.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedBuyUnitPrice *float64 `json:"forcedBuyUnitPrice,omitempty"`
	// If buy price is forced, buy global pricing will be disabled.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedBuyPrice *float64 `json:"forcedBuyPrice,omitempty"`
	// Forced buy price can be specified in reference currency when it is different from customer's currency    and when this option is available in general settings.    Forced buy price and forced buy price in reference currency must not be both set.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
...
type _CreateTransportDtoSubServiceDto CreateTransportDtoSubServiceDto
...
func NewCreateTransportDtoSubServiceDto(code string) *CreateTransportDtoSubServiceDto {
	this := CreateTransportDtoSubServiceDto{}
	this.Code = code
	return &this
}
...
func (o CreateTransportDtoSubServiceDto) MarshalJSON() ([]byte, error) {
...
func (o CreateTransportDtoSubServiceDto) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTransportDtoSubServiceDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTransportDtoSubServiceDto := _CreateTransportDtoSubServiceDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTransportDtoSubServiceDto)

	if err != nil {
		return err
	}

	*o = CreateTransportDtoSubServiceDto(varCreateTransportDtoSubServiceDto)

	return err
}

type NullableCreateTransportDtoSubServiceDto struct {
	value *CreateTransportDtoSubServiceDto
	isSet bool
}

func (v NullableCreateTransportDtoSubServiceDto) Get() *CreateTransportDtoSubServiceDto {
	return v.value
}

func (v *NullableCreateTransportDtoSubServiceDto) Set(val *CreateTransportDtoSubServiceDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTransportDtoSubServiceDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTransportDtoSubServiceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTransportDtoSubServiceDto(val *CreateTransportDtoSubServiceDto) *NullableCreateTransportDtoSubServiceDto {
	return &NullableCreateTransportDtoSubServiceDto{value: val, isSet: true}
}

func (v NullableCreateTransportDtoSubServiceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTransportDtoSubServiceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
