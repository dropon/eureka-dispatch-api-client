...
type MissionDto struct {
	...
	IsReadyToBill *bool `json:"isReadyToBill,omitempty"`
...
// GetIsReadyToBill returns the IsReadyToBill field value if set, zero value otherwise.
func (o *MissionDto) GetIsReadyToBill() bool {
	if o == nil || IsNil(o.IsReadyToBill) {
		var ret bool
		return ret
	}
	return *o.IsReadyToBill
}

// GetIsReadyToBillOk returns a tuple with the IsReadyToBill field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MissionDto) GetIsReadyToBillOk() (*bool, bool) {
	if o == nil || IsNil(o.IsReadyToBill) {
		return nil, false
	}
	return o.IsReadyToBill, true
}
...
// SetIsReadyToBill gets a reference to the given bool and assigns it to the IsReadyToBill field.
...
func (o MissionDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsReadyToBill) {
		toSerialize["isReadyToBill"] = o.IsReadyToBill
	}
