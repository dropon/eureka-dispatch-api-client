...
type MissionsAPICancelMissionRequest struct {
	ctx context.Context
...
func (r MissionsAPICancelMissionRequest) Command(command CancelMissionCommand) MissionsAPICancelMissionRequest {
	r.command = &command
	return r
}

func (r MissionsAPICancelMissionRequest) Execute() (*http.Response, error) {
...
Cancel the mission with all its included transports.  
The following permission(s) are required to access this route:  Cancel orders.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Mission's unique identifier
 @return MissionsAPICancelMissionRequest
*/
func (a *MissionsAPIService) CancelMission(ctx context.Context, uid string) MissionsAPICancelMissionRequest {
	return MissionsAPICancelMissionRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *MissionsAPIService) CancelMissionExecute(r MissionsAPICancelMissionRequest) (*http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v3/missions/{uid}/cancellation-process"
...
type MissionsAPICreateMissionRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	command *CreateMissionCommand
}

func (r MissionsAPICreateMissionRequest) Command(command CreateMissionCommand) MissionsAPICreateMissionRequest {
	r.command = &command
	return r
}

func (r MissionsAPICreateMissionRequest) Execute() (*CreateMissionResultDto, *http.Response, error) {
...
CreateMission Create a mission
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MissionsAPICreateMissionRequest
*/
func (a *MissionsAPIService) CreateMission(ctx context.Context) MissionsAPICreateMissionRequest {
	return MissionsAPICreateMissionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CreateMissionResultDto
func (a *MissionsAPIService) CreateMissionExecute(r MissionsAPICreateMissionRequest) (*CreateMissionResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateMissionResultDto
	)
	...
	localVarPath := localBasePath + "/v3/missions"
...
type MissionsAPIGetMissionByIdRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	uid string
	fields *string
...
func (r MissionsAPIGetMissionByIdRequest) Fields(fields string) MissionsAPIGetMissionByIdRequest {
	r.fields = &fields
	return r
}

func (r MissionsAPIGetMissionByIdRequest) Execute() (*MissionDto, *http.Response, error) {
	return r.ApiService.GetMissionByIdExecute(r)
}

/*
GetMissionById Get a mission by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Mission's unique identifier
 @return MissionsAPIGetMissionByIdRequest
*/
func (a *MissionsAPIService) GetMissionById(ctx context.Context, uid string) MissionsAPIGetMissionByIdRequest {
	return MissionsAPIGetMissionByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return MissionDto
func (a *MissionsAPIService) GetMissionByIdExecute(r MissionsAPIGetMissionByIdRequest) (*MissionDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MissionDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MissionsAPIService.GetMissionById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/missions/{uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type MissionsAPIGetMissionByMissionNumberRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	missionNumber *int32
	fields *string
...
// Mission number
func (r MissionsAPIGetMissionByMissionNumberRequest) MissionNumber(missionNumber int32) MissionsAPIGetMissionByMissionNumberRequest {
	r.missionNumber = &missionNumber
	return r
}

// Projection fields separated with a comma
func (r MissionsAPIGetMissionByMissionNumberRequest) Fields(fields string) MissionsAPIGetMissionByMissionNumberRequest {
	r.fields = &fields
	return r
}

func (r MissionsAPIGetMissionByMissionNumberRequest) Execute() (*MissionDto, *http.Response, error) {
	return r.ApiService.GetMissionByMissionNumberExecute(r)
}

/*
GetMissionByMissionNumber Get a mission by its mission number

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MissionsAPIGetMissionByMissionNumberRequest
*/
func (a *MissionsAPIService) GetMissionByMissionNumber(ctx context.Context) MissionsAPIGetMissionByMissionNumberRequest {
	return MissionsAPIGetMissionByMissionNumberRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MissionDto
func (a *MissionsAPIService) GetMissionByMissionNumberExecute(r MissionsAPIGetMissionByMissionNumberRequest) (*MissionDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MissionsAPIService.GetMissionByMissionNumber")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/missions/by-mission-number"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.missionNumber == nil {
		return localVarReturnValue, nil, reportError("missionNumber is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "missionNumber", r.missionNumber, "", "")
	if r.fields != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields", r.fields, "", "")
	}
	// to determine the Content-Type header
...
type MissionsAPIMissionCreationDryRunRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	command *SimulateMissionCreationDryRunCommand
}

func (r MissionsAPIMissionCreationDryRunRequest) Command(command SimulateMissionCreationDryRunCommand) MissionsAPIMissionCreationDryRunRequest {
	r.command = &command
	return r
}

func (r MissionsAPIMissionCreationDryRunRequest) Execute() (*MissionEntryDryRunDto, *http.Response, error) {
	return r.ApiService.MissionCreationDryRunExecute(r)
}

/*
MissionCreationDryRun Mission creation dry run

Simulate a mission creation: performs a dry run.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MissionsAPIMissionCreationDryRunRequest
*/
func (a *MissionsAPIService) MissionCreationDryRun(ctx context.Context) MissionsAPIMissionCreationDryRunRequest {
	return MissionsAPIMissionCreationDryRunRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MissionEntryDryRunDto
func (a *MissionsAPIService) MissionCreationDryRunExecute(r MissionsAPIMissionCreationDryRunRequest) (*MissionEntryDryRunDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MissionEntryDryRunDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MissionsAPIService.MissionCreationDryRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/missions/dry-run"
...
type MissionsAPIMissionUpdateDryRunRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	uid string
	command *UpdateMissionDto
}

func (r MissionsAPIMissionUpdateDryRunRequest) Command(command UpdateMissionDto) MissionsAPIMissionUpdateDryRunRequest {
	r.command = &command
	return r
}

func (r MissionsAPIMissionUpdateDryRunRequest) Execute() (*MissionEntryDryRunDto, *http.Response, error) {
	return r.ApiService.MissionUpdateDryRunExecute(r)
}

/*
MissionUpdateDryRun Mission update dry run

Simulate a mission update : performs a dry run.  
The following permission(s) are required to access this route:  Update orders.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid
 @return MissionsAPIMissionUpdateDryRunRequest
*/
func (a *MissionsAPIService) MissionUpdateDryRun(ctx context.Context, uid string) MissionsAPIMissionUpdateDryRunRequest {
	return MissionsAPIMissionUpdateDryRunRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return MissionEntryDryRunDto
func (a *MissionsAPIService) MissionUpdateDryRunExecute(r MissionsAPIMissionUpdateDryRunRequest) (*MissionEntryDryRunDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MissionsAPIService.MissionUpdateDryRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/missions/{uid}/dry-run"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type MissionsAPIUpdateMissionRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	uid string
	command *UpdateMissionDto
...
func (r MissionsAPIUpdateMissionRequest) Command(command UpdateMissionDto) MissionsAPIUpdateMissionRequest {
	r.command = &command
	return r
}

func (r MissionsAPIUpdateMissionRequest) Execute() (*http.Response, error) {
...
Updates a mission using merge patch semantics : you need to provide only the fields to update.
...
Deleting a transport in the mission is not supported.
For all changes requiring more complex modifications, you will need to cancel the mission and create another one.  
The following permission(s) are required to access this route:  Update orders.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Mission's unique identifier
 @return MissionsAPIUpdateMissionRequest
*/
func (a *MissionsAPIService) UpdateMission(ctx context.Context, uid string) MissionsAPIUpdateMissionRequest {
	return MissionsAPIUpdateMissionRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
func (a *MissionsAPIService) UpdateMissionExecute(r MissionsAPIUpdateMissionRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MissionsAPIService.UpdateMission")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
