...
func (r ApiCancelMissionRequest) Command(command CancelMissionCommand) ApiCancelMissionRequest {
	r.command = &command
	return r
}
...
*/
func (a *MissionsAPIService) CancelMission(ctx context.Context, uid string) ApiCancelMissionRequest {
	return ApiCancelMissionRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (r ApiCreateMissionRequest) Command(command CreateMissionCommand) ApiCreateMissionRequest {
	r.command = &command
	return r
}

func (r ApiCreateMissionRequest) Execute() (*CreateMissionResultDto, *http.Response, error) {
...
*/
func (a *MissionsAPIService) CreateMission(ctx context.Context) ApiCreateMissionRequest {
	return ApiCreateMissionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MissionsAPIService) CreateMissionExecute(r ApiCreateMissionRequest) (*CreateMissionResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetMissionByIdRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	uid string
	fields *string
...
func (r ApiGetMissionByIdRequest) Fields(fields string) ApiGetMissionByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetMissionByIdRequest) Execute() (*MissionDto, *http.Response, error) {
	return r.ApiService.GetMissionByIdExecute(r)
}

/*
GetMissionById Get mission by id

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Mission's unique identifier
 @return ApiGetMissionByIdRequest
*/
func (a *MissionsAPIService) GetMissionById(ctx context.Context, uid string) ApiGetMissionByIdRequest {
	return ApiGetMissionByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return MissionDto
func (a *MissionsAPIService) GetMissionByIdExecute(r ApiGetMissionByIdRequest) (*MissionDto, *http.Response, error) {
	var (
...
type ApiGetMissionByMissionNumberRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	missionNumber *int32
	fields *string
...
// Mission number
func (r ApiGetMissionByMissionNumberRequest) MissionNumber(missionNumber int32) ApiGetMissionByMissionNumberRequest {
	r.missionNumber = &missionNumber
	return r
}

// Projection fields separated with a comma
func (r ApiGetMissionByMissionNumberRequest) Fields(fields string) ApiGetMissionByMissionNumberRequest {
	r.fields = &fields
	return r
}

func (r ApiGetMissionByMissionNumberRequest) Execute() (*MissionDto, *http.Response, error) {
	return r.ApiService.GetMissionByMissionNumberExecute(r)
}

/*
GetMissionByMissionNumber Get mission by mission number

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMissionByMissionNumberRequest
*/
func (a *MissionsAPIService) GetMissionByMissionNumber(ctx context.Context) ApiGetMissionByMissionNumberRequest {
	return ApiGetMissionByMissionNumberRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MissionDto
func (a *MissionsAPIService) GetMissionByMissionNumberExecute(r ApiGetMissionByMissionNumberRequest) (*MissionDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiMissionCreationDryRunRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	command *SimulateMissionCreationDryRunCommand
}

func (r ApiMissionCreationDryRunRequest) Command(command SimulateMissionCreationDryRunCommand) ApiMissionCreationDryRunRequest {
	r.command = &command
	return r
}

func (r ApiMissionCreationDryRunRequest) Execute() (*MissionEntryDryRunDto, *http.Response, error) {
...
Simulate a mission creation: performs a dry run.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMissionCreationDryRunRequest
*/
func (a *MissionsAPIService) MissionCreationDryRun(ctx context.Context) ApiMissionCreationDryRunRequest {
	return ApiMissionCreationDryRunRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MissionsAPIService) MissionCreationDryRunExecute(r ApiMissionCreationDryRunRequest) (*MissionEntryDryRunDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiMissionUpdateDryRunRequest struct {
	ctx context.Context
	ApiService *MissionsAPIService
	uid string
...
func (r ApiMissionUpdateDryRunRequest) Command(command UpdateMissionDto) ApiMissionUpdateDryRunRequest {
	r.command = &command
	return r
}

func (r ApiMissionUpdateDryRunRequest) Execute() (*MissionEntryDryRunDto, *http.Response, error) {
...
The following permission(s) are required to access this route:  Update orders.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid
 @return ApiMissionUpdateDryRunRequest
*/
func (a *MissionsAPIService) MissionUpdateDryRun(ctx context.Context, uid string) ApiMissionUpdateDryRunRequest {
	return ApiMissionUpdateDryRunRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return MissionEntryDryRunDto
func (a *MissionsAPIService) MissionUpdateDryRunExecute(r ApiMissionUpdateDryRunRequest) (*MissionEntryDryRunDto, *http.Response, error) {
	var (
...
func (r ApiUpdateMissionRequest) Command(command UpdateMissionDto) ApiUpdateMissionRequest {
	r.command = &command
	return r
}

func (r ApiUpdateMissionRequest) Execute() (*http.Response, error) {
...
*/
func (a *MissionsAPIService) UpdateMission(ctx context.Context, uid string) ApiUpdateMissionRequest {
	return ApiUpdateMissionRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
func (a *MissionsAPIService) UpdateMissionExecute(r ApiUpdateMissionRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
