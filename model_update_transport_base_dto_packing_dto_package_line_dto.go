...
// checks if the UpdateTransportBaseDtoPackingDtoPackageLineDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTransportBaseDtoPackingDtoPackageLineDto{}

// UpdateTransportBaseDtoPackingDtoPackageLineDto struct for UpdateTransportBaseDtoPackingDtoPackageLineDto
type UpdateTransportBaseDtoPackingDtoPackageLineDto struct {
	...
	PackageLineId *int32 `json:"packageLineId,omitempty"`
	NatureId *int32 `json:"natureId,omitempty"`
	// The access to this property is rejected if the user has at least one of the following restriction(s):  Disable free entry in package nature.
	Nature *string `json:"nature,omitempty"`
	// This number can have up to 2 decimals.
	Quantity *float64 `json:"quantity,omitempty"`
	// Allowed dimension units are m, dm, cm and mm.
	...
	PackageSizes []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageSizeDto `json:"packageSizes,omitempty"`
	References []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageReferenceDto `json:"references,omitempty"`
}
...
func NewUpdateTransportBaseDtoPackingDtoPackageLineDto() *UpdateTransportBaseDtoPackingDtoPackageLineDto {
	this := UpdateTransportBaseDtoPackingDtoPackageLineDto{}
	return &this
}
...
// GetPackageLineId returns the PackageLineId field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoPackingDtoPackageLineDto) GetPackageLineId() int32 {
	if o == nil || IsNil(o.PackageLineId) {
		var ret int32
		return ret
	}
	return *o.PackageLineId
}

// GetPackageLineIdOk returns a tuple with the PackageLineId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoPackingDtoPackageLineDto) GetPackageLineIdOk() (*int32, bool) {
	if o == nil || IsNil(o.PackageLineId) {
		return nil, false
	}
	return o.PackageLineId, true
}
...
// SetPackageLineId gets a reference to the given int32 and assigns it to the PackageLineId field.
func (o *UpdateTransportBaseDtoPackingDtoPackageLineDto) SetPackageLineId(v int32) {
	o.PackageLineId = &v
}

// GetNatureId returns the NatureId field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoPackingDtoPackageLineDto) GetNatureId() int32 {
	if o == nil || IsNil(o.NatureId) {
		var ret int32
		return ret
	}
	return *o.NatureId
...
// GetNatureIdOk returns a tuple with the NatureId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoPackingDtoPackageLineDto) GetNatureIdOk() (*int32, bool) {
	if o == nil || IsNil(o.NatureId) {
		return nil, false
	}
	return o.NatureId, true
}
...
// SetNatureId gets a reference to the given int32 and assigns it to the NatureId field.
...
// GetPackageSizes returns the PackageSizes field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoPackingDtoPackageLineDto) GetPackageSizes() []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageSizeDto {
	if o == nil || IsNil(o.PackageSizes) {
		var ret []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageSizeDto
		return ret
	}
	return o.PackageSizes
}

// GetPackageSizesOk returns a tuple with the PackageSizes field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPackageSizes gets a reference to the given []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageSizeDto and assigns it to the PackageSizes field.
...
func (o *UpdateTransportBaseDtoPackingDtoPackageLineDto) GetReferences() []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageReferenceDto {
	if o == nil || IsNil(o.References) {
		var ret []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageReferenceDto
		return ret
	}
	return o.References
}
...
// SetReferences gets a reference to the given []UpdateTransportBaseDtoPackingDtoPackageLineDtoPackageReferenceDto and assigns it to the References field.
...
func (o UpdateTransportBaseDtoPackingDtoPackageLineDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateTransportBaseDtoPackingDtoPackageLineDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MergeAction) {
		toSerialize["mergeAction"] = o.MergeAction
	}
	if !IsNil(o.PackageLineId) {
		toSerialize["packageLineId"] = o.PackageLineId
	}
	if !IsNil(o.NatureId) {
		toSerialize["natureId"] = o.NatureId
	}
	if !IsNil(o.Nature) {
	...
	if !IsNil(o.PackageSizes) {
		toSerialize["packageSizes"] = o.PackageSizes
	}
...
type NullableUpdateTransportBaseDtoPackingDtoPackageLineDto struct {
	value *UpdateTransportBaseDtoPackingDtoPackageLineDto
	isSet bool
}

func (v NullableUpdateTransportBaseDtoPackingDtoPackageLineDto) Get() *UpdateTransportBaseDtoPackingDtoPackageLineDto {
	return v.value
}

func (v *NullableUpdateTransportBaseDtoPackingDtoPackageLineDto) Set(val *UpdateTransportBaseDtoPackingDtoPackageLineDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateTransportBaseDtoPackingDtoPackageLineDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateTransportBaseDtoPackingDtoPackageLineDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateTransportBaseDtoPackingDtoPackageLineDto(val *UpdateTransportBaseDtoPackingDtoPackageLineDto) *NullableUpdateTransportBaseDtoPackingDtoPackageLineDto {
	return &NullableUpdateTransportBaseDtoPackingDtoPackageLineDto{value: val, isSet: true}
}

func (v NullableUpdateTransportBaseDtoPackingDtoPackageLineDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateTransportBaseDtoPackingDtoPackageLineDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
