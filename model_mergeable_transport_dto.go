...
// checks if the MergeableTransportDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MergeableTransportDto{}

// MergeableTransportDto struct for MergeableTransportDto
type MergeableTransportDto struct {
...
func (o MergeableTransportDto) MarshalJSON() ([]byte, error) {
...
func (o MergeableTransportDto) ToMap() (map[string]interface{}, error) {
...
type NullableMergeableTransportDto struct {
	value *MergeableTransportDto
	isSet bool
}

func (v NullableMergeableTransportDto) Get() *MergeableTransportDto {
	return v.value
}

func (v *NullableMergeableTransportDto) Set(val *MergeableTransportDto) {
	v.value = val
	v.isSet = true
}

func (v NullableMergeableTransportDto) IsSet() bool {
	return v.isSet
}

func (v *NullableMergeableTransportDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMergeableTransportDto(val *MergeableTransportDto) *NullableMergeableTransportDto {
	return &NullableMergeableTransportDto{value: val, isSet: true}
}

func (v NullableMergeableTransportDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMergeableTransportDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
