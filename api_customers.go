...
type ApiCheckCustomerDeletionConstraintsRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	uid string
}

func (r ApiCheckCustomerDeletionConstraintsRequest) Execute() (*EntityDeletionConstraintsDto, *http.Response, error) {
	return r.ApiService.CheckCustomerDeletionConstraintsExecute(r)
}

/*
CheckCustomerDeletionConstraints Check customer deletion constraints

The following permission(s) are required to access this route:  Update customers.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid customer unique identifier
 @return ApiCheckCustomerDeletionConstraintsRequest
*/
func (a *CustomersAPIService) CheckCustomerDeletionConstraints(ctx context.Context, uid string) ApiCheckCustomerDeletionConstraintsRequest {
	return ApiCheckCustomerDeletionConstraintsRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *CustomersAPIService) CheckCustomerDeletionConstraintsExecute(r ApiCheckCustomerDeletionConstraintsRequest) (*EntityDeletionConstraintsDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.CheckCustomerDeletionConstraints")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/customers/{uid}/deletion-constraints"
...
func (r ApiCreateCustomerRequest) Command(command CreateCustomerCommand) ApiCreateCustomerRequest {
	r.command = &command
	return r
}

func (r ApiCreateCustomerRequest) Execute() (*CreateCustomerResultDto, *http.Response, error) {
...
func (a *CustomersAPIService) CreateCustomerExecute(r ApiCreateCustomerRequest) (*CreateCustomerResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateCustomerResultDto
	)
	...
	localVarPath := localBasePath + "/v3/customers"
...
*/
func (a *CustomersAPIService) DeleteCustomer(ctx context.Context, uid string) ApiDeleteCustomerRequest {
	return ApiDeleteCustomerRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *CustomersAPIService) DeleteCustomerExecute(r ApiDeleteCustomerRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/v3/customers/{uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type ApiGetCustomParameterValuesRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	uid string
	parameterId int32
...
func (r ApiGetCustomParameterValuesRequest) StartIndex(startIndex int32) ApiGetCustomParameterValuesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCustomParameterValuesRequest) Count(count int32) ApiGetCustomParameterValuesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetCustomParameterValuesRequest) Sort(sort []string) ApiGetCustomParameterValuesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCustomParameterValuesRequest) Desc(desc []string) ApiGetCustomParameterValuesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCustomParameterValuesRequest) Fields(fields string) ApiGetCustomParameterValuesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomParameterValuesRequest) Execute() (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
	return r.ApiService.GetCustomParameterValuesExecute(r)
}

/*
GetCustomParameterValues Get custom parameter values

Get a paginated list of custom parameter values for the custom parameter and customer.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Customer's unique identifier.
 @param parameterId Identifier of the custom parameter
 @return ApiGetCustomParameterValuesRequest
*/
func (a *CustomersAPIService) GetCustomParameterValues(ctx context.Context, uid string, parameterId int32) ApiGetCustomParameterValuesRequest {
	return ApiGetCustomParameterValuesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IPagedResourceListCustomParameterValueDto
func (a *CustomersAPIService) GetCustomParameterValuesExecute(r ApiGetCustomParameterValuesRequest) (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListCustomParameterValueDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.GetCustomParameterValues")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/customers/{uid}/custom-parameters/{parameterId}/values"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type ApiGetCustomParametersRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetCustomParametersRequest) StartIndex(startIndex int32) ApiGetCustomParametersRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCustomParametersRequest) Count(count int32) ApiGetCustomParametersRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetCustomParametersRequest) Sort(sort []string) ApiGetCustomParametersRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCustomParametersRequest) Desc(desc []string) ApiGetCustomParametersRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCustomParametersRequest) Fields(fields string) ApiGetCustomParametersRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomParametersRequest) Execute() (*IPagedResourceListCustomParameterDto, *http.Response, error) {
	return r.ApiService.GetCustomParametersExecute(r)
}

/*
GetCustomParameters Get custom parameters

Get a paginated list of custom parameters corresponding to the specified customer.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Customer's unique identifier.
 @return ApiGetCustomParametersRequest
*/
func (a *CustomersAPIService) GetCustomParameters(ctx context.Context, uid string) ApiGetCustomParametersRequest {
	return ApiGetCustomParametersRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IPagedResourceListCustomParameterDto
func (a *CustomersAPIService) GetCustomParametersExecute(r ApiGetCustomParametersRequest) (*IPagedResourceListCustomParameterDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListCustomParameterDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.GetCustomParameters")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/customers/{uid}/custom-parameters"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type ApiGetCustomerByCodeRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	customerCode *string
	fields *string
...
// Customer&#39;s code
func (r ApiGetCustomerByCodeRequest) CustomerCode(customerCode string) ApiGetCustomerByCodeRequest {
	r.customerCode = &customerCode
	return r
}

// Projection fields separated with a comma
func (r ApiGetCustomerByCodeRequest) Fields(fields string) ApiGetCustomerByCodeRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomerByCodeRequest) Execute() (*CustomerDto, *http.Response, error) {
	return r.ApiService.GetCustomerByCodeExecute(r)
}

/*
GetCustomerByCode Get customer by code

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCustomerByCodeRequest
*/
func (a *CustomersAPIService) GetCustomerByCode(ctx context.Context) ApiGetCustomerByCodeRequest {
	return ApiGetCustomerByCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CustomerDto
func (a *CustomersAPIService) GetCustomerByCodeExecute(r ApiGetCustomerByCodeRequest) (*CustomerDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.GetCustomerByCode")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/customers/by-customer-code"
...
// Projection fields separated with a comma
func (r ApiGetCustomerByIdRequest) Fields(fields string) ApiGetCustomerByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomerByIdRequest) Execute() (*CustomerDto, *http.Response, error) {
...
*/
func (a *CustomersAPIService) GetCustomerById(ctx context.Context, uid string) ApiGetCustomerByIdRequest {
	return ApiGetCustomerByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return CustomerDto
func (a *CustomersAPIService) GetCustomerByIdExecute(r ApiGetCustomerByIdRequest) (*CustomerDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetCustomerReferencesRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	uid string
...
// Optional level of the references to get
func (r ApiGetCustomerReferencesRequest) ReferenceLevel(referenceLevel int32) ApiGetCustomerReferencesRequest {
	r.referenceLevel = &referenceLevel
	return r
}

// Pattern of the reference value
func (r ApiGetCustomerReferencesRequest) Value(value string) ApiGetCustomerReferencesRequest {
	r.value = &value
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetCustomerReferencesRequest) StartIndex(startIndex int32) ApiGetCustomerReferencesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCustomerReferencesRequest) Count(count int32) ApiGetCustomerReferencesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetCustomerReferencesRequest) Sort(sort []string) ApiGetCustomerReferencesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCustomerReferencesRequest) Desc(desc []string) ApiGetCustomerReferencesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCustomerReferencesRequest) Fields(fields string) ApiGetCustomerReferencesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomerReferencesRequest) Execute() (*IPagedResourceListCustomerReferenceDto, *http.Response, error) {
	return r.ApiService.GetCustomerReferencesExecute(r)
}

/*
GetCustomerReferences Get customer references

Get a paginated list of customer references corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Customer's unique identifier.
 @return ApiGetCustomerReferencesRequest
*/
func (a *CustomersAPIService) GetCustomerReferences(ctx context.Context, uid string) ApiGetCustomerReferencesRequest {
	return ApiGetCustomerReferencesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IPagedResourceListCustomerReferenceDto
func (a *CustomersAPIService) GetCustomerReferencesExecute(r ApiGetCustomerReferencesRequest) (*IPagedResourceListCustomerReferenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListCustomerReferenceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomersAPIService.GetCustomerReferences")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/customers/{uid}/references"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
	...
	if r.referenceLevel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "referenceLevel", r.referenceLevel, "", "")
	}
	if r.value != nil {
...
func (r ApiGetCustomersRequest) Code(code string) ApiGetCustomersRequest {
	r.code = &code
	return r
}

// Customer label pattern
func (r ApiGetCustomersRequest) Label(label string) ApiGetCustomersRequest {
	r.label = &label
	return r
}

// Search for customers with enabled/disabled status.   When not set, both enabled and disabled customers are returned.
func (r ApiGetCustomersRequest) IsEnabled(isEnabled bool) ApiGetCustomersRequest {
	r.isEnabled = &isEnabled
	return r
}

// Search for customers with exit date reached or not.  When not set, both customers with exit date reached and not reached are returned.
func (r ApiGetCustomersRequest) HasExited(hasExited bool) ApiGetCustomersRequest {
	r.hasExited = &hasExited
	return r
}

// Customer operation address post code pattern
func (r ApiGetCustomersRequest) PostCode(postCode string) ApiGetCustomersRequest {
	r.postCode = &postCode
	return r
}

// Customer operation address city name pattern
func (r ApiGetCustomersRequest) CityName(cityName string) ApiGetCustomersRequest {
	r.cityName = &cityName
	return r
}

// Customer operation address country code pattern
func (r ApiGetCustomersRequest) CountryCode(countryCode string) ApiGetCustomersRequest {
	r.countryCode = &countryCode
	return r
}

// Customer family code pattern
func (r ApiGetCustomersRequest) FamilyCode(familyCode string) ApiGetCustomersRequest {
	r.familyCode = &familyCode
	return r
}

// Customer agency code pattern
func (r ApiGetCustomersRequest) AgencyCode(agencyCode string) ApiGetCustomersRequest {
	r.agencyCode = &agencyCode
	return r
}

// A list of exact agency codes
func (r ApiGetCustomersRequest) AgencyCodes(agencyCodes []string) ApiGetCustomersRequest {
	r.agencyCodes = &agencyCodes
	return r
}

// Collection of customer unique identifiers
func (r ApiGetCustomersRequest) CustomerUids(customerUids []string) ApiGetCustomersRequest {
	r.customerUids = &customerUids
	return r
}

// A list of exact customer codes
func (r ApiGetCustomersRequest) CustomerCodes(customerCodes []string) ApiGetCustomersRequest {
	r.customerCodes = &customerCodes
	return r
}

// Company registration number pattern
func (r ApiGetCustomersRequest) CompanyRegistrationNumber(companyRegistrationNumber string) ApiGetCustomersRequest {
	r.companyRegistrationNumber = &companyRegistrationNumber
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetCustomersRequest) Pattern(pattern string) ApiGetCustomersRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetCustomersRequest) PatternFields(patternFields []string) ApiGetCustomersRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetCustomersRequest) StartIndex(startIndex int32) ApiGetCustomersRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCustomersRequest) Count(count int32) ApiGetCustomersRequest {
	r.count = &count
	return r
}
...
// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCustomersRequest) Desc(desc []string) ApiGetCustomersRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCustomersRequest) Fields(fields string) ApiGetCustomersRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomersRequest) Execute() (*IPagedResourceListCustomerDto, *http.Response, error) {
...
Get a paginated list of customers corresponding to the specified filters.
...
// Execute executes the request
//  @return IPagedResourceListCustomerDto
func (a *CustomersAPIService) GetCustomersExecute(r ApiGetCustomersRequest) (*IPagedResourceListCustomerDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListCustomerDto
	)
	...
	if r.hasExited != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hasExited", r.hasExited, "", "")
	}
	if r.postCode != nil {
	...
	if r.familyCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "familyCode", r.familyCode, "", "")
	}
	if r.agencyCode != nil {
	...
	if r.customerUids != nil {
		t := *r.customerUids
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "customerUids", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "customerUids", t, "form", "multi")
		}
	}
	...
	if r.companyRegistrationNumber != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "companyRegistrationNumber", r.companyRegistrationNumber, "", "")
	}
	if r.pattern != nil {
...
type ApiUpdateCustomerRequest struct {
	...
	ApiService *CustomersAPIService
	uid string
	command *UpdateCustomerDto
}

// Update customer command.
func (r ApiUpdateCustomerRequest) Command(command UpdateCustomerDto) ApiUpdateCustomerRequest {
	r.command = &command
	return r
}

func (r ApiUpdateCustomerRequest) Execute() (*http.Response, error) {
...
Updates a customer using merge patch semantics : you need to provide only the fields to update.
...
*/
func (a *CustomersAPIService) UpdateCustomer(ctx context.Context, uid string) ApiUpdateCustomerRequest {
	return ApiUpdateCustomerRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
func (a *CustomersAPIService) UpdateCustomerExecute(r ApiUpdateCustomerRequest) (*http.Response, error) {
	var (
