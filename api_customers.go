...
type CustomersAPIGetCustomParameterValuesRequest struct {
	ctx context.Context
...
func (r CustomersAPIGetCustomParameterValuesRequest) StartIndex(startIndex int32) CustomersAPIGetCustomParameterValuesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r CustomersAPIGetCustomParameterValuesRequest) Count(count int32) CustomersAPIGetCustomParameterValuesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r CustomersAPIGetCustomParameterValuesRequest) Sort(sort []string) CustomersAPIGetCustomParameterValuesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r CustomersAPIGetCustomParameterValuesRequest) Desc(desc []string) CustomersAPIGetCustomParameterValuesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r CustomersAPIGetCustomParameterValuesRequest) Fields(fields string) CustomersAPIGetCustomParameterValuesRequest {
	r.fields = &fields
	return r
}

func (r CustomersAPIGetCustomParameterValuesRequest) Execute() (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
...
Get a paginated list of custom parameter values for the custom parameter and customer.
 ...
 @return CustomersAPIGetCustomParameterValuesRequest
*/
func (a *CustomersAPIService) GetCustomParameterValues(ctx context.Context, uid string, parameterId int32) CustomersAPIGetCustomParameterValuesRequest {
	return CustomersAPIGetCustomParameterValuesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *CustomersAPIService) GetCustomParameterValuesExecute(r CustomersAPIGetCustomParameterValuesRequest) (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
	var (
...
type CustomersAPIGetCustomParametersRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r CustomersAPIGetCustomParametersRequest) StartIndex(startIndex int32) CustomersAPIGetCustomParametersRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r CustomersAPIGetCustomParametersRequest) Count(count int32) CustomersAPIGetCustomParametersRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r CustomersAPIGetCustomParametersRequest) Sort(sort []string) CustomersAPIGetCustomParametersRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r CustomersAPIGetCustomParametersRequest) Desc(desc []string) CustomersAPIGetCustomParametersRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r CustomersAPIGetCustomParametersRequest) Fields(fields string) CustomersAPIGetCustomParametersRequest {
	r.fields = &fields
	return r
}

func (r CustomersAPIGetCustomParametersRequest) Execute() (*IPagedResourceListCustomParameterDto, *http.Response, error) {
...
Get a paginated list of custom parameters corresponding to the specified customer.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Customer's unique identifier.
 @return CustomersAPIGetCustomParametersRequest
*/
func (a *CustomersAPIService) GetCustomParameters(ctx context.Context, uid string) CustomersAPIGetCustomParametersRequest {
	return CustomersAPIGetCustomParametersRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *CustomersAPIService) GetCustomParametersExecute(r CustomersAPIGetCustomParametersRequest) (*IPagedResourceListCustomParameterDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type CustomersAPIGetCustomerByCodeRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	customerCode *string
	fields *string
...
// Customer&#39;s code.
func (r CustomersAPIGetCustomerByCodeRequest) CustomerCode(customerCode string) CustomersAPIGetCustomerByCodeRequest {
	r.customerCode = &customerCode
	return r
}

// Projection fields separated with a comma
func (r CustomersAPIGetCustomerByCodeRequest) Fields(fields string) CustomersAPIGetCustomerByCodeRequest {
	r.fields = &fields
	return r
}

func (r CustomersAPIGetCustomerByCodeRequest) Execute() (*CustomerDto, *http.Response, error) {
	return r.ApiService.GetCustomerByCodeExecute(r)
}

/*
GetCustomerByCode Get a customer by its code

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return CustomersAPIGetCustomerByCodeRequest
*/
func (a *CustomersAPIService) GetCustomerByCode(ctx context.Context) CustomersAPIGetCustomerByCodeRequest {
	return CustomersAPIGetCustomerByCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CustomerDto
func (a *CustomersAPIService) GetCustomerByCodeExecute(r CustomersAPIGetCustomerByCodeRequest) (*CustomerDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Projection fields separated with a comma
func (r CustomersAPIGetCustomerByIdRequest) Fields(fields string) CustomersAPIGetCustomerByIdRequest {
	r.fields = &fields
	return r
}

func (r CustomersAPIGetCustomerByIdRequest) Execute() (*CustomerDto, *http.Response, error) {
	return r.ApiService.GetCustomerByIdExecute(r)
}

/*
GetCustomerById Get a customer by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Customer's unique identifier.
 @return CustomersAPIGetCustomerByIdRequest
*/
func (a *CustomersAPIService) GetCustomerById(ctx context.Context, uid string) CustomersAPIGetCustomerByIdRequest {
	return CustomersAPIGetCustomerByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return CustomerDto
func (a *CustomersAPIService) GetCustomerByIdExecute(r CustomersAPIGetCustomerByIdRequest) (*CustomerDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type CustomersAPIGetCustomerReferencesRequest struct {
	ctx context.Context
	ApiService *CustomersAPIService
	uid string
...
func (r CustomersAPIGetCustomerReferencesRequest) ReferenceLevel(referenceLevel int32) CustomersAPIGetCustomerReferencesRequest {
	r.referenceLevel = &referenceLevel
	return r
}

// Pattern of the reference value
func (r CustomersAPIGetCustomerReferencesRequest) Value(value string) CustomersAPIGetCustomerReferencesRequest {
	r.value = &value
	return r
}

// Pagination start index (offset). Default is 0.
func (r CustomersAPIGetCustomerReferencesRequest) StartIndex(startIndex int32) CustomersAPIGetCustomerReferencesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r CustomersAPIGetCustomerReferencesRequest) Count(count int32) CustomersAPIGetCustomerReferencesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r CustomersAPIGetCustomerReferencesRequest) Sort(sort []string) CustomersAPIGetCustomerReferencesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r CustomersAPIGetCustomerReferencesRequest) Desc(desc []string) CustomersAPIGetCustomerReferencesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r CustomersAPIGetCustomerReferencesRequest) Fields(fields string) CustomersAPIGetCustomerReferencesRequest {
	r.fields = &fields
	return r
}

func (r CustomersAPIGetCustomerReferencesRequest) Execute() (*IPagedResourceListCustomerReferenceDto, *http.Response, error) {
...
Get a paginated list of customer references corresponding to the specified filters.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Customer's unique identifier.
 @return CustomersAPIGetCustomerReferencesRequest
*/
func (a *CustomersAPIService) GetCustomerReferences(ctx context.Context, uid string) CustomersAPIGetCustomerReferencesRequest {
	return CustomersAPIGetCustomerReferencesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *CustomersAPIService) GetCustomerReferencesExecute(r CustomersAPIGetCustomerReferencesRequest) (*IPagedResourceListCustomerReferenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CustomersAPIGetCustomersRequest) Code(code string) CustomersAPIGetCustomersRequest {
	r.code = &code
	return r
}

// Customer label pattern
func (r CustomersAPIGetCustomersRequest) Label(label string) CustomersAPIGetCustomersRequest {
	r.label = &label
	return r
}

// Customer operation address post code pattern
func (r CustomersAPIGetCustomersRequest) PostCode(postCode string) CustomersAPIGetCustomersRequest {
	r.postCode = &postCode
	return r
}

// Customer operation address city name pattern
func (r CustomersAPIGetCustomersRequest) CityName(cityName string) CustomersAPIGetCustomersRequest {
	r.cityName = &cityName
	return r
}

// Customer operation address country code pattern
func (r CustomersAPIGetCustomersRequest) CountryCode(countryCode string) CustomersAPIGetCustomersRequest {
	r.countryCode = &countryCode
	return r
}

// Customer family code pattern
func (r CustomersAPIGetCustomersRequest) FamilyCode(familyCode string) CustomersAPIGetCustomersRequest {
	r.familyCode = &familyCode
	return r
}

// Customer agency code pattern
func (r CustomersAPIGetCustomersRequest) AgencyCode(agencyCode string) CustomersAPIGetCustomersRequest {
	r.agencyCode = &agencyCode
	return r
}

// A list of exact agency codes
func (r CustomersAPIGetCustomersRequest) AgencyCodes(agencyCodes []string) CustomersAPIGetCustomersRequest {
	r.agencyCodes = &agencyCodes
	return r
}

// Collection of customer unique identifiers
func (r CustomersAPIGetCustomersRequest) CustomerUids(customerUids []string) CustomersAPIGetCustomersRequest {
	r.customerUids = &customerUids
	return r
}

// A list of exact customer codes
func (r CustomersAPIGetCustomersRequest) CustomerCodes(customerCodes []string) CustomersAPIGetCustomersRequest {
	r.customerCodes = &customerCodes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r CustomersAPIGetCustomersRequest) Pattern(pattern string) CustomersAPIGetCustomersRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r CustomersAPIGetCustomersRequest) PatternFields(patternFields []string) CustomersAPIGetCustomersRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r CustomersAPIGetCustomersRequest) StartIndex(startIndex int32) CustomersAPIGetCustomersRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r CustomersAPIGetCustomersRequest) Count(count int32) CustomersAPIGetCustomersRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r CustomersAPIGetCustomersRequest) Sort(sort []string) CustomersAPIGetCustomersRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r CustomersAPIGetCustomersRequest) Desc(desc []string) CustomersAPIGetCustomersRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r CustomersAPIGetCustomersRequest) Fields(fields string) CustomersAPIGetCustomersRequest {
	r.fields = &fields
	return r
}

func (r CustomersAPIGetCustomersRequest) Execute() (*IPagedResourceListCustomerDto, *http.Response, error) {
...
func (a *CustomersAPIService) GetCustomersExecute(r CustomersAPIGetCustomersRequest) (*IPagedResourceListCustomerDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
