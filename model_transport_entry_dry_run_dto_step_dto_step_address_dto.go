...
// checks if the TransportEntryDryRunDtoStepDtoStepAddressDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportEntryDryRunDtoStepDtoStepAddressDto{}

// TransportEntryDryRunDtoStepDtoStepAddressDto struct for TransportEntryDryRunDtoStepDtoStepAddressDto
type TransportEntryDryRunDtoStepDtoStepAddressDto struct {
	AddressId *int32 `json:"addressId,omitempty"`
	CityId *int32 `json:"cityId,omitempty"`
	CountryCode *string `json:"countryCode,omitempty"`
	OperationZoneCode *string `json:"operationZoneCode,omitempty"`
	...
	GeocodingLevel *string `json:"geocodingLevel,omitempty"`
...
// NewTransportEntryDryRunDtoStepDtoStepAddressDto instantiates a new TransportEntryDryRunDtoStepDtoStepAddressDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTransportEntryDryRunDtoStepDtoStepAddressDto() *TransportEntryDryRunDtoStepDtoStepAddressDto {
	this := TransportEntryDryRunDtoStepDtoStepAddressDto{}
	return &this
}

// NewTransportEntryDryRunDtoStepDtoStepAddressDtoWithDefaults instantiates a new TransportEntryDryRunDtoStepDtoStepAddressDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTransportEntryDryRunDtoStepDtoStepAddressDtoWithDefaults() *TransportEntryDryRunDtoStepDtoStepAddressDto {
	this := TransportEntryDryRunDtoStepDtoStepAddressDto{}
	return &this
}

// GetAddressId returns the AddressId field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressId() int32 {
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressIdOk() (*int32, bool) {
	if o == nil || IsNil(o.AddressId) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasAddressId() bool {
	if o != nil && !IsNil(o.AddressId) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetAddressId(v int32) {
	o.AddressId = &v
}

// GetCityId returns the CityId field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetCityId() int32 {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetCityIdOk() (*int32, bool) {
	if o == nil || IsNil(o.CityId) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasCityId() bool {
	if o != nil && !IsNil(o.CityId) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetCityId(v int32) {
	o.CityId = &v
}

// GetCountryCode returns the CountryCode field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetCountryCode() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetCountryCodeOk() (*string, bool) {
	if o == nil || IsNil(o.CountryCode) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasCountryCode() bool {
	if o != nil && !IsNil(o.CountryCode) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetCountryCode(v string) {
	o.CountryCode = &v
}

// GetOperationZoneCode returns the OperationZoneCode field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetOperationZoneCode() string {
	if o == nil || IsNil(o.OperationZoneCode) {
		var ret string
		return ret
	}
	return *o.OperationZoneCode
}

// GetOperationZoneCodeOk returns a tuple with the OperationZoneCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetOperationZoneCodeOk() (*string, bool) {
	if o == nil || IsNil(o.OperationZoneCode) {
		return nil, false
	}
	return o.OperationZoneCode, true
}

// HasOperationZoneCode returns a boolean if a field has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasOperationZoneCode() bool {
	if o != nil && !IsNil(o.OperationZoneCode) {
		return true
	}
...
// SetOperationZoneCode gets a reference to the given string and assigns it to the OperationZoneCode field.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetOperationZoneCode(v string) {
	o.OperationZoneCode = &v
}

// GetPostCode returns the PostCode field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetPostCode() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetPostCodeOk() (*string, bool) {
	if o == nil || IsNil(o.PostCode) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasPostCode() bool {
	if o != nil && !IsNil(o.PostCode) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetPostCode(v string) {
	o.PostCode = &v
}

// GetCityName returns the CityName field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetCityName() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetCityNameOk() (*string, bool) {
	if o == nil || IsNil(o.CityName) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasCityName() bool {
	if o != nil && !IsNil(o.CityName) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetCityName(v string) {
	o.CityName = &v
}

// GetSectorCode returns the SectorCode field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetSectorCode() string {
	if o == nil || IsNil(o.SectorCode) {
		var ret string
		return ret
	}
	return *o.SectorCode
...
// GetSectorCodeOk returns a tuple with the SectorCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetSectorCodeOk() (*string, bool) {
	if o == nil || IsNil(o.SectorCode) {
		return nil, false
	}
	return o.SectorCode, true
}

// HasSectorCode returns a boolean if a field has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasSectorCode() bool {
	if o != nil && !IsNil(o.SectorCode) {
		return true
	}
...
// SetSectorCode gets a reference to the given string and assigns it to the SectorCode field.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetSectorCode(v string) {
	o.SectorCode = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetName(v string) {
	o.Name = &v
}

// GetStreetNumber returns the StreetNumber field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetStreetNumber() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetStreetNumberOk() (*string, bool) {
	if o == nil || IsNil(o.StreetNumber) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasStreetNumber() bool {
	if o != nil && !IsNil(o.StreetNumber) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetStreetNumber(v string) {
	o.StreetNumber = &v
}

// GetStreetName returns the StreetName field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetStreetName() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetStreetNameOk() (*string, bool) {
	if o == nil || IsNil(o.StreetName) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasStreetName() bool {
	if o != nil && !IsNil(o.StreetName) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetStreetName(v string) {
	o.StreetName = &v
}

// GetAddressLine1 returns the AddressLine1 field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressLine1() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressLine1Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressLine1) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasAddressLine1() bool {
	if o != nil && !IsNil(o.AddressLine1) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetAddressLine1(v string) {
	o.AddressLine1 = &v
}

// GetAddressLine2 returns the AddressLine2 field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressLine2() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressLine2Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressLine2) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasAddressLine2() bool {
	if o != nil && !IsNil(o.AddressLine2) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetAddressLine2(v string) {
	o.AddressLine2 = &v
}

// GetGeocodingLevel returns the GeocodingLevel field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetGeocodingLevel() string {
	if o == nil || IsNil(o.GeocodingLevel) {
		var ret string
		return ret
	}
	return *o.GeocodingLevel
}

// GetGeocodingLevelOk returns a tuple with the GeocodingLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetGeocodingLevelOk() (*string, bool) {
	if o == nil || IsNil(o.GeocodingLevel) {
		return nil, false
	}
	return o.GeocodingLevel, true
}

// HasGeocodingLevel returns a boolean if a field has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasGeocodingLevel() bool {
	if o != nil && !IsNil(o.GeocodingLevel) {
		return true
	}
...
// SetGeocodingLevel gets a reference to the given string and assigns it to the GeocodingLevel field.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetGeocodingLevel(v string) {
	o.GeocodingLevel = &v
}

// GetLongitude returns the Longitude field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetLongitude() float64 {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetLongitudeOk() (*float64, bool) {
	if o == nil || IsNil(o.Longitude) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasLongitude() bool {
	if o != nil && !IsNil(o.Longitude) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetLongitude(v float64) {
	o.Longitude = &v
}

// GetLatitude returns the Latitude field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetLatitude() float64 {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetLatitudeOk() (*float64, bool) {
	if o == nil || IsNil(o.Latitude) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasLatitude() bool {
	if o != nil && !IsNil(o.Latitude) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetLatitude(v float64) {
	o.Latitude = &v
}

// GetAddressComplement1 returns the AddressComplement1 field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement1() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement1Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement1) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasAddressComplement1() bool {
	if o != nil && !IsNil(o.AddressComplement1) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetAddressComplement1(v string) {
	o.AddressComplement1 = &v
}

// GetAddressComplement2 returns the AddressComplement2 field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement2() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement2Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement2) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasAddressComplement2() bool {
	if o != nil && !IsNil(o.AddressComplement2) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetAddressComplement2(v string) {
	o.AddressComplement2 = &v
}

// GetAddressComplement3 returns the AddressComplement3 field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement3() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement3Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement3) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasAddressComplement3() bool {
	if o != nil && !IsNil(o.AddressComplement3) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetAddressComplement3(v string) {
	o.AddressComplement3 = &v
}

// GetAddressComplement4 returns the AddressComplement4 field value if set, zero value otherwise.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement4() string {
...
// and a boolean to check if the value has been set.
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) GetAddressComplement4Ok() (*string, bool) {
	if o == nil || IsNil(o.AddressComplement4) {
		return nil, false
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) HasAddressComplement4() bool {
	if o != nil && !IsNil(o.AddressComplement4) {
		return true
	}
...
func (o *TransportEntryDryRunDtoStepDtoStepAddressDto) SetAddressComplement4(v string) {
	o.AddressComplement4 = &v
}

func (o TransportEntryDryRunDtoStepDtoStepAddressDto) MarshalJSON() ([]byte, error) {
...
func (o TransportEntryDryRunDtoStepDtoStepAddressDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OperationZoneCode) {
		toSerialize["operationZoneCode"] = o.OperationZoneCode
	}
	if !IsNil(o.PostCode) {
	...
	if !IsNil(o.SectorCode) {
		toSerialize["sectorCode"] = o.SectorCode
	}
	if !IsNil(o.Name) {
	...
	if !IsNil(o.GeocodingLevel) {
		toSerialize["geocodingLevel"] = o.GeocodingLevel
	}
...
type NullableTransportEntryDryRunDtoStepDtoStepAddressDto struct {
	value *TransportEntryDryRunDtoStepDtoStepAddressDto
	isSet bool
}

func (v NullableTransportEntryDryRunDtoStepDtoStepAddressDto) Get() *TransportEntryDryRunDtoStepDtoStepAddressDto {
	return v.value
}

func (v *NullableTransportEntryDryRunDtoStepDtoStepAddressDto) Set(val *TransportEntryDryRunDtoStepDtoStepAddressDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportEntryDryRunDtoStepDtoStepAddressDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportEntryDryRunDtoStepDtoStepAddressDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportEntryDryRunDtoStepDtoStepAddressDto(val *TransportEntryDryRunDtoStepDtoStepAddressDto) *NullableTransportEntryDryRunDtoStepDtoStepAddressDto {
	return &NullableTransportEntryDryRunDtoStepDtoStepAddressDto{value: val, isSet: true}
}

func (v NullableTransportEntryDryRunDtoStepDtoStepAddressDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportEntryDryRunDtoStepDtoStepAddressDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
