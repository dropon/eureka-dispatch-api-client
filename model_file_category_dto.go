...
// checks if the FileCategoryDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileCategoryDto{}

// FileCategoryDto struct for FileCategoryDto
type FileCategoryDto struct {
	// The unique business code for the file category.
	Code *string `json:"code,omitempty"`
	// The file category label
	Label *string `json:"label,omitempty"`
	// Defines whether the file category is visible for orderers
	IsVisibleForOrderers *bool `json:"isVisibleForOrderers,omitempty"`
	// Defines whether the file category is visible for drivers.
	IsVisibleForDrivers *bool `json:"isVisibleForDrivers,omitempty"`
	// Defines whether thi file category is a billing receipt.
	IsBillingReceipt *bool `json:"isBillingReceipt,omitempty"`
	// The substate triggered by the file category
...
// GetIsVisibleForOrderers returns the IsVisibleForOrderers field value if set, zero value otherwise.
func (o *FileCategoryDto) GetIsVisibleForOrderers() bool {
	if o == nil || IsNil(o.IsVisibleForOrderers) {
		var ret bool
		return ret
	}
	return *o.IsVisibleForOrderers
}

// GetIsVisibleForOrderersOk returns a tuple with the IsVisibleForOrderers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FileCategoryDto) GetIsVisibleForOrderersOk() (*bool, bool) {
	if o == nil || IsNil(o.IsVisibleForOrderers) {
		return nil, false
	}
	return o.IsVisibleForOrderers, true
}
...
// SetIsVisibleForOrderers gets a reference to the given bool and assigns it to the IsVisibleForOrderers field.
func (o *FileCategoryDto) SetIsVisibleForOrderers(v bool) {
	o.IsVisibleForOrderers = &v
}

// GetIsVisibleForDrivers returns the IsVisibleForDrivers field value if set, zero value otherwise.
func (o *FileCategoryDto) GetIsVisibleForDrivers() bool {
	if o == nil || IsNil(o.IsVisibleForDrivers) {
		var ret bool
		return ret
	}
	return *o.IsVisibleForDrivers
}

// GetIsVisibleForDriversOk returns a tuple with the IsVisibleForDrivers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FileCategoryDto) GetIsVisibleForDriversOk() (*bool, bool) {
	if o == nil || IsNil(o.IsVisibleForDrivers) {
		return nil, false
	}
	return o.IsVisibleForDrivers, true
}
...
// SetIsVisibleForDrivers gets a reference to the given bool and assigns it to the IsVisibleForDrivers field.
func (o *FileCategoryDto) SetIsVisibleForDrivers(v bool) {
	o.IsVisibleForDrivers = &v
}

// GetIsBillingReceipt returns the IsBillingReceipt field value if set, zero value otherwise.
func (o *FileCategoryDto) GetIsBillingReceipt() bool {
	if o == nil || IsNil(o.IsBillingReceipt) {
		var ret bool
		return ret
	}
	return *o.IsBillingReceipt
}

// GetIsBillingReceiptOk returns a tuple with the IsBillingReceipt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FileCategoryDto) GetIsBillingReceiptOk() (*bool, bool) {
	if o == nil || IsNil(o.IsBillingReceipt) {
		return nil, false
	}
	return o.IsBillingReceipt, true
}
...
// SetIsBillingReceipt gets a reference to the given bool and assigns it to the IsBillingReceipt field.
func (o *FileCategoryDto) SetIsBillingReceipt(v bool) {
	o.IsBillingReceipt = &v
}
...
func (o FileCategoryDto) MarshalJSON() ([]byte, error) {
...
func (o FileCategoryDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsVisibleForOrderers) {
		toSerialize["isVisibleForOrderers"] = o.IsVisibleForOrderers
	}
	if !IsNil(o.IsVisibleForDrivers) {
		toSerialize["isVisibleForDrivers"] = o.IsVisibleForDrivers
	}
	if !IsNil(o.IsBillingReceipt) {
		toSerialize["isBillingReceipt"] = o.IsBillingReceipt
	}
...
type NullableFileCategoryDto struct {
	value *FileCategoryDto
	isSet bool
}

func (v NullableFileCategoryDto) Get() *FileCategoryDto {
	return v.value
}

func (v *NullableFileCategoryDto) Set(val *FileCategoryDto) {
	v.value = val
	v.isSet = true
}

func (v NullableFileCategoryDto) IsSet() bool {
	return v.isSet
}

func (v *NullableFileCategoryDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileCategoryDto(val *FileCategoryDto) *NullableFileCategoryDto {
	return &NullableFileCategoryDto{value: val, isSet: true}
}

func (v NullableFileCategoryDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileCategoryDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
