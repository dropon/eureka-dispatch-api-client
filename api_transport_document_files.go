...
type ApiDeleteTransportDocumentFileRequest struct {
	ctx context.Context
...
func (r ApiDeleteTransportDocumentFileRequest) Execute() (*http.Response, error) {
...
Delete a transport document file by transport unique identifier and file identifier.
 ...
 @return ApiDeleteTransportDocumentFileRequest
*/
func (a *TransportDocumentFilesAPIService) DeleteTransportDocumentFile(ctx context.Context, uid string, fileId string) ApiDeleteTransportDocumentFileRequest {
	return ApiDeleteTransportDocumentFileRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentFilesAPIService) DeleteTransportDocumentFileExecute(r ApiDeleteTransportDocumentFileRequest) (*http.Response, error) {
	var (
...
type ApiDownloadTransportDocumentFileRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	fileId string
...
func (r ApiDownloadTransportDocumentFileRequest) Execute() (*os.File, *http.Response, error) {
...
Download a transport document file by transport unique identifier and file identifier.
 ...
 @param uid Transport's unique identifier
 @param fileId File identifier
 @return ApiDownloadTransportDocumentFileRequest
*/
func (a *TransportDocumentFilesAPIService) DownloadTransportDocumentFile(ctx context.Context, uid string, fileId string) ApiDownloadTransportDocumentFileRequest {
	return ApiDownloadTransportDocumentFileRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return *os.File
func (a *TransportDocumentFilesAPIService) DownloadTransportDocumentFileExecute(r ApiDownloadTransportDocumentFileRequest) (*os.File, *http.Response, error) {
	var (
...
type ApiGetTransportDocumentFileByIdRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	fileId string
...
func (r ApiGetTransportDocumentFileByIdRequest) Fields(fields string) ApiGetTransportDocumentFileByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetTransportDocumentFileByIdRequest) Execute() (*TransportDocumentFileDto, *http.Response, error) {
...
Get a transport document file by transport unique identifier and file identifier.
 ...
 @param uid Transport's unique identifier
 @param fileId File identifier
 @return ApiGetTransportDocumentFileByIdRequest
*/
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFileById(ctx context.Context, uid string, fileId string) ApiGetTransportDocumentFileByIdRequest {
	return ApiGetTransportDocumentFileByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFileByIdExecute(r ApiGetTransportDocumentFileByIdRequest) (*TransportDocumentFileDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetTransportDocumentFilesRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	startIndex *int32
...
func (r ApiGetTransportDocumentFilesRequest) StartIndex(startIndex int32) ApiGetTransportDocumentFilesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetTransportDocumentFilesRequest) Count(count int32) ApiGetTransportDocumentFilesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetTransportDocumentFilesRequest) Sort(sort []string) ApiGetTransportDocumentFilesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetTransportDocumentFilesRequest) Desc(desc []string) ApiGetTransportDocumentFilesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetTransportDocumentFilesRequest) Fields(fields string) ApiGetTransportDocumentFilesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetTransportDocumentFilesRequest) Execute() (*IPagedResourceListTransportDocumentFileDto, *http.Response, error) {
...
Get a paginated list of transport document files by the transport unique identifier.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @return ApiGetTransportDocumentFilesRequest
*/
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFiles(ctx context.Context, uid string) ApiGetTransportDocumentFilesRequest {
	return ApiGetTransportDocumentFilesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFilesExecute(r ApiGetTransportDocumentFilesRequest) (*IPagedResourceListTransportDocumentFileDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiUploadTransportDocumentFileRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	file *os.File
...
func (r ApiUploadTransportDocumentFileRequest) File(file *os.File) ApiUploadTransportDocumentFileRequest {
	r.file = file
	return r
}

func (r ApiUploadTransportDocumentFileRequest) FileCategoryCode(fileCategoryCode string) ApiUploadTransportDocumentFileRequest {
	r.fileCategoryCode = &fileCategoryCode
	return r
}

func (r ApiUploadTransportDocumentFileRequest) FileLabel(fileLabel string) ApiUploadTransportDocumentFileRequest {
	r.fileLabel = &fileLabel
	return r
}

func (r ApiUploadTransportDocumentFileRequest) Execute() (*UploadTransportDocumentFileResultDto, *http.Response, error) {
...
This value can change depending on the carrier.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @return ApiUploadTransportDocumentFileRequest
*/
func (a *TransportDocumentFilesAPIService) UploadTransportDocumentFile(ctx context.Context, uid string) ApiUploadTransportDocumentFileRequest {
	return ApiUploadTransportDocumentFileRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentFilesAPIService) UploadTransportDocumentFileExecute(r ApiUploadTransportDocumentFileRequest) (*UploadTransportDocumentFileResultDto, *http.Response, error) {
	var (
