...
// TransportDocumentFilesAPIService TransportDocumentFilesAPI service
type TransportDocumentFilesAPIService service

type TransportDocumentFilesAPIDeleteTransportDocumentFileRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	fileId string
}

func (r TransportDocumentFilesAPIDeleteTransportDocumentFileRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteTransportDocumentFileExecute(r)
}

/*
DeleteTransportDocumentFile Delete transport document file

Delete a transport document file by transport unique identifier and file identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @param fileId File identifier
 @return TransportDocumentFilesAPIDeleteTransportDocumentFileRequest
*/
func (a *TransportDocumentFilesAPIService) DeleteTransportDocumentFile(ctx context.Context, uid string, fileId string) TransportDocumentFilesAPIDeleteTransportDocumentFileRequest {
	return TransportDocumentFilesAPIDeleteTransportDocumentFileRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentFilesAPIService) DeleteTransportDocumentFileExecute(r TransportDocumentFilesAPIDeleteTransportDocumentFileRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentFilesAPIService.DeleteTransportDocumentFile")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transports/{uid}/documents/files/{fileId}"
...
type TransportDocumentFilesAPIDownloadTransportDocumentFileRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	fileId string
...
func (r TransportDocumentFilesAPIDownloadTransportDocumentFileRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.DownloadTransportDocumentFileExecute(r)
}

/*
DownloadTransportDocumentFile Download transport document file

Download a transport document file by transport unique identifier and file identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @param fileId File identifier
 @return TransportDocumentFilesAPIDownloadTransportDocumentFileRequest
*/
func (a *TransportDocumentFilesAPIService) DownloadTransportDocumentFile(ctx context.Context, uid string, fileId string) TransportDocumentFilesAPIDownloadTransportDocumentFileRequest {
	return TransportDocumentFilesAPIDownloadTransportDocumentFileRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return *os.File
func (a *TransportDocumentFilesAPIService) DownloadTransportDocumentFileExecute(r TransportDocumentFilesAPIDownloadTransportDocumentFileRequest) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentFilesAPIService.DownloadTransportDocumentFile")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transports/{uid}/documents/files/{fileId}/data"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"fileId"+"}", url.PathEscape(parameterValueToString(r.fileId, "fileId")), -1)
...
type TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	fileId string
...
func (r TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest) Fields(fields string) TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest {
	r.fields = &fields
	return r
}

func (r TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest) Execute() (*TransportDocumentFileDto, *http.Response, error) {
	return r.ApiService.GetTransportDocumentFileByIdExecute(r)
}

/*
GetTransportDocumentFileById Get transport document file by id

Get a transport document file by transport unique identifier and file identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @param fileId File identifier
 @return TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest
*/
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFileById(ctx context.Context, uid string, fileId string) TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest {
	return TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return TransportDocumentFileDto
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFileByIdExecute(r TransportDocumentFilesAPIGetTransportDocumentFileByIdRequest) (*TransportDocumentFileDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TransportDocumentFileDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentFilesAPIService.GetTransportDocumentFileById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type TransportDocumentFilesAPIGetTransportDocumentFilesRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	startIndex *int32
...
func (r TransportDocumentFilesAPIGetTransportDocumentFilesRequest) StartIndex(startIndex int32) TransportDocumentFilesAPIGetTransportDocumentFilesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r TransportDocumentFilesAPIGetTransportDocumentFilesRequest) Count(count int32) TransportDocumentFilesAPIGetTransportDocumentFilesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r TransportDocumentFilesAPIGetTransportDocumentFilesRequest) Sort(sort []string) TransportDocumentFilesAPIGetTransportDocumentFilesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r TransportDocumentFilesAPIGetTransportDocumentFilesRequest) Desc(desc []string) TransportDocumentFilesAPIGetTransportDocumentFilesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r TransportDocumentFilesAPIGetTransportDocumentFilesRequest) Fields(fields string) TransportDocumentFilesAPIGetTransportDocumentFilesRequest {
	r.fields = &fields
	return r
}

func (r TransportDocumentFilesAPIGetTransportDocumentFilesRequest) Execute() (*IPagedResourceListTransportDocumentFileDto, *http.Response, error) {
	return r.ApiService.GetTransportDocumentFilesExecute(r)
}

/*
GetTransportDocumentFiles Get transport document files

Get a paginated list of transport document files by the transport unique identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @return TransportDocumentFilesAPIGetTransportDocumentFilesRequest
*/
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFiles(ctx context.Context, uid string) TransportDocumentFilesAPIGetTransportDocumentFilesRequest {
	return TransportDocumentFilesAPIGetTransportDocumentFilesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IPagedResourceListTransportDocumentFileDto
func (a *TransportDocumentFilesAPIService) GetTransportDocumentFilesExecute(r TransportDocumentFilesAPIGetTransportDocumentFilesRequest) (*IPagedResourceListTransportDocumentFileDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListTransportDocumentFileDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentFilesAPIService.GetTransportDocumentFiles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transports/{uid}/documents/files"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type TransportDocumentFilesAPIUploadTransportDocumentFileRequest struct {
	ctx context.Context
	ApiService *TransportDocumentFilesAPIService
	uid string
	file *os.File
...
func (r TransportDocumentFilesAPIUploadTransportDocumentFileRequest) File(file *os.File) TransportDocumentFilesAPIUploadTransportDocumentFileRequest {
	r.file = file
	return r
}

func (r TransportDocumentFilesAPIUploadTransportDocumentFileRequest) FileCategoryCode(fileCategoryCode string) TransportDocumentFilesAPIUploadTransportDocumentFileRequest {
	r.fileCategoryCode = &fileCategoryCode
	return r
}

func (r TransportDocumentFilesAPIUploadTransportDocumentFileRequest) FileLabel(fileLabel string) TransportDocumentFilesAPIUploadTransportDocumentFileRequest {
	r.fileLabel = &fileLabel
	return r
}

func (r TransportDocumentFilesAPIUploadTransportDocumentFileRequest) Execute() (*UploadTransportDocumentFileResultDto, *http.Response, error) {
	return r.ApiService.UploadTransportDocumentFileExecute(r)
}

/*
UploadTransportDocumentFile Upload transport document file

Upload a transport document file with additional metadata.  
This method expects a request with a MIME multi part content containing :
 - A file attachment.
 - An optional form input with key 'fileLabel' corresponding to file's label. 
 - An optional form input with key 'fileCategoryCode' corresponding to the code of an existing file category.
   If no file category code is provided, the default code defined in the global settings will be used.
The file size must not exceed the maximum allowed content length, which is 100 Mb by default.
This value can change depending on the carrier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @return TransportDocumentFilesAPIUploadTransportDocumentFileRequest
*/
func (a *TransportDocumentFilesAPIService) UploadTransportDocumentFile(ctx context.Context, uid string) TransportDocumentFilesAPIUploadTransportDocumentFileRequest {
	return TransportDocumentFilesAPIUploadTransportDocumentFileRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return UploadTransportDocumentFileResultDto
func (a *TransportDocumentFilesAPIService) UploadTransportDocumentFileExecute(r TransportDocumentFilesAPIUploadTransportDocumentFileRequest) (*UploadTransportDocumentFileResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UploadTransportDocumentFileResultDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentFilesAPIService.UploadTransportDocumentFile")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.fileCategoryCode == nil {
		return localVarReturnValue, nil, reportError("fileCategoryCode is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarFormParams, "fileCategoryCode", r.fileCategoryCode, "", "")
	if r.fileLabel != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "fileLabel", r.fileLabel, "", "")
	}
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
