...
type ApiGetAllSubServicesRequest struct {
	ctx context.Context
...
func (r ApiGetAllSubServicesRequest) IsEnabled(isEnabled bool) ApiGetAllSubServicesRequest {
	r.isEnabled = &isEnabled
	return r
}

// Sub service code pattern
func (r ApiGetAllSubServicesRequest) Code(code string) ApiGetAllSubServicesRequest {
	r.code = &code
	return r
}

// Sub service label pattern
func (r ApiGetAllSubServicesRequest) Label(label string) ApiGetAllSubServicesRequest {
	r.label = &label
	return r
}

// List of sub service codes
func (r ApiGetAllSubServicesRequest) Codes(codes []string) ApiGetAllSubServicesRequest {
	r.codes = &codes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetAllSubServicesRequest) Pattern(pattern string) ApiGetAllSubServicesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetAllSubServicesRequest) PatternFields(patternFields []string) ApiGetAllSubServicesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetAllSubServicesRequest) StartIndex(startIndex int32) ApiGetAllSubServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetAllSubServicesRequest) Count(count int32) ApiGetAllSubServicesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetAllSubServicesRequest) Sort(sort []string) ApiGetAllSubServicesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetAllSubServicesRequest) Desc(desc []string) ApiGetAllSubServicesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetAllSubServicesRequest) Fields(fields string) ApiGetAllSubServicesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetAllSubServicesRequest) Execute() (*IPagedResourceListSubServiceDto, *http.Response, error) {
	return r.ApiService.GetAllSubServicesExecute(r)
}

/*
GetAllSubServices Get sub services

Get a paginated list of sub services corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAllSubServicesRequest
*/
func (a *SubServicesAPIService) GetAllSubServices(ctx context.Context) ApiGetAllSubServicesRequest {
	return ApiGetAllSubServicesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubServicesAPIService) GetAllSubServicesExecute(r ApiGetAllSubServicesRequest) (*IPagedResourceListSubServiceDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubServicesAPIService.GetAllSubServices")
	if err != nil {
...
type ApiGetQuantitiesRequest struct {
	ctx context.Context
	ApiService *SubServicesAPIService
...
// Sub service code
func (r ApiGetQuantitiesRequest) SubServiceCode(subServiceCode string) ApiGetQuantitiesRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetQuantitiesRequest) StartIndex(startIndex int32) ApiGetQuantitiesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetQuantitiesRequest) Count(count int32) ApiGetQuantitiesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetQuantitiesRequest) Sort(sort []string) ApiGetQuantitiesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetQuantitiesRequest) Desc(desc []string) ApiGetQuantitiesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetQuantitiesRequest) Fields(fields string) ApiGetQuantitiesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetQuantitiesRequest) Execute() (*IPagedResourceListSubServiceQuantityDto, *http.Response, error) {
...
Get a paginated list of quantities corresponding to the specified sub service.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetQuantitiesRequest
*/
func (a *SubServicesAPIService) GetQuantities(ctx context.Context) ApiGetQuantitiesRequest {
	return ApiGetQuantitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubServicesAPIService) GetQuantitiesExecute(r ApiGetQuantitiesRequest) (*IPagedResourceListSubServiceQuantityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
