...
// SubServicesAPIService SubServicesAPI service
type SubServicesAPIService service

type SubServicesAPIGetQuantitiesRequest struct {
	ctx context.Context
	ApiService *SubServicesAPIService
...
// Sub service code
func (r SubServicesAPIGetQuantitiesRequest) SubServiceCode(subServiceCode string) SubServicesAPIGetQuantitiesRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r SubServicesAPIGetQuantitiesRequest) StartIndex(startIndex int32) SubServicesAPIGetQuantitiesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r SubServicesAPIGetQuantitiesRequest) Count(count int32) SubServicesAPIGetQuantitiesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r SubServicesAPIGetQuantitiesRequest) Sort(sort []string) SubServicesAPIGetQuantitiesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r SubServicesAPIGetQuantitiesRequest) Desc(desc []string) SubServicesAPIGetQuantitiesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r SubServicesAPIGetQuantitiesRequest) Fields(fields string) SubServicesAPIGetQuantitiesRequest {
	r.fields = &fields
	return r
}

func (r SubServicesAPIGetQuantitiesRequest) Execute() (*IPagedResourceListSubServiceQuantityDto, *http.Response, error) {
	return r.ApiService.GetQuantitiesExecute(r)
}

/*
GetQuantities Get quantities

Get a paginated list of quantities corresponding to the specified sub service.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubServicesAPIGetQuantitiesRequest
*/
func (a *SubServicesAPIService) GetQuantities(ctx context.Context) SubServicesAPIGetQuantitiesRequest {
	return SubServicesAPIGetQuantitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return IPagedResourceListSubServiceQuantityDto
func (a *SubServicesAPIService) GetQuantitiesExecute(r SubServicesAPIGetQuantitiesRequest) (*IPagedResourceListSubServiceQuantityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListSubServiceQuantityDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubServicesAPIService.GetQuantities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/sub-services/quantities"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.subServiceCode == nil {
		return localVarReturnValue, nil, reportError("subServiceCode is required and must be specified")
	}
...
type SubServicesAPIGetSubServicesRequest struct {
	ctx context.Context
	ApiService *SubServicesAPIService
	isEnabled *bool
	code *string
...
func (r SubServicesAPIGetSubServicesRequest) IsEnabled(isEnabled bool) SubServicesAPIGetSubServicesRequest {
	r.isEnabled = &isEnabled
	return r
}

// Sub service code pattern
func (r SubServicesAPIGetSubServicesRequest) Code(code string) SubServicesAPIGetSubServicesRequest {
	r.code = &code
	return r
}

// Sub service label pattern
func (r SubServicesAPIGetSubServicesRequest) Label(label string) SubServicesAPIGetSubServicesRequest {
	r.label = &label
	return r
}

// List of sub service codes
func (r SubServicesAPIGetSubServicesRequest) Codes(codes []string) SubServicesAPIGetSubServicesRequest {
	r.codes = &codes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r SubServicesAPIGetSubServicesRequest) Pattern(pattern string) SubServicesAPIGetSubServicesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r SubServicesAPIGetSubServicesRequest) PatternFields(patternFields []string) SubServicesAPIGetSubServicesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r SubServicesAPIGetSubServicesRequest) StartIndex(startIndex int32) SubServicesAPIGetSubServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r SubServicesAPIGetSubServicesRequest) Count(count int32) SubServicesAPIGetSubServicesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r SubServicesAPIGetSubServicesRequest) Sort(sort []string) SubServicesAPIGetSubServicesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r SubServicesAPIGetSubServicesRequest) Desc(desc []string) SubServicesAPIGetSubServicesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r SubServicesAPIGetSubServicesRequest) Fields(fields string) SubServicesAPIGetSubServicesRequest {
	r.fields = &fields
	return r
}

func (r SubServicesAPIGetSubServicesRequest) Execute() (*IPagedResourceListSubServiceDto, *http.Response, error) {
...
Get a paginated list of sub services corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubServicesAPIGetSubServicesRequest
*/
func (a *SubServicesAPIService) GetSubServices(ctx context.Context) SubServicesAPIGetSubServicesRequest {
	return SubServicesAPIGetSubServicesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListSubServiceDto
func (a *SubServicesAPIService) GetSubServicesExecute(r SubServicesAPIGetSubServicesRequest) (*IPagedResourceListSubServiceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListSubServiceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubServicesAPIService.GetSubServices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/sub-services"
