...
// TransportDocumentLinksAPIService TransportDocumentLinksAPI service
type TransportDocumentLinksAPIService service

type TransportDocumentLinksAPICreateTransportDocumentLinkRequest struct {
	ctx context.Context
	ApiService *TransportDocumentLinksAPIService
	uid string
	command *CreateTransportDocumentLinkCommand
}

// Transport link creation command
func (r TransportDocumentLinksAPICreateTransportDocumentLinkRequest) Command(command CreateTransportDocumentLinkCommand) TransportDocumentLinksAPICreateTransportDocumentLinkRequest {
	r.command = &command
	return r
}

func (r TransportDocumentLinksAPICreateTransportDocumentLinkRequest) Execute() (*CreateTransportDocumentLinkResultDto, *http.Response, error) {
	return r.ApiService.CreateTransportDocumentLinkExecute(r)
}

/*
CreateTransportDocumentLink Create a transport document link
...
If no file category code is provided, the default code defined in the global settings will be used.
 ...
 @return TransportDocumentLinksAPICreateTransportDocumentLinkRequest
*/
func (a *TransportDocumentLinksAPIService) CreateTransportDocumentLink(ctx context.Context, uid string) TransportDocumentLinksAPICreateTransportDocumentLinkRequest {
	return TransportDocumentLinksAPICreateTransportDocumentLinkRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
//  @return CreateTransportDocumentLinkResultDto
func (a *TransportDocumentLinksAPIService) CreateTransportDocumentLinkExecute(r TransportDocumentLinksAPICreateTransportDocumentLinkRequest) (*CreateTransportDocumentLinkResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateTransportDocumentLinkResultDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentLinksAPIService.CreateTransportDocumentLink")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transports/{uid}/documents/links"
...
type TransportDocumentLinksAPIDeleteTransportDocumentLinkRequest struct {
	ctx context.Context
	ApiService *TransportDocumentLinksAPIService
	uid string
	linkId string
...
func (r TransportDocumentLinksAPIDeleteTransportDocumentLinkRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteTransportDocumentLinkExecute(r)
}

/*
DeleteTransportDocumentLink Delete transport document link

Delete a transport document link by transport unique identifier and link identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @param linkId Link identifier
 @return TransportDocumentLinksAPIDeleteTransportDocumentLinkRequest
*/
func (a *TransportDocumentLinksAPIService) DeleteTransportDocumentLink(ctx context.Context, uid string, linkId string) TransportDocumentLinksAPIDeleteTransportDocumentLinkRequest {
	return TransportDocumentLinksAPIDeleteTransportDocumentLinkRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
func (a *TransportDocumentLinksAPIService) DeleteTransportDocumentLinkExecute(r TransportDocumentLinksAPIDeleteTransportDocumentLinkRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentLinksAPIService.DeleteTransportDocumentLink")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transports/{uid}/documents/links/{linkId}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest struct {
	ctx context.Context
	ApiService *TransportDocumentLinksAPIService
	uid string
	linkId string
...
func (r TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest) Fields(fields string) TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest {
	r.fields = &fields
	return r
}

func (r TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest) Execute() (*TransportDocumentLinkDto, *http.Response, error) {
	return r.ApiService.GetTransportDocumentLinkByIdExecute(r)
}

/*
GetTransportDocumentLinkById Get transport document link by id

Get a transport document link by transport unique identifier and link identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @param linkId Link identifier
 @return TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest
*/
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinkById(ctx context.Context, uid string, linkId string) TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest {
	return TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return TransportDocumentLinkDto
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinkByIdExecute(r TransportDocumentLinksAPIGetTransportDocumentLinkByIdRequest) (*TransportDocumentLinkDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TransportDocumentLinkDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentLinksAPIService.GetTransportDocumentLinkById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type TransportDocumentLinksAPIGetTransportDocumentLinksRequest struct {
	ctx context.Context
	ApiService *TransportDocumentLinksAPIService
	uid string
	startIndex *int32
...
func (r TransportDocumentLinksAPIGetTransportDocumentLinksRequest) StartIndex(startIndex int32) TransportDocumentLinksAPIGetTransportDocumentLinksRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r TransportDocumentLinksAPIGetTransportDocumentLinksRequest) Count(count int32) TransportDocumentLinksAPIGetTransportDocumentLinksRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r TransportDocumentLinksAPIGetTransportDocumentLinksRequest) Sort(sort []string) TransportDocumentLinksAPIGetTransportDocumentLinksRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r TransportDocumentLinksAPIGetTransportDocumentLinksRequest) Desc(desc []string) TransportDocumentLinksAPIGetTransportDocumentLinksRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r TransportDocumentLinksAPIGetTransportDocumentLinksRequest) Fields(fields string) TransportDocumentLinksAPIGetTransportDocumentLinksRequest {
	r.fields = &fields
	return r
}

func (r TransportDocumentLinksAPIGetTransportDocumentLinksRequest) Execute() (*IPagedResourceListTransportDocumentLinkDto, *http.Response, error) {
	return r.ApiService.GetTransportDocumentLinksExecute(r)
}

/*
GetTransportDocumentLinks Get transport document links

Get a paginated list of transport document links by the transport unique identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @return TransportDocumentLinksAPIGetTransportDocumentLinksRequest
*/
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinks(ctx context.Context, uid string) TransportDocumentLinksAPIGetTransportDocumentLinksRequest {
	return TransportDocumentLinksAPIGetTransportDocumentLinksRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IPagedResourceListTransportDocumentLinkDto
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinksExecute(r TransportDocumentLinksAPIGetTransportDocumentLinksRequest) (*IPagedResourceListTransportDocumentLinkDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListTransportDocumentLinkDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentLinksAPIService.GetTransportDocumentLinks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
