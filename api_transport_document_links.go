...
type ApiCreateTransportDocumentLinkRequest struct {
	ctx context.Context
...
func (r ApiCreateTransportDocumentLinkRequest) Command(command CreateTransportDocumentLinkCommand) ApiCreateTransportDocumentLinkRequest {
	r.command = &command
	return r
}

func (r ApiCreateTransportDocumentLinkRequest) Execute() (*CreateTransportDocumentLinkResultDto, *http.Response, error) {
...
If no file category code is provided, the default code defined in the global settings will be used.
 ...
 @return ApiCreateTransportDocumentLinkRequest
*/
func (a *TransportDocumentLinksAPIService) CreateTransportDocumentLink(ctx context.Context, uid string) ApiCreateTransportDocumentLinkRequest {
	return ApiCreateTransportDocumentLinkRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentLinksAPIService) CreateTransportDocumentLinkExecute(r ApiCreateTransportDocumentLinkRequest) (*CreateTransportDocumentLinkResultDto, *http.Response, error) {
	var (
...
type ApiDeleteTransportDocumentLinkRequest struct {
	ctx context.Context
	ApiService *TransportDocumentLinksAPIService
	uid string
	linkId string
...
func (r ApiDeleteTransportDocumentLinkRequest) Execute() (*http.Response, error) {
...
Delete a transport document link by transport unique identifier and link identifier.
 ...
 @return ApiDeleteTransportDocumentLinkRequest
*/
func (a *TransportDocumentLinksAPIService) DeleteTransportDocumentLink(ctx context.Context, uid string, linkId string) ApiDeleteTransportDocumentLinkRequest {
	return ApiDeleteTransportDocumentLinkRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
func (a *TransportDocumentLinksAPIService) DeleteTransportDocumentLinkExecute(r ApiDeleteTransportDocumentLinkRequest) (*http.Response, error) {
	var (
...
type ApiGetTransportDocumentLinkByIdRequest struct {
	ctx context.Context
	ApiService *TransportDocumentLinksAPIService
	uid string
	linkId string
...
func (r ApiGetTransportDocumentLinkByIdRequest) Fields(fields string) ApiGetTransportDocumentLinkByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetTransportDocumentLinkByIdRequest) Execute() (*TransportDocumentLinkDto, *http.Response, error) {
...
Get a transport document link by transport unique identifier and link identifier.
 ...
 @param uid Transport's unique identifier
 @param linkId Link identifier
 @return ApiGetTransportDocumentLinkByIdRequest
*/
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinkById(ctx context.Context, uid string, linkId string) ApiGetTransportDocumentLinkByIdRequest {
	return ApiGetTransportDocumentLinkByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinkByIdExecute(r ApiGetTransportDocumentLinkByIdRequest) (*TransportDocumentLinkDto, *http.Response, error) {
	var (
...
type ApiGetTransportDocumentLinksRequest struct {
	ctx context.Context
	ApiService *TransportDocumentLinksAPIService
	uid string
	startIndex *int32
...
func (r ApiGetTransportDocumentLinksRequest) StartIndex(startIndex int32) ApiGetTransportDocumentLinksRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetTransportDocumentLinksRequest) Count(count int32) ApiGetTransportDocumentLinksRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetTransportDocumentLinksRequest) Sort(sort []string) ApiGetTransportDocumentLinksRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetTransportDocumentLinksRequest) Desc(desc []string) ApiGetTransportDocumentLinksRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetTransportDocumentLinksRequest) Fields(fields string) ApiGetTransportDocumentLinksRequest {
	r.fields = &fields
	return r
}

func (r ApiGetTransportDocumentLinksRequest) Execute() (*IPagedResourceListTransportDocumentLinkDto, *http.Response, error) {
...
Get a paginated list of transport document links by the transport unique identifier.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Transport's unique identifier
 @return ApiGetTransportDocumentLinksRequest
*/
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinks(ctx context.Context, uid string) ApiGetTransportDocumentLinksRequest {
	return ApiGetTransportDocumentLinksRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentLinksAPIService) GetTransportDocumentLinksExecute(r ApiGetTransportDocumentLinksRequest) (*IPagedResourceListTransportDocumentLinkDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
