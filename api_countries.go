...
type ApiCheckCountryDeletionConstraintsRequest struct {
	ctx context.Context
	ApiService *CountriesAPIService
	code string
}

func (r ApiCheckCountryDeletionConstraintsRequest) Execute() (*EntityDeletionConstraintsDto, *http.Response, error) {
	return r.ApiService.CheckCountryDeletionConstraintsExecute(r)
}

/*
CheckCountryDeletionConstraints Check country deletion constraints

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param code Country iso code
 @return ApiCheckCountryDeletionConstraintsRequest
*/
func (a *CountriesAPIService) CheckCountryDeletionConstraints(ctx context.Context, code string) ApiCheckCountryDeletionConstraintsRequest {
	return ApiCheckCountryDeletionConstraintsRequest{
		ApiService: a,
		ctx: ctx,
		code: code,
...
func (a *CountriesAPIService) CheckCountryDeletionConstraintsExecute(r ApiCheckCountryDeletionConstraintsRequest) (*EntityDeletionConstraintsDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CountriesAPIService.CheckCountryDeletionConstraints")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/countries/{code}/deletion-constraints"
...
func (r ApiCreateCountryRequest) Command(command CreateCountryCommand) ApiCreateCountryRequest {
	r.command = &command
	return r
}

func (r ApiCreateCountryRequest) Execute() (*http.Response, error) {
...
*/
func (a *CountriesAPIService) CreateCountry(ctx context.Context) ApiCreateCountryRequest {
	return ApiCreateCountryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CountriesAPIService) CreateCountryExecute(r ApiCreateCountryRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CountriesAPIService.CreateCountry")
	if err != nil {
...
func (r ApiDeleteCountryRequest) Execute() (*http.Response, error) {
...
*/
func (a *CountriesAPIService) DeleteCountry(ctx context.Context, code string) ApiDeleteCountryRequest {
	return ApiDeleteCountryRequest{
		ApiService: a,
		ctx: ctx,
		code: code,
...
// Execute executes the request
func (a *CountriesAPIService) DeleteCountryExecute(r ApiDeleteCountryRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CountriesAPIService.DeleteCountry")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/countries/{code}"
	localVarPath = strings.Replace(localVarPath, "{"+"code"+"}", url.PathEscape(parameterValueToString(r.code, "code")), -1)
...
func (r ApiGetCountriesRequest) Code(code string) ApiGetCountriesRequest {
	r.code = &code
	return r
}

// Country label pattern
func (r ApiGetCountriesRequest) Label(label string) ApiGetCountriesRequest {
	r.label = &label
	return r
}

// List of exact country codes
func (r ApiGetCountriesRequest) Codes(codes []string) ApiGetCountriesRequest {
	r.codes = &codes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetCountriesRequest) Pattern(pattern string) ApiGetCountriesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetCountriesRequest) PatternFields(patternFields []string) ApiGetCountriesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetCountriesRequest) StartIndex(startIndex int32) ApiGetCountriesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCountriesRequest) Count(count int32) ApiGetCountriesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetCountriesRequest) Sort(sort []string) ApiGetCountriesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCountriesRequest) Desc(desc []string) ApiGetCountriesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCountriesRequest) Fields(fields string) ApiGetCountriesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCountriesRequest) Execute() (*IPagedResourceListCountryDto, *http.Response, error) {
...
Get a paginated list of countries corresponding to the specified filters.
...
// Execute executes the request
//  @return IPagedResourceListCountryDto
func (a *CountriesAPIService) GetCountriesExecute(r ApiGetCountriesRequest) (*IPagedResourceListCountryDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListCountryDto
	)
...
func (r ApiGetCountryByCodeRequest) Execute() (*CountryDto, *http.Response, error) {
...
// Execute executes the request
//  @return CountryDto
func (a *CountriesAPIService) GetCountryByCodeExecute(r ApiGetCountryByCodeRequest) (*CountryDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CountryDto
	)
...
type ApiGetCountryByCodeAlternativeRouteRequest struct {
	ctx context.Context
	ApiService *CountriesAPIService
	countryCode *string
	fields *string
...
// Country iso code
func (r ApiGetCountryByCodeAlternativeRouteRequest) CountryCode(countryCode string) ApiGetCountryByCodeAlternativeRouteRequest {
	r.countryCode = &countryCode
	return r
}

// Projection fields separated with a comma
func (r ApiGetCountryByCodeAlternativeRouteRequest) Fields(fields string) ApiGetCountryByCodeAlternativeRouteRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCountryByCodeAlternativeRouteRequest) Execute() (*CountryDto, *http.Response, error) {
	return r.ApiService.GetCountryByCodeAlternativeRouteExecute(r)
}

/*
GetCountryByCodeAlternativeRoute Get country by code (alternative route)

Get a country by its iso code.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCountryByCodeAlternativeRouteRequest
*/
func (a *CountriesAPIService) GetCountryByCodeAlternativeRoute(ctx context.Context) ApiGetCountryByCodeAlternativeRouteRequest {
	return ApiGetCountryByCodeAlternativeRouteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CountryDto
func (a *CountriesAPIService) GetCountryByCodeAlternativeRouteExecute(r ApiGetCountryByCodeAlternativeRouteRequest) (*CountryDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CountriesAPIService.GetCountryByCodeAlternativeRoute")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/countries/by-country-code"
...
type ApiUpdateCountryRequest struct {
	...
	ApiService *CountriesAPIService
	code string
	command *UpdateCountryDto
}

// Update country command
func (r ApiUpdateCountryRequest) Command(command UpdateCountryDto) ApiUpdateCountryRequest {
	r.command = &command
	return r
}

func (r ApiUpdateCountryRequest) Execute() (*http.Response, error) {
...
Updates a country using merge patch semantics : you need to provide only the fields to update.
...
*/
func (a *CountriesAPIService) UpdateCountry(ctx context.Context, code string) ApiUpdateCountryRequest {
	return ApiUpdateCountryRequest{
		ApiService: a,
		ctx: ctx,
		code: code,
...
// Execute executes the request
func (a *CountriesAPIService) UpdateCountryExecute(r ApiUpdateCountryRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CountriesAPIService.UpdateCountry")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
