...
func (r CountriesAPIGetCountriesRequest) Code(code string) CountriesAPIGetCountriesRequest {
	r.code = &code
	return r
}

// Country label pattern
func (r CountriesAPIGetCountriesRequest) Label(label string) CountriesAPIGetCountriesRequest {
	r.label = &label
	return r
}

// List of exact country codes
func (r CountriesAPIGetCountriesRequest) Codes(codes []string) CountriesAPIGetCountriesRequest {
	r.codes = &codes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r CountriesAPIGetCountriesRequest) Pattern(pattern string) CountriesAPIGetCountriesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r CountriesAPIGetCountriesRequest) PatternFields(patternFields []string) CountriesAPIGetCountriesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r CountriesAPIGetCountriesRequest) StartIndex(startIndex int32) CountriesAPIGetCountriesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r CountriesAPIGetCountriesRequest) Count(count int32) CountriesAPIGetCountriesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r CountriesAPIGetCountriesRequest) Sort(sort []string) CountriesAPIGetCountriesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r CountriesAPIGetCountriesRequest) Desc(desc []string) CountriesAPIGetCountriesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r CountriesAPIGetCountriesRequest) Fields(fields string) CountriesAPIGetCountriesRequest {
	r.fields = &fields
	return r
}

func (r CountriesAPIGetCountriesRequest) Execute() (*IPagedResourceListCountryDto, *http.Response, error) {
...
func (a *CountriesAPIService) GetCountriesExecute(r CountriesAPIGetCountriesRequest) (*IPagedResourceListCountryDto, *http.Response, error) {
	var (
...
type CountriesAPIGetCountryByCodeRequest struct {
	ctx context.Context
	ApiService *CountriesAPIService
	countryCode *string
	fields *string
...
// Country iso code.
func (r CountriesAPIGetCountryByCodeRequest) CountryCode(countryCode string) CountriesAPIGetCountryByCodeRequest {
	r.countryCode = &countryCode
	return r
}

// Projection fields separated with a comma
func (r CountriesAPIGetCountryByCodeRequest) Fields(fields string) CountriesAPIGetCountryByCodeRequest {
	r.fields = &fields
	return r
}

func (r CountriesAPIGetCountryByCodeRequest) Execute() (*CountryDto, *http.Response, error) {
...
Get a country by its iso code.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return CountriesAPIGetCountryByCodeRequest
*/
func (a *CountriesAPIService) GetCountryByCode(ctx context.Context) CountriesAPIGetCountryByCodeRequest {
	return CountriesAPIGetCountryByCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CountryDto
func (a *CountriesAPIService) GetCountryByCodeExecute(r CountriesAPIGetCountryByCodeRequest) (*CountryDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
