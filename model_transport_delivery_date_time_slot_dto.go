...
var _ MappedNullable = &TransportDeliveryDateTimeSlotDto{}
...
func NewTransportDeliveryDateTimeSlotDto() *TransportDeliveryDateTimeSlotDto {
	this := TransportDeliveryDateTimeSlotDto{}
	return &this
}
...
// GetPlannedStart returns the PlannedStart field value if set, zero value otherwise.
func (o *TransportDeliveryDateTimeSlotDto) GetPlannedStart() SlotDto {
	if o == nil || IsNil(o.PlannedStart) {
		var ret SlotDto
		return ret
	}
	return *o.PlannedStart
}

// GetPlannedStartOk returns a tuple with the PlannedStart field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDeliveryDateTimeSlotDto) GetPlannedStartOk() (*SlotDto, bool) {
	if o == nil || IsNil(o.PlannedStart) {
		return nil, false
	}
	return o.PlannedStart, true
}
...
// SetPlannedStart gets a reference to the given SlotDto and assigns it to the PlannedStart field.
func (o *TransportDeliveryDateTimeSlotDto) SetPlannedStart(v SlotDto) {
	o.PlannedStart = &v
}

// GetPlannedEnd returns the PlannedEnd field value if set, zero value otherwise.
func (o *TransportDeliveryDateTimeSlotDto) GetPlannedEnd() SlotDto {
	if o == nil || IsNil(o.PlannedEnd) {
		var ret SlotDto
		return ret
	}
	return *o.PlannedEnd
...
// GetPlannedEndOk returns a tuple with the PlannedEnd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDeliveryDateTimeSlotDto) GetPlannedEndOk() (*SlotDto, bool) {
	if o == nil || IsNil(o.PlannedEnd) {
		return nil, false
	}
	return o.PlannedEnd, true
}
...
// SetPlannedEnd gets a reference to the given SlotDto and assigns it to the PlannedEnd field.
...
func (o TransportDeliveryDateTimeSlotDto) MarshalJSON() ([]byte, error) {
...
func (o TransportDeliveryDateTimeSlotDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.UnloadingStart) {
		toSerialize["unloadingStart"] = o.UnloadingStart
	}
	if !IsNil(o.UnloadingEnd) {
		toSerialize["unloadingEnd"] = o.UnloadingEnd
	}
	if !IsNil(o.PlannedStart) {
		toSerialize["plannedStart"] = o.PlannedStart
	}
	if !IsNil(o.PlannedEnd) {
		toSerialize["plannedEnd"] = o.PlannedEnd
	}
	if !IsNil(o.ArrivalOnSite) {
		toSerialize["arrivalOnSite"] = o.ArrivalOnSite
	}
...
type NullableTransportDeliveryDateTimeSlotDto struct {
	value *TransportDeliveryDateTimeSlotDto
	isSet bool
}

func (v NullableTransportDeliveryDateTimeSlotDto) Get() *TransportDeliveryDateTimeSlotDto {
	return v.value
}

func (v *NullableTransportDeliveryDateTimeSlotDto) Set(val *TransportDeliveryDateTimeSlotDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportDeliveryDateTimeSlotDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportDeliveryDateTimeSlotDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportDeliveryDateTimeSlotDto(val *TransportDeliveryDateTimeSlotDto) *NullableTransportDeliveryDateTimeSlotDto {
	return &NullableTransportDeliveryDateTimeSlotDto{value: val, isSet: true}
}

func (v NullableTransportDeliveryDateTimeSlotDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportDeliveryDateTimeSlotDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
