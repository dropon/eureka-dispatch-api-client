...
func main() {
	code := "code_example" // string | Vehicle type code pattern (optional)
	label := "label_example" // string | Vehicle type label pattern (optional)
...
------------- | ------------- | ------------- | -------------
 **code** | **string** | Vehicle type code pattern | 
 **label** | **string** | Vehicle type label pattern | 
...
[**IPagedResourceListVehicleTypeDto**](IPagedResourceListVehicleTypeDto.md)
