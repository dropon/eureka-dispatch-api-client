...
------------- | ------------- | -------------
[**ApplyHistoryStateOnTransportPackageLine**](TransportsAPI.md#ApplyHistoryStateOnTransportPackageLine) | **Post** /v3/transports/{uid}/package-lines/{packageLineId}/history-states | Apply a history state on a transport package line
[**ApplySubState**](TransportsAPI.md#ApplySubState) | **Post** /v3/transports/{uid}/substates | Apply sub state
...
[**CheckSeveralTransportsAssignmentConstraints**](TransportsAPI.md#CheckSeveralTransportsAssignmentConstraints) | **Patch** /v3/transports/assignment/constraints-validation/batch | Check several transports&#39; assignment constraints
...
[**GetTransportByTransportIdentifier**](TransportsAPI.md#GetTransportByTransportIdentifier) | **Get** /v3/transports/by-transport-id | Get transport by transport identifier
...
[**UpdateSeveralTransportsAssignment**](TransportsAPI.md#UpdateSeveralTransportsAssignment) | **Patch** /v3/transports/assignment/batch | Update several transports&#39; assignment
...
## ApplyHistoryStateOnTransportPackageLine

> ApplyHistoryStateOnTransportPackageLine(ctx, uid, packageLineId).Command(command).Execute()

Apply a history state on a transport package line
...
func main() {
	...
	packageLineId := int32(56) // int32 | Package line identifier
	command := *openapiclient.NewApplyHistoryStateOnTransportPackageLineCommand() // ApplyHistoryStateOnTransportPackageLineCommand | Command containing the new state information

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.TransportsAPI.ApplyHistoryStateOnTransportPackageLine(context.Background(), uid, packageLineId).Command(command).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TransportsAPI.ApplyHistoryStateOnTransportPackageLine``: %v\n", err)
...
**packageLineId** | **int32** | Package line identifier | 

### Other Parameters

Other parameters are passed through a pointer to a apiApplyHistoryStateOnTransportPackageLineRequest struct via the builder pattern
 ...
 **command** | [**ApplyHistoryStateOnTransportPackageLineCommand**](ApplyHistoryStateOnTransportPackageLineCommand.md) | Command containing the new state information | 
...
## CheckSeveralTransportsAssignmentConstraints

> CheckBatchTransportsAssignmentConstraintsResultDto CheckSeveralTransportsAssignmentConstraints(ctx).Command(command).Execute()

Check several transports' assignment constraints
...
func main() {
	command := *openapiclient.NewAssignBatchTransportsDto([]string{"00000000-0000-0000-0000-000000000000"}, *openapiclient.NewAssignTransportDto()) // AssignBatchTransportsDto | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransportsAPI.CheckSeveralTransportsAssignmentConstraints(context.Background()).Command(command).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TransportsAPI.CheckSeveralTransportsAssignmentConstraints``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CheckSeveralTransportsAssignmentConstraints`: CheckBatchTransportsAssignmentConstraintsResultDto
	fmt.Fprintf(os.Stdout, "Response from `TransportsAPI.CheckSeveralTransportsAssignmentConstraints`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCheckSeveralTransportsAssignmentConstraintsRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **command** | [**AssignBatchTransportsDto**](AssignBatchTransportsDto.md) |  | 

### Return type

[**CheckBatchTransportsAssignmentConstraintsResultDto**](CheckBatchTransportsAssignmentConstraintsResultDto.md)
...
## GetTransportByTransportIdentifier

> TransportDto GetTransportByTransportIdentifier(ctx).TransportId(transportId).Fields(fields).Execute()

Get transport by transport identifier
...
func main() {
	transportId := int32(56) // int32 | Transport identifier
	fields := "fields_example" // string | Projection fields separated with a comma (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransportsAPI.GetTransportByTransportIdentifier(context.Background()).TransportId(transportId).Fields(fields).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TransportsAPI.GetTransportByTransportIdentifier``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetTransportByTransportIdentifier`: TransportDto
	fmt.Fprintf(os.Stdout, "Response from `TransportsAPI.GetTransportByTransportIdentifier`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTransportByTransportIdentifierRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **transportId** | **int32** | Transport identifier | 
 **fields** | **string** | Projection fields separated with a comma | 
...
## UpdateSeveralTransportsAssignment

> AssignBatchTransportsResultDto UpdateSeveralTransportsAssignment(ctx).Command(command).Execute()

Update several transports' assignment
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TransportsAPI.UpdateSeveralTransportsAssignment(context.Background()).Command(command).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TransportsAPI.UpdateSeveralTransportsAssignment``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UpdateSeveralTransportsAssignment`: AssignBatchTransportsResultDto
	fmt.Fprintf(os.Stdout, "Response from `TransportsAPI.UpdateSeveralTransportsAssignment`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSeveralTransportsAssignmentRequest struct via the builder pattern
...
[**AssignBatchTransportsResultDto**](AssignBatchTransportsResultDto.md)
