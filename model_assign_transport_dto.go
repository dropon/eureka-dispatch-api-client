...
// checks if the AssignTransportDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssignTransportDto{}

// AssignTransportDto Assignment/unassignment context to apply to a transport.
type AssignTransportDto struct {
	// Identifier of the driver to assign to the transport.    When the driver is unset, the transport is un-assigned.    When the driver is updated, the transport is assigned to this driver.
	DriverId *int32 `json:"driverId,omitempty"`
	// Vehicle's unique identifier
	VehicleUid *string `json:"vehicleUid,omitempty"`
	// Trailer's unique identifier
	TrailerUid *string `json:"trailerUid,omitempty"`
	// Identifier of the handler
	HandlerId *int32 `json:"handlerId,omitempty"`
	// Identifier of the contractor agent.    It can be provided only when the driver is a subcontractor or a subcontractor employee.
	ContractorAgentId *int32 `json:"contractorAgentId,omitempty"`
	// Name of the contractor agent.    To be provided when the contractor does not exist in the system (free text).    It can be provided only when the driver is a subcontractor or a subcontractor employee.
	ContractorAgentName *string `json:"contractorAgentName,omitempty"`
	ApiBehavior *AssignTransportDtoApiBehaviorDto `json:"apiBehavior,omitempty"`
}
...
// GetVehicleUid returns the VehicleUid field value if set, zero value otherwise.
func (o *AssignTransportDto) GetVehicleUid() string {
	if o == nil || IsNil(o.VehicleUid) {
		var ret string
		return ret
	}
	return *o.VehicleUid
...
// GetVehicleUidOk returns a tuple with the VehicleUid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AssignTransportDto) GetVehicleUidOk() (*string, bool) {
	if o == nil || IsNil(o.VehicleUid) {
		return nil, false
	}
	return o.VehicleUid, true
}
...
// SetVehicleUid gets a reference to the given string and assigns it to the VehicleUid field.
...
func (o *AssignTransportDto) GetApiBehavior() AssignTransportDtoApiBehaviorDto {
	if o == nil || IsNil(o.ApiBehavior) {
		var ret AssignTransportDtoApiBehaviorDto
		return ret
	}
...
// SetApiBehavior gets a reference to the given AssignTransportDtoApiBehaviorDto and assigns it to the ApiBehavior field.
func (o *AssignTransportDto) SetApiBehavior(v AssignTransportDtoApiBehaviorDto) {
	o.ApiBehavior = &v
}

func (o AssignTransportDto) MarshalJSON() ([]byte, error) {
...
func (o AssignTransportDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DriverId) {
		toSerialize["driverId"] = o.DriverId
	}
	if !IsNil(o.VehicleUid) {
		toSerialize["vehicleUid"] = o.VehicleUid
	}
...
type NullableAssignTransportDto struct {
	value *AssignTransportDto
	isSet bool
}

func (v NullableAssignTransportDto) Get() *AssignTransportDto {
	return v.value
}

func (v *NullableAssignTransportDto) Set(val *AssignTransportDto) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignTransportDto) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignTransportDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignTransportDto(val *AssignTransportDto) *NullableAssignTransportDto {
	return &NullableAssignTransportDto{value: val, isSet: true}
}

func (v NullableAssignTransportDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignTransportDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
