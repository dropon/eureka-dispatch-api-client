...
// checks if the CustomerBillingAddressDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerBillingAddressDto{}

// CustomerBillingAddressDto struct for CustomerBillingAddressDto
type CustomerBillingAddressDto struct {
...
func NewCustomerBillingAddressDto() *CustomerBillingAddressDto {
	this := CustomerBillingAddressDto{}
	return &this
}
...
func (o CustomerBillingAddressDto) MarshalJSON() ([]byte, error) {
...
func (o CustomerBillingAddressDto) ToMap() (map[string]interface{}, error) {
...
type NullableCustomerBillingAddressDto struct {
	value *CustomerBillingAddressDto
	isSet bool
}

func (v NullableCustomerBillingAddressDto) Get() *CustomerBillingAddressDto {
	return v.value
}

func (v *NullableCustomerBillingAddressDto) Set(val *CustomerBillingAddressDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerBillingAddressDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerBillingAddressDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerBillingAddressDto(val *CustomerBillingAddressDto) *NullableCustomerBillingAddressDto {
	return &NullableCustomerBillingAddressDto{value: val, isSet: true}
}

func (v NullableCustomerBillingAddressDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerBillingAddressDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
