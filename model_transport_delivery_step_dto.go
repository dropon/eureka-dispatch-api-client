...
// checks if the TransportDeliveryStepDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportDeliveryStepDto{}

// TransportDeliveryStepDto struct for TransportDeliveryStepDto
type TransportDeliveryStepDto struct {
	StepDate *TransportDeliveryDateTimeSlotDto `json:"stepDate,omitempty"`
	StepId *int32 `json:"stepId,omitempty"`
	Sign *string `json:"sign,omitempty"`
	Comment *string `json:"comment,omitempty"`
	StepAddress *TransportStepAddressDto `json:"stepAddress,omitempty"`
	StepContact *TransportStepContactDto `json:"stepContact,omitempty"`
	StepConstraints *TransportStepConstraintsDto `json:"stepConstraints,omitempty"`
}
...
// GetStepDate returns the StepDate field value if set, zero value otherwise.
func (o *TransportDeliveryStepDto) GetStepDate() TransportDeliveryDateTimeSlotDto {
	if o == nil || IsNil(o.StepDate) {
		var ret TransportDeliveryDateTimeSlotDto
		return ret
	}
	return *o.StepDate
}

// GetStepDateOk returns a tuple with the StepDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDeliveryStepDto) GetStepDateOk() (*TransportDeliveryDateTimeSlotDto, bool) {
	if o == nil || IsNil(o.StepDate) {
		return nil, false
	}
	return o.StepDate, true
}
...
// SetStepDate gets a reference to the given TransportDeliveryDateTimeSlotDto and assigns it to the StepDate field.
...
// GetStepAddress returns the StepAddress field value if set, zero value otherwise.
func (o *TransportDeliveryStepDto) GetStepAddress() TransportStepAddressDto {
	if o == nil || IsNil(o.StepAddress) {
		var ret TransportStepAddressDto
		return ret
	}
	return *o.StepAddress
}

// GetStepAddressOk returns a tuple with the StepAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDeliveryStepDto) GetStepAddressOk() (*TransportStepAddressDto, bool) {
	if o == nil || IsNil(o.StepAddress) {
		return nil, false
	}
	return o.StepAddress, true
}
...
// SetStepAddress gets a reference to the given TransportStepAddressDto and assigns it to the StepAddress field.
func (o *TransportDeliveryStepDto) SetStepAddress(v TransportStepAddressDto) {
	o.StepAddress = &v
}

// GetStepContact returns the StepContact field value if set, zero value otherwise.
func (o *TransportDeliveryStepDto) GetStepContact() TransportStepContactDto {
	if o == nil || IsNil(o.StepContact) {
		var ret TransportStepContactDto
		return ret
	}
	return *o.StepContact
}

// GetStepContactOk returns a tuple with the StepContact field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDeliveryStepDto) GetStepContactOk() (*TransportStepContactDto, bool) {
	if o == nil || IsNil(o.StepContact) {
		return nil, false
	}
	return o.StepContact, true
}
...
// SetStepContact gets a reference to the given TransportStepContactDto and assigns it to the StepContact field.
func (o *TransportDeliveryStepDto) SetStepContact(v TransportStepContactDto) {
	o.StepContact = &v
}

// GetStepConstraints returns the StepConstraints field value if set, zero value otherwise.
func (o *TransportDeliveryStepDto) GetStepConstraints() TransportStepConstraintsDto {
	if o == nil || IsNil(o.StepConstraints) {
		var ret TransportStepConstraintsDto
		return ret
	}
	return *o.StepConstraints
}

// GetStepConstraintsOk returns a tuple with the StepConstraints field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDeliveryStepDto) GetStepConstraintsOk() (*TransportStepConstraintsDto, bool) {
	if o == nil || IsNil(o.StepConstraints) {
		return nil, false
	}
	return o.StepConstraints, true
}
...
// SetStepConstraints gets a reference to the given TransportStepConstraintsDto and assigns it to the StepConstraints field.
func (o *TransportDeliveryStepDto) SetStepConstraints(v TransportStepConstraintsDto) {
	o.StepConstraints = &v
}

func (o TransportDeliveryStepDto) MarshalJSON() ([]byte, error) {
...
func (o TransportDeliveryStepDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StepDate) {
		toSerialize["stepDate"] = o.StepDate
	}
	if !IsNil(o.StepId) {
	...
	if !IsNil(o.StepAddress) {
		toSerialize["stepAddress"] = o.StepAddress
	}
	if !IsNil(o.StepContact) {
		toSerialize["stepContact"] = o.StepContact
	}
	if !IsNil(o.StepConstraints) {
		toSerialize["stepConstraints"] = o.StepConstraints
	}
	return toSerialize, nil
}

type NullableTransportDeliveryStepDto struct {
	value *TransportDeliveryStepDto
	isSet bool
}

func (v NullableTransportDeliveryStepDto) Get() *TransportDeliveryStepDto {
	return v.value
}

func (v *NullableTransportDeliveryStepDto) Set(val *TransportDeliveryStepDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportDeliveryStepDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportDeliveryStepDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportDeliveryStepDto(val *TransportDeliveryStepDto) *NullableTransportDeliveryStepDto {
	return &NullableTransportDeliveryStepDto{value: val, isSet: true}
}

func (v NullableTransportDeliveryStepDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportDeliveryStepDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
