...
type ApiDownloadTransportDocumentReportRequest struct {
	ctx context.Context
	ApiService *TransportDocumentReportsAPIService
	uid string
}

func (r ApiDownloadTransportDocumentReportRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.DownloadTransportDocumentReportExecute(r)
}

/*
DownloadTransportDocumentReport Download transport document report
...
Download a transport document report by its unique identifier.
 ...
 @return ApiDownloadTransportDocumentReportRequest
*/
func (a *TransportDocumentReportsAPIService) DownloadTransportDocumentReport(ctx context.Context, uid string) ApiDownloadTransportDocumentReportRequest {
	return ApiDownloadTransportDocumentReportRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
//  @return *os.File
func (a *TransportDocumentReportsAPIService) DownloadTransportDocumentReportExecute(r ApiDownloadTransportDocumentReportRequest) (*os.File, *http.Response, error) {
	var (
...
type ApiGenerateTransportDocumentReportRequest struct {
	ctx context.Context
	ApiService *TransportDocumentReportsAPIService
	command *GenerateTransportDocumentReportCommand
}

func (r ApiGenerateTransportDocumentReportRequest) Command(command GenerateTransportDocumentReportCommand) ApiGenerateTransportDocumentReportRequest {
	r.command = &command
	return r
}

func (r ApiGenerateTransportDocumentReportRequest) Execute() (*GenerateTransportDocumentReportResultDto, *http.Response, error) {
...
GenerateTransportDocumentReport Generate transport document reports
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGenerateTransportDocumentReportRequest
*/
func (a *TransportDocumentReportsAPIService) GenerateTransportDocumentReport(ctx context.Context) ApiGenerateTransportDocumentReportRequest {
	return ApiGenerateTransportDocumentReportRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TransportDocumentReportsAPIService) GenerateTransportDocumentReportExecute(r ApiGenerateTransportDocumentReportRequest) (*GenerateTransportDocumentReportResultDto, *http.Response, error) {
	var (
...
type ApiGetTransportDocumentReportByIdRequest struct {
	ctx context.Context
	ApiService *TransportDocumentReportsAPIService
	uid string
}

func (r ApiGetTransportDocumentReportByIdRequest) Execute() (*DocumentReportDto, *http.Response, error) {
	return r.ApiService.GetTransportDocumentReportByIdExecute(r)
}

/*
GetTransportDocumentReportById Get transport document report by id

Get a transport document report by its unique identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Unique identifier of the transport document report
 @return ApiGetTransportDocumentReportByIdRequest
*/
func (a *TransportDocumentReportsAPIService) GetTransportDocumentReportById(ctx context.Context, uid string) ApiGetTransportDocumentReportByIdRequest {
	return ApiGetTransportDocumentReportByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentReportsAPIService) GetTransportDocumentReportByIdExecute(r ApiGetTransportDocumentReportByIdRequest) (*DocumentReportDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
