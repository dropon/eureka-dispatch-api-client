...
// TransportDocumentReportsAPIService TransportDocumentReportsAPI service
type TransportDocumentReportsAPIService service

type TransportDocumentReportsAPIDownloadTransportDocumentReportRequest struct {
	ctx context.Context
	ApiService *TransportDocumentReportsAPIService
	uid string
}

func (r TransportDocumentReportsAPIDownloadTransportDocumentReportRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.DownloadTransportDocumentReportExecute(r)
}

/*
DownloadTransportDocumentReport Download a transport document report by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Unique identifier of the transport document report
 @return TransportDocumentReportsAPIDownloadTransportDocumentReportRequest
*/
func (a *TransportDocumentReportsAPIService) DownloadTransportDocumentReport(ctx context.Context, uid string) TransportDocumentReportsAPIDownloadTransportDocumentReportRequest {
	return TransportDocumentReportsAPIDownloadTransportDocumentReportRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
//  @return *os.File
func (a *TransportDocumentReportsAPIService) DownloadTransportDocumentReportExecute(r TransportDocumentReportsAPIDownloadTransportDocumentReportRequest) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentReportsAPIService.DownloadTransportDocumentReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transport-document-reports/{uid}/data"
...
type TransportDocumentReportsAPIGenerateTransportDocumentReportRequest struct {
	ctx context.Context
	ApiService *TransportDocumentReportsAPIService
	command *GenerateTransportDocumentReportCommand
}

func (r TransportDocumentReportsAPIGenerateTransportDocumentReportRequest) Command(command GenerateTransportDocumentReportCommand) TransportDocumentReportsAPIGenerateTransportDocumentReportRequest {
	r.command = &command
	return r
}

func (r TransportDocumentReportsAPIGenerateTransportDocumentReportRequest) Execute() (*GenerateTransportDocumentReportResultDto, *http.Response, error) {
	return r.ApiService.GenerateTransportDocumentReportExecute(r)
}

/*
GenerateTransportDocumentReport Generate transport document reports

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return TransportDocumentReportsAPIGenerateTransportDocumentReportRequest
*/
func (a *TransportDocumentReportsAPIService) GenerateTransportDocumentReport(ctx context.Context) TransportDocumentReportsAPIGenerateTransportDocumentReportRequest {
	return TransportDocumentReportsAPIGenerateTransportDocumentReportRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GenerateTransportDocumentReportResultDto
func (a *TransportDocumentReportsAPIService) GenerateTransportDocumentReportExecute(r TransportDocumentReportsAPIGenerateTransportDocumentReportRequest) (*GenerateTransportDocumentReportResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenerateTransportDocumentReportResultDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentReportsAPIService.GenerateTransportDocumentReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transport-document-reports"
...
type TransportDocumentReportsAPIGetTransportDocumentReportByIdRequest struct {
	ctx context.Context
	ApiService *TransportDocumentReportsAPIService
	uid string
}

func (r TransportDocumentReportsAPIGetTransportDocumentReportByIdRequest) Execute() (*DocumentReportDto, *http.Response, error) {
	return r.ApiService.GetTransportDocumentReportByIdExecute(r)
}

/*
GetTransportDocumentReportById Get a transport document report by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Unique identifier of the transport document report
 @return TransportDocumentReportsAPIGetTransportDocumentReportByIdRequest
*/
func (a *TransportDocumentReportsAPIService) GetTransportDocumentReportById(ctx context.Context, uid string) TransportDocumentReportsAPIGetTransportDocumentReportByIdRequest {
	return TransportDocumentReportsAPIGetTransportDocumentReportByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *TransportDocumentReportsAPIService) GetTransportDocumentReportByIdExecute(r TransportDocumentReportsAPIGetTransportDocumentReportByIdRequest) (*DocumentReportDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DocumentReportDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransportDocumentReportsAPIService.GetTransportDocumentReportById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/transport-document-reports/{uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
