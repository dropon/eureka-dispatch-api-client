...
// checks if the ApplyTerminatedStatusCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyTerminatedStatusCommand{}

// ApplyTerminatedStatusCommand struct for ApplyTerminatedStatusCommand
type ApplyTerminatedStatusCommand struct {
...
type _ApplyTerminatedStatusCommand ApplyTerminatedStatusCommand
...
func NewApplyTerminatedStatusCommand(transportUid string) *ApplyTerminatedStatusCommand {
	this := ApplyTerminatedStatusCommand{}
...
// GetDeliveryData returns the DeliveryData field value if set, zero value otherwise.
func (o *ApplyTerminatedStatusCommand) GetDeliveryData() DeliveryDataOnStatusAppliedDto {
	if o == nil || IsNil(o.DeliveryData) {
		var ret DeliveryDataOnStatusAppliedDto
		return ret
	}
	return *o.DeliveryData
}

// GetDeliveryDataOk returns a tuple with the DeliveryData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplyTerminatedStatusCommand) GetDeliveryDataOk() (*DeliveryDataOnStatusAppliedDto, bool) {
	if o == nil || IsNil(o.DeliveryData) {
		return nil, false
	}
	return o.DeliveryData, true
}
...
// SetDeliveryData gets a reference to the given DeliveryDataOnStatusAppliedDto and assigns it to the DeliveryData field.
func (o *ApplyTerminatedStatusCommand) SetDeliveryData(v DeliveryDataOnStatusAppliedDto) {
	o.DeliveryData = &v
}

func (o ApplyTerminatedStatusCommand) MarshalJSON() ([]byte, error) {
...
func (o ApplyTerminatedStatusCommand) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DeliveryData) {
		toSerialize["deliveryData"] = o.DeliveryData
	}
	return toSerialize, nil
}

func (o *ApplyTerminatedStatusCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varApplyTerminatedStatusCommand := _ApplyTerminatedStatusCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplyTerminatedStatusCommand)
	if err != nil {
		return err
	}

	*o = ApplyTerminatedStatusCommand(varApplyTerminatedStatusCommand)

	return err
}

type NullableApplyTerminatedStatusCommand struct {
	value *ApplyTerminatedStatusCommand
	isSet bool
}

func (v NullableApplyTerminatedStatusCommand) Get() *ApplyTerminatedStatusCommand {
	return v.value
}

func (v *NullableApplyTerminatedStatusCommand) Set(val *ApplyTerminatedStatusCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyTerminatedStatusCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyTerminatedStatusCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyTerminatedStatusCommand(val *ApplyTerminatedStatusCommand) *NullableApplyTerminatedStatusCommand {
	return &NullableApplyTerminatedStatusCommand{value: val, isSet: true}
}

func (v NullableApplyTerminatedStatusCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyTerminatedStatusCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
