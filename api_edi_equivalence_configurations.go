...
// EdiEquivalenceConfigurationsAPIService EdiEquivalenceConfigurationsAPI service
type EdiEquivalenceConfigurationsAPIService service

type ApiGetCustomerEquivalencesConfigurationByUidRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uid string
	startIndex *int32
	count *int32
	sort *[]string
...
func (r ApiGetCustomerEquivalencesConfigurationByUidRequest) StartIndex(startIndex int32) ApiGetCustomerEquivalencesConfigurationByUidRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCustomerEquivalencesConfigurationByUidRequest) Count(count int32) ApiGetCustomerEquivalencesConfigurationByUidRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetCustomerEquivalencesConfigurationByUidRequest) Sort(sort []string) ApiGetCustomerEquivalencesConfigurationByUidRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCustomerEquivalencesConfigurationByUidRequest) Desc(desc []string) ApiGetCustomerEquivalencesConfigurationByUidRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCustomerEquivalencesConfigurationByUidRequest) Fields(fields string) ApiGetCustomerEquivalencesConfigurationByUidRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomerEquivalencesConfigurationByUidRequest) Execute() (*IResourceListCustomerEquivalenceDto, *http.Response, error) {
	return r.ApiService.GetCustomerEquivalencesConfigurationByUidExecute(r)
}

/*
GetCustomerEquivalencesConfigurationByUid Get a customer equivalences configuration by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Unique identifier of the customer equivalences configuration
 @return ApiGetCustomerEquivalencesConfigurationByUidRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetCustomerEquivalencesConfigurationByUid(ctx context.Context, uid string) ApiGetCustomerEquivalencesConfigurationByUidRequest {
	return ApiGetCustomerEquivalencesConfigurationByUidRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
//  @return IResourceListCustomerEquivalenceDto
func (a *EdiEquivalenceConfigurationsAPIService) GetCustomerEquivalencesConfigurationByUidExecute(r ApiGetCustomerEquivalencesConfigurationByUidRequest) (*IResourceListCustomerEquivalenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IResourceListCustomerEquivalenceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetCustomerEquivalencesConfigurationByUid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/customer-type-configurations/{uid}"
...
type ApiGetCustomerEquivalencesConfigurationsRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uids *[]string
	codes *[]string
...
// Equivalence configuration unique identifiers
func (r ApiGetCustomerEquivalencesConfigurationsRequest) Uids(uids []string) ApiGetCustomerEquivalencesConfigurationsRequest {
	r.uids = &uids
	return r
}

// Equivalence configuration codes
func (r ApiGetCustomerEquivalencesConfigurationsRequest) Codes(codes []string) ApiGetCustomerEquivalencesConfigurationsRequest {
	r.codes = &codes
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetCustomerEquivalencesConfigurationsRequest) StartIndex(startIndex int32) ApiGetCustomerEquivalencesConfigurationsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCustomerEquivalencesConfigurationsRequest) Count(count int32) ApiGetCustomerEquivalencesConfigurationsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetCustomerEquivalencesConfigurationsRequest) Sort(sort []string) ApiGetCustomerEquivalencesConfigurationsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCustomerEquivalencesConfigurationsRequest) Desc(desc []string) ApiGetCustomerEquivalencesConfigurationsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCustomerEquivalencesConfigurationsRequest) Fields(fields string) ApiGetCustomerEquivalencesConfigurationsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCustomerEquivalencesConfigurationsRequest) Execute() (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	return r.ApiService.GetCustomerEquivalencesConfigurationsExecute(r)
}

/*
GetCustomerEquivalencesConfigurations Get customer equivalences configurations

Get a paginated list of customer equivalences configurations filtered by optional query parameters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCustomerEquivalencesConfigurationsRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetCustomerEquivalencesConfigurations(ctx context.Context) ApiGetCustomerEquivalencesConfigurationsRequest {
	return ApiGetCustomerEquivalencesConfigurationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListEdiEquivalenceConfigurationDto
func (a *EdiEquivalenceConfigurationsAPIService) GetCustomerEquivalencesConfigurationsExecute(r ApiGetCustomerEquivalencesConfigurationsRequest) (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListEdiEquivalenceConfigurationDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetCustomerEquivalencesConfigurations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/customer-type-configurations"
	...
	if r.uids != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "uids", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "uids", t, "form", "multi")
		}
	}
	if r.codes != nil {
		t := *r.codes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "codes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "codes", t, "form", "multi")
		}
	}
	if r.startIndex != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "startIndex", r.startIndex, "", "")
...
type ApiGetPackageNatureEquivalencesConfigurationByUidRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetPackageNatureEquivalencesConfigurationByUidRequest) StartIndex(startIndex int32) ApiGetPackageNatureEquivalencesConfigurationByUidRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPackageNatureEquivalencesConfigurationByUidRequest) Count(count int32) ApiGetPackageNatureEquivalencesConfigurationByUidRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPackageNatureEquivalencesConfigurationByUidRequest) Sort(sort []string) ApiGetPackageNatureEquivalencesConfigurationByUidRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPackageNatureEquivalencesConfigurationByUidRequest) Desc(desc []string) ApiGetPackageNatureEquivalencesConfigurationByUidRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPackageNatureEquivalencesConfigurationByUidRequest) Fields(fields string) ApiGetPackageNatureEquivalencesConfigurationByUidRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPackageNatureEquivalencesConfigurationByUidRequest) Execute() (*IResourceListPackageNatureEquivalenceDto, *http.Response, error) {
	return r.ApiService.GetPackageNatureEquivalencesConfigurationByUidExecute(r)
}

/*
GetPackageNatureEquivalencesConfigurationByUid Get a package nature equivalences configuration by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Unique identifier of the package nature equivalences configuration
 @return ApiGetPackageNatureEquivalencesConfigurationByUidRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetPackageNatureEquivalencesConfigurationByUid(ctx context.Context, uid string) ApiGetPackageNatureEquivalencesConfigurationByUidRequest {
	return ApiGetPackageNatureEquivalencesConfigurationByUidRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IResourceListPackageNatureEquivalenceDto
func (a *EdiEquivalenceConfigurationsAPIService) GetPackageNatureEquivalencesConfigurationByUidExecute(r ApiGetPackageNatureEquivalencesConfigurationByUidRequest) (*IResourceListPackageNatureEquivalenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IResourceListPackageNatureEquivalenceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetPackageNatureEquivalencesConfigurationByUid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/package-nature-type-configurations/{uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type ApiGetPackageNatureEquivalencesConfigurationsRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uids *[]string
	codes *[]string
...
// Equivalence configuration unique identifiers
func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) Uids(uids []string) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	r.uids = &uids
	return r
}

// Equivalence configuration codes
func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) Codes(codes []string) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	r.codes = &codes
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) StartIndex(startIndex int32) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) Count(count int32) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) Sort(sort []string) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) Desc(desc []string) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) Fields(fields string) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPackageNatureEquivalencesConfigurationsRequest) Execute() (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	return r.ApiService.GetPackageNatureEquivalencesConfigurationsExecute(r)
}

/*
GetPackageNatureEquivalencesConfigurations Get package nature equivalences configurations

Get a paginated list of package nature equivalences configurations filtered by optional query parameters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPackageNatureEquivalencesConfigurationsRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetPackageNatureEquivalencesConfigurations(ctx context.Context) ApiGetPackageNatureEquivalencesConfigurationsRequest {
	return ApiGetPackageNatureEquivalencesConfigurationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListEdiEquivalenceConfigurationDto
func (a *EdiEquivalenceConfigurationsAPIService) GetPackageNatureEquivalencesConfigurationsExecute(r ApiGetPackageNatureEquivalencesConfigurationsRequest) (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetPackageNatureEquivalencesConfigurations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/package-nature-type-configurations"
...
type ApiGetServiceEquivalencesConfigurationByUidRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetServiceEquivalencesConfigurationByUidRequest) StartIndex(startIndex int32) ApiGetServiceEquivalencesConfigurationByUidRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetServiceEquivalencesConfigurationByUidRequest) Count(count int32) ApiGetServiceEquivalencesConfigurationByUidRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetServiceEquivalencesConfigurationByUidRequest) Sort(sort []string) ApiGetServiceEquivalencesConfigurationByUidRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetServiceEquivalencesConfigurationByUidRequest) Desc(desc []string) ApiGetServiceEquivalencesConfigurationByUidRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetServiceEquivalencesConfigurationByUidRequest) Fields(fields string) ApiGetServiceEquivalencesConfigurationByUidRequest {
	r.fields = &fields
	return r
}

func (r ApiGetServiceEquivalencesConfigurationByUidRequest) Execute() (*IResourceListServiceEquivalenceDto, *http.Response, error) {
	return r.ApiService.GetServiceEquivalencesConfigurationByUidExecute(r)
}

/*
GetServiceEquivalencesConfigurationByUid Get a service equivalences configuration by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Unique identifier of the service equivalences configuration
 @return ApiGetServiceEquivalencesConfigurationByUidRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetServiceEquivalencesConfigurationByUid(ctx context.Context, uid string) ApiGetServiceEquivalencesConfigurationByUidRequest {
	return ApiGetServiceEquivalencesConfigurationByUidRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IResourceListServiceEquivalenceDto
func (a *EdiEquivalenceConfigurationsAPIService) GetServiceEquivalencesConfigurationByUidExecute(r ApiGetServiceEquivalencesConfigurationByUidRequest) (*IResourceListServiceEquivalenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IResourceListServiceEquivalenceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetServiceEquivalencesConfigurationByUid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/service-type-configurations/{uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type ApiGetServiceEquivalencesConfigurationsRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uids *[]string
	codes *[]string
...
// Equivalence configuration unique identifiers
func (r ApiGetServiceEquivalencesConfigurationsRequest) Uids(uids []string) ApiGetServiceEquivalencesConfigurationsRequest {
	r.uids = &uids
	return r
}

// Equivalence configuration codes
func (r ApiGetServiceEquivalencesConfigurationsRequest) Codes(codes []string) ApiGetServiceEquivalencesConfigurationsRequest {
	r.codes = &codes
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetServiceEquivalencesConfigurationsRequest) StartIndex(startIndex int32) ApiGetServiceEquivalencesConfigurationsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetServiceEquivalencesConfigurationsRequest) Count(count int32) ApiGetServiceEquivalencesConfigurationsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetServiceEquivalencesConfigurationsRequest) Sort(sort []string) ApiGetServiceEquivalencesConfigurationsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetServiceEquivalencesConfigurationsRequest) Desc(desc []string) ApiGetServiceEquivalencesConfigurationsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetServiceEquivalencesConfigurationsRequest) Fields(fields string) ApiGetServiceEquivalencesConfigurationsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetServiceEquivalencesConfigurationsRequest) Execute() (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	return r.ApiService.GetServiceEquivalencesConfigurationsExecute(r)
}

/*
GetServiceEquivalencesConfigurations Get service equivalences configurations

Get a paginated list of service equivalences configurations filtered by optional query parameters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetServiceEquivalencesConfigurationsRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetServiceEquivalencesConfigurations(ctx context.Context) ApiGetServiceEquivalencesConfigurationsRequest {
	return ApiGetServiceEquivalencesConfigurationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListEdiEquivalenceConfigurationDto
func (a *EdiEquivalenceConfigurationsAPIService) GetServiceEquivalencesConfigurationsExecute(r ApiGetServiceEquivalencesConfigurationsRequest) (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetServiceEquivalencesConfigurations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/service-type-configurations"
...
type ApiGetSubstateEquivalencesConfigurationByUidRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetSubstateEquivalencesConfigurationByUidRequest) StartIndex(startIndex int32) ApiGetSubstateEquivalencesConfigurationByUidRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetSubstateEquivalencesConfigurationByUidRequest) Count(count int32) ApiGetSubstateEquivalencesConfigurationByUidRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetSubstateEquivalencesConfigurationByUidRequest) Sort(sort []string) ApiGetSubstateEquivalencesConfigurationByUidRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetSubstateEquivalencesConfigurationByUidRequest) Desc(desc []string) ApiGetSubstateEquivalencesConfigurationByUidRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetSubstateEquivalencesConfigurationByUidRequest) Fields(fields string) ApiGetSubstateEquivalencesConfigurationByUidRequest {
	r.fields = &fields
	return r
}

func (r ApiGetSubstateEquivalencesConfigurationByUidRequest) Execute() (*IResourceListSubstateEquivalenceDto, *http.Response, error) {
	return r.ApiService.GetSubstateEquivalencesConfigurationByUidExecute(r)
}

/*
GetSubstateEquivalencesConfigurationByUid Get a substate equivalences configuration by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Unique identifier of the substate equivalences configuration
 @return ApiGetSubstateEquivalencesConfigurationByUidRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetSubstateEquivalencesConfigurationByUid(ctx context.Context, uid string) ApiGetSubstateEquivalencesConfigurationByUidRequest {
	return ApiGetSubstateEquivalencesConfigurationByUidRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IResourceListSubstateEquivalenceDto
func (a *EdiEquivalenceConfigurationsAPIService) GetSubstateEquivalencesConfigurationByUidExecute(r ApiGetSubstateEquivalencesConfigurationByUidRequest) (*IResourceListSubstateEquivalenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IResourceListSubstateEquivalenceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetSubstateEquivalencesConfigurationByUid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/substate-type-configurations/{uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type ApiGetSubstateEquivalencesConfigurationsRequest struct {
	ctx context.Context
	ApiService *EdiEquivalenceConfigurationsAPIService
	uids *[]string
	codes *[]string
...
// Equivalence configuration unique identifiers
func (r ApiGetSubstateEquivalencesConfigurationsRequest) Uids(uids []string) ApiGetSubstateEquivalencesConfigurationsRequest {
	r.uids = &uids
	return r
}

// Equivalence configuration codes
func (r ApiGetSubstateEquivalencesConfigurationsRequest) Codes(codes []string) ApiGetSubstateEquivalencesConfigurationsRequest {
	r.codes = &codes
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetSubstateEquivalencesConfigurationsRequest) StartIndex(startIndex int32) ApiGetSubstateEquivalencesConfigurationsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetSubstateEquivalencesConfigurationsRequest) Count(count int32) ApiGetSubstateEquivalencesConfigurationsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetSubstateEquivalencesConfigurationsRequest) Sort(sort []string) ApiGetSubstateEquivalencesConfigurationsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetSubstateEquivalencesConfigurationsRequest) Desc(desc []string) ApiGetSubstateEquivalencesConfigurationsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetSubstateEquivalencesConfigurationsRequest) Fields(fields string) ApiGetSubstateEquivalencesConfigurationsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetSubstateEquivalencesConfigurationsRequest) Execute() (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	return r.ApiService.GetSubstateEquivalencesConfigurationsExecute(r)
}

/*
GetSubstateEquivalencesConfigurations Get substate equivalences configurations

Get a paginated list of substate equivalences configurations filtered by optional query parameters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSubstateEquivalencesConfigurationsRequest
*/
func (a *EdiEquivalenceConfigurationsAPIService) GetSubstateEquivalencesConfigurations(ctx context.Context) ApiGetSubstateEquivalencesConfigurationsRequest {
	return ApiGetSubstateEquivalencesConfigurationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListEdiEquivalenceConfigurationDto
func (a *EdiEquivalenceConfigurationsAPIService) GetSubstateEquivalencesConfigurationsExecute(r ApiGetSubstateEquivalencesConfigurationsRequest) (*IPagedResourceListEdiEquivalenceConfigurationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EdiEquivalenceConfigurationsAPIService.GetSubstateEquivalencesConfigurations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/edi-equivalences-configurations/substate-type-configurations"
