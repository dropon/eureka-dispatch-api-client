...
type ServiceDto struct {
	...
	ServiceFamily *ServiceFamilyDto `json:"serviceFamily,omitempty"`
	ServiceType *ServiceTypeDto `json:"serviceType,omitempty"`
}
...
// GetForegroundColor returns the ForegroundColor field value if set, zero value otherwise.
func (o *ServiceDto) GetForegroundColor() string {
	if o == nil || IsNil(o.ForegroundColor) {
		var ret string
		return ret
	}
...
// SetForegroundColor gets a reference to the given string and assigns it to the ForegroundColor field.
...
// SetServiceFamily gets a reference to the given ServiceFamilyDto and assigns it to the ServiceFamily field.
...
// SetServiceType gets a reference to the given ServiceTypeDto and assigns it to the ServiceType field.
...
func (o ServiceDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ForegroundColor) {
		toSerialize["foregroundColor"] = o.ForegroundColor
	}
