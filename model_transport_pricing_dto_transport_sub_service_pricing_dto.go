...
// checks if the TransportPricingDtoTransportSubServicePricingDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportPricingDtoTransportSubServicePricingDto{}

// TransportPricingDtoTransportSubServicePricingDto struct for TransportPricingDtoTransportSubServicePricingDto
type TransportPricingDtoTransportSubServicePricingDto struct {
	...
	// Sub service's sell price forced in reference currency, otherwise sell price converted to reference currency
	SellPriceInReferenceCurrency *float64 `json:"sellPriceInReferenceCurrency,omitempty"`
	// Sub service's sell unit price converted to reference currency
	SellUnitPriceInReferenceCurrency *float64 `json:"sellUnitPriceInReferenceCurrency,omitempty"`
	// Sub service's buy price forced in reference currency, otherwise buy price converted to reference currency
	BuyPriceInReferenceCurrency *float64 `json:"buyPriceInReferenceCurrency,omitempty"`
	// Sub service's buy unit price converted to reference currency
...
func NewTransportPricingDtoTransportSubServicePricingDto() *TransportPricingDtoTransportSubServicePricingDto {
	this := TransportPricingDtoTransportSubServicePricingDto{}
	return &this
}
...
func (o TransportPricingDtoTransportSubServicePricingDto) MarshalJSON() ([]byte, error) {
...
func (o TransportPricingDtoTransportSubServicePricingDto) ToMap() (map[string]interface{}, error) {
...
type NullableTransportPricingDtoTransportSubServicePricingDto struct {
	value *TransportPricingDtoTransportSubServicePricingDto
	isSet bool
}

func (v NullableTransportPricingDtoTransportSubServicePricingDto) Get() *TransportPricingDtoTransportSubServicePricingDto {
	return v.value
}

func (v *NullableTransportPricingDtoTransportSubServicePricingDto) Set(val *TransportPricingDtoTransportSubServicePricingDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportPricingDtoTransportSubServicePricingDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportPricingDtoTransportSubServicePricingDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportPricingDtoTransportSubServicePricingDto(val *TransportPricingDtoTransportSubServicePricingDto) *NullableTransportPricingDtoTransportSubServicePricingDto {
	return &NullableTransportPricingDtoTransportSubServicePricingDto{value: val, isSet: true}
}

func (v NullableTransportPricingDtoTransportSubServicePricingDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportPricingDtoTransportSubServicePricingDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
