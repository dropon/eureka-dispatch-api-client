...
type CustomerDto struct {
	...
	CustomerFamilyLabel *string `json:"customerFamilyLabel,omitempty"`
	EdiConfigurationId *int32 `json:"ediConfigurationId,omitempty"`
	OperationalConfiguration *CustomerOperationalConfigurationDto `json:"operationalConfiguration,omitempty"`
	BillingAddress *CustomerBillingAddressDto `json:"billingAddress,omitempty"`
	BillingConfiguration *CustomerBillingConfigurationDto `json:"billingConfiguration,omitempty"`
	BillingDetails *CustomerBillingDetailsDto `json:"billingDetails,omitempty"`
	Included *CustomerIncludedDto `json:"included,omitempty"`
}
...
func (o *CustomerDto) GetLastModificationDateTimeOk() (*Time, bool) {
	...
	return o.LastModificationDateTime, true
}
...
// GetOperationAddressId returns the OperationAddressId field value if set, zero value otherwise.
func (o *CustomerDto) GetOperationAddressId() int32 {
	if o == nil || IsNil(o.OperationAddressId) {
		var ret int32
		return ret
	}
	return *o.OperationAddressId
}

// GetOperationAddressIdOk returns a tuple with the OperationAddressId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomerDto) GetOperationAddressIdOk() (*int32, bool) {
	if o == nil || IsNil(o.OperationAddressId) {
		return nil, false
	}
	return o.OperationAddressId, true
}
...
// SetOperationAddressId gets a reference to the given int32 and assigns it to the OperationAddressId field.
func (o *CustomerDto) SetOperationAddressId(v int32) {
	o.OperationAddressId = &v
}
...
// GetCustomerFamilyLabel returns the CustomerFamilyLabel field value if set, zero value otherwise.
func (o *CustomerDto) GetCustomerFamilyLabel() string {
	if o == nil || IsNil(o.CustomerFamilyLabel) {
		var ret string
		return ret
	}
	return *o.CustomerFamilyLabel
}

// GetCustomerFamilyLabelOk returns a tuple with the CustomerFamilyLabel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomerDto) GetCustomerFamilyLabelOk() (*string, bool) {
	if o == nil || IsNil(o.CustomerFamilyLabel) {
		return nil, false
	}
	return o.CustomerFamilyLabel, true
}
...
// SetCustomerFamilyLabel gets a reference to the given string and assigns it to the CustomerFamilyLabel field.
func (o *CustomerDto) SetCustomerFamilyLabel(v string) {
	o.CustomerFamilyLabel = &v
}

// GetEdiConfigurationId returns the EdiConfigurationId field value if set, zero value otherwise.
func (o *CustomerDto) GetEdiConfigurationId() int32 {
	if o == nil || IsNil(o.EdiConfigurationId) {
		var ret int32
		return ret
	}
	return *o.EdiConfigurationId
}

// GetEdiConfigurationIdOk returns a tuple with the EdiConfigurationId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomerDto) GetEdiConfigurationIdOk() (*int32, bool) {
	if o == nil || IsNil(o.EdiConfigurationId) {
		return nil, false
	}
	return o.EdiConfigurationId, true
}
...
// SetEdiConfigurationId gets a reference to the given int32 and assigns it to the EdiConfigurationId field.
func (o *CustomerDto) SetEdiConfigurationId(v int32) {
	o.EdiConfigurationId = &v
}
...
func (o *CustomerDto) GetOperationalConfiguration() CustomerOperationalConfigurationDto {
	if o == nil || IsNil(o.OperationalConfiguration) {
		var ret CustomerOperationalConfigurationDto
		return ret
	}
...
// SetOperationalConfiguration gets a reference to the given CustomerOperationalConfigurationDto and assigns it to the OperationalConfiguration field.
...
func (o *CustomerDto) GetBillingAddress() CustomerBillingAddressDto {
	if o == nil || IsNil(o.BillingAddress) {
		var ret CustomerBillingAddressDto
		return ret
	}
...
// SetBillingAddress gets a reference to the given CustomerBillingAddressDto and assigns it to the BillingAddress field.
...
func (o *CustomerDto) GetBillingConfiguration() CustomerBillingConfigurationDto {
	if o == nil || IsNil(o.BillingConfiguration) {
		var ret CustomerBillingConfigurationDto
		return ret
	}
...
// SetBillingConfiguration gets a reference to the given CustomerBillingConfigurationDto and assigns it to the BillingConfiguration field.
...
func (o *CustomerDto) GetBillingDetails() CustomerBillingDetailsDto {
	if o == nil || IsNil(o.BillingDetails) {
		var ret CustomerBillingDetailsDto
		return ret
	}
...
// SetBillingDetails gets a reference to the given CustomerBillingDetailsDto and assigns it to the BillingDetails field.
...
// SetIncluded gets a reference to the given CustomerIncludedDto and assigns it to the Included field.
...
func (o CustomerDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LastModificationDateTime) {
		toSerialize["lastModificationDateTime"] = o.LastModificationDateTime
	}
	if !IsNil(o.AgencyCode) {
		toSerialize["agencyCode"] = o.AgencyCode
	}
	if !IsNil(o.OperationAddressId) {
		toSerialize["operationAddressId"] = o.OperationAddressId
	}
	...
	if !IsNil(o.CustomerFamilyLabel) {
		toSerialize["customerFamilyLabel"] = o.CustomerFamilyLabel
	}
	if !IsNil(o.EdiConfigurationId) {
		toSerialize["ediConfigurationId"] = o.EdiConfigurationId
	}
