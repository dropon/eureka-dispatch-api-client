...
// checks if the UpdateCityDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCityDto{}

// UpdateCityDto struct for UpdateCityDto
type UpdateCityDto struct {
	...
	Geocoding *UpdateCityDtoUpdateCityGeocodingDto `json:"geocoding,omitempty"`
...
func (o *UpdateCityDto) GetGeocoding() UpdateCityDtoUpdateCityGeocodingDto {
	if o == nil || IsNil(o.Geocoding) {
		var ret UpdateCityDtoUpdateCityGeocodingDto
		return ret
	}
	return *o.Geocoding
}
...
// SetGeocoding gets a reference to the given UpdateCityDtoUpdateCityGeocodingDto and assigns it to the Geocoding field.
...
func (o UpdateCityDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateCityDto) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateCityDto struct {
	value *UpdateCityDto
	isSet bool
}

func (v NullableUpdateCityDto) Get() *UpdateCityDto {
	return v.value
}

func (v *NullableUpdateCityDto) Set(val *UpdateCityDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCityDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCityDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCityDto(val *UpdateCityDto) *NullableUpdateCityDto {
	return &NullableUpdateCityDto{value: val, isSet: true}
}

func (v NullableUpdateCityDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCityDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
