...
type ServicesAPIGetCustomParameterValuesRequest struct {
	ctx context.Context
...
func (r ServicesAPIGetCustomParameterValuesRequest) StartIndex(startIndex int32) ServicesAPIGetCustomParameterValuesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ServicesAPIGetCustomParameterValuesRequest) Count(count int32) ServicesAPIGetCustomParameterValuesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ServicesAPIGetCustomParameterValuesRequest) Sort(sort []string) ServicesAPIGetCustomParameterValuesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ServicesAPIGetCustomParameterValuesRequest) Desc(desc []string) ServicesAPIGetCustomParameterValuesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ServicesAPIGetCustomParameterValuesRequest) Fields(fields string) ServicesAPIGetCustomParameterValuesRequest {
	r.fields = &fields
	return r
}

func (r ServicesAPIGetCustomParameterValuesRequest) Execute() (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
...
Get a paginated list of custom parameter values for the custom parameter and service.
 ...
 @return ServicesAPIGetCustomParameterValuesRequest
*/
func (a *ServicesAPIService) GetCustomParameterValues(ctx context.Context, uid string, parameterId int32) ServicesAPIGetCustomParameterValuesRequest {
	return ServicesAPIGetCustomParameterValuesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *ServicesAPIService) GetCustomParameterValuesExecute(r ServicesAPIGetCustomParameterValuesRequest) (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicesAPIService.GetCustomParameterValues")
	if err != nil {
...
type ServicesAPIGetCustomParametersRequest struct {
	ctx context.Context
	ApiService *ServicesAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ServicesAPIGetCustomParametersRequest) StartIndex(startIndex int32) ServicesAPIGetCustomParametersRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ServicesAPIGetCustomParametersRequest) Count(count int32) ServicesAPIGetCustomParametersRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ServicesAPIGetCustomParametersRequest) Sort(sort []string) ServicesAPIGetCustomParametersRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ServicesAPIGetCustomParametersRequest) Desc(desc []string) ServicesAPIGetCustomParametersRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ServicesAPIGetCustomParametersRequest) Fields(fields string) ServicesAPIGetCustomParametersRequest {
	r.fields = &fields
	return r
}

func (r ServicesAPIGetCustomParametersRequest) Execute() (*IPagedResourceListCustomParameterDto, *http.Response, error) {
...
Get a paginated list of custom parameters corresponding to the specified service.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Service's unique identifier.
 @return ServicesAPIGetCustomParametersRequest
*/
func (a *ServicesAPIService) GetCustomParameters(ctx context.Context, uid string) ServicesAPIGetCustomParametersRequest {
	return ServicesAPIGetCustomParametersRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *ServicesAPIService) GetCustomParametersExecute(r ServicesAPIGetCustomParametersRequest) (*IPagedResourceListCustomParameterDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicesAPIService.GetCustomParameters")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ServicesAPIGetServicesRequest) Code(code string) ServicesAPIGetServicesRequest {
	r.code = &code
	return r
}

// Service label pattern
func (r ServicesAPIGetServicesRequest) Label(label string) ServicesAPIGetServicesRequest {
	r.label = &label
	return r
}

// List of service codes.
func (r ServicesAPIGetServicesRequest) Codes(codes []string) ServicesAPIGetServicesRequest {
	r.codes = &codes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ServicesAPIGetServicesRequest) Pattern(pattern string) ServicesAPIGetServicesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ServicesAPIGetServicesRequest) PatternFields(patternFields []string) ServicesAPIGetServicesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ServicesAPIGetServicesRequest) StartIndex(startIndex int32) ServicesAPIGetServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ServicesAPIGetServicesRequest) Count(count int32) ServicesAPIGetServicesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ServicesAPIGetServicesRequest) Sort(sort []string) ServicesAPIGetServicesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ServicesAPIGetServicesRequest) Desc(desc []string) ServicesAPIGetServicesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ServicesAPIGetServicesRequest) Fields(fields string) ServicesAPIGetServicesRequest {
	r.fields = &fields
	return r
}

func (r ServicesAPIGetServicesRequest) Execute() (*IPagedResourceListServiceDto, *http.Response, error) {
...
func (a *ServicesAPIService) GetServicesExecute(r ServicesAPIGetServicesRequest) (*IPagedResourceListServiceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ServicesAPIGetSubServicesRequest struct {
	ctx context.Context
	ApiService *ServicesAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ServicesAPIGetSubServicesRequest) StartIndex(startIndex int32) ServicesAPIGetSubServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ServicesAPIGetSubServicesRequest) Count(count int32) ServicesAPIGetSubServicesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ServicesAPIGetSubServicesRequest) Sort(sort []string) ServicesAPIGetSubServicesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ServicesAPIGetSubServicesRequest) Desc(desc []string) ServicesAPIGetSubServicesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ServicesAPIGetSubServicesRequest) Fields(fields string) ServicesAPIGetSubServicesRequest {
	r.fields = &fields
	return r
}

func (r ServicesAPIGetSubServicesRequest) Execute() (*IPagedResourceListServiceSubServiceDto, *http.Response, error) {
...
Get a paginated list of sub services corresponding to the specified service.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Service's unique identifier.
 @return ServicesAPIGetSubServicesRequest
*/
func (a *ServicesAPIService) GetSubServices(ctx context.Context, uid string) ServicesAPIGetSubServicesRequest {
	return ServicesAPIGetSubServicesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *ServicesAPIService) GetSubServicesExecute(r ServicesAPIGetSubServicesRequest) (*IPagedResourceListServiceSubServiceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
