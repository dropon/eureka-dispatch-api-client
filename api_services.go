...
type ApiGetServiceCustomParameterValuesRequest struct {
	ctx context.Context
...
func (r ApiGetServiceCustomParameterValuesRequest) StartIndex(startIndex int32) ApiGetServiceCustomParameterValuesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetServiceCustomParameterValuesRequest) Count(count int32) ApiGetServiceCustomParameterValuesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetServiceCustomParameterValuesRequest) Sort(sort []string) ApiGetServiceCustomParameterValuesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetServiceCustomParameterValuesRequest) Desc(desc []string) ApiGetServiceCustomParameterValuesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetServiceCustomParameterValuesRequest) Fields(fields string) ApiGetServiceCustomParameterValuesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetServiceCustomParameterValuesRequest) Execute() (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
	return r.ApiService.GetServiceCustomParameterValuesExecute(r)
}

/*
GetServiceCustomParameterValues Get custom parameter values

Get a paginated list of custom parameter values for the custom parameter and service.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Service's unique identifier.
 @param parameterId Identifier of the custom parameter
 @return ApiGetServiceCustomParameterValuesRequest
*/
func (a *ServicesAPIService) GetServiceCustomParameterValues(ctx context.Context, uid string, parameterId int32) ApiGetServiceCustomParameterValuesRequest {
	return ApiGetServiceCustomParameterValuesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *ServicesAPIService) GetServiceCustomParameterValuesExecute(r ApiGetServiceCustomParameterValuesRequest) (*IPagedResourceListCustomParameterValueDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicesAPIService.GetServiceCustomParameterValues")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/services/{uid}/custom-parameters/{parameterId}/values"
...
type ApiGetServiceCustomParametersRequest struct {
	ctx context.Context
	ApiService *ServicesAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetServiceCustomParametersRequest) StartIndex(startIndex int32) ApiGetServiceCustomParametersRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetServiceCustomParametersRequest) Count(count int32) ApiGetServiceCustomParametersRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetServiceCustomParametersRequest) Sort(sort []string) ApiGetServiceCustomParametersRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetServiceCustomParametersRequest) Desc(desc []string) ApiGetServiceCustomParametersRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetServiceCustomParametersRequest) Fields(fields string) ApiGetServiceCustomParametersRequest {
	r.fields = &fields
	return r
}

func (r ApiGetServiceCustomParametersRequest) Execute() (*IPagedResourceListCustomParameterDto, *http.Response, error) {
	return r.ApiService.GetServiceCustomParametersExecute(r)
}

/*
GetServiceCustomParameters Get custom parameters

Get a paginated list of custom parameters corresponding to the specified service.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Service's unique identifier.
 @return ApiGetServiceCustomParametersRequest
*/
func (a *ServicesAPIService) GetServiceCustomParameters(ctx context.Context, uid string) ApiGetServiceCustomParametersRequest {
	return ApiGetServiceCustomParametersRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *ServicesAPIService) GetServiceCustomParametersExecute(r ApiGetServiceCustomParametersRequest) (*IPagedResourceListCustomParameterDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicesAPIService.GetServiceCustomParameters")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/services/{uid}/custom-parameters"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
func (r ApiGetServicesRequest) Code(code string) ApiGetServicesRequest {
	r.code = &code
	return r
}

// Service label pattern
func (r ApiGetServicesRequest) Label(label string) ApiGetServicesRequest {
	r.label = &label
	return r
}

// List of service codes.
func (r ApiGetServicesRequest) Codes(codes []string) ApiGetServicesRequest {
	r.codes = &codes
	return r
}

// Search for services with enabled/disabled status.   When not set, both enabled and disabled services are returned.
func (r ApiGetServicesRequest) IsEnabled(isEnabled bool) ApiGetServicesRequest {
	r.isEnabled = &isEnabled
	return r
}

// If this filter is specified, the results will be filtered to services that are either :  - Available from any agency.  - Available only from the specific agency
func (r ApiGetServicesRequest) RestrictToAgencyCode(restrictToAgencyCode string) ApiGetServicesRequest {
	r.restrictToAgencyCode = &restrictToAgencyCode
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetServicesRequest) Pattern(pattern string) ApiGetServicesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetServicesRequest) PatternFields(patternFields []string) ApiGetServicesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetServicesRequest) StartIndex(startIndex int32) ApiGetServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetServicesRequest) Count(count int32) ApiGetServicesRequest {
	r.count = &count
	return r
}
...
// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetServicesRequest) Desc(desc []string) ApiGetServicesRequest {
	r.desc = &desc
	return r
}
...
func (r ApiGetServicesRequest) Execute() (*IPagedResourceListServiceDto, *http.Response, error) {
...
Get a paginated list of services corresponding to the specified filters.
...
// Execute executes the request
//  @return IPagedResourceListServiceDto
func (a *ServicesAPIService) GetServicesExecute(r ApiGetServicesRequest) (*IPagedResourceListServiceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListServiceDto
	)
	...
	localVarPath := localBasePath + "/v3/services"
...
type ApiGetSubServicesRequest struct {
	ctx context.Context
	ApiService *ServicesAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetSubServicesRequest) StartIndex(startIndex int32) ApiGetSubServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetSubServicesRequest) Count(count int32) ApiGetSubServicesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetSubServicesRequest) Sort(sort []string) ApiGetSubServicesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetSubServicesRequest) Desc(desc []string) ApiGetSubServicesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetSubServicesRequest) Fields(fields string) ApiGetSubServicesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetSubServicesRequest) Execute() (*IPagedResourceListServiceSubServiceDto, *http.Response, error) {
	return r.ApiService.GetSubServicesExecute(r)
}

/*
GetSubServices Get sub services

Get a paginated list of sub services corresponding to the specified service.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Service's unique identifier.
 @return ApiGetSubServicesRequest
*/
func (a *ServicesAPIService) GetSubServices(ctx context.Context, uid string) ApiGetSubServicesRequest {
	return ApiGetSubServicesRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return IPagedResourceListServiceSubServiceDto
func (a *ServicesAPIService) GetSubServicesExecute(r ApiGetSubServicesRequest) (*IPagedResourceListServiceSubServiceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListServiceSubServiceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicesAPIService.GetSubServices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/services/{uid}/sub-services"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
