...
type ApiCancelQuotationRequest struct {
	ctx context.Context
...
func (r ApiCancelQuotationRequest) Command(command CancelQuotationCommand) ApiCancelQuotationRequest {
	r.command = &command
	return r
}

func (r ApiCancelQuotationRequest) Execute() (*http.Response, error) {
...
The following permission(s) are required to access this route:  Cancel orders.
 ...
 @return ApiCancelQuotationRequest
*/
func (a *QuotationsAPIService) CancelQuotation(ctx context.Context, uid string) ApiCancelQuotationRequest {
	return ApiCancelQuotationRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *QuotationsAPIService) CancelQuotationExecute(r ApiCancelQuotationRequest) (*http.Response, error) {
	var (
...
type ApiCreateMissionFromQuotationRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	uid string
...
func (r ApiCreateMissionFromQuotationRequest) Command(command CreateMissionFromQuotationCommand) ApiCreateMissionFromQuotationRequest {
	r.command = &command
	return r
}

func (r ApiCreateMissionFromQuotationRequest) Execute() (*CreateMissionFromQuotationResultDto, *http.Response, error) {
...
Once the mission is created, the quotation is archived.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Quotation's unique identifier
 @return ApiCreateMissionFromQuotationRequest
*/
func (a *QuotationsAPIService) CreateMissionFromQuotation(ctx context.Context, uid string) ApiCreateMissionFromQuotationRequest {
	return ApiCreateMissionFromQuotationRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *QuotationsAPIService) CreateMissionFromQuotationExecute(r ApiCreateMissionFromQuotationRequest) (*CreateMissionFromQuotationResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiCreateQuotationRequest) Command(command CreateQuotationCommand) ApiCreateQuotationRequest {
	r.command = &command
	return r
}

func (r ApiCreateQuotationRequest) Execute() (*CreateQuotationResultDto, *http.Response, error) {
...
func (a *QuotationsAPIService) CreateQuotationExecute(r ApiCreateQuotationRequest) (*CreateQuotationResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetQuotationByIdRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	uid string
	fields *string
...
func (r ApiGetQuotationByIdRequest) Fields(fields string) ApiGetQuotationByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetQuotationByIdRequest) Execute() (*QuotationDto, *http.Response, error) {
...
GetQuotationById Get quotation by id
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Quotation's unique identifier
 @return ApiGetQuotationByIdRequest
*/
func (a *QuotationsAPIService) GetQuotationById(ctx context.Context, uid string) ApiGetQuotationByIdRequest {
	return ApiGetQuotationByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return QuotationDto
func (a *QuotationsAPIService) GetQuotationByIdExecute(r ApiGetQuotationByIdRequest) (*QuotationDto, *http.Response, error) {
	var (
...
type ApiGetQuotationByQuotationNumberRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
...
// Quotation number
func (r ApiGetQuotationByQuotationNumberRequest) QuotationNumber(quotationNumber int32) ApiGetQuotationByQuotationNumberRequest {
	r.quotationNumber = &quotationNumber
	return r
}

// Projection fields separated with a comma
func (r ApiGetQuotationByQuotationNumberRequest) Fields(fields string) ApiGetQuotationByQuotationNumberRequest {
	r.fields = &fields
	return r
}

func (r ApiGetQuotationByQuotationNumberRequest) Execute() (*QuotationDto, *http.Response, error) {
	return r.ApiService.GetQuotationByQuotationNumberExecute(r)
}

/*
GetQuotationByQuotationNumber Get quotation by quotation number

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetQuotationByQuotationNumberRequest
*/
func (a *QuotationsAPIService) GetQuotationByQuotationNumber(ctx context.Context) ApiGetQuotationByQuotationNumberRequest {
	return ApiGetQuotationByQuotationNumberRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return QuotationDto
func (a *QuotationsAPIService) GetQuotationByQuotationNumberExecute(r ApiGetQuotationByQuotationNumberRequest) (*QuotationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiQuotationCreationDryRunRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	command *SimulateQuotationCreationDryRunCommand
}

func (r ApiQuotationCreationDryRunRequest) Command(command SimulateQuotationCreationDryRunCommand) ApiQuotationCreationDryRunRequest {
	r.command = &command
	return r
}

func (r ApiQuotationCreationDryRunRequest) Execute() (*QuotationEntryDryRunDto, *http.Response, error) {
...
Simulate a quotation creation: performs a dry run.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiQuotationCreationDryRunRequest
*/
func (a *QuotationsAPIService) QuotationCreationDryRun(ctx context.Context) ApiQuotationCreationDryRunRequest {
	return ApiQuotationCreationDryRunRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *QuotationsAPIService) QuotationCreationDryRunExecute(r ApiQuotationCreationDryRunRequest) (*QuotationEntryDryRunDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiQuotationUpdateDryRunRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	uid string
...
func (r ApiQuotationUpdateDryRunRequest) Command(command UpdateQuotationDto) ApiQuotationUpdateDryRunRequest {
	r.command = &command
	return r
}

func (r ApiQuotationUpdateDryRunRequest) Execute() (*QuotationEntryDryRunDto, *http.Response, error) {
...
The following permission(s) are required to access this route:  Update orders.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid
 @return ApiQuotationUpdateDryRunRequest
*/
func (a *QuotationsAPIService) QuotationUpdateDryRun(ctx context.Context, uid string) ApiQuotationUpdateDryRunRequest {
	return ApiQuotationUpdateDryRunRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return QuotationEntryDryRunDto
func (a *QuotationsAPIService) QuotationUpdateDryRunExecute(r ApiQuotationUpdateDryRunRequest) (*QuotationEntryDryRunDto, *http.Response, error) {
	var (
...
func (r ApiUpdateQuotationRequest) Command(command UpdateQuotationDto) ApiUpdateQuotationRequest {
	r.command = &command
	return r
}

func (r ApiUpdateQuotationRequest) Execute() (*http.Response, error) {
...
*/
func (a *QuotationsAPIService) UpdateQuotation(ctx context.Context, uid string) ApiUpdateQuotationRequest {
	return ApiUpdateQuotationRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
func (a *QuotationsAPIService) UpdateQuotationExecute(r ApiUpdateQuotationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
