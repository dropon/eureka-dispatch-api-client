...
type QuotationsAPICancelQuotationRequest struct {
	ctx context.Context
...
// Cancel quotation command.
func (r QuotationsAPICancelQuotationRequest) Command(command CancelQuotationCommand) QuotationsAPICancelQuotationRequest {
	r.command = &command
	return r
}

func (r QuotationsAPICancelQuotationRequest) Execute() (*http.Response, error) {
	return r.ApiService.CancelQuotationExecute(r)
}

/*
CancelQuotation Cancel quotation

Cancel the quotation with all its included transports.  
The following permission(s) are required to access this route:  Cancel orders.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Quotation's unique identifier
 @return QuotationsAPICancelQuotationRequest
*/
func (a *QuotationsAPIService) CancelQuotation(ctx context.Context, uid string) QuotationsAPICancelQuotationRequest {
	return QuotationsAPICancelQuotationRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *QuotationsAPIService) CancelQuotationExecute(r QuotationsAPICancelQuotationRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotationsAPIService.CancelQuotation")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/quotations/{uid}/cancellation-process"
...
type QuotationsAPICreateMissionFromQuotationRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	uid string
	command *CreateMissionFromQuotationCommand
}

// Quotation to mission command.
func (r QuotationsAPICreateMissionFromQuotationRequest) Command(command CreateMissionFromQuotationCommand) QuotationsAPICreateMissionFromQuotationRequest {
	r.command = &command
	return r
}

func (r QuotationsAPICreateMissionFromQuotationRequest) Execute() (*CreateMissionFromQuotationResultDto, *http.Response, error) {
	return r.ApiService.CreateMissionFromQuotationExecute(r)
}

/*
CreateMissionFromQuotation Create mission from quotation

Create a mission from the quotation with all its non canceled transports.
Once the mission is created, the quotation is archived.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Quotation's unique identifier
 @return QuotationsAPICreateMissionFromQuotationRequest
*/
func (a *QuotationsAPIService) CreateMissionFromQuotation(ctx context.Context, uid string) QuotationsAPICreateMissionFromQuotationRequest {
	return QuotationsAPICreateMissionFromQuotationRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return CreateMissionFromQuotationResultDto
func (a *QuotationsAPIService) CreateMissionFromQuotationExecute(r QuotationsAPICreateMissionFromQuotationRequest) (*CreateMissionFromQuotationResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateMissionFromQuotationResultDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotationsAPIService.CreateMissionFromQuotation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/quotations/{uid}/to-mission-process"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type QuotationsAPICreateQuotationRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	command *CreateQuotationCommand
}

func (r QuotationsAPICreateQuotationRequest) Command(command CreateQuotationCommand) QuotationsAPICreateQuotationRequest {
	r.command = &command
	return r
}

func (r QuotationsAPICreateQuotationRequest) Execute() (*CreateQuotationResultDto, *http.Response, error) {
...
CreateQuotation Create a quotation
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return QuotationsAPICreateQuotationRequest
*/
func (a *QuotationsAPIService) CreateQuotation(ctx context.Context) QuotationsAPICreateQuotationRequest {
	return QuotationsAPICreateQuotationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CreateQuotationResultDto
func (a *QuotationsAPIService) CreateQuotationExecute(r QuotationsAPICreateQuotationRequest) (*CreateQuotationResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateQuotationResultDto
	)
	...
	localVarPath := localBasePath + "/v3/quotations"
...
type QuotationsAPIGetQuotationByIdRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	uid string
	fields *string
...
func (r QuotationsAPIGetQuotationByIdRequest) Fields(fields string) QuotationsAPIGetQuotationByIdRequest {
	r.fields = &fields
	return r
}

func (r QuotationsAPIGetQuotationByIdRequest) Execute() (*QuotationDto, *http.Response, error) {
	return r.ApiService.GetQuotationByIdExecute(r)
}

/*
GetQuotationById Get a quotation by its unique identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Quotation's unique identifier
 @return QuotationsAPIGetQuotationByIdRequest
*/
func (a *QuotationsAPIService) GetQuotationById(ctx context.Context, uid string) QuotationsAPIGetQuotationByIdRequest {
	return QuotationsAPIGetQuotationByIdRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return QuotationDto
func (a *QuotationsAPIService) GetQuotationByIdExecute(r QuotationsAPIGetQuotationByIdRequest) (*QuotationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *QuotationDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotationsAPIService.GetQuotationById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/quotations/{uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type QuotationsAPIGetQuotationByQuotationNumberRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	quotationNumber *int32
	fields *string
}

// Quotation number
func (r QuotationsAPIGetQuotationByQuotationNumberRequest) QuotationNumber(quotationNumber int32) QuotationsAPIGetQuotationByQuotationNumberRequest {
	r.quotationNumber = &quotationNumber
	return r
}

// Projection fields separated with a comma
func (r QuotationsAPIGetQuotationByQuotationNumberRequest) Fields(fields string) QuotationsAPIGetQuotationByQuotationNumberRequest {
	r.fields = &fields
	return r
}

func (r QuotationsAPIGetQuotationByQuotationNumberRequest) Execute() (*QuotationDto, *http.Response, error) {
	return r.ApiService.GetQuotationByQuotationNumberExecute(r)
}

/*
GetQuotationByQuotationNumber Get a quotation by its quotation number

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return QuotationsAPIGetQuotationByQuotationNumberRequest
*/
func (a *QuotationsAPIService) GetQuotationByQuotationNumber(ctx context.Context) QuotationsAPIGetQuotationByQuotationNumberRequest {
	return QuotationsAPIGetQuotationByQuotationNumberRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return QuotationDto
func (a *QuotationsAPIService) GetQuotationByQuotationNumberExecute(r QuotationsAPIGetQuotationByQuotationNumberRequest) (*QuotationDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotationsAPIService.GetQuotationByQuotationNumber")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/quotations/by-quotation-number"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.quotationNumber == nil {
		return localVarReturnValue, nil, reportError("quotationNumber is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "quotationNumber", r.quotationNumber, "", "")
	if r.fields != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields", r.fields, "", "")
	}
	// to determine the Content-Type header
...
type QuotationsAPIQuotationCreationDryRunRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	command *SimulateQuotationCreationDryRunCommand
}

func (r QuotationsAPIQuotationCreationDryRunRequest) Command(command SimulateQuotationCreationDryRunCommand) QuotationsAPIQuotationCreationDryRunRequest {
	r.command = &command
	return r
}

func (r QuotationsAPIQuotationCreationDryRunRequest) Execute() (*QuotationEntryDryRunDto, *http.Response, error) {
	return r.ApiService.QuotationCreationDryRunExecute(r)
}

/*
QuotationCreationDryRun Quotation creation dry run

Simulate a quotation creation: performs a dry run.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return QuotationsAPIQuotationCreationDryRunRequest
*/
func (a *QuotationsAPIService) QuotationCreationDryRun(ctx context.Context) QuotationsAPIQuotationCreationDryRunRequest {
	return QuotationsAPIQuotationCreationDryRunRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return QuotationEntryDryRunDto
func (a *QuotationsAPIService) QuotationCreationDryRunExecute(r QuotationsAPIQuotationCreationDryRunRequest) (*QuotationEntryDryRunDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *QuotationEntryDryRunDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotationsAPIService.QuotationCreationDryRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/quotations/dry-run"
...
type QuotationsAPIQuotationUpdateDryRunRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	uid string
	command *UpdateQuotationDto
}

func (r QuotationsAPIQuotationUpdateDryRunRequest) Command(command UpdateQuotationDto) QuotationsAPIQuotationUpdateDryRunRequest {
	r.command = &command
	return r
}

func (r QuotationsAPIQuotationUpdateDryRunRequest) Execute() (*QuotationEntryDryRunDto, *http.Response, error) {
	return r.ApiService.QuotationUpdateDryRunExecute(r)
}

/*
QuotationUpdateDryRun Quotation update dry run

Simulate a quotation update : performs a dry run.  
The following permission(s) are required to access this route:  Update orders.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid
 @return QuotationsAPIQuotationUpdateDryRunRequest
*/
func (a *QuotationsAPIService) QuotationUpdateDryRun(ctx context.Context, uid string) QuotationsAPIQuotationUpdateDryRunRequest {
	return QuotationsAPIQuotationUpdateDryRunRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
//  @return QuotationEntryDryRunDto
func (a *QuotationsAPIService) QuotationUpdateDryRunExecute(r QuotationsAPIQuotationUpdateDryRunRequest) (*QuotationEntryDryRunDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotationsAPIService.QuotationUpdateDryRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/quotations/{uid}/dry-run"
	localVarPath = strings.Replace(localVarPath, "{"+"uid"+"}", url.PathEscape(parameterValueToString(r.uid, "uid")), -1)
...
type QuotationsAPIUpdateQuotationRequest struct {
	ctx context.Context
	ApiService *QuotationsAPIService
	uid string
	command *UpdateQuotationDto
...
// Update quotation command.
func (r QuotationsAPIUpdateQuotationRequest) Command(command UpdateQuotationDto) QuotationsAPIUpdateQuotationRequest {
	r.command = &command
	return r
}

func (r QuotationsAPIUpdateQuotationRequest) Execute() (*http.Response, error) {
...
Updates a quotation using merge patch semantics : you need to provide only the fields to update.
...
Deleting a transport in the quotation is not supported.
For all changes requiring more complex modifications, you will need to cancel the quotation and create another one.  
The following permission(s) are required to access this route:  Update orders.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid Quotation's unique identifier
 @return QuotationsAPIUpdateQuotationRequest
*/
func (a *QuotationsAPIService) UpdateQuotation(ctx context.Context, uid string) QuotationsAPIUpdateQuotationRequest {
	return QuotationsAPIUpdateQuotationRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
// Execute executes the request
func (a *QuotationsAPIService) UpdateQuotationExecute(r QuotationsAPIUpdateQuotationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
