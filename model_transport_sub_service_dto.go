...
// checks if the TransportSubServiceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportSubServiceDto{}

// TransportSubServiceDto struct for TransportSubServiceDto
type TransportSubServiceDto struct {
	...
	// Sell global pricing is disabled when sell price or sell unit price is forced.    The following permission(s) are required to access this property:  See prices.
	...
	// Buy global pricing is disabled when buy price or buy unit price is forced.    The following permission(s) are required to access this property:  See prices.
...
func (o TransportSubServiceDto) MarshalJSON() ([]byte, error) {
...
func (o TransportSubServiceDto) ToMap() (map[string]interface{}, error) {
...
type NullableTransportSubServiceDto struct {
	value *TransportSubServiceDto
	isSet bool
}

func (v NullableTransportSubServiceDto) Get() *TransportSubServiceDto {
	return v.value
}

func (v *NullableTransportSubServiceDto) Set(val *TransportSubServiceDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportSubServiceDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportSubServiceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportSubServiceDto(val *TransportSubServiceDto) *NullableTransportSubServiceDto {
	return &NullableTransportSubServiceDto{value: val, isSet: true}
}

func (v NullableTransportSubServiceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportSubServiceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
