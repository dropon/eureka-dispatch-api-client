...
type CitiesAPIGetBestMatchRequest struct {
	ctx context.Context
...
func (r CitiesAPIGetBestMatchRequest) PostCode(postCode string) CitiesAPIGetBestMatchRequest {
	r.postCode = &postCode
	return r
}

// The city name to look for.
func (r CitiesAPIGetBestMatchRequest) CityName(cityName string) CitiesAPIGetBestMatchRequest {
	r.cityName = &cityName
	return r
}
...
func (r CitiesAPIGetBestMatchRequest) AgencyCode(agencyCode string) CitiesAPIGetBestMatchRequest {
...
func (r CitiesAPIGetBestMatchRequest) CountryCode(countryCode string) CitiesAPIGetBestMatchRequest {
	r.countryCode = &countryCode
	return r
}

// Optional : Restrict to cities in the specified country family.  Used only if CountryCode is not provided.
func (r CitiesAPIGetBestMatchRequest) CountryFamilyCode(countryFamilyCode string) CitiesAPIGetBestMatchRequest {
	r.countryFamilyCode = &countryFamilyCode
	return r
}

// Restrict to cities that are available or not for mission entry.    Default value is &#39;Yes&#39;.
func (r CitiesAPIGetBestMatchRequest) MissionEntryAvailability(missionEntryAvailability string) CitiesAPIGetBestMatchRequest {
	r.missionEntryAvailability = &missionEntryAvailability
	return r
}

// Projection fields separated with a comma
func (r CitiesAPIGetBestMatchRequest) Fields(fields string) CitiesAPIGetBestMatchRequest {
	r.fields = &fields
	return r
}

func (r CitiesAPIGetBestMatchRequest) Execute() (*CityDto, *http.Response, error) {
...
If no country code is provided, cities with the default Dispatch country code will have priority over the others.
 ...
 @return CitiesAPIGetBestMatchRequest
*/
func (a *CitiesAPIService) GetBestMatch(ctx context.Context) CitiesAPIGetBestMatchRequest {
	return CitiesAPIGetBestMatchRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CityDto
func (a *CitiesAPIService) GetBestMatchExecute(r CitiesAPIGetBestMatchRequest) (*CityDto, *http.Response, error) {
	var (
...
type CitiesAPIGetCitiesRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	postCode *string
	cityName *string
...
func (r CitiesAPIGetCitiesRequest) PostCode(postCode string) CitiesAPIGetCitiesRequest {
	r.postCode = &postCode
	return r
}

// The city name pattern to look for.
func (r CitiesAPIGetCitiesRequest) CityName(cityName string) CitiesAPIGetCitiesRequest {
	r.cityName = &cityName
	return r
}

// Optional : Restrict research to cities in the specified agency,  or that are not linked to a specific agency.
func (r CitiesAPIGetCitiesRequest) AgencyCode(agencyCode string) CitiesAPIGetCitiesRequest {
	r.agencyCode = &agencyCode
	return r
}

// Optional : Restrict research to cities in the specified country.
func (r CitiesAPIGetCitiesRequest) CountryCode(countryCode string) CitiesAPIGetCitiesRequest {
	r.countryCode = &countryCode
	return r
}

// Optional : Restrict to cities in the specified country family.  Used only if CountryCode is not provided.
func (r CitiesAPIGetCitiesRequest) CountryFamilyCode(countryFamilyCode string) CitiesAPIGetCitiesRequest {
	r.countryFamilyCode = &countryFamilyCode
	return r
}

// Restrict to cities that are available or not for mission entry.    Default value is &#39;Yes&#39;.
func (r CitiesAPIGetCitiesRequest) MissionEntryAvailability(missionEntryAvailability string) CitiesAPIGetCitiesRequest {
	r.missionEntryAvailability = &missionEntryAvailability
	return r
}

// A list of city ids
func (r CitiesAPIGetCitiesRequest) CityIds(cityIds []int32) CitiesAPIGetCitiesRequest {
	r.cityIds = &cityIds
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r CitiesAPIGetCitiesRequest) Pattern(pattern string) CitiesAPIGetCitiesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r CitiesAPIGetCitiesRequest) PatternFields(patternFields []string) CitiesAPIGetCitiesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r CitiesAPIGetCitiesRequest) StartIndex(startIndex int32) CitiesAPIGetCitiesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r CitiesAPIGetCitiesRequest) Count(count int32) CitiesAPIGetCitiesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r CitiesAPIGetCitiesRequest) Sort(sort []string) CitiesAPIGetCitiesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r CitiesAPIGetCitiesRequest) Desc(desc []string) CitiesAPIGetCitiesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r CitiesAPIGetCitiesRequest) Fields(fields string) CitiesAPIGetCitiesRequest {
	r.fields = &fields
	return r
}

func (r CitiesAPIGetCitiesRequest) Execute() (*IPagedResourceListCityDto, *http.Response, error) {
...
Get a paginated list of cities corresponding to the specified filters.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return CitiesAPIGetCitiesRequest
*/
func (a *CitiesAPIService) GetCities(ctx context.Context) CitiesAPIGetCitiesRequest {
	return CitiesAPIGetCitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CitiesAPIService) GetCitiesExecute(r CitiesAPIGetCitiesRequest) (*IPagedResourceListCityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type CitiesAPIGetCityByIdRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	cityId *int32
	fields *string
...
func (r CitiesAPIGetCityByIdRequest) CityId(cityId int32) CitiesAPIGetCityByIdRequest {
	r.cityId = &cityId
	return r
}

// Projection fields separated with a comma
func (r CitiesAPIGetCityByIdRequest) Fields(fields string) CitiesAPIGetCityByIdRequest {
	r.fields = &fields
	return r
}

func (r CitiesAPIGetCityByIdRequest) Execute() (*CityDto, *http.Response, error) {
	return r.ApiService.GetCityByIdExecute(r)
}

/*
GetCityById Get a city by its identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return CitiesAPIGetCityByIdRequest
*/
func (a *CitiesAPIService) GetCityById(ctx context.Context) CitiesAPIGetCityByIdRequest {
	return CitiesAPIGetCityByIdRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CityDto
func (a *CitiesAPIService) GetCityByIdExecute(r CitiesAPIGetCityByIdRequest) (*CityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
