...
type ApiCheckCityDeletionConstraintsRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	cityId int32
}

func (r ApiCheckCityDeletionConstraintsRequest) Execute() (*EntityDeletionConstraintsDto, *http.Response, error) {
	return r.ApiService.CheckCityDeletionConstraintsExecute(r)
}

/*
CheckCityDeletionConstraints Check city deletion constraints

The following permission(s) are required to access this route:  Update cities.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param cityId City identifier
 @return ApiCheckCityDeletionConstraintsRequest
*/
func (a *CitiesAPIService) CheckCityDeletionConstraints(ctx context.Context, cityId int32) ApiCheckCityDeletionConstraintsRequest {
	return ApiCheckCityDeletionConstraintsRequest{
		ApiService: a,
		ctx: ctx,
		cityId: cityId,
...
func (a *CitiesAPIService) CheckCityDeletionConstraintsExecute(r ApiCheckCityDeletionConstraintsRequest) (*EntityDeletionConstraintsDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.CheckCityDeletionConstraints")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/cities/{cityId}/deletion-constraints"
...
type ApiCreateCityRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	command *CreateCityCommand
}

func (r ApiCreateCityRequest) Command(command CreateCityCommand) ApiCreateCityRequest {
	r.command = &command
	return r
}

func (r ApiCreateCityRequest) Execute() (*CreateCityResultDto, *http.Response, error) {
	return r.ApiService.CreateCityExecute(r)
}
...
The following permission(s) are required to access this route:  Update cities.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateCityRequest
*/
func (a *CitiesAPIService) CreateCity(ctx context.Context) ApiCreateCityRequest {
	return ApiCreateCityRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CreateCityResultDto
func (a *CitiesAPIService) CreateCityExecute(r ApiCreateCityRequest) (*CreateCityResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateCityResultDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.CreateCity")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/cities"
...
type ApiDeleteCityRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	cityId int32
}

func (r ApiDeleteCityRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteCityExecute(r)
}
...
The following permission(s) are required to access this route:  Update cities.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param cityId City identifier
 @return ApiDeleteCityRequest
*/
func (a *CitiesAPIService) DeleteCity(ctx context.Context, cityId int32) ApiDeleteCityRequest {
	return ApiDeleteCityRequest{
		ApiService: a,
		ctx: ctx,
		cityId: cityId,
...
// Execute executes the request
func (a *CitiesAPIService) DeleteCityExecute(r ApiDeleteCityRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.DeleteCity")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/cities/{cityId}"
	localVarPath = strings.Replace(localVarPath, "{"+"cityId"+"}", url.PathEscape(parameterValueToString(r.cityId, "cityId")), -1)
...
type ApiGetBestMatchRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	postCode *string
	cityName *string
	agencyCode *string
	countryCode *string
	countryFamilyCode *string
	missionEntryAvailability *string
	fields *string
}

// The post code to look for.
func (r ApiGetBestMatchRequest) PostCode(postCode string) ApiGetBestMatchRequest {
	r.postCode = &postCode
	return r
}

// The city name to look for.
func (r ApiGetBestMatchRequest) CityName(cityName string) ApiGetBestMatchRequest {
	r.cityName = &cityName
	return r
}

// Optional : Restrict research to cities in the specified agency,  or that are not linked to a specific agency.  A city having the correct agency code will have priority over  other cities with no specific agency.
func (r ApiGetBestMatchRequest) AgencyCode(agencyCode string) ApiGetBestMatchRequest {
	r.agencyCode = &agencyCode
	return r
}

// Optional : Restrict research to cities in the specified country.  If no country code is specified, a city from the default Dispatch country code  will have priority over the others.
func (r ApiGetBestMatchRequest) CountryCode(countryCode string) ApiGetBestMatchRequest {
	r.countryCode = &countryCode
	return r
}

// Optional : Restrict to cities in the specified country family.  Used only if CountryCode is not provided.
func (r ApiGetBestMatchRequest) CountryFamilyCode(countryFamilyCode string) ApiGetBestMatchRequest {
	r.countryFamilyCode = &countryFamilyCode
	return r
}

// Restrict to cities that are available or not for mission entry.    Default value is &#39;Yes&#39;.
func (r ApiGetBestMatchRequest) MissionEntryAvailability(missionEntryAvailability string) ApiGetBestMatchRequest {
	r.missionEntryAvailability = &missionEntryAvailability
	return r
}

// Projection fields separated with a comma
func (r ApiGetBestMatchRequest) Fields(fields string) ApiGetBestMatchRequest {
	r.fields = &fields
	return r
}

func (r ApiGetBestMatchRequest) Execute() (*CityDto, *http.Response, error) {
	return r.ApiService.GetBestMatchExecute(r)
}

/*
GetBestMatch Get best match

Gets the city that best matches the request.  
If provided, the PostCode and CityName must match exactly (case insensitive).  
An advanced search is done if no match is found with the provided city name, and if the postal code is also specified :  
* try to find a city corresponding to the specified criteria, while ignoring special characters (hyphen, slash, single quote) and whitespaces, and considering "st" as abbreviation for "sainte" and "saint".  
* if there is no match and only if the provided name has more than 4 characters, search a city corresponding to the specified criteria, starting with the provided name.  
* if there is no match and only if the provided name has more than 4 characters, search a city corresponding to the specified criteria, for which the provided name starts with city's name.  
If an agency code is provided, cities with the specified agency code will have priority over cities without agency code.  
If no country code is provided, cities with the default Dispatch country code will have priority over the others.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetBestMatchRequest
*/
func (a *CitiesAPIService) GetBestMatch(ctx context.Context) ApiGetBestMatchRequest {
	return ApiGetBestMatchRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CityDto
func (a *CitiesAPIService) GetBestMatchExecute(r ApiGetBestMatchRequest) (*CityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CityDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.GetBestMatch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/cities/best-match"
	...
	if r.countryFamilyCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "countryFamilyCode", r.countryFamilyCode, "", "")
	}
	if r.missionEntryAvailability != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "missionEntryAvailability", r.missionEntryAvailability, "", "")
	} else {
		var defaultValue string = "Yes"
		r.missionEntryAvailability = &defaultValue
	}
	if r.fields != nil {
...
// The postal code pattern to look for.
func (r ApiGetCitiesRequest) PostCode(postCode string) ApiGetCitiesRequest {
	r.postCode = &postCode
	return r
}

// The city name pattern to look for.
func (r ApiGetCitiesRequest) CityName(cityName string) ApiGetCitiesRequest {
	r.cityName = &cityName
	return r
}

// The sector code pattern to look for.
func (r ApiGetCitiesRequest) SectorCode(sectorCode string) ApiGetCitiesRequest {
	r.sectorCode = &sectorCode
	return r
}

// Optional : Restrict research to cities in the specified agency,  or that are not linked to a specific agency.
func (r ApiGetCitiesRequest) AgencyCode(agencyCode string) ApiGetCitiesRequest {
	r.agencyCode = &agencyCode
	return r
}

// Optional : Restrict research to cities in the specified country.
func (r ApiGetCitiesRequest) CountryCode(countryCode string) ApiGetCitiesRequest {
	r.countryCode = &countryCode
	return r
}

// Optional : Restrict to cities in the specified country family.  Used only if CountryCode is not provided.
func (r ApiGetCitiesRequest) CountryFamilyCode(countryFamilyCode string) ApiGetCitiesRequest {
	r.countryFamilyCode = &countryFamilyCode
	return r
}

// Restrict to cities that are available or not for mission entry.    Default value is &#39;Yes&#39;.
func (r ApiGetCitiesRequest) MissionEntryAvailability(missionEntryAvailability string) ApiGetCitiesRequest {
	r.missionEntryAvailability = &missionEntryAvailability
	return r
}

// A list of city ids
func (r ApiGetCitiesRequest) CityIds(cityIds []int32) ApiGetCitiesRequest {
	r.cityIds = &cityIds
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetCitiesRequest) Pattern(pattern string) ApiGetCitiesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetCitiesRequest) PatternFields(patternFields []string) ApiGetCitiesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetCitiesRequest) StartIndex(startIndex int32) ApiGetCitiesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetCitiesRequest) Count(count int32) ApiGetCitiesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetCitiesRequest) Sort(sort []string) ApiGetCitiesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetCitiesRequest) Desc(desc []string) ApiGetCitiesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetCitiesRequest) Fields(fields string) ApiGetCitiesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCitiesRequest) Execute() (*IPagedResourceListCityDto, *http.Response, error) {
...
Get a paginated list of cities corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCitiesRequest
*/
func (a *CitiesAPIService) GetCities(ctx context.Context) ApiGetCitiesRequest {
	return ApiGetCitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListCityDto
func (a *CitiesAPIService) GetCitiesExecute(r ApiGetCitiesRequest) (*IPagedResourceListCityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListCityDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.GetCities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.cityIds != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "cityIds", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "cityIds", t, "form", "multi")
		}
	}
	if r.pattern != nil {
...
// Projection fields separated with a comma
func (r ApiGetCityByIdRequest) Fields(fields string) ApiGetCityByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCityByIdRequest) Execute() (*CityDto, *http.Response, error) {
...
*/
func (a *CitiesAPIService) GetCityById(ctx context.Context, cityId int32) ApiGetCityByIdRequest {
	return ApiGetCityByIdRequest{
		ApiService: a,
		ctx: ctx,
		cityId: cityId,
...
// Execute executes the request
//  @return CityDto
func (a *CitiesAPIService) GetCityByIdExecute(r ApiGetCityByIdRequest) (*CityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.GetCityById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetCityByIdAlternativeRouteRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	cityId *int32
	fields *string
...
func (r ApiGetCityByIdAlternativeRouteRequest) CityId(cityId int32) ApiGetCityByIdAlternativeRouteRequest {
	r.cityId = &cityId
	return r
}

// Projection fields separated with a comma
func (r ApiGetCityByIdAlternativeRouteRequest) Fields(fields string) ApiGetCityByIdAlternativeRouteRequest {
	r.fields = &fields
	return r
}

func (r ApiGetCityByIdAlternativeRouteRequest) Execute() (*CityDto, *http.Response, error) {
	return r.ApiService.GetCityByIdAlternativeRouteExecute(r)
}

/*
GetCityByIdAlternativeRoute Get city by id (alternative route)

Get a city by its identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCityByIdAlternativeRouteRequest
*/
func (a *CitiesAPIService) GetCityByIdAlternativeRoute(ctx context.Context) ApiGetCityByIdAlternativeRouteRequest {
	return ApiGetCityByIdAlternativeRouteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CityDto
func (a *CitiesAPIService) GetCityByIdAlternativeRouteExecute(r ApiGetCityByIdAlternativeRouteRequest) (*CityDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.GetCityByIdAlternativeRoute")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/cities/by-city-id"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.cityId == nil {
		return localVarReturnValue, nil, reportError("cityId is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "cityId", r.cityId, "", "")
	if r.fields != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields", r.fields, "", "")
	}
	// to determine the Content-Type header
...
type ApiUpdateCityRequest struct {
	ctx context.Context
	ApiService *CitiesAPIService
	cityId int32
	command *UpdateCityDto
}

// Update city command.
func (r ApiUpdateCityRequest) Command(command UpdateCityDto) ApiUpdateCityRequest {
	r.command = &command
	return r
}

func (r ApiUpdateCityRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateCityExecute(r)
}

/*
UpdateCity Update city

Updates a city using merge patch semantics : you need to provide only the fields to update.
Fields that are not present in the request will be preserved, and fields set to null will be cleared.  
The following permission(s) are required to access this route:  Update cities.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param cityId City identifier
 @return ApiUpdateCityRequest
*/
func (a *CitiesAPIService) UpdateCity(ctx context.Context, cityId int32) ApiUpdateCityRequest {
	return ApiUpdateCityRequest{
		ApiService: a,
		ctx: ctx,
		cityId: cityId,
...
// Execute executes the request
func (a *CitiesAPIService) UpdateCityExecute(r ApiUpdateCityRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CitiesAPIService.UpdateCity")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
