...
func (r TransportsAPIGetTransportRouteRequest) StartDate(startDate time.Time) TransportsAPIGetTransportRouteRequest {
	r.startDate = &startDate
	return r
}

// Optional end date, restrict to positions acquired before this date
func (r TransportsAPIGetTransportRouteRequest) EndDate(endDate time.Time) TransportsAPIGetTransportRouteRequest {
	r.endDate = &endDate
	return r
}
...
func (r TransportsAPIGetTransportsRequest) DateFrom(dateFrom time.Time) TransportsAPIGetTransportsRequest {
	r.dateFrom = &dateFrom
	return r
}

// The exclusive end date and time for the search.
func (r TransportsAPIGetTransportsRequest) DateTo(dateTo time.Time) TransportsAPIGetTransportsRequest {
	r.dateTo = &dateTo
	return r
}
