...
// checks if the ApplyPickedUpStatusCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyPickedUpStatusCommand{}

// ApplyPickedUpStatusCommand struct for ApplyPickedUpStatusCommand
type ApplyPickedUpStatusCommand struct {
	// Mandatory. Transport unique identifier
	TransportUid string `json:"transportUid"`
	// Transport receipt
	TransportReceipt *string `json:"transportReceipt,omitempty"`
	// Transport pickup sign
	PickupSign *string `json:"pickupSign,omitempty"`
...
func NewApplyPickedUpStatusCommand(transportUid string) *ApplyPickedUpStatusCommand {
	this := ApplyPickedUpStatusCommand{}
...
// GetPickupSign returns the PickupSign field value if set, zero value otherwise.
func (o *ApplyPickedUpStatusCommand) GetPickupSign() string {
	if o == nil || IsNil(o.PickupSign) {
		var ret string
		return ret
	}
	return *o.PickupSign
...
// GetPickupSignOk returns a tuple with the PickupSign field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplyPickedUpStatusCommand) GetPickupSignOk() (*string, bool) {
	if o == nil || IsNil(o.PickupSign) {
		return nil, false
	}
	return o.PickupSign, true
}
...
// SetPickupSign gets a reference to the given string and assigns it to the PickupSign field.
func (o *ApplyPickedUpStatusCommand) SetPickupSign(v string) {
	o.PickupSign = &v
}

// GetPickupComment returns the PickupComment field value if set, zero value otherwise.
func (o *ApplyPickedUpStatusCommand) GetPickupComment() string {
	if o == nil || IsNil(o.PickupComment) {
		var ret string
		return ret
	}
	return *o.PickupComment
}

// GetPickupCommentOk returns a tuple with the PickupComment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplyPickedUpStatusCommand) GetPickupCommentOk() (*string, bool) {
	if o == nil || IsNil(o.PickupComment) {
		return nil, false
	}
	return o.PickupComment, true
}
...
// SetPickupComment gets a reference to the given string and assigns it to the PickupComment field.
...
func (o *ApplyPickedUpStatusCommand) GetRealizedLoadingStartDateTimeOk() (*time.Time, bool) {
	...
	return o.RealizedLoadingStartDateTime, true
}
...
func (o *ApplyPickedUpStatusCommand) GetRealizedLoadingEndDateTimeOk() (*time.Time, bool) {
	...
	return o.RealizedLoadingEndDateTime, true
}
...
func (o ApplyPickedUpStatusCommand) MarshalJSON() ([]byte, error) {
...
func (o ApplyPickedUpStatusCommand) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["transportUid"] = o.TransportUid
	if !IsNil(o.TransportReceipt) {
		toSerialize["transportReceipt"] = o.TransportReceipt
	}
	if !IsNil(o.PickupSign) {
		toSerialize["pickupSign"] = o.PickupSign
	}
	if !IsNil(o.PickupComment) {
		toSerialize["pickupComment"] = o.PickupComment
	}
	...
	if !IsNil(o.RealizedLoadingStartDateTime) {
		toSerialize["realizedLoadingStartDateTime"] = o.RealizedLoadingStartDateTime
	}
	if !IsNil(o.RealizedLoadingEndDateTime) {
		toSerialize["realizedLoadingEndDateTime"] = o.RealizedLoadingEndDateTime
	}
	return toSerialize, nil
}

func (o *ApplyPickedUpStatusCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varApplyPickedUpStatusCommand := _ApplyPickedUpStatusCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplyPickedUpStatusCommand)

	if err != nil {
		return err
	}

	*o = ApplyPickedUpStatusCommand(varApplyPickedUpStatusCommand)

	return err
}

type NullableApplyPickedUpStatusCommand struct {
	value *ApplyPickedUpStatusCommand
	isSet bool
}

func (v NullableApplyPickedUpStatusCommand) Get() *ApplyPickedUpStatusCommand {
	return v.value
}

func (v *NullableApplyPickedUpStatusCommand) Set(val *ApplyPickedUpStatusCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyPickedUpStatusCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyPickedUpStatusCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyPickedUpStatusCommand(val *ApplyPickedUpStatusCommand) *NullableApplyPickedUpStatusCommand {
	return &NullableApplyPickedUpStatusCommand{value: val, isSet: true}
}

func (v NullableApplyPickedUpStatusCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyPickedUpStatusCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
