...
// checks if the UpdateTransportBaseDtoSubServiceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTransportBaseDtoSubServiceDto{}

// UpdateTransportBaseDtoSubServiceDto struct for UpdateTransportBaseDtoSubServiceDto
type UpdateTransportBaseDtoSubServiceDto struct {
	...
	// This number can have up to 2 decimals.
	ForcedSellQuantity *float64 `json:"forcedSellQuantity,omitempty"`
	// To use default sell prices, unset (set to null) forced sell unit price, forced sell price and forced sell price in reference currency (if applicable).    If the forced sell unit price is set, the forced sell price and the forced sell price in reference currency (if applicable) must be unset.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedSellUnitPrice *float64 `json:"forcedSellUnitPrice,omitempty"`
	// If the forced sell price is set, the forced sell unit price and the forced sell price in reference currency (if applicable) must be unset.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedSellPrice *float64 `json:"forcedSellPrice,omitempty"`
	// Forced sell price can be specified in reference currency when it is different from customer's currency    and when this option is available in general settings.    If the forced sell price in reference currency is set, the forced sell unit price and the forced sell price must be unset.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedSellPriceInReferenceCurrency *float64 `json:"forcedSellPriceInReferenceCurrency,omitempty"`
	// The following permission(s) are required to access this property:  Set VAT in orders.
	ForcedSellVatCode *string `json:"forcedSellVatCode,omitempty"`
	// This number can have up to 2 decimals.
	ForcedBuyQuantity *float64 `json:"forcedBuyQuantity,omitempty"`
	// To use default buy prices, unset (set to null) forced buy unit price, forced buy price and forced buy price in reference currency (if applicable).    If the forced buy unit price is set, the forced buy price and the forced buy price in reference currency (if applicable) must be unset.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedBuyUnitPrice *float64 `json:"forcedBuyUnitPrice,omitempty"`
	// If the forced buy price is set, the forced buy unit price and the forced buy price in reference currency (if applicable) must be unset.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedBuyPrice *float64 `json:"forcedBuyPrice,omitempty"`
	// Forced buy price can be specified in reference currency when it is different from customer's currency    and when this option is available in general settings.    If the forced buy price in reference currency is set, the forced buy unit price and the forced buy price must be unset.    This number can have up to 2 decimals.    The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedBuyPriceInReferenceCurrency *float64 `json:"forcedBuyPriceInReferenceCurrency,omitempty"`
	// The following permission(s) are required to access this property:  Set VAT in orders.
	ForcedBuyVatCode *string `json:"forcedBuyVatCode,omitempty"`
}
...
func NewUpdateTransportBaseDtoSubServiceDto() *UpdateTransportBaseDtoSubServiceDto {
	this := UpdateTransportBaseDtoSubServiceDto{}
	return &this
}
...
// GetForcedSellQuantity returns the ForcedSellQuantity field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedSellQuantity() float64 {
	if o == nil || IsNil(o.ForcedSellQuantity) {
		var ret float64
		return ret
	}
	return *o.ForcedSellQuantity
}

// GetForcedSellQuantityOk returns a tuple with the ForcedSellQuantity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedSellQuantityOk() (*float64, bool) {
	if o == nil || IsNil(o.ForcedSellQuantity) {
		return nil, false
	}
	return o.ForcedSellQuantity, true
}
...
// SetForcedSellQuantity gets a reference to the given float64 and assigns it to the ForcedSellQuantity field.
func (o *UpdateTransportBaseDtoSubServiceDto) SetForcedSellQuantity(v float64) {
	o.ForcedSellQuantity = &v
}

// GetForcedSellUnitPrice returns the ForcedSellUnitPrice field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedSellUnitPrice() float64 {
	if o == nil || IsNil(o.ForcedSellUnitPrice) {
		var ret float64
		return ret
	}
	return *o.ForcedSellUnitPrice
}

// GetForcedSellUnitPriceOk returns a tuple with the ForcedSellUnitPrice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedSellUnitPriceOk() (*float64, bool) {
	if o == nil || IsNil(o.ForcedSellUnitPrice) {
		return nil, false
	}
	return o.ForcedSellUnitPrice, true
}
...
// SetForcedSellUnitPrice gets a reference to the given float64 and assigns it to the ForcedSellUnitPrice field.
func (o *UpdateTransportBaseDtoSubServiceDto) SetForcedSellUnitPrice(v float64) {
	o.ForcedSellUnitPrice = &v
}
...
// GetForcedSellVatCode returns the ForcedSellVatCode field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedSellVatCode() string {
	if o == nil || IsNil(o.ForcedSellVatCode) {
		var ret string
		return ret
	}
	return *o.ForcedSellVatCode
}

// GetForcedSellVatCodeOk returns a tuple with the ForcedSellVatCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedSellVatCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ForcedSellVatCode) {
		return nil, false
	}
	return o.ForcedSellVatCode, true
}
...
// SetForcedSellVatCode gets a reference to the given string and assigns it to the ForcedSellVatCode field.
func (o *UpdateTransportBaseDtoSubServiceDto) SetForcedSellVatCode(v string) {
	o.ForcedSellVatCode = &v
}

// GetForcedBuyQuantity returns the ForcedBuyQuantity field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedBuyQuantity() float64 {
	if o == nil || IsNil(o.ForcedBuyQuantity) {
		var ret float64
		return ret
	}
	return *o.ForcedBuyQuantity
}

// GetForcedBuyQuantityOk returns a tuple with the ForcedBuyQuantity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedBuyQuantityOk() (*float64, bool) {
	if o == nil || IsNil(o.ForcedBuyQuantity) {
		return nil, false
	}
	return o.ForcedBuyQuantity, true
}
...
// SetForcedBuyQuantity gets a reference to the given float64 and assigns it to the ForcedBuyQuantity field.
func (o *UpdateTransportBaseDtoSubServiceDto) SetForcedBuyQuantity(v float64) {
	o.ForcedBuyQuantity = &v
}

// GetForcedBuyUnitPrice returns the ForcedBuyUnitPrice field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedBuyUnitPrice() float64 {
	if o == nil || IsNil(o.ForcedBuyUnitPrice) {
		var ret float64
		return ret
	}
	return *o.ForcedBuyUnitPrice
}

// GetForcedBuyUnitPriceOk returns a tuple with the ForcedBuyUnitPrice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedBuyUnitPriceOk() (*float64, bool) {
	if o == nil || IsNil(o.ForcedBuyUnitPrice) {
		return nil, false
	}
	return o.ForcedBuyUnitPrice, true
}
...
// SetForcedBuyUnitPrice gets a reference to the given float64 and assigns it to the ForcedBuyUnitPrice field.
func (o *UpdateTransportBaseDtoSubServiceDto) SetForcedBuyUnitPrice(v float64) {
	o.ForcedBuyUnitPrice = &v
}
...
// GetForcedBuyVatCode returns the ForcedBuyVatCode field value if set, zero value otherwise.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedBuyVatCode() string {
	if o == nil || IsNil(o.ForcedBuyVatCode) {
		var ret string
		return ret
	}
	return *o.ForcedBuyVatCode
}

// GetForcedBuyVatCodeOk returns a tuple with the ForcedBuyVatCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTransportBaseDtoSubServiceDto) GetForcedBuyVatCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ForcedBuyVatCode) {
		return nil, false
	}
	return o.ForcedBuyVatCode, true
}
...
// SetForcedBuyVatCode gets a reference to the given string and assigns it to the ForcedBuyVatCode field.
func (o *UpdateTransportBaseDtoSubServiceDto) SetForcedBuyVatCode(v string) {
	o.ForcedBuyVatCode = &v
}

func (o UpdateTransportBaseDtoSubServiceDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateTransportBaseDtoSubServiceDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ForcedSellQuantity) {
		toSerialize["forcedSellQuantity"] = o.ForcedSellQuantity
	}
	if !IsNil(o.ForcedSellUnitPrice) {
		toSerialize["forcedSellUnitPrice"] = o.ForcedSellUnitPrice
	}
	...
	if !IsNil(o.ForcedSellVatCode) {
		toSerialize["forcedSellVatCode"] = o.ForcedSellVatCode
	}
	if !IsNil(o.ForcedBuyQuantity) {
		toSerialize["forcedBuyQuantity"] = o.ForcedBuyQuantity
	}
	if !IsNil(o.ForcedBuyUnitPrice) {
		toSerialize["forcedBuyUnitPrice"] = o.ForcedBuyUnitPrice
	}
	...
	if !IsNil(o.ForcedBuyVatCode) {
		toSerialize["forcedBuyVatCode"] = o.ForcedBuyVatCode
	}
	return toSerialize, nil
}

type NullableUpdateTransportBaseDtoSubServiceDto struct {
	value *UpdateTransportBaseDtoSubServiceDto
	isSet bool
}

func (v NullableUpdateTransportBaseDtoSubServiceDto) Get() *UpdateTransportBaseDtoSubServiceDto {
	return v.value
}

func (v *NullableUpdateTransportBaseDtoSubServiceDto) Set(val *UpdateTransportBaseDtoSubServiceDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateTransportBaseDtoSubServiceDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateTransportBaseDtoSubServiceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateTransportBaseDtoSubServiceDto(val *UpdateTransportBaseDtoSubServiceDto) *NullableUpdateTransportBaseDtoSubServiceDto {
	return &NullableUpdateTransportBaseDtoSubServiceDto{value: val, isSet: true}
}

func (v NullableUpdateTransportBaseDtoSubServiceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateTransportBaseDtoSubServiceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
