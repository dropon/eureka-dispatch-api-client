...
type ApiCheckAddressDeletionConstraintsRequest struct {
	ctx context.Context
	ApiService *AddressesAPIService
	id int32
}

func (r ApiCheckAddressDeletionConstraintsRequest) Execute() (*EntityDeletionConstraintsDto, *http.Response, error) {
	return r.ApiService.CheckAddressDeletionConstraintsExecute(r)
}

/*
CheckAddressDeletionConstraints Check address deletion constraints

The following permission(s) are required to access this route:  Update addresses.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Address identifier
 @return ApiCheckAddressDeletionConstraintsRequest
*/
func (a *AddressesAPIService) CheckAddressDeletionConstraints(ctx context.Context, id int32) ApiCheckAddressDeletionConstraintsRequest {
	return ApiCheckAddressDeletionConstraintsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return EntityDeletionConstraintsDto
func (a *AddressesAPIService) CheckAddressDeletionConstraintsExecute(r ApiCheckAddressDeletionConstraintsRequest) (*EntityDeletionConstraintsDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EntityDeletionConstraintsDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AddressesAPIService.CheckAddressDeletionConstraints")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/addresses/{id}/deletion-constraints"
...
func (r ApiCreateAddressRequest) Command(command CreateAddressCommand) ApiCreateAddressRequest {
	r.command = &command
	return r
}

func (r ApiCreateAddressRequest) Execute() (*CreateAddressResultDto, *http.Response, error) {
...
// Execute executes the request
//  @return CreateAddressResultDto
func (a *AddressesAPIService) CreateAddressExecute(r ApiCreateAddressRequest) (*CreateAddressResultDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateAddressResultDto
	)
	...
	localVarPath := localBasePath + "/v3/addresses"
...
func (a *AddressesAPIService) DeleteAddressExecute(r ApiDeleteAddressRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/v3/addresses/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiGetAddressAdditionalContactsRequest struct {
	ctx context.Context
	ApiService *AddressesAPIService
	id int32
	startIndex *int32
...
func (r ApiGetAddressAdditionalContactsRequest) StartIndex(startIndex int32) ApiGetAddressAdditionalContactsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetAddressAdditionalContactsRequest) Count(count int32) ApiGetAddressAdditionalContactsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetAddressAdditionalContactsRequest) Sort(sort []string) ApiGetAddressAdditionalContactsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetAddressAdditionalContactsRequest) Desc(desc []string) ApiGetAddressAdditionalContactsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetAddressAdditionalContactsRequest) Fields(fields string) ApiGetAddressAdditionalContactsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetAddressAdditionalContactsRequest) Execute() (*IPagedResourceListAddressContactDto, *http.Response, error) {
	return r.ApiService.GetAddressAdditionalContactsExecute(r)
}

/*
GetAddressAdditionalContacts Get address additional contacts

Get a paginated list of contacts corresponding to the specified address.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiGetAddressAdditionalContactsRequest
*/
func (a *AddressesAPIService) GetAddressAdditionalContacts(ctx context.Context, id int32) ApiGetAddressAdditionalContactsRequest {
	return ApiGetAddressAdditionalContactsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return IPagedResourceListAddressContactDto
func (a *AddressesAPIService) GetAddressAdditionalContactsExecute(r ApiGetAddressAdditionalContactsRequest) (*IPagedResourceListAddressContactDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListAddressContactDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AddressesAPIService.GetAddressAdditionalContacts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/addresses/{id}/additional-contacts"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// Projection fields separated with a comma
func (r ApiGetAddressByIdRequest) Fields(fields string) ApiGetAddressByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetAddressByIdRequest) Execute() (*AddressDto, *http.Response, error) {
...
*/
func (a *AddressesAPIService) GetAddressById(ctx context.Context, id int32) ApiGetAddressByIdRequest {
	return ApiGetAddressByIdRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return AddressDto
func (a *AddressesAPIService) GetAddressByIdExecute(r ApiGetAddressByIdRequest) (*AddressDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AddressDto
	)
...
type ApiGetAddressByIdAlternativeRouteRequest struct {
	ctx context.Context
	ApiService *AddressesAPIService
	addressId *int32
	fields *string
...
func (r ApiGetAddressByIdAlternativeRouteRequest) AddressId(addressId int32) ApiGetAddressByIdAlternativeRouteRequest {
	r.addressId = &addressId
	return r
}

// Projection fields separated with a comma
func (r ApiGetAddressByIdAlternativeRouteRequest) Fields(fields string) ApiGetAddressByIdAlternativeRouteRequest {
	r.fields = &fields
	return r
}

func (r ApiGetAddressByIdAlternativeRouteRequest) Execute() (*AddressDto, *http.Response, error) {
	return r.ApiService.GetAddressByIdAlternativeRouteExecute(r)
}

/*
GetAddressByIdAlternativeRoute Get address by id (alternative route)

Get an address by its identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAddressByIdAlternativeRouteRequest
*/
func (a *AddressesAPIService) GetAddressByIdAlternativeRoute(ctx context.Context) ApiGetAddressByIdAlternativeRouteRequest {
	return ApiGetAddressByIdAlternativeRouteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AddressDto
func (a *AddressesAPIService) GetAddressByIdAlternativeRouteExecute(r ApiGetAddressByIdAlternativeRouteRequest) (*AddressDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AddressesAPIService.GetAddressByIdAlternativeRoute")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/addresses/by-address-id"
...
type ApiGetAddressForbiddenVehicleTypesRequest struct {
	ctx context.Context
	ApiService *AddressesAPIService
	id int32
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetAddressForbiddenVehicleTypesRequest) StartIndex(startIndex int32) ApiGetAddressForbiddenVehicleTypesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetAddressForbiddenVehicleTypesRequest) Count(count int32) ApiGetAddressForbiddenVehicleTypesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetAddressForbiddenVehicleTypesRequest) Sort(sort []string) ApiGetAddressForbiddenVehicleTypesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetAddressForbiddenVehicleTypesRequest) Desc(desc []string) ApiGetAddressForbiddenVehicleTypesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetAddressForbiddenVehicleTypesRequest) Fields(fields string) ApiGetAddressForbiddenVehicleTypesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetAddressForbiddenVehicleTypesRequest) Execute() (*IPagedResourceListAddressVehicleTypeDto, *http.Response, error) {
	return r.ApiService.GetAddressForbiddenVehicleTypesExecute(r)
}

/*
GetAddressForbiddenVehicleTypes Get address forbidden vehicle types

Get a paginated list of forbidden vehicle types corresponding to the specified address.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiGetAddressForbiddenVehicleTypesRequest
*/
func (a *AddressesAPIService) GetAddressForbiddenVehicleTypes(ctx context.Context, id int32) ApiGetAddressForbiddenVehicleTypesRequest {
	return ApiGetAddressForbiddenVehicleTypesRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return IPagedResourceListAddressVehicleTypeDto
func (a *AddressesAPIService) GetAddressForbiddenVehicleTypesExecute(r ApiGetAddressForbiddenVehicleTypesRequest) (*IPagedResourceListAddressVehicleTypeDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListAddressVehicleTypeDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AddressesAPIService.GetAddressForbiddenVehicleTypes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/addresses/{id}/forbidden-vehicle-types"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiGetAddressesRequest struct {
	...
	agencyCode *string
	sectorCode *string
	operationZoneCode *string
	onlyFavoritesOfCustomerCode *string
	restrictToAgencyCode *string
	startIndex *int32
	count *int32
	sort *[]string
	desc *[]string
...
// Get addresses having the specified ids
func (r ApiGetAddressesRequest) AddressesIds(addressesIds []int32) ApiGetAddressesRequest {
	r.addressesIds = &addressesIds
	return r
}

// Get addresses matching the specified address name pattern.  This field supports _startsWith_, _endsWith_ and _contains_ patterns.
func (r ApiGetAddressesRequest) AddressName(addressName string) ApiGetAddressesRequest {
	r.addressName = &addressName
	return r
}

// Get addresses matching the specified street number pattern
func (r ApiGetAddressesRequest) StreetNumber(streetNumber string) ApiGetAddressesRequest {
	r.streetNumber = &streetNumber
	return r
}

// Get addresses matching the specified street name pattern
func (r ApiGetAddressesRequest) StreetName(streetName string) ApiGetAddressesRequest {
	r.streetName = &streetName
	return r
}

// Get addresses matching the specified post code pattern
func (r ApiGetAddressesRequest) PostCode(postCode string) ApiGetAddressesRequest {
	r.postCode = &postCode
	return r
}

// Get addresses matching the specified city name pattern
func (r ApiGetAddressesRequest) CityName(cityName string) ApiGetAddressesRequest {
	r.cityName = &cityName
	return r
}

// Get addresses matching the specified country code pattern
func (r ApiGetAddressesRequest) CountryCode(countryCode string) ApiGetAddressesRequest {
	r.countryCode = &countryCode
	return r
}

// Get addresses matching this specified external address code pattern
func (r ApiGetAddressesRequest) ExternalAddressCode(externalAddressCode string) ApiGetAddressesRequest {
	r.externalAddressCode = &externalAddressCode
	return r
}

// Get addresses matching the specified agency code pattern
func (r ApiGetAddressesRequest) AgencyCode(agencyCode string) ApiGetAddressesRequest {
	r.agencyCode = &agencyCode
	return r
}

// Get addresses matching the specified sector code pattern
func (r ApiGetAddressesRequest) SectorCode(sectorCode string) ApiGetAddressesRequest {
	r.sectorCode = &sectorCode
	return r
}

// Get addresses matching the specified operation zone code pattern
func (r ApiGetAddressesRequest) OperationZoneCode(operationZoneCode string) ApiGetAddressesRequest {
	r.operationZoneCode = &operationZoneCode
	return r
}

// If set, only the addresses that are favorites of the specified customer  will be retrieved.
func (r ApiGetAddressesRequest) OnlyFavoritesOfCustomerCode(onlyFavoritesOfCustomerCode string) ApiGetAddressesRequest {
	r.onlyFavoritesOfCustomerCode = &onlyFavoritesOfCustomerCode
	return r
}

// If this filter is specified, the results will be filtered to addresses that are either :  - Available from any agency.  - Available only from the specific agency (the restriction can be directly on the address, or in the city)
func (r ApiGetAddressesRequest) RestrictToAgencyCode(restrictToAgencyCode string) ApiGetAddressesRequest {
	r.restrictToAgencyCode = &restrictToAgencyCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetAddressesRequest) StartIndex(startIndex int32) ApiGetAddressesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetAddressesRequest) Count(count int32) ApiGetAddressesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetAddressesRequest) Sort(sort []string) ApiGetAddressesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetAddressesRequest) Desc(desc []string) ApiGetAddressesRequest {
	r.desc = &desc
	return r
}
...
func (r ApiGetAddressesRequest) Execute() (*IPagedResourceListAddressDto, *http.Response, error) {
...
Get a paginated list of addresses corresponding to the specified filters.
...
// Execute executes the request
//  @return IPagedResourceListAddressDto
func (a *AddressesAPIService) GetAddressesExecute(r ApiGetAddressesRequest) (*IPagedResourceListAddressDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListAddressDto
	)
	...
	if r.addressesIds != nil {
		t := *r.addressesIds
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "addressesIds", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "addressesIds", t, "form", "multi")
		}
	}
	if r.addressName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "addressName", r.addressName, "", "")
	}
	if r.streetNumber != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "streetNumber", r.streetNumber, "", "")
	}
	if r.streetName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "streetName", r.streetName, "", "")
	}
	if r.postCode != nil {
	...
	if r.externalAddressCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "externalAddressCode", r.externalAddressCode, "", "")
	}
	if r.agencyCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "agencyCode", r.agencyCode, "", "")
	}
	if r.sectorCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sectorCode", r.sectorCode, "", "")
	}
	if r.operationZoneCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "operationZoneCode", r.operationZoneCode, "", "")
	}
	if r.onlyFavoritesOfCustomerCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "onlyFavoritesOfCustomerCode", r.onlyFavoritesOfCustomerCode, "", "")
	}
	if r.restrictToAgencyCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "restrictToAgencyCode", r.restrictToAgencyCode, "", "")
	}
	if r.startIndex != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "startIndex", r.startIndex, "", "")
	}
...
type ApiGetStreetsSuggestionsRequest struct {
	ctx context.Context
	ApiService *AddressesAPIService
	countryCode *string
	cityName *string
...
// Mandatory. The exact country code
func (r ApiGetStreetsSuggestionsRequest) CountryCode(countryCode string) ApiGetStreetsSuggestionsRequest {
	r.countryCode = &countryCode
	return r
}

// Mandatory. An exact or partial city name
func (r ApiGetStreetsSuggestionsRequest) CityName(cityName string) ApiGetStreetsSuggestionsRequest {
	r.cityName = &cityName
	return r
}

// Mandatory. An exact or partial post code
func (r ApiGetStreetsSuggestionsRequest) PostCode(postCode string) ApiGetStreetsSuggestionsRequest {
	r.postCode = &postCode
	return r
}

// Mandatory. Search term. An exact or partial street name
func (r ApiGetStreetsSuggestionsRequest) StreetName(streetName string) ApiGetStreetsSuggestionsRequest {
	r.streetName = &streetName
	return r
}

// Default value is &#39;100&#39;.
func (r ApiGetStreetsSuggestionsRequest) Count(count int32) ApiGetStreetsSuggestionsRequest {
	r.count = &count
	return r
}

func (r ApiGetStreetsSuggestionsRequest) Execute() (*IResourceListStreetSuggestionDto, *http.Response, error) {
	return r.ApiService.GetStreetsSuggestionsExecute(r)
}

/*
GetStreetsSuggestions Get streets suggestions

Get a collection of street suggestions corresponding to the provided criteria.
Please note that this query does not return paginated results.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetStreetsSuggestionsRequest
*/
func (a *AddressesAPIService) GetStreetsSuggestions(ctx context.Context) ApiGetStreetsSuggestionsRequest {
	return ApiGetStreetsSuggestionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IResourceListStreetSuggestionDto
func (a *AddressesAPIService) GetStreetsSuggestionsExecute(r ApiGetStreetsSuggestionsRequest) (*IResourceListStreetSuggestionDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IResourceListStreetSuggestionDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AddressesAPIService.GetStreetsSuggestions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/addresses/streets/suggestions"
	...
	if r.streetName == nil {
		return localVarReturnValue, nil, reportError("streetName is required and must be specified")
	}
...
type ApiUpdateAddressRequest struct {
	...
	ApiService *AddressesAPIService
	id int32
	command *UpdateAddressDto
}

// Update address command.
func (r ApiUpdateAddressRequest) Command(command UpdateAddressDto) ApiUpdateAddressRequest {
	r.command = &command
	return r
}

func (r ApiUpdateAddressRequest) Execute() (*http.Response, error) {
...
Updates an address using merge patch semantics : you need to provide only the fields to update.
...
// Execute executes the request
func (a *AddressesAPIService) UpdateAddressExecute(r ApiUpdateAddressRequest) (*http.Response, error) {
	var (
