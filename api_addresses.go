...
type AddressesAPIGetAddressByIdRequest struct {
	ctx context.Context
...
func (r AddressesAPIGetAddressByIdRequest) AddressId(addressId int32) AddressesAPIGetAddressByIdRequest {
	r.addressId = &addressId
	return r
}

// Projection fields separated with a comma
func (r AddressesAPIGetAddressByIdRequest) Fields(fields string) AddressesAPIGetAddressByIdRequest {
	r.fields = &fields
	return r
}

func (r AddressesAPIGetAddressByIdRequest) Execute() (*AddressDto, *http.Response, error) {
	return r.ApiService.GetAddressByIdExecute(r)
}

/*
GetAddressById Get an address by its identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return AddressesAPIGetAddressByIdRequest
*/
func (a *AddressesAPIService) GetAddressById(ctx context.Context) AddressesAPIGetAddressByIdRequest {
	return AddressesAPIGetAddressByIdRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return AddressDto
func (a *AddressesAPIService) GetAddressByIdExecute(r AddressesAPIGetAddressByIdRequest) (*AddressDto, *http.Response, error) {
	var (
...
func (r AddressesAPIGetAddressesRequest) AddressesIds(addressesIds []int32) AddressesAPIGetAddressesRequest {
...
func (r AddressesAPIGetAddressesRequest) AddressName(addressName string) AddressesAPIGetAddressesRequest {
	r.addressName = &addressName
	return r
}

// Get addresses matching the specified street number pattern
func (r AddressesAPIGetAddressesRequest) StreetNumber(streetNumber string) AddressesAPIGetAddressesRequest {
	r.streetNumber = &streetNumber
	return r
}

// Get addresses matching the specified street name pattern
func (r AddressesAPIGetAddressesRequest) StreetName(streetName string) AddressesAPIGetAddressesRequest {
	r.streetName = &streetName
	return r
}

// Get addresses matching the specified post code pattern
func (r AddressesAPIGetAddressesRequest) PostCode(postCode string) AddressesAPIGetAddressesRequest {
	r.postCode = &postCode
	return r
}

// Get addresses matching the specified city name pattern
func (r AddressesAPIGetAddressesRequest) CityName(cityName string) AddressesAPIGetAddressesRequest {
	r.cityName = &cityName
	return r
}

// Get addresses matching the specified country code pattern
func (r AddressesAPIGetAddressesRequest) CountryCode(countryCode string) AddressesAPIGetAddressesRequest {
	r.countryCode = &countryCode
	return r
}

// Get addresses matching this specified external address code pattern
func (r AddressesAPIGetAddressesRequest) ExternalAddressCode(externalAddressCode string) AddressesAPIGetAddressesRequest {
	r.externalAddressCode = &externalAddressCode
	return r
}

// Get addresses matching the specified agency code pattern
func (r AddressesAPIGetAddressesRequest) AgencyCode(agencyCode string) AddressesAPIGetAddressesRequest {
	r.agencyCode = &agencyCode
	return r
}

// Get addresses matching the specified sector code pattern
func (r AddressesAPIGetAddressesRequest) SectorCode(sectorCode string) AddressesAPIGetAddressesRequest {
	r.sectorCode = &sectorCode
	return r
}

// Get addresses matching the specified operation zone code pattern
func (r AddressesAPIGetAddressesRequest) OperationZoneCode(operationZoneCode string) AddressesAPIGetAddressesRequest {
...
func (r AddressesAPIGetAddressesRequest) OnlyFavoritesOfCustomerCode(onlyFavoritesOfCustomerCode string) AddressesAPIGetAddressesRequest {
...
func (r AddressesAPIGetAddressesRequest) RestrictToAgencyCode(restrictToAgencyCode string) AddressesAPIGetAddressesRequest {
	r.restrictToAgencyCode = &restrictToAgencyCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r AddressesAPIGetAddressesRequest) StartIndex(startIndex int32) AddressesAPIGetAddressesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r AddressesAPIGetAddressesRequest) Count(count int32) AddressesAPIGetAddressesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r AddressesAPIGetAddressesRequest) Sort(sort []string) AddressesAPIGetAddressesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r AddressesAPIGetAddressesRequest) Desc(desc []string) AddressesAPIGetAddressesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r AddressesAPIGetAddressesRequest) Fields(fields string) AddressesAPIGetAddressesRequest {
	r.fields = &fields
	return r
}

func (r AddressesAPIGetAddressesRequest) Execute() (*IPagedResourceListAddressDto, *http.Response, error) {
...
func (a *AddressesAPIService) GetAddressesExecute(r AddressesAPIGetAddressesRequest) (*IPagedResourceListAddressDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type AddressesAPIGetStreetsSuggestionsRequest struct {
	ctx context.Context
	ApiService *AddressesAPIService
	countryCode *string
	cityName *string
...
func (r AddressesAPIGetStreetsSuggestionsRequest) CountryCode(countryCode string) AddressesAPIGetStreetsSuggestionsRequest {
	r.countryCode = &countryCode
	return r
}

// Mandatory. An exact or partial city name
func (r AddressesAPIGetStreetsSuggestionsRequest) CityName(cityName string) AddressesAPIGetStreetsSuggestionsRequest {
	r.cityName = &cityName
	return r
}

// Mandatory. An exact or partial post code
func (r AddressesAPIGetStreetsSuggestionsRequest) PostCode(postCode string) AddressesAPIGetStreetsSuggestionsRequest {
	r.postCode = &postCode
	return r
}

// Mandatory. Search term. An exact or partial street name
func (r AddressesAPIGetStreetsSuggestionsRequest) StreetName(streetName string) AddressesAPIGetStreetsSuggestionsRequest {
	r.streetName = &streetName
	return r
}

// Default value is &#39;100&#39;.
func (r AddressesAPIGetStreetsSuggestionsRequest) Count(count int32) AddressesAPIGetStreetsSuggestionsRequest {
	r.count = &count
	return r
}

func (r AddressesAPIGetStreetsSuggestionsRequest) Execute() (*IResourceListStreetSuggestionDto, *http.Response, error) {
...
Please note that this query does not return paginated results.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return AddressesAPIGetStreetsSuggestionsRequest
*/
func (a *AddressesAPIService) GetStreetsSuggestions(ctx context.Context) AddressesAPIGetStreetsSuggestionsRequest {
	return AddressesAPIGetStreetsSuggestionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AddressesAPIService) GetStreetsSuggestionsExecute(r AddressesAPIGetStreetsSuggestionsRequest) (*IResourceListStreetSuggestionDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
