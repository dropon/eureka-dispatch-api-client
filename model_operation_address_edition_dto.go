...
// checks if the OperationAddressEditionDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OperationAddressEditionDto{}

// OperationAddressEditionDto struct for OperationAddressEditionDto
type OperationAddressEditionDto struct {
	// When address id is provided, all other properties are ignored
	...
	// City id is mandatory when the address id is not provided.
...
func NewOperationAddressEditionDto() *OperationAddressEditionDto {
	this := OperationAddressEditionDto{}
	return &this
}
...
func (o OperationAddressEditionDto) MarshalJSON() ([]byte, error) {
...
func (o OperationAddressEditionDto) ToMap() (map[string]interface{}, error) {
...
type NullableOperationAddressEditionDto struct {
	value *OperationAddressEditionDto
	isSet bool
}

func (v NullableOperationAddressEditionDto) Get() *OperationAddressEditionDto {
	return v.value
}

func (v *NullableOperationAddressEditionDto) Set(val *OperationAddressEditionDto) {
	v.value = val
	v.isSet = true
}

func (v NullableOperationAddressEditionDto) IsSet() bool {
	return v.isSet
}

func (v *NullableOperationAddressEditionDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOperationAddressEditionDto(val *OperationAddressEditionDto) *NullableOperationAddressEditionDto {
	return &NullableOperationAddressEditionDto{value: val, isSet: true}
}

func (v NullableOperationAddressEditionDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOperationAddressEditionDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
