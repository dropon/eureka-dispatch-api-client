...
// checks if the CreateCountryCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCountryCommand{}

// CreateCountryCommand struct for CreateCountryCommand
type CreateCountryCommand struct {
	// Mandatory. Country iso code in ISO 3166-1 alpha-2 format.  Must contain only ASCII letters (A-Z, a-z), digits (0-9), underscores (_), or hyphens (-).
	Code string `json:"code"`
	// Country default label.  When this value is provided, it overrides the localized labels for user's and global settings' locale.
	Label *string `json:"label,omitempty"`
	// Country label localizations
	LocalizedLabels []LocalizedLabelDto `json:"localizedLabels,omitempty"`
	// Country iso code in ISO 3166-1 alpha-3 format.
	Iso3Code *string `json:"iso3Code,omitempty"`
	DefaultVatCode *string `json:"defaultVatCode,omitempty"`
	CountryFamilyCode *string `json:"countryFamilyCode,omitempty"`
	LanguageCode *string `json:"languageCode,omitempty"`
}

type _CreateCountryCommand CreateCountryCommand
...
// GetLocalizedLabels returns the LocalizedLabels field value if set, zero value otherwise.
func (o *CreateCountryCommand) GetLocalizedLabels() []LocalizedLabelDto {
	if o == nil || IsNil(o.LocalizedLabels) {
		var ret []LocalizedLabelDto
		return ret
	}
	return o.LocalizedLabels
}

// GetLocalizedLabelsOk returns a tuple with the LocalizedLabels field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCountryCommand) GetLocalizedLabelsOk() ([]LocalizedLabelDto, bool) {
	if o == nil || IsNil(o.LocalizedLabels) {
		return nil, false
	}
	return o.LocalizedLabels, true
}
...
// SetLocalizedLabels gets a reference to the given []LocalizedLabelDto and assigns it to the LocalizedLabels field.
...
// GetDefaultVatCode returns the DefaultVatCode field value if set, zero value otherwise.
func (o *CreateCountryCommand) GetDefaultVatCode() string {
	if o == nil || IsNil(o.DefaultVatCode) {
		var ret string
		return ret
	}
	return *o.DefaultVatCode
}

// GetDefaultVatCodeOk returns a tuple with the DefaultVatCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCountryCommand) GetDefaultVatCodeOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultVatCode) {
		return nil, false
	}
	return o.DefaultVatCode, true
}
...
// SetDefaultVatCode gets a reference to the given string and assigns it to the DefaultVatCode field.
func (o *CreateCountryCommand) SetDefaultVatCode(v string) {
	o.DefaultVatCode = &v
}

// GetCountryFamilyCode returns the CountryFamilyCode field value if set, zero value otherwise.
func (o *CreateCountryCommand) GetCountryFamilyCode() string {
	if o == nil || IsNil(o.CountryFamilyCode) {
		var ret string
		return ret
	}
	return *o.CountryFamilyCode
}

// GetCountryFamilyCodeOk returns a tuple with the CountryFamilyCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCountryCommand) GetCountryFamilyCodeOk() (*string, bool) {
	if o == nil || IsNil(o.CountryFamilyCode) {
		return nil, false
	}
	return o.CountryFamilyCode, true
}
...
// SetCountryFamilyCode gets a reference to the given string and assigns it to the CountryFamilyCode field.
func (o *CreateCountryCommand) SetCountryFamilyCode(v string) {
	o.CountryFamilyCode = &v
}
...
func (o CreateCountryCommand) MarshalJSON() ([]byte, error) {
...
func (o CreateCountryCommand) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["code"] = o.Code
	if !IsNil(o.Label) {
		toSerialize["label"] = o.Label
	}
	if !IsNil(o.LocalizedLabels) {
		toSerialize["localizedLabels"] = o.LocalizedLabels
	}
	if !IsNil(o.Iso3Code) {
		toSerialize["iso3Code"] = o.Iso3Code
	}
	if !IsNil(o.DefaultVatCode) {
		toSerialize["defaultVatCode"] = o.DefaultVatCode
	}
	if !IsNil(o.CountryFamilyCode) {
		toSerialize["countryFamilyCode"] = o.CountryFamilyCode
	}
...
func (o *CreateCountryCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCountryCommand := _CreateCountryCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCountryCommand)

	if err != nil {
		return err
	}

	*o = CreateCountryCommand(varCreateCountryCommand)

	return err
}

type NullableCreateCountryCommand struct {
	value *CreateCountryCommand
	isSet bool
}

func (v NullableCreateCountryCommand) Get() *CreateCountryCommand {
	return v.value
}

func (v *NullableCreateCountryCommand) Set(val *CreateCountryCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCountryCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCountryCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCountryCommand(val *CreateCountryCommand) *NullableCreateCountryCommand {
	return &NullableCreateCountryCommand{value: val, isSet: true}
}

func (v NullableCreateCountryCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCountryCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
