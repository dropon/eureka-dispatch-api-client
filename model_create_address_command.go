...
// checks if the CreateAddressCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAddressCommand{}

// CreateAddressCommand struct for CreateAddressCommand
type CreateAddressCommand struct {
	...
	AdditionalContacts []CreateAddressCommandCreateAddressAdditionalContactDto `json:"additionalContacts,omitempty"`
	AddressOpenings []CreateAddressCommandCreateAddressOpeningDto `json:"addressOpenings,omitempty"`
	ForbiddenVehicleTypeCodes []string `json:"forbiddenVehicleTypeCodes,omitempty"`
}

type _CreateAddressCommand CreateAddressCommand
...
func (o *CreateAddressCommand) GetAdditionalContacts() []CreateAddressCommandCreateAddressAdditionalContactDto {
	if o == nil || IsNil(o.AdditionalContacts) {
		var ret []CreateAddressCommandCreateAddressAdditionalContactDto
		return ret
	}
...
// SetAdditionalContacts gets a reference to the given []CreateAddressCommandCreateAddressAdditionalContactDto and assigns it to the AdditionalContacts field.
...
func (o *CreateAddressCommand) GetAddressOpenings() []CreateAddressCommandCreateAddressOpeningDto {
	if o == nil || IsNil(o.AddressOpenings) {
		var ret []CreateAddressCommandCreateAddressOpeningDto
		return ret
	}
...
// SetAddressOpenings gets a reference to the given []CreateAddressCommandCreateAddressOpeningDto and assigns it to the AddressOpenings field.
...
func (o CreateAddressCommand) MarshalJSON() ([]byte, error) {
...
func (o CreateAddressCommand) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAddressCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAddressCommand := _CreateAddressCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAddressCommand)

	if err != nil {
		return err
	}

	*o = CreateAddressCommand(varCreateAddressCommand)

	return err
}

type NullableCreateAddressCommand struct {
	value *CreateAddressCommand
	isSet bool
}

func (v NullableCreateAddressCommand) Get() *CreateAddressCommand {
	return v.value
}

func (v *NullableCreateAddressCommand) Set(val *CreateAddressCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAddressCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAddressCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAddressCommand(val *CreateAddressCommand) *NullableCreateAddressCommand {
	return &NullableCreateAddressCommand{value: val, isSet: true}
}

func (v NullableCreateAddressCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAddressCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
