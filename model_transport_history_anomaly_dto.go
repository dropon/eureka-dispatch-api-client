...
var _ MappedNullable = &TransportHistoryAnomalyDto{}

// TransportHistoryAnomalyDto struct for TransportHistoryAnomalyDto
type TransportHistoryAnomalyDto struct {
	TransportHistoryAnomalyId *int32  `json:"transportHistoryAnomalyId,omitempty"`
...
func NewTransportHistoryAnomalyDto() *TransportHistoryAnomalyDto {
	this := TransportHistoryAnomalyDto{}
	return &this
}

// NewTransportHistoryAnomalyDtoWithDefaults instantiates a new TransportHistoryAnomalyDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTransportHistoryAnomalyDtoWithDefaults() *TransportHistoryAnomalyDto {
	this := TransportHistoryAnomalyDto{}
	return &this
}

// GetTransportHistoryAnomalyId returns the TransportHistoryAnomalyId field value if set, zero value otherwise.
func (o *TransportHistoryAnomalyDto) GetTransportHistoryAnomalyId() int32 {
	if o == nil || IsNil(o.TransportHistoryAnomalyId) {
		var ret int32
		return ret
	}
	return *o.TransportHistoryAnomalyId
}

// GetTransportHistoryAnomalyIdOk returns a tuple with the TransportHistoryAnomalyId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportHistoryAnomalyDto) GetTransportHistoryAnomalyIdOk() (*int32, bool) {
	if o == nil || IsNil(o.TransportHistoryAnomalyId) {
		return nil, false
	}
	return o.TransportHistoryAnomalyId, true
}

// HasTransportHistoryAnomalyId returns a boolean if a field has been set.
func (o *TransportHistoryAnomalyDto) HasTransportHistoryAnomalyId() bool {
	if o != nil && !IsNil(o.TransportHistoryAnomalyId) {
		return true
	}
...
// SetTransportHistoryAnomalyId gets a reference to the given int32 and assigns it to the TransportHistoryAnomalyId field.
func (o *TransportHistoryAnomalyDto) SetTransportHistoryAnomalyId(v int32) {
	o.TransportHistoryAnomalyId = &v
}

// GetAnomalyCode returns the AnomalyCode field value if set, zero value otherwise.
func (o *TransportHistoryAnomalyDto) GetAnomalyCode() string {
...
// and a boolean to check if the value has been set.
func (o *TransportHistoryAnomalyDto) GetAnomalyCodeOk() (*string, bool) {
	if o == nil || IsNil(o.AnomalyCode) {
		return nil, false
	}
...
func (o *TransportHistoryAnomalyDto) HasAnomalyCode() bool {
	if o != nil && !IsNil(o.AnomalyCode) {
		return true
	}
...
func (o *TransportHistoryAnomalyDto) SetAnomalyCode(v string) {
	o.AnomalyCode = &v
}

// GetAnomalyType returns the AnomalyType field value if set, zero value otherwise.
func (o *TransportHistoryAnomalyDto) GetAnomalyType() string {
...
// and a boolean to check if the value has been set.
func (o *TransportHistoryAnomalyDto) GetAnomalyTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AnomalyType) {
		return nil, false
	}
...
func (o *TransportHistoryAnomalyDto) HasAnomalyType() bool {
	if o != nil && !IsNil(o.AnomalyType) {
		return true
	}
...
func (o *TransportHistoryAnomalyDto) SetAnomalyType(v string) {
	o.AnomalyType = &v
}

// GetAnomalyCategory returns the AnomalyCategory field value if set, zero value otherwise.
func (o *TransportHistoryAnomalyDto) GetAnomalyCategory() string {
	if o == nil || IsNil(o.AnomalyCategory) {
		var ret string
		return ret
	}
	return *o.AnomalyCategory
}

// GetAnomalyCategoryOk returns a tuple with the AnomalyCategory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportHistoryAnomalyDto) GetAnomalyCategoryOk() (*string, bool) {
	if o == nil || IsNil(o.AnomalyCategory) {
		return nil, false
	}
	return o.AnomalyCategory, true
}

// HasAnomalyCategory returns a boolean if a field has been set.
func (o *TransportHistoryAnomalyDto) HasAnomalyCategory() bool {
	if o != nil && !IsNil(o.AnomalyCategory) {
		return true
	}
...
// SetAnomalyCategory gets a reference to the given string and assigns it to the AnomalyCategory field.
func (o *TransportHistoryAnomalyDto) SetAnomalyCategory(v string) {
	o.AnomalyCategory = &v
}

// GetComment returns the Comment field value if set, zero value otherwise.
func (o *TransportHistoryAnomalyDto) GetComment() string {
...
// and a boolean to check if the value has been set.
func (o *TransportHistoryAnomalyDto) GetCommentOk() (*string, bool) {
	if o == nil || IsNil(o.Comment) {
		return nil, false
	}
...
func (o *TransportHistoryAnomalyDto) HasComment() bool {
	if o != nil && !IsNil(o.Comment) {
		return true
	}
...
func (o *TransportHistoryAnomalyDto) SetComment(v string) {
	o.Comment = &v
}
...
func (o *TransportHistoryAnomalyDto) GetAnomalyDateTimeOk() (*Time, bool) {
	...
	return o.AnomalyDateTime, true
}

// HasAnomalyDateTime returns a boolean if a field has been set.
func (o *TransportHistoryAnomalyDto) HasAnomalyDateTime() bool {
	if o != nil && !IsNil(o.AnomalyDateTime) {
		return true
	}
...
func (o TransportHistoryAnomalyDto) MarshalJSON() ([]byte, error) {
...
func (o TransportHistoryAnomalyDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TransportHistoryAnomalyId) {
		toSerialize["transportHistoryAnomalyId"] = o.TransportHistoryAnomalyId
	}
	...
	if !IsNil(o.AnomalyCategory) {
		toSerialize["anomalyCategory"] = o.AnomalyCategory
	}
	if !IsNil(o.Comment) {
		toSerialize["comment"] = o.Comment
	}
	if !IsNil(o.AnomalyDateTime) {
		toSerialize["anomalyDateTime"] = o.AnomalyDateTime
	}
	return toSerialize, nil
}

type NullableTransportHistoryAnomalyDto struct {
	value *TransportHistoryAnomalyDto
	isSet bool
}

func (v NullableTransportHistoryAnomalyDto) Get() *TransportHistoryAnomalyDto {
	return v.value
}

func (v *NullableTransportHistoryAnomalyDto) Set(val *TransportHistoryAnomalyDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportHistoryAnomalyDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportHistoryAnomalyDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportHistoryAnomalyDto(val *TransportHistoryAnomalyDto) *NullableTransportHistoryAnomalyDto {
	return &NullableTransportHistoryAnomalyDto{value: val, isSet: true}
}

func (v NullableTransportHistoryAnomalyDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportHistoryAnomalyDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
