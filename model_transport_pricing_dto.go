...
// checks if the TransportPricingDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportPricingDto{}

// TransportPricingDto The following permission(s) are required to access this resource:  See prices.
type TransportPricingDto struct {
...
func (o *TransportPricingDto) GetSubServices() CappedCollectionDtoTransportPricingDtoTransportSubServicePricingDto {
	if o == nil || IsNil(o.SubServices) {
		var ret CappedCollectionDtoTransportPricingDtoTransportSubServicePricingDto
		return ret
	}
...
// SetSubServices gets a reference to the given CappedCollectionDtoTransportPricingDtoTransportSubServicePricingDto and assigns it to the SubServices field.
func (o *TransportPricingDto) SetSubServices(v CappedCollectionDtoTransportPricingDtoTransportSubServicePricingDto) {
	o.SubServices = &v
}

func (o TransportPricingDto) MarshalJSON() ([]byte, error) {
...
func (o TransportPricingDto) ToMap() (map[string]interface{}, error) {
...
type NullableTransportPricingDto struct {
	value *TransportPricingDto
	isSet bool
}

func (v NullableTransportPricingDto) Get() *TransportPricingDto {
	return v.value
}

func (v *NullableTransportPricingDto) Set(val *TransportPricingDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportPricingDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportPricingDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportPricingDto(val *TransportPricingDto) *NullableTransportPricingDto {
	return &NullableTransportPricingDto{value: val, isSet: true}
}

func (v NullableTransportPricingDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportPricingDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
