...
// checks if the CreateTransportDtoStepDtoStepAddressDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransportDtoStepDtoStepAddressDto{}

// CreateTransportDtoStepDtoStepAddressDto struct for CreateTransportDtoStepDtoStepAddressDto
type CreateTransportDtoStepDtoStepAddressDto struct {
	// When an address id is provided, step address information is filled with address data,  but address line 1 and 2 can be overridden.
	AddressId *int32 `json:"addressId,omitempty"`
	// When a city id is provided, the country, post code and city name are pre-filled with city data.
...
func NewCreateTransportDtoStepDtoStepAddressDto() *CreateTransportDtoStepDtoStepAddressDto {
	this := CreateTransportDtoStepDtoStepAddressDto{}
	return &this
}
...
func (o CreateTransportDtoStepDtoStepAddressDto) MarshalJSON() ([]byte, error) {
...
func (o CreateTransportDtoStepDtoStepAddressDto) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTransportDtoStepDtoStepAddressDto struct {
	value *CreateTransportDtoStepDtoStepAddressDto
	isSet bool
}

func (v NullableCreateTransportDtoStepDtoStepAddressDto) Get() *CreateTransportDtoStepDtoStepAddressDto {
	return v.value
}

func (v *NullableCreateTransportDtoStepDtoStepAddressDto) Set(val *CreateTransportDtoStepDtoStepAddressDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTransportDtoStepDtoStepAddressDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTransportDtoStepDtoStepAddressDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTransportDtoStepDtoStepAddressDto(val *CreateTransportDtoStepDtoStepAddressDto) *NullableCreateTransportDtoStepDtoStepAddressDto {
	return &NullableCreateTransportDtoStepDtoStepAddressDto{value: val, isSet: true}
}

func (v NullableCreateTransportDtoStepDtoStepAddressDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTransportDtoStepDtoStepAddressDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
