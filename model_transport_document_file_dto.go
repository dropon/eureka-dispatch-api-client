...
// checks if the TransportDocumentFileDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportDocumentFileDto{}

// TransportDocumentFileDto struct for TransportDocumentFileDto
type TransportDocumentFileDto struct {
	Id *int32 `json:"id,omitempty"`
	FileCategoryCode *string `json:"fileCategoryCode,omitempty"`
...
// NewTransportDocumentFileDto instantiates a new TransportDocumentFileDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTransportDocumentFileDto() *TransportDocumentFileDto {
	this := TransportDocumentFileDto{}
	return &this
}

// NewTransportDocumentFileDtoWithDefaults instantiates a new TransportDocumentFileDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTransportDocumentFileDtoWithDefaults() *TransportDocumentFileDto {
	this := TransportDocumentFileDto{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *TransportDocumentFileDto) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *TransportDocumentFileDto) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *TransportDocumentFileDto) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *TransportDocumentFileDto) SetId(v int32) {
	o.Id = &v
}

// GetFileCategoryCode returns the FileCategoryCode field value if set, zero value otherwise.
func (o *TransportDocumentFileDto) GetFileCategoryCode() string {
	if o == nil || IsNil(o.FileCategoryCode) {
		var ret string
		return ret
	}
	return *o.FileCategoryCode
}

// GetFileCategoryCodeOk returns a tuple with the FileCategoryCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDocumentFileDto) GetFileCategoryCodeOk() (*string, bool) {
	if o == nil || IsNil(o.FileCategoryCode) {
		return nil, false
	}
	return o.FileCategoryCode, true
}

// HasFileCategoryCode returns a boolean if a field has been set.
func (o *TransportDocumentFileDto) HasFileCategoryCode() bool {
	if o != nil && !IsNil(o.FileCategoryCode) {
		return true
	}
...
// SetFileCategoryCode gets a reference to the given string and assigns it to the FileCategoryCode field.
func (o *TransportDocumentFileDto) SetFileCategoryCode(v string) {
	o.FileCategoryCode = &v
}

// GetFileCategoryLabel returns the FileCategoryLabel field value if set, zero value otherwise.
func (o *TransportDocumentFileDto) GetFileCategoryLabel() string {
	if o == nil || IsNil(o.FileCategoryLabel) {
		var ret string
		return ret
	}
	return *o.FileCategoryLabel
}

// GetFileCategoryLabelOk returns a tuple with the FileCategoryLabel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportDocumentFileDto) GetFileCategoryLabelOk() (*string, bool) {
	if o == nil || IsNil(o.FileCategoryLabel) {
		return nil, false
	}
	return o.FileCategoryLabel, true
}

// HasFileCategoryLabel returns a boolean if a field has been set.
func (o *TransportDocumentFileDto) HasFileCategoryLabel() bool {
	if o != nil && !IsNil(o.FileCategoryLabel) {
		return true
	}
...
// SetFileCategoryLabel gets a reference to the given string and assigns it to the FileCategoryLabel field.
func (o *TransportDocumentFileDto) SetFileCategoryLabel(v string) {
	o.FileCategoryLabel = &v
}

// GetLabel returns the Label field value if set, zero value otherwise.
func (o *TransportDocumentFileDto) GetLabel() string {
...
// and a boolean to check if the value has been set.
func (o *TransportDocumentFileDto) GetLabelOk() (*string, bool) {
	if o == nil || IsNil(o.Label) {
		return nil, false
	}
	return o.Label, true
...
func (o *TransportDocumentFileDto) HasLabel() bool {
	if o != nil && !IsNil(o.Label) {
		return true
	}
...
func (o *TransportDocumentFileDto) SetLabel(v string) {
	o.Label = &v
}

// GetExtension returns the Extension field value if set, zero value otherwise.
func (o *TransportDocumentFileDto) GetExtension() string {
...
// and a boolean to check if the value has been set.
func (o *TransportDocumentFileDto) GetExtensionOk() (*string, bool) {
	if o == nil || IsNil(o.Extension) {
		return nil, false
	}
...
func (o *TransportDocumentFileDto) HasExtension() bool {
	if o != nil && !IsNil(o.Extension) {
		return true
	}
...
func (o *TransportDocumentFileDto) SetExtension(v string) {
	o.Extension = &v
}

// GetCreationDateTime returns the CreationDateTime field value if set, zero value otherwise.
func (o *TransportDocumentFileDto) GetCreationDateTime() time.Time {
...
// and a boolean to check if the value has been set.
func (o *TransportDocumentFileDto) GetCreationDateTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreationDateTime) {
		return nil, false
	}
...
func (o *TransportDocumentFileDto) HasCreationDateTime() bool {
	if o != nil && !IsNil(o.CreationDateTime) {
		return true
	}
...
func (o *TransportDocumentFileDto) SetCreationDateTime(v time.Time) {
	o.CreationDateTime = &v
}

func (o TransportDocumentFileDto) MarshalJSON() ([]byte, error) {
...
func (o TransportDocumentFileDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Id) {
		toSerialize["id"] = o.Id
	}
	if !IsNil(o.FileCategoryCode) {
		toSerialize["fileCategoryCode"] = o.FileCategoryCode
	}
	if !IsNil(o.FileCategoryLabel) {
		toSerialize["fileCategoryLabel"] = o.FileCategoryLabel
	}
	if !IsNil(o.Label) {
...
type NullableTransportDocumentFileDto struct {
	value *TransportDocumentFileDto
	isSet bool
}

func (v NullableTransportDocumentFileDto) Get() *TransportDocumentFileDto {
	return v.value
}

func (v *NullableTransportDocumentFileDto) Set(val *TransportDocumentFileDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportDocumentFileDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportDocumentFileDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportDocumentFileDto(val *TransportDocumentFileDto) *NullableTransportDocumentFileDto {
	return &NullableTransportDocumentFileDto{value: val, isSet: true}
}

func (v NullableTransportDocumentFileDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportDocumentFileDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
