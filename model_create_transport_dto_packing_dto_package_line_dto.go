...
// checks if the CreateTransportDtoPackingDtoPackageLineDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransportDtoPackingDtoPackageLineDto{}

// CreateTransportDtoPackingDtoPackageLineDto struct for CreateTransportDtoPackingDtoPackageLineDto
type CreateTransportDtoPackingDtoPackageLineDto struct {
	// Identifier of the package nature.  Mandatory when Nature is not provided.
	NatureId *int32 `json:"natureId,omitempty"`
	// Package nature name.  Mandatory when NatureId is not provided.    The access to this property is rejected if the user has at least one of the following restriction(s):  Disable free entry in package nature.
	...
	PackageSizes []CreateTransportDtoPackingDtoPackageLineDtoPackageSizeDto `json:"packageSizes,omitempty"`
	References []CreateTransportDtoPackingDtoPackageLineDtoPackageReferenceDto `json:"references,omitempty"`
}
...
func NewCreateTransportDtoPackingDtoPackageLineDto() *CreateTransportDtoPackingDtoPackageLineDto {
	this := CreateTransportDtoPackingDtoPackageLineDto{}
	return &this
}
...
func (o *CreateTransportDtoPackingDtoPackageLineDto) GetPackageSizes() []CreateTransportDtoPackingDtoPackageLineDtoPackageSizeDto {
	if o == nil || IsNil(o.PackageSizes) {
		var ret []CreateTransportDtoPackingDtoPackageLineDtoPackageSizeDto
		return ret
	}
...
// SetPackageSizes gets a reference to the given []CreateTransportDtoPackingDtoPackageLineDtoPackageSizeDto and assigns it to the PackageSizes field.
...
func (o *CreateTransportDtoPackingDtoPackageLineDto) GetReferences() []CreateTransportDtoPackingDtoPackageLineDtoPackageReferenceDto {
	if o == nil || IsNil(o.References) {
		var ret []CreateTransportDtoPackingDtoPackageLineDtoPackageReferenceDto
		return ret
	}
	return o.References
}
...
// SetReferences gets a reference to the given []CreateTransportDtoPackingDtoPackageLineDtoPackageReferenceDto and assigns it to the References field.
...
func (o CreateTransportDtoPackingDtoPackageLineDto) MarshalJSON() ([]byte, error) {
...
func (o CreateTransportDtoPackingDtoPackageLineDto) ToMap() (map[string]interface{}, error) {
...
type NullableCreateTransportDtoPackingDtoPackageLineDto struct {
	value *CreateTransportDtoPackingDtoPackageLineDto
	isSet bool
}

func (v NullableCreateTransportDtoPackingDtoPackageLineDto) Get() *CreateTransportDtoPackingDtoPackageLineDto {
	return v.value
}

func (v *NullableCreateTransportDtoPackingDtoPackageLineDto) Set(val *CreateTransportDtoPackingDtoPackageLineDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTransportDtoPackingDtoPackageLineDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTransportDtoPackingDtoPackageLineDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTransportDtoPackingDtoPackageLineDto(val *CreateTransportDtoPackingDtoPackageLineDto) *NullableCreateTransportDtoPackingDtoPackageLineDto {
	return &NullableCreateTransportDtoPackingDtoPackageLineDto{value: val, isSet: true}
}

func (v NullableCreateTransportDtoPackingDtoPackageLineDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTransportDtoPackingDtoPackageLineDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
