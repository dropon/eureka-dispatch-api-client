...
func (r ApiGetVehiclesRequest) Code(code string) ApiGetVehiclesRequest {
	r.code = &code
	return r
}

// Vehicle codes
func (r ApiGetVehiclesRequest) Codes(codes []string) ApiGetVehiclesRequest {
	r.codes = &codes
	return r
}

// Vehicle type code
func (r ApiGetVehiclesRequest) TypeCode(typeCode string) ApiGetVehiclesRequest {
	r.typeCode = &typeCode
	return r
}

// Vehicle type codes
func (r ApiGetVehiclesRequest) TypeCodes(typeCodes []string) ApiGetVehiclesRequest {
	r.typeCodes = &typeCodes
	return r
}

// Vehicle license plate
func (r ApiGetVehiclesRequest) LicensePlate(licensePlate string) ApiGetVehiclesRequest {
	r.licensePlate = &licensePlate
	return r
}

// Vehicle brand
func (r ApiGetVehiclesRequest) Brand(brand string) ApiGetVehiclesRequest {
	r.brand = &brand
	return r
}

// Vehicle label pattern
func (r ApiGetVehiclesRequest) Label(label string) ApiGetVehiclesRequest {
	r.label = &label
	return r
}

func (r ApiGetVehiclesRequest) IsEnabled(isEnabled bool) ApiGetVehiclesRequest {
	r.isEnabled = &isEnabled
	return r
}

// Vehicle agency code
func (r ApiGetVehiclesRequest) AgencyCode(agencyCode string) ApiGetVehiclesRequest {
	r.agencyCode = &agencyCode
	return r
}

// Vehicle agency codes
func (r ApiGetVehiclesRequest) AgencyCodes(agencyCodes []string) ApiGetVehiclesRequest {
	r.agencyCodes = &agencyCodes
	return r
}

// Defines whether the vehicle is habilitated to transport dangerous good
func (r ApiGetVehiclesRequest) HasDangerousGoodsCase(hasDangerousGoodsCase bool) ApiGetVehiclesRequest {
	r.hasDangerousGoodsCase = &hasDangerousGoodsCase
	return r
}

// Defines whether the vehicle has a hatchback
func (r ApiGetVehiclesRequest) HasHatchback(hasHatchback bool) ApiGetVehiclesRequest {
	r.hasHatchback = &hasHatchback
	return r
}

// Defines whether the vehicle is specific to subcontractors
func (r ApiGetVehiclesRequest) IsSubcontractorsSpecific(isSubcontractorsSpecific bool) ApiGetVehiclesRequest {
	r.isSubcontractorsSpecific = &isSubcontractorsSpecific
	return r
}

// Code of a subcontractor specific to vehicles
func (r ApiGetVehiclesRequest) SubcontractorCode(subcontractorCode string) ApiGetVehiclesRequest {
	r.subcontractorCode = &subcontractorCode
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetVehiclesRequest) Pattern(pattern string) ApiGetVehiclesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetVehiclesRequest) PatternFields(patternFields []string) ApiGetVehiclesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetVehiclesRequest) StartIndex(startIndex int32) ApiGetVehiclesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetVehiclesRequest) Count(count int32) ApiGetVehiclesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetVehiclesRequest) Sort(sort []string) ApiGetVehiclesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetVehiclesRequest) Desc(desc []string) ApiGetVehiclesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetVehiclesRequest) Fields(fields string) ApiGetVehiclesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetVehiclesRequest) Execute() (*IPagedResourceListVehicleDto, *http.Response, error) {
...
func (a *VehiclesAPIService) GetVehiclesExecute(r ApiGetVehiclesRequest) (*IPagedResourceListVehicleDto, *http.Response, error) {
	var (
...
type ApiGetVehiclesSubcontractorsRequest struct {
	ctx context.Context
	ApiService *VehiclesAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetVehiclesSubcontractorsRequest) StartIndex(startIndex int32) ApiGetVehiclesSubcontractorsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetVehiclesSubcontractorsRequest) Count(count int32) ApiGetVehiclesSubcontractorsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetVehiclesSubcontractorsRequest) Sort(sort []string) ApiGetVehiclesSubcontractorsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetVehiclesSubcontractorsRequest) Desc(desc []string) ApiGetVehiclesSubcontractorsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetVehiclesSubcontractorsRequest) Fields(fields string) ApiGetVehiclesSubcontractorsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetVehiclesSubcontractorsRequest) Execute() (*IPagedResourceListDriverDto, *http.Response, error) {
	return r.ApiService.GetVehiclesSubcontractorsExecute(r)
}

/*
GetVehiclesSubcontractors Get vehicle's subcontractors

Get a paginated list of subcontractors linked to the vehicle.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid
 @return ApiGetVehiclesSubcontractorsRequest
*/
func (a *VehiclesAPIService) GetVehiclesSubcontractors(ctx context.Context, uid string) ApiGetVehiclesSubcontractorsRequest {
	return ApiGetVehiclesSubcontractorsRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *VehiclesAPIService) GetVehiclesSubcontractorsExecute(r ApiGetVehiclesSubcontractorsRequest) (*IPagedResourceListDriverDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
