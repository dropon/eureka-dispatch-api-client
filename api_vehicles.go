...
type VehiclesAPIGetVehiclesRequest struct {
	ctx context.Context
	...
	agencyCode *string
	agencyCodes *[]string
	hasDangerousGoodsCase *bool
	hasHatchback *bool
	isSubcontractorsSpecific *bool
...
func (r VehiclesAPIGetVehiclesRequest) Code(code string) VehiclesAPIGetVehiclesRequest {
	r.code = &code
	return r
}

// Vehicle codes
func (r VehiclesAPIGetVehiclesRequest) Codes(codes []string) VehiclesAPIGetVehiclesRequest {
	r.codes = &codes
	return r
}

// Vehicle type code
func (r VehiclesAPIGetVehiclesRequest) TypeCode(typeCode string) VehiclesAPIGetVehiclesRequest {
	r.typeCode = &typeCode
	return r
}

// Vehicle type codes
func (r VehiclesAPIGetVehiclesRequest) TypeCodes(typeCodes []string) VehiclesAPIGetVehiclesRequest {
	r.typeCodes = &typeCodes
	return r
}

// Vehicle license plate
func (r VehiclesAPIGetVehiclesRequest) LicensePlate(licensePlate string) VehiclesAPIGetVehiclesRequest {
	r.licensePlate = &licensePlate
	return r
}

// Vehicle brand
func (r VehiclesAPIGetVehiclesRequest) Brand(brand string) VehiclesAPIGetVehiclesRequest {
	r.brand = &brand
	return r
}

// Vehicle label pattern
func (r VehiclesAPIGetVehiclesRequest) Label(label string) VehiclesAPIGetVehiclesRequest {
	r.label = &label
	return r
}

func (r VehiclesAPIGetVehiclesRequest) IsEnabled(isEnabled bool) VehiclesAPIGetVehiclesRequest {
	r.isEnabled = &isEnabled
	return r
}

// Vehicle agency code
func (r VehiclesAPIGetVehiclesRequest) AgencyCode(agencyCode string) VehiclesAPIGetVehiclesRequest {
	r.agencyCode = &agencyCode
	return r
}

// Vehicle agency codes
func (r VehiclesAPIGetVehiclesRequest) AgencyCodes(agencyCodes []string) VehiclesAPIGetVehiclesRequest {
	r.agencyCodes = &agencyCodes
	return r
}

// Defines whether the vehicle is habilitated to transport dangerous good
func (r VehiclesAPIGetVehiclesRequest) HasDangerousGoodsCase(hasDangerousGoodsCase bool) VehiclesAPIGetVehiclesRequest {
	r.hasDangerousGoodsCase = &hasDangerousGoodsCase
	return r
}

// Defines whether the vehicle has a hatchback
func (r VehiclesAPIGetVehiclesRequest) HasHatchback(hasHatchback bool) VehiclesAPIGetVehiclesRequest {
	r.hasHatchback = &hasHatchback
	return r
}

// Defines whether the vehicle is specific to subcontractors
func (r VehiclesAPIGetVehiclesRequest) IsSubcontractorsSpecific(isSubcontractorsSpecific bool) VehiclesAPIGetVehiclesRequest {
	r.isSubcontractorsSpecific = &isSubcontractorsSpecific
	return r
}

// Code of a subcontractor specific to vehicles
func (r VehiclesAPIGetVehiclesRequest) SubcontractorCode(subcontractorCode string) VehiclesAPIGetVehiclesRequest {
	r.subcontractorCode = &subcontractorCode
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r VehiclesAPIGetVehiclesRequest) Pattern(pattern string) VehiclesAPIGetVehiclesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r VehiclesAPIGetVehiclesRequest) PatternFields(patternFields []string) VehiclesAPIGetVehiclesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r VehiclesAPIGetVehiclesRequest) StartIndex(startIndex int32) VehiclesAPIGetVehiclesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r VehiclesAPIGetVehiclesRequest) Count(count int32) VehiclesAPIGetVehiclesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r VehiclesAPIGetVehiclesRequest) Sort(sort []string) VehiclesAPIGetVehiclesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r VehiclesAPIGetVehiclesRequest) Desc(desc []string) VehiclesAPIGetVehiclesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r VehiclesAPIGetVehiclesRequest) Fields(fields string) VehiclesAPIGetVehiclesRequest {
	r.fields = &fields
	return r
}

func (r VehiclesAPIGetVehiclesRequest) Execute() (*IPagedResourceListVehicleDto, *http.Response, error) {
...
Get a paginated list of vehicles corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return VehiclesAPIGetVehiclesRequest
*/
func (a *VehiclesAPIService) GetVehicles(ctx context.Context) VehiclesAPIGetVehiclesRequest {
	return VehiclesAPIGetVehiclesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return IPagedResourceListVehicleDto
func (a *VehiclesAPIService) GetVehiclesExecute(r VehiclesAPIGetVehiclesRequest) (*IPagedResourceListVehicleDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListVehicleDto
	)
	...
	localVarPath := localBasePath + "/v3/vehicles"
	...
	if r.typeCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "typeCode", r.typeCode, "", "")
	}
	if r.typeCodes != nil {
		t := *r.typeCodes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "typeCodes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "typeCodes", t, "form", "multi")
		}
	}
	if r.licensePlate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "licensePlate", r.licensePlate, "", "")
	}
	if r.brand != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "brand", r.brand, "", "")
	}
	if r.label != nil {
	...
	if r.hasDangerousGoodsCase != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hasDangerousGoodsCase", r.hasDangerousGoodsCase, "", "")
	}
	if r.hasHatchback != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hasHatchback", r.hasHatchback, "", "")
	}
	if r.isSubcontractorsSpecific != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isSubcontractorsSpecific", r.isSubcontractorsSpecific, "", "")
	}
...
type VehiclesAPIGetVehiclesSubcontractorsRequest struct {
	ctx context.Context
	ApiService *VehiclesAPIService
	uid string
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r VehiclesAPIGetVehiclesSubcontractorsRequest) StartIndex(startIndex int32) VehiclesAPIGetVehiclesSubcontractorsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r VehiclesAPIGetVehiclesSubcontractorsRequest) Count(count int32) VehiclesAPIGetVehiclesSubcontractorsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r VehiclesAPIGetVehiclesSubcontractorsRequest) Sort(sort []string) VehiclesAPIGetVehiclesSubcontractorsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r VehiclesAPIGetVehiclesSubcontractorsRequest) Desc(desc []string) VehiclesAPIGetVehiclesSubcontractorsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r VehiclesAPIGetVehiclesSubcontractorsRequest) Fields(fields string) VehiclesAPIGetVehiclesSubcontractorsRequest {
	r.fields = &fields
	return r
}

func (r VehiclesAPIGetVehiclesSubcontractorsRequest) Execute() (*IPagedResourceListDriverDto, *http.Response, error) {
	return r.ApiService.GetVehiclesSubcontractorsExecute(r)
}

/*
GetVehiclesSubcontractors Get the subcontractors linked to the vehicle

Get a paginated list of subcontractors linked to the vehicle.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid
 @return VehiclesAPIGetVehiclesSubcontractorsRequest
*/
func (a *VehiclesAPIService) GetVehiclesSubcontractors(ctx context.Context, uid string) VehiclesAPIGetVehiclesSubcontractorsRequest {
	return VehiclesAPIGetVehiclesSubcontractorsRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
func (a *VehiclesAPIService) GetVehiclesSubcontractorsExecute(r VehiclesAPIGetVehiclesSubcontractorsRequest) (*IPagedResourceListDriverDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VehiclesAPIService.GetVehiclesSubcontractors")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/vehicles/{uid}/subcontractors"
