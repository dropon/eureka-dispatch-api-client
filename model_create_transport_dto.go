...
// checks if the CreateTransportDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTransportDto{}

// CreateTransportDto struct for CreateTransportDto
type CreateTransportDto struct {
	// Mandatory. Customer's unique code.
	CustomerCode string `json:"customerCode"`
	// Mandatory. Agency unique code.
	AgencyCode string `json:"agencyCode"`
	// Orderer unique code.
	OrdererCode *string `json:"ordererCode,omitempty"`
	// Orderer name, when orderer code is not specified.
	...
	// Transport's sub services.  When this list is null or empty, the transport uses service's default sub services.  When at least an element is specified in this list, the transport uses only the specified sub services:  service's default sub services are not included and must be specified manually if they are needed.
	SubServices []CreateTransportDtoSubServiceDto `json:"subServices,omitempty"`
	Packing     *CreateTransportDtoPackingDto     `json:"packing,omitempty"`
	// Custom parameters related to the customer.
	CustomerCustomParameters []CreateTransportDtoCustomParameterDto `json:"customerCustomParameters,omitempty"`
	// Custom parameters related to the service.
	ServiceCustomParameters []CreateTransportDtoCustomParameterDto `json:"serviceCustomParameters,omitempty"`
	...
	// Indicates if the transport has a strategic importance.  When not specified, this information is filled from the customer.
	...
	// The identifier of a dispatch user that is responsible for following the execution of the transport.
	ResponsibleOperatorId *int32 `json:"responsibleOperatorId,omitempty"`
	// Gas emission (CO2) in Kilograms.  Used only when gas emission is forced.
	GasEmission         *float64 `json:"gasEmission,omitempty"`
	IsGasEmissionForced *bool    `json:"isGasEmissionForced,omitempty"`
	// The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedSellPrice *float64 `json:"forcedSellPrice,omitempty"`
	// The following permission(s) are required to access this property:  See prices,Set prices in orders.
	ForcedBuyPrice *float64 `json:"forcedBuyPrice,omitempty"`
	// Used to force a specific sell pricing path.  The pricing path must be a customer pricing path (not a subcontractor's one).    When provided, the addresses are overwritten with the ones defined in the provided sell pricing path.    The provided service must match the one defined in the pricing path.
	SellPricingPathId    *int32                                     `json:"sellPricingPathId,omitempty"`
	Comment              *CreateTransportDtoCommentDto              `json:"comment,omitempty"`
	TransportBillAddress *CreateTransportDtoTransportBillAddressDto `json:"transportBillAddress,omitempty"`
	CashOnDelivery       *CreateTransportDtoCashOnDeliveryDto       `json:"cashOnDelivery,omitempty"`
	Communication        *TransportCommunicationConfigurationDto    `json:"communication,omitempty"`
	DangerousGoods       []CreateTransportDtoDangerousGoodDto       `json:"dangerousGoods,omitempty"`
}

type _CreateTransportDto CreateTransportDto
...
// GetPickupStep returns the PickupStep field value
func (o *CreateTransportDto) GetPickupStep() CreateTransportDtoStepDto {
	if o == nil {
		var ret CreateTransportDtoStepDto
		return ret
	}
...
// GetPickupStepOk returns a tuple with the PickupStep field value
// and a boolean to check if the value has been set.
...
// SetPickupStep sets field value
func (o *CreateTransportDto) SetPickupStep(v CreateTransportDtoStepDto) {
	o.PickupStep = v
}

// GetDeliveryStep returns the DeliveryStep field value
...
// GetDeliveryStepOk returns a tuple with the DeliveryStep field value
// and a boolean to check if the value has been set.
...
// SetDeliveryStep sets field value
...
func (o *CreateTransportDto) GetSubServices() []CreateTransportDtoSubServiceDto {
	if o == nil || IsNil(o.SubServices) {
		var ret []CreateTransportDtoSubServiceDto
		return ret
	}
...
// SetSubServices gets a reference to the given []CreateTransportDtoSubServiceDto and assigns it to the SubServices field.
...
func (o *CreateTransportDto) GetPacking() CreateTransportDtoPackingDto {
	if o == nil || IsNil(o.Packing) {
		var ret CreateTransportDtoPackingDto
		return ret
	}
	return *o.Packing
}
...
// SetPacking gets a reference to the given CreateTransportDtoPackingDto and assigns it to the Packing field.
...
func (o *CreateTransportDto) GetCustomerCustomParameters() []CreateTransportDtoCustomParameterDto {
	if o == nil || IsNil(o.CustomerCustomParameters) {
		var ret []CreateTransportDtoCustomParameterDto
		return ret
	}
...
// SetCustomerCustomParameters gets a reference to the given []CreateTransportDtoCustomParameterDto and assigns it to the CustomerCustomParameters field.
...
// SetServiceCustomParameters gets a reference to the given []CreateTransportDtoCustomParameterDto and assigns it to the ServiceCustomParameters field.
...
func (o *CreateTransportDto) GetComment() CreateTransportDtoCommentDto {
	if o == nil || IsNil(o.Comment) {
		var ret CreateTransportDtoCommentDto
		return ret
	}
	return *o.Comment
}
...
// SetComment gets a reference to the given CreateTransportDtoCommentDto and assigns it to the Comment field.
...
func (o *CreateTransportDto) GetTransportBillAddress() CreateTransportDtoTransportBillAddressDto {
	if o == nil || IsNil(o.TransportBillAddress) {
		var ret CreateTransportDtoTransportBillAddressDto
		return ret
	}
...
// SetTransportBillAddress gets a reference to the given CreateTransportDtoTransportBillAddressDto and assigns it to the TransportBillAddress field.
...
func (o *CreateTransportDto) GetCashOnDelivery() CreateTransportDtoCashOnDeliveryDto {
	if o == nil || IsNil(o.CashOnDelivery) {
		var ret CreateTransportDtoCashOnDeliveryDto
		return ret
	}
...
// SetCashOnDelivery gets a reference to the given CreateTransportDtoCashOnDeliveryDto and assigns it to the CashOnDelivery field.
...
func (o *CreateTransportDto) GetDangerousGoods() []CreateTransportDtoDangerousGoodDto {
	if o == nil || IsNil(o.DangerousGoods) {
		var ret []CreateTransportDtoDangerousGoodDto
		return ret
	}
...
// SetDangerousGoods gets a reference to the given []CreateTransportDtoDangerousGoodDto and assigns it to the DangerousGoods field.
func (o *CreateTransportDto) SetDangerousGoods(v []CreateTransportDtoDangerousGoodDto) {
	o.DangerousGoods = v
}

func (o CreateTransportDto) MarshalJSON() ([]byte, error) {
...
func (o CreateTransportDto) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTransportDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTransportDto := _CreateTransportDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTransportDto)
	if err != nil {
		return err
	}

	*o = CreateTransportDto(varCreateTransportDto)

	return err
}

type NullableCreateTransportDto struct {
	value *CreateTransportDto
	isSet bool
}

func (v NullableCreateTransportDto) Get() *CreateTransportDto {
	return v.value
}

func (v *NullableCreateTransportDto) Set(val *CreateTransportDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTransportDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTransportDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTransportDto(val *CreateTransportDto) *NullableCreateTransportDto {
	return &NullableCreateTransportDto{value: val, isSet: true}
}

func (v NullableCreateTransportDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTransportDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
