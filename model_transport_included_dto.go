...
// checks if the TransportIncludedDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportIncludedDto{}

// TransportIncludedDto struct for TransportIncludedDto
type TransportIncludedDto struct {
	Service *ServiceDto `json:"service,omitempty"`
	SubState *SubStateDto `json:"subState,omitempty"`
	Customer *CustomerDto `json:"customer,omitempty"`
	Agency *AgencyDto `json:"agency,omitempty"`
	SearchFlags *SearchFlagsDto `json:"searchFlags,omitempty"`
	Handler *DriverDto `json:"handler,omitempty"`
	Driver *DriverDto `json:"driver,omitempty"`
	Vehicle *VehicleDto `json:"vehicle,omitempty"`
	Trailer *VehicleDto `json:"trailer,omitempty"`
}
...
// SetSubState gets a reference to the given SubStateDto and assigns it to the SubState field.
...
// SetAgency gets a reference to the given AgencyDto and assigns it to the Agency field.
func (o *TransportIncludedDto) SetAgency(v AgencyDto) {
	o.Agency = &v
}

// GetSearchFlags returns the SearchFlags field value if set, zero value otherwise.
func (o *TransportIncludedDto) GetSearchFlags() SearchFlagsDto {
	if o == nil || IsNil(o.SearchFlags) {
		var ret SearchFlagsDto
		return ret
	}
	return *o.SearchFlags
}

// GetSearchFlagsOk returns a tuple with the SearchFlags field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransportIncludedDto) GetSearchFlagsOk() (*SearchFlagsDto, bool) {
	if o == nil || IsNil(o.SearchFlags) {
		return nil, false
	}
	return o.SearchFlags, true
}
...
// SetSearchFlags gets a reference to the given SearchFlagsDto and assigns it to the SearchFlags field.
...
// SetHandler gets a reference to the given DriverDto and assigns it to the Handler field.
...
// SetDriver gets a reference to the given DriverDto and assigns it to the Driver field.
...
// SetVehicle gets a reference to the given VehicleDto and assigns it to the Vehicle field.
...
// SetTrailer gets a reference to the given VehicleDto and assigns it to the Trailer field.
func (o *TransportIncludedDto) SetTrailer(v VehicleDto) {
	o.Trailer = &v
}

func (o TransportIncludedDto) MarshalJSON() ([]byte, error) {
...
func (o TransportIncludedDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SearchFlags) {
		toSerialize["searchFlags"] = o.SearchFlags
	}
	if !IsNil(o.Handler) {
...
type NullableTransportIncludedDto struct {
	value *TransportIncludedDto
	isSet bool
}

func (v NullableTransportIncludedDto) Get() *TransportIncludedDto {
	return v.value
}

func (v *NullableTransportIncludedDto) Set(val *TransportIncludedDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportIncludedDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportIncludedDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportIncludedDto(val *TransportIncludedDto) *NullableTransportIncludedDto {
	return &NullableTransportIncludedDto{value: val, isSet: true}
}

func (v NullableTransportIncludedDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportIncludedDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
