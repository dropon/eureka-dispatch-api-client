...
// checks if the PricingPathDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PricingPathDto{}

// PricingPathDto struct for PricingPathDto
type PricingPathDto struct {
	PricingPathId *int32 `json:"pricingPathId,omitempty"`
	PriceCatalogCode *string `json:"priceCatalogCode,omitempty"`
	ServiceCode *string `json:"serviceCode,omitempty"`
	CustomerCode *string `json:"customerCode,omitempty"`
	SubcontractorCode *string `json:"subcontractorCode,omitempty"`
	// Distance of the pricing path in kilometers
	DistanceKm *float64 `json:"distanceKm,omitempty"`
	WithReturn *bool `json:"withReturn,omitempty"`
	PickupDelayTimeMode *string `json:"pickupDelayTimeMode,omitempty"`
	PickupDurationTotalMinutes *int32 `json:"pickupDurationTotalMinutes,omitempty"`
	PickupDelayDays *int32 `json:"pickupDelayDays,omitempty"`
	PickupDelayTime *string `json:"pickupDelayTime,omitempty"`
	DeliveryDelayTimeMode *string `json:"deliveryDelayTimeMode,omitempty"`
	DeliveryDurationTotalMinutes *int32 `json:"deliveryDurationTotalMinutes,omitempty"`
	DeliveryDelayDays *int32 `json:"deliveryDelayDays,omitempty"`
	DeliveryDelayTime *string `json:"deliveryDelayTime,omitempty"`
	DeliveryTimeSlotValueMinutes *int32 `json:"deliveryTimeSlotValueMinutes,omitempty"`
	DeliveryPoint *PricingPointDto `json:"deliveryPoint,omitempty"`
	PickupPoint *PricingPointDto `json:"pickupPoint,omitempty"`
	SubServices *CappedCollectionDtoPricingPathSubServiceDto `json:"subServices,omitempty"`
	SubServiceAdditionalUnits *CappedCollectionDtoPricingPathSubServiceAdditionalUnitDto `json:"subServiceAdditionalUnits,omitempty"`
	SubServiceUnitPricingSlots *CappedCollectionDtoPricingPathSubServiceUnitPricingSlotDto `json:"subServiceUnitPricingSlots,omitempty"`
	UnitPricingSlotEquivalences *CappedCollectionDtoPricingPathUnitPricingSlotEquivalenceDto `json:"unitPricingSlotEquivalences,omitempty"`
}
...
// GetPricingPathId returns the PricingPathId field value if set, zero value otherwise.
func (o *PricingPathDto) GetPricingPathId() int32 {
	if o == nil || IsNil(o.PricingPathId) {
		var ret int32
		return ret
	}
	return *o.PricingPathId
}

// GetPricingPathIdOk returns a tuple with the PricingPathId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetPricingPathIdOk() (*int32, bool) {
	if o == nil || IsNil(o.PricingPathId) {
		return nil, false
	}
	return o.PricingPathId, true
}
...
// SetPricingPathId gets a reference to the given int32 and assigns it to the PricingPathId field.
func (o *PricingPathDto) SetPricingPathId(v int32) {
	o.PricingPathId = &v
}

// GetPriceCatalogCode returns the PriceCatalogCode field value if set, zero value otherwise.
func (o *PricingPathDto) GetPriceCatalogCode() string {
	if o == nil || IsNil(o.PriceCatalogCode) {
		var ret string
		return ret
	}
	return *o.PriceCatalogCode
}

// GetPriceCatalogCodeOk returns a tuple with the PriceCatalogCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetPriceCatalogCodeOk() (*string, bool) {
	if o == nil || IsNil(o.PriceCatalogCode) {
		return nil, false
	}
	return o.PriceCatalogCode, true
}
...
// SetPriceCatalogCode gets a reference to the given string and assigns it to the PriceCatalogCode field.
func (o *PricingPathDto) SetPriceCatalogCode(v string) {
	o.PriceCatalogCode = &v
}
...
// GetSubcontractorCode returns the SubcontractorCode field value if set, zero value otherwise.
func (o *PricingPathDto) GetSubcontractorCode() string {
	if o == nil || IsNil(o.SubcontractorCode) {
		var ret string
		return ret
	}
	return *o.SubcontractorCode
}

// GetSubcontractorCodeOk returns a tuple with the SubcontractorCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetSubcontractorCodeOk() (*string, bool) {
	if o == nil || IsNil(o.SubcontractorCode) {
		return nil, false
	}
	return o.SubcontractorCode, true
}
...
// SetSubcontractorCode gets a reference to the given string and assigns it to the SubcontractorCode field.
func (o *PricingPathDto) SetSubcontractorCode(v string) {
	o.SubcontractorCode = &v
}
...
// GetWithReturn returns the WithReturn field value if set, zero value otherwise.
func (o *PricingPathDto) GetWithReturn() bool {
	if o == nil || IsNil(o.WithReturn) {
		var ret bool
		return ret
	}
	return *o.WithReturn
...
// GetWithReturnOk returns a tuple with the WithReturn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetWithReturnOk() (*bool, bool) {
	if o == nil || IsNil(o.WithReturn) {
		return nil, false
	}
	return o.WithReturn, true
}
...
// SetWithReturn gets a reference to the given bool and assigns it to the WithReturn field.
func (o *PricingPathDto) SetWithReturn(v bool) {
	o.WithReturn = &v
}

// GetPickupDelayTimeMode returns the PickupDelayTimeMode field value if set, zero value otherwise.
func (o *PricingPathDto) GetPickupDelayTimeMode() string {
	if o == nil || IsNil(o.PickupDelayTimeMode) {
		var ret string
		return ret
	}
	return *o.PickupDelayTimeMode
}

// GetPickupDelayTimeModeOk returns a tuple with the PickupDelayTimeMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetPickupDelayTimeModeOk() (*string, bool) {
	if o == nil || IsNil(o.PickupDelayTimeMode) {
		return nil, false
	}
	return o.PickupDelayTimeMode, true
}
...
// SetPickupDelayTimeMode gets a reference to the given string and assigns it to the PickupDelayTimeMode field.
func (o *PricingPathDto) SetPickupDelayTimeMode(v string) {
	o.PickupDelayTimeMode = &v
}

// GetPickupDurationTotalMinutes returns the PickupDurationTotalMinutes field value if set, zero value otherwise.
func (o *PricingPathDto) GetPickupDurationTotalMinutes() int32 {
	if o == nil || IsNil(o.PickupDurationTotalMinutes) {
		var ret int32
		return ret
	}
	return *o.PickupDurationTotalMinutes
}

// GetPickupDurationTotalMinutesOk returns a tuple with the PickupDurationTotalMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetPickupDurationTotalMinutesOk() (*int32, bool) {
	if o == nil || IsNil(o.PickupDurationTotalMinutes) {
		return nil, false
	}
	return o.PickupDurationTotalMinutes, true
}
...
// SetPickupDurationTotalMinutes gets a reference to the given int32 and assigns it to the PickupDurationTotalMinutes field.
func (o *PricingPathDto) SetPickupDurationTotalMinutes(v int32) {
	o.PickupDurationTotalMinutes = &v
}

// GetPickupDelayDays returns the PickupDelayDays field value if set, zero value otherwise.
func (o *PricingPathDto) GetPickupDelayDays() int32 {
	if o == nil || IsNil(o.PickupDelayDays) {
		var ret int32
		return ret
	}
	return *o.PickupDelayDays
}

// GetPickupDelayDaysOk returns a tuple with the PickupDelayDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetPickupDelayDaysOk() (*int32, bool) {
	if o == nil || IsNil(o.PickupDelayDays) {
		return nil, false
	}
	return o.PickupDelayDays, true
}
...
// SetPickupDelayDays gets a reference to the given int32 and assigns it to the PickupDelayDays field.
func (o *PricingPathDto) SetPickupDelayDays(v int32) {
	o.PickupDelayDays = &v
}

// GetPickupDelayTime returns the PickupDelayTime field value if set, zero value otherwise.
func (o *PricingPathDto) GetPickupDelayTime() string {
	if o == nil || IsNil(o.PickupDelayTime) {
		var ret string
		return ret
	}
	return *o.PickupDelayTime
}

// GetPickupDelayTimeOk returns a tuple with the PickupDelayTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetPickupDelayTimeOk() (*string, bool) {
	if o == nil || IsNil(o.PickupDelayTime) {
		return nil, false
	}
	return o.PickupDelayTime, true
}
...
// SetPickupDelayTime gets a reference to the given string and assigns it to the PickupDelayTime field.
func (o *PricingPathDto) SetPickupDelayTime(v string) {
	o.PickupDelayTime = &v
}

// GetDeliveryDelayTimeMode returns the DeliveryDelayTimeMode field value if set, zero value otherwise.
func (o *PricingPathDto) GetDeliveryDelayTimeMode() string {
	if o == nil || IsNil(o.DeliveryDelayTimeMode) {
		var ret string
		return ret
	}
	return *o.DeliveryDelayTimeMode
}

// GetDeliveryDelayTimeModeOk returns a tuple with the DeliveryDelayTimeMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetDeliveryDelayTimeModeOk() (*string, bool) {
	if o == nil || IsNil(o.DeliveryDelayTimeMode) {
		return nil, false
	}
	return o.DeliveryDelayTimeMode, true
}
...
// SetDeliveryDelayTimeMode gets a reference to the given string and assigns it to the DeliveryDelayTimeMode field.
func (o *PricingPathDto) SetDeliveryDelayTimeMode(v string) {
	o.DeliveryDelayTimeMode = &v
}

// GetDeliveryDurationTotalMinutes returns the DeliveryDurationTotalMinutes field value if set, zero value otherwise.
func (o *PricingPathDto) GetDeliveryDurationTotalMinutes() int32 {
	if o == nil || IsNil(o.DeliveryDurationTotalMinutes) {
		var ret int32
		return ret
	}
	return *o.DeliveryDurationTotalMinutes
}

// GetDeliveryDurationTotalMinutesOk returns a tuple with the DeliveryDurationTotalMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetDeliveryDurationTotalMinutesOk() (*int32, bool) {
	if o == nil || IsNil(o.DeliveryDurationTotalMinutes) {
		return nil, false
	}
	return o.DeliveryDurationTotalMinutes, true
}
...
// SetDeliveryDurationTotalMinutes gets a reference to the given int32 and assigns it to the DeliveryDurationTotalMinutes field.
func (o *PricingPathDto) SetDeliveryDurationTotalMinutes(v int32) {
	o.DeliveryDurationTotalMinutes = &v
}

// GetDeliveryDelayDays returns the DeliveryDelayDays field value if set, zero value otherwise.
func (o *PricingPathDto) GetDeliveryDelayDays() int32 {
	if o == nil || IsNil(o.DeliveryDelayDays) {
		var ret int32
		return ret
	}
	return *o.DeliveryDelayDays
}

// GetDeliveryDelayDaysOk returns a tuple with the DeliveryDelayDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetDeliveryDelayDaysOk() (*int32, bool) {
	if o == nil || IsNil(o.DeliveryDelayDays) {
		return nil, false
	}
	return o.DeliveryDelayDays, true
}
...
// SetDeliveryDelayDays gets a reference to the given int32 and assigns it to the DeliveryDelayDays field.
func (o *PricingPathDto) SetDeliveryDelayDays(v int32) {
	o.DeliveryDelayDays = &v
}

// GetDeliveryDelayTime returns the DeliveryDelayTime field value if set, zero value otherwise.
func (o *PricingPathDto) GetDeliveryDelayTime() string {
	if o == nil || IsNil(o.DeliveryDelayTime) {
		var ret string
		return ret
	}
	return *o.DeliveryDelayTime
}

// GetDeliveryDelayTimeOk returns a tuple with the DeliveryDelayTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetDeliveryDelayTimeOk() (*string, bool) {
	if o == nil || IsNil(o.DeliveryDelayTime) {
		return nil, false
	}
	return o.DeliveryDelayTime, true
}
...
// SetDeliveryDelayTime gets a reference to the given string and assigns it to the DeliveryDelayTime field.
func (o *PricingPathDto) SetDeliveryDelayTime(v string) {
	o.DeliveryDelayTime = &v
}

// GetDeliveryTimeSlotValueMinutes returns the DeliveryTimeSlotValueMinutes field value if set, zero value otherwise.
func (o *PricingPathDto) GetDeliveryTimeSlotValueMinutes() int32 {
	if o == nil || IsNil(o.DeliveryTimeSlotValueMinutes) {
		var ret int32
		return ret
	}
	return *o.DeliveryTimeSlotValueMinutes
}

// GetDeliveryTimeSlotValueMinutesOk returns a tuple with the DeliveryTimeSlotValueMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetDeliveryTimeSlotValueMinutesOk() (*int32, bool) {
	if o == nil || IsNil(o.DeliveryTimeSlotValueMinutes) {
		return nil, false
	}
	return o.DeliveryTimeSlotValueMinutes, true
}
...
// SetDeliveryTimeSlotValueMinutes gets a reference to the given int32 and assigns it to the DeliveryTimeSlotValueMinutes field.
func (o *PricingPathDto) SetDeliveryTimeSlotValueMinutes(v int32) {
	o.DeliveryTimeSlotValueMinutes = &v
}

// GetDeliveryPoint returns the DeliveryPoint field value if set, zero value otherwise.
func (o *PricingPathDto) GetDeliveryPoint() PricingPointDto {
	if o == nil || IsNil(o.DeliveryPoint) {
		var ret PricingPointDto
		return ret
	}
	return *o.DeliveryPoint
}

// GetDeliveryPointOk returns a tuple with the DeliveryPoint field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetDeliveryPointOk() (*PricingPointDto, bool) {
	if o == nil || IsNil(o.DeliveryPoint) {
		return nil, false
	}
	return o.DeliveryPoint, true
}
...
// SetDeliveryPoint gets a reference to the given PricingPointDto and assigns it to the DeliveryPoint field.
...
// SetPickupPoint gets a reference to the given PricingPointDto and assigns it to the PickupPoint field.
...
func (o *PricingPathDto) GetSubServices() CappedCollectionDtoPricingPathSubServiceDto {
	if o == nil || IsNil(o.SubServices) {
		var ret CappedCollectionDtoPricingPathSubServiceDto
		return ret
	}
...
// SetSubServices gets a reference to the given CappedCollectionDtoPricingPathSubServiceDto and assigns it to the SubServices field.
func (o *PricingPathDto) SetSubServices(v CappedCollectionDtoPricingPathSubServiceDto) {
	o.SubServices = &v
}

// GetSubServiceAdditionalUnits returns the SubServiceAdditionalUnits field value if set, zero value otherwise.
func (o *PricingPathDto) GetSubServiceAdditionalUnits() CappedCollectionDtoPricingPathSubServiceAdditionalUnitDto {
	if o == nil || IsNil(o.SubServiceAdditionalUnits) {
		var ret CappedCollectionDtoPricingPathSubServiceAdditionalUnitDto
		return ret
	}
	return *o.SubServiceAdditionalUnits
}

// GetSubServiceAdditionalUnitsOk returns a tuple with the SubServiceAdditionalUnits field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetSubServiceAdditionalUnitsOk() (*CappedCollectionDtoPricingPathSubServiceAdditionalUnitDto, bool) {
	if o == nil || IsNil(o.SubServiceAdditionalUnits) {
		return nil, false
	}
	return o.SubServiceAdditionalUnits, true
}
...
// SetSubServiceAdditionalUnits gets a reference to the given CappedCollectionDtoPricingPathSubServiceAdditionalUnitDto and assigns it to the SubServiceAdditionalUnits field.
func (o *PricingPathDto) SetSubServiceAdditionalUnits(v CappedCollectionDtoPricingPathSubServiceAdditionalUnitDto) {
	o.SubServiceAdditionalUnits = &v
}

// GetSubServiceUnitPricingSlots returns the SubServiceUnitPricingSlots field value if set, zero value otherwise.
func (o *PricingPathDto) GetSubServiceUnitPricingSlots() CappedCollectionDtoPricingPathSubServiceUnitPricingSlotDto {
	if o == nil || IsNil(o.SubServiceUnitPricingSlots) {
		var ret CappedCollectionDtoPricingPathSubServiceUnitPricingSlotDto
		return ret
	}
	return *o.SubServiceUnitPricingSlots
}

// GetSubServiceUnitPricingSlotsOk returns a tuple with the SubServiceUnitPricingSlots field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetSubServiceUnitPricingSlotsOk() (*CappedCollectionDtoPricingPathSubServiceUnitPricingSlotDto, bool) {
	if o == nil || IsNil(o.SubServiceUnitPricingSlots) {
		return nil, false
	}
	return o.SubServiceUnitPricingSlots, true
}
...
// SetSubServiceUnitPricingSlots gets a reference to the given CappedCollectionDtoPricingPathSubServiceUnitPricingSlotDto and assigns it to the SubServiceUnitPricingSlots field.
func (o *PricingPathDto) SetSubServiceUnitPricingSlots(v CappedCollectionDtoPricingPathSubServiceUnitPricingSlotDto) {
	o.SubServiceUnitPricingSlots = &v
}

// GetUnitPricingSlotEquivalences returns the UnitPricingSlotEquivalences field value if set, zero value otherwise.
func (o *PricingPathDto) GetUnitPricingSlotEquivalences() CappedCollectionDtoPricingPathUnitPricingSlotEquivalenceDto {
	if o == nil || IsNil(o.UnitPricingSlotEquivalences) {
		var ret CappedCollectionDtoPricingPathUnitPricingSlotEquivalenceDto
		return ret
	}
	return *o.UnitPricingSlotEquivalences
}

// GetUnitPricingSlotEquivalencesOk returns a tuple with the UnitPricingSlotEquivalences field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PricingPathDto) GetUnitPricingSlotEquivalencesOk() (*CappedCollectionDtoPricingPathUnitPricingSlotEquivalenceDto, bool) {
	if o == nil || IsNil(o.UnitPricingSlotEquivalences) {
		return nil, false
	}
	return o.UnitPricingSlotEquivalences, true
}
...
// SetUnitPricingSlotEquivalences gets a reference to the given CappedCollectionDtoPricingPathUnitPricingSlotEquivalenceDto and assigns it to the UnitPricingSlotEquivalences field.
func (o *PricingPathDto) SetUnitPricingSlotEquivalences(v CappedCollectionDtoPricingPathUnitPricingSlotEquivalenceDto) {
	o.UnitPricingSlotEquivalences = &v
}

func (o PricingPathDto) MarshalJSON() ([]byte, error) {
...
func (o PricingPathDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PricingPathId) {
		toSerialize["pricingPathId"] = o.PricingPathId
	}
	if !IsNil(o.PriceCatalogCode) {
		toSerialize["priceCatalogCode"] = o.PriceCatalogCode
	}
	...
	if !IsNil(o.SubcontractorCode) {
		toSerialize["subcontractorCode"] = o.SubcontractorCode
	}
	if !IsNil(o.DistanceKm) {
		toSerialize["distanceKm"] = o.DistanceKm
	}
	if !IsNil(o.WithReturn) {
		toSerialize["withReturn"] = o.WithReturn
	}
	if !IsNil(o.PickupDelayTimeMode) {
		toSerialize["pickupDelayTimeMode"] = o.PickupDelayTimeMode
	}
	if !IsNil(o.PickupDurationTotalMinutes) {
		toSerialize["pickupDurationTotalMinutes"] = o.PickupDurationTotalMinutes
	}
	if !IsNil(o.PickupDelayDays) {
		toSerialize["pickupDelayDays"] = o.PickupDelayDays
	}
	if !IsNil(o.PickupDelayTime) {
		toSerialize["pickupDelayTime"] = o.PickupDelayTime
	}
	if !IsNil(o.DeliveryDelayTimeMode) {
		toSerialize["deliveryDelayTimeMode"] = o.DeliveryDelayTimeMode
	}
	if !IsNil(o.DeliveryDurationTotalMinutes) {
		toSerialize["deliveryDurationTotalMinutes"] = o.DeliveryDurationTotalMinutes
	}
	if !IsNil(o.DeliveryDelayDays) {
		toSerialize["deliveryDelayDays"] = o.DeliveryDelayDays
	}
	if !IsNil(o.DeliveryDelayTime) {
		toSerialize["deliveryDelayTime"] = o.DeliveryDelayTime
	}
	if !IsNil(o.DeliveryTimeSlotValueMinutes) {
		toSerialize["deliveryTimeSlotValueMinutes"] = o.DeliveryTimeSlotValueMinutes
	}
	if !IsNil(o.DeliveryPoint) {
		toSerialize["deliveryPoint"] = o.DeliveryPoint
	}
	if !IsNil(o.PickupPoint) {
		toSerialize["pickupPoint"] = o.PickupPoint
	}
	if !IsNil(o.SubServices) {
		toSerialize["subServices"] = o.SubServices
	}
	if !IsNil(o.SubServiceAdditionalUnits) {
		toSerialize["subServiceAdditionalUnits"] = o.SubServiceAdditionalUnits
	}
	if !IsNil(o.SubServiceUnitPricingSlots) {
		toSerialize["subServiceUnitPricingSlots"] = o.SubServiceUnitPricingSlots
	}
	if !IsNil(o.UnitPricingSlotEquivalences) {
		toSerialize["unitPricingSlotEquivalences"] = o.UnitPricingSlotEquivalences
	}
	return toSerialize, nil
}

type NullablePricingPathDto struct {
	value *PricingPathDto
	isSet bool
}

func (v NullablePricingPathDto) Get() *PricingPathDto {
	return v.value
}

func (v *NullablePricingPathDto) Set(val *PricingPathDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePricingPathDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePricingPathDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePricingPathDto(val *PricingPathDto) *NullablePricingPathDto {
	return &NullablePricingPathDto{value: val, isSet: true}
}

func (v NullablePricingPathDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePricingPathDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
