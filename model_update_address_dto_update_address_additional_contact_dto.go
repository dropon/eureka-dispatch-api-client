...
// checks if the UpdateAddressDtoUpdateAddressAdditionalContactDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAddressDtoUpdateAddressAdditionalContactDto{}

// UpdateAddressDtoUpdateAddressAdditionalContactDto struct for UpdateAddressDtoUpdateAddressAdditionalContactDto
type UpdateAddressDtoUpdateAddressAdditionalContactDto struct {
...
func NewUpdateAddressDtoUpdateAddressAdditionalContactDto() *UpdateAddressDtoUpdateAddressAdditionalContactDto {
	this := UpdateAddressDtoUpdateAddressAdditionalContactDto{}
	return &this
}
...
func (o UpdateAddressDtoUpdateAddressAdditionalContactDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateAddressDtoUpdateAddressAdditionalContactDto) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateAddressDtoUpdateAddressAdditionalContactDto struct {
	value *UpdateAddressDtoUpdateAddressAdditionalContactDto
	isSet bool
}

func (v NullableUpdateAddressDtoUpdateAddressAdditionalContactDto) Get() *UpdateAddressDtoUpdateAddressAdditionalContactDto {
	return v.value
}

func (v *NullableUpdateAddressDtoUpdateAddressAdditionalContactDto) Set(val *UpdateAddressDtoUpdateAddressAdditionalContactDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateAddressDtoUpdateAddressAdditionalContactDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAddressDtoUpdateAddressAdditionalContactDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAddressDtoUpdateAddressAdditionalContactDto(val *UpdateAddressDtoUpdateAddressAdditionalContactDto) *NullableUpdateAddressDtoUpdateAddressAdditionalContactDto {
	return &NullableUpdateAddressDtoUpdateAddressAdditionalContactDto{value: val, isSet: true}
}

func (v NullableUpdateAddressDtoUpdateAddressAdditionalContactDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateAddressDtoUpdateAddressAdditionalContactDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
