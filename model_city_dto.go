...
type CityDto struct {
	...
	Included *CityIncludedDto `json:"included,omitempty"`
}
...
// SetIncluded gets a reference to the given CityIncludedDto and assigns it to the Included field.
