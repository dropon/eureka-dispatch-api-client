...
// checks if the UpdateTransportBaseDtoStepDtoStepAddressDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTransportBaseDtoStepDtoStepAddressDto{}

// UpdateTransportBaseDtoStepDtoStepAddressDto struct for UpdateTransportBaseDtoStepDtoStepAddressDto
type UpdateTransportBaseDtoStepDtoStepAddressDto struct {
	// Identifier of the address.   To update the address, provide the new address id,   or set the address id to null and provide all address information.  When an address id is provided, step address information is filled with address data,  but address line 1 and 2 can be overridden.
	AddressId *int32 `json:"addressId,omitempty"`
	// Identifier of the city.   To update the city, provide the new city id,  or set the city id to null and provide the new city name, the post code and the country code.   Used only when the final address id (the address id after the update) is null.
	...
	// This number must be between -180 and 180.
	Longitude *float64 `json:"longitude,omitempty"`
	// This number must be between -90 and 90.
...
func NewUpdateTransportBaseDtoStepDtoStepAddressDto() *UpdateTransportBaseDtoStepDtoStepAddressDto {
	this := UpdateTransportBaseDtoStepDtoStepAddressDto{}
	return &this
}
...
func (o UpdateTransportBaseDtoStepDtoStepAddressDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateTransportBaseDtoStepDtoStepAddressDto) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateTransportBaseDtoStepDtoStepAddressDto struct {
	value *UpdateTransportBaseDtoStepDtoStepAddressDto
	isSet bool
}

func (v NullableUpdateTransportBaseDtoStepDtoStepAddressDto) Get() *UpdateTransportBaseDtoStepDtoStepAddressDto {
	return v.value
}

func (v *NullableUpdateTransportBaseDtoStepDtoStepAddressDto) Set(val *UpdateTransportBaseDtoStepDtoStepAddressDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateTransportBaseDtoStepDtoStepAddressDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateTransportBaseDtoStepDtoStepAddressDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateTransportBaseDtoStepDtoStepAddressDto(val *UpdateTransportBaseDtoStepDtoStepAddressDto) *NullableUpdateTransportBaseDtoStepDtoStepAddressDto {
	return &NullableUpdateTransportBaseDtoStepDtoStepAddressDto{value: val, isSet: true}
}

func (v NullableUpdateTransportBaseDtoStepDtoStepAddressDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateTransportBaseDtoStepDtoStepAddressDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
