...
// checks if the PackageNatureReferenceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackageNatureReferenceDto{}

// PackageNatureReferenceDto struct for PackageNatureReferenceDto
type PackageNatureReferenceDto struct {
	ReferenceIndex *int32 `json:"referenceIndex,omitempty"`
	Label *string `json:"label,omitempty"`
	DefaultValue *string `json:"defaultValue,omitempty"`
	IsMandatory *bool `json:"isMandatory,omitempty"`
	IsValueChoiceForced *bool `json:"isValueChoiceForced,omitempty"`
	Values *CappedCollectionDtoPackageNatureReferenceValueDto `json:"values,omitempty"`
}
...
func NewPackageNatureReferenceDto() *PackageNatureReferenceDto {
	this := PackageNatureReferenceDto{}
	return &this
}
...
// GetReferenceIndex returns the ReferenceIndex field value if set, zero value otherwise.
func (o *PackageNatureReferenceDto) GetReferenceIndex() int32 {
	if o == nil || IsNil(o.ReferenceIndex) {
		var ret int32
		return ret
	}
	return *o.ReferenceIndex
}

// GetReferenceIndexOk returns a tuple with the ReferenceIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PackageNatureReferenceDto) GetReferenceIndexOk() (*int32, bool) {
	if o == nil || IsNil(o.ReferenceIndex) {
		return nil, false
	}
	return o.ReferenceIndex, true
}
...
// SetReferenceIndex gets a reference to the given int32 and assigns it to the ReferenceIndex field.
...
// GetIsValueChoiceForced returns the IsValueChoiceForced field value if set, zero value otherwise.
func (o *PackageNatureReferenceDto) GetIsValueChoiceForced() bool {
	if o == nil || IsNil(o.IsValueChoiceForced) {
		var ret bool
		return ret
	}
	return *o.IsValueChoiceForced
}

// GetIsValueChoiceForcedOk returns a tuple with the IsValueChoiceForced field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PackageNatureReferenceDto) GetIsValueChoiceForcedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsValueChoiceForced) {
		return nil, false
	}
	return o.IsValueChoiceForced, true
}
...
// SetIsValueChoiceForced gets a reference to the given bool and assigns it to the IsValueChoiceForced field.
func (o *PackageNatureReferenceDto) SetIsValueChoiceForced(v bool) {
	o.IsValueChoiceForced = &v
}

// GetValues returns the Values field value if set, zero value otherwise.
func (o *PackageNatureReferenceDto) GetValues() CappedCollectionDtoPackageNatureReferenceValueDto {
	if o == nil || IsNil(o.Values) {
		var ret CappedCollectionDtoPackageNatureReferenceValueDto
		return ret
	}
	return *o.Values
}
...
// SetValues gets a reference to the given CappedCollectionDtoPackageNatureReferenceValueDto and assigns it to the Values field.
func (o *PackageNatureReferenceDto) SetValues(v CappedCollectionDtoPackageNatureReferenceValueDto) {
	o.Values = &v
}

func (o PackageNatureReferenceDto) MarshalJSON() ([]byte, error) {
...
func (o PackageNatureReferenceDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ReferenceIndex) {
		toSerialize["referenceIndex"] = o.ReferenceIndex
	}
	if !IsNil(o.Label) {
	...
	if !IsNil(o.IsValueChoiceForced) {
		toSerialize["isValueChoiceForced"] = o.IsValueChoiceForced
	}
	if !IsNil(o.Values) {
...
type NullablePackageNatureReferenceDto struct {
	value *PackageNatureReferenceDto
	isSet bool
}

func (v NullablePackageNatureReferenceDto) Get() *PackageNatureReferenceDto {
	return v.value
}

func (v *NullablePackageNatureReferenceDto) Set(val *PackageNatureReferenceDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageNatureReferenceDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageNatureReferenceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageNatureReferenceDto(val *PackageNatureReferenceDto) *NullablePackageNatureReferenceDto {
	return &NullablePackageNatureReferenceDto{value: val, isSet: true}
}

func (v NullablePackageNatureReferenceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageNatureReferenceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
