...
// checks if the ApplyTransportSubStateCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyTransportSubStateCommand{}

// ApplyTransportSubStateCommand Apply a sub state to the transport
type ApplyTransportSubStateCommand struct {
	// Mandatory. Transport unique identifier
	TransportUid string `json:"transportUid"`
	// Mandatory. Sub state code to apply
	SubStateCode string `json:"subStateCode"`
	// Free text comment
...
func NewApplyTransportSubStateCommand(transportUid string, subStateCode string) *ApplyTransportSubStateCommand {
	this := ApplyTransportSubStateCommand{}
...
// GetSubStateCode returns the SubStateCode field value
...
// GetSubStateCodeOk returns a tuple with the SubStateCode field value
// and a boolean to check if the value has been set.
...
// SetSubStateCode sets field value
...
func (o *ApplyTransportSubStateCommand) GetPositionDateTimeOk() (*time.Time, bool) {
	...
	return o.PositionDateTime, true
}
...
func (o ApplyTransportSubStateCommand) MarshalJSON() ([]byte, error) {
...
func (o ApplyTransportSubStateCommand) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PositionDateTime) {
		toSerialize["positionDateTime"] = o.PositionDateTime
	}
	return toSerialize, nil
}

func (o *ApplyTransportSubStateCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varApplyTransportSubStateCommand := _ApplyTransportSubStateCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplyTransportSubStateCommand)

	if err != nil {
		return err
	}

	*o = ApplyTransportSubStateCommand(varApplyTransportSubStateCommand)

	return err
}

type NullableApplyTransportSubStateCommand struct {
	value *ApplyTransportSubStateCommand
	isSet bool
}

func (v NullableApplyTransportSubStateCommand) Get() *ApplyTransportSubStateCommand {
	return v.value
}

func (v *NullableApplyTransportSubStateCommand) Set(val *ApplyTransportSubStateCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyTransportSubStateCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyTransportSubStateCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyTransportSubStateCommand(val *ApplyTransportSubStateCommand) *NullableApplyTransportSubStateCommand {
	return &NullableApplyTransportSubStateCommand{value: val, isSet: true}
}

func (v NullableApplyTransportSubStateCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyTransportSubStateCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
