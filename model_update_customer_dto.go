...
func (o *UpdateCustomerDto) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCustomerDto := _UpdateCustomerDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateCustomerDto)

	if err != nil {
		return err
	}

	*o = UpdateCustomerDto(varUpdateCustomerDto)
