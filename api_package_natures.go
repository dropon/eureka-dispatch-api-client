...
type ApiGetPackageNatureByIdRequest struct {
	ctx context.Context
...
func (r ApiGetPackageNatureByIdRequest) Fields(fields string) ApiGetPackageNatureByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPackageNatureByIdRequest) Execute() (*PackageNatureDto, *http.Response, error) {
...
Get the package nature by its identifier.
 ...
 @return ApiGetPackageNatureByIdRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatureById(ctx context.Context, packageNatureId int32) ApiGetPackageNatureByIdRequest {
	return ApiGetPackageNatureByIdRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *PackageNaturesAPIService) GetPackageNatureByIdExecute(r ApiGetPackageNatureByIdRequest) (*PackageNatureDto, *http.Response, error) {
	var (
...
type ApiGetPackageNatureReferenceValuesRequest struct {
	ctx context.Context
	ApiService *PackageNaturesAPIService
	packageNatureId int32
...
func (r ApiGetPackageNatureReferenceValuesRequest) StartIndex(startIndex int32) ApiGetPackageNatureReferenceValuesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPackageNatureReferenceValuesRequest) Count(count int32) ApiGetPackageNatureReferenceValuesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPackageNatureReferenceValuesRequest) Sort(sort []string) ApiGetPackageNatureReferenceValuesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPackageNatureReferenceValuesRequest) Desc(desc []string) ApiGetPackageNatureReferenceValuesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPackageNatureReferenceValuesRequest) Fields(fields string) ApiGetPackageNatureReferenceValuesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPackageNatureReferenceValuesRequest) Execute() (*IPagedResourceListPackageNatureReferenceValueDto, *http.Response, error) {
...
Get a paginated list of package natures reference values for a package nature and reference index.
 ...
 @return ApiGetPackageNatureReferenceValuesRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatureReferenceValues(ctx context.Context, packageNatureId int32, referenceIndex int32) ApiGetPackageNatureReferenceValuesRequest {
	return ApiGetPackageNatureReferenceValuesRequest{
		ApiService: a,
		ctx: ctx,
		packageNatureId: packageNatureId,
...
func (a *PackageNaturesAPIService) GetPackageNatureReferenceValuesExecute(r ApiGetPackageNatureReferenceValuesRequest) (*IPagedResourceListPackageNatureReferenceValueDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetPackageNatureReferencesRequest struct {
	ctx context.Context
	ApiService *PackageNaturesAPIService
	packageNatureId int32
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetPackageNatureReferencesRequest) StartIndex(startIndex int32) ApiGetPackageNatureReferencesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPackageNatureReferencesRequest) Count(count int32) ApiGetPackageNatureReferencesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPackageNatureReferencesRequest) Sort(sort []string) ApiGetPackageNatureReferencesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPackageNatureReferencesRequest) Desc(desc []string) ApiGetPackageNatureReferencesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPackageNatureReferencesRequest) Fields(fields string) ApiGetPackageNatureReferencesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPackageNatureReferencesRequest) Execute() (*IPagedResourceListPackageNatureReferenceDto, *http.Response, error) {
...
Get a paginated list of package natures references for a package nature.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param packageNatureId Package nature's identifier.
 @return ApiGetPackageNatureReferencesRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatureReferences(ctx context.Context, packageNatureId int32) ApiGetPackageNatureReferencesRequest {
	return ApiGetPackageNatureReferencesRequest{
		ApiService: a,
		ctx: ctx,
		packageNatureId: packageNatureId,
...
func (a *PackageNaturesAPIService) GetPackageNatureReferencesExecute(r ApiGetPackageNatureReferencesRequest) (*IPagedResourceListPackageNatureReferenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetPackageNaturesRequest struct {
	ctx context.Context
	ApiService *PackageNaturesAPIService
	code *string
	label *string
...
func (r ApiGetPackageNaturesRequest) Code(code string) ApiGetPackageNaturesRequest {
	r.code = &code
	return r
}

// Package nature label pattern
func (r ApiGetPackageNaturesRequest) Label(label string) ApiGetPackageNaturesRequest {
	r.label = &label
	return r
}

func (r ApiGetPackageNaturesRequest) IsEnabled(isEnabled bool) ApiGetPackageNaturesRequest {
	r.isEnabled = &isEnabled
	return r
}

// Package nature family code pattern
func (r ApiGetPackageNaturesRequest) PackageFamilyCode(packageFamilyCode string) ApiGetPackageNaturesRequest {
	r.packageFamilyCode = &packageFamilyCode
	return r
}

// Collection of customer unique identifiers
func (r ApiGetPackageNaturesRequest) CustomerUids(customerUids []string) ApiGetPackageNaturesRequest {
	r.customerUids = &customerUids
	return r
}

// Collection of parent package nature identifiers
func (r ApiGetPackageNaturesRequest) ParentPackageNatureIds(parentPackageNatureIds []int32) ApiGetPackageNaturesRequest {
	r.parentPackageNatureIds = &parentPackageNatureIds
	return r
}

// Collection of package nature labels
func (r ApiGetPackageNaturesRequest) Labels(labels []string) ApiGetPackageNaturesRequest {
	r.labels = &labels
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetPackageNaturesRequest) Pattern(pattern string) ApiGetPackageNaturesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetPackageNaturesRequest) PatternFields(patternFields []string) ApiGetPackageNaturesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetPackageNaturesRequest) StartIndex(startIndex int32) ApiGetPackageNaturesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPackageNaturesRequest) Count(count int32) ApiGetPackageNaturesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPackageNaturesRequest) Sort(sort []string) ApiGetPackageNaturesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPackageNaturesRequest) Desc(desc []string) ApiGetPackageNaturesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPackageNaturesRequest) Fields(fields string) ApiGetPackageNaturesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPackageNaturesRequest) Execute() (*IPagedResourceListPackageNatureDto, *http.Response, error) {
...
Get a paginated list of package natures corresponding to the specified filters.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPackageNaturesRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatures(ctx context.Context) ApiGetPackageNaturesRequest {
	return ApiGetPackageNaturesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PackageNaturesAPIService) GetPackageNaturesExecute(r ApiGetPackageNaturesRequest) (*IPagedResourceListPackageNatureDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
