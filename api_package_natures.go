...
// PackageNaturesAPIService PackageNaturesAPI service
type PackageNaturesAPIService service

type PackageNaturesAPIGetPackageNatureByIdRequest struct {
	ctx context.Context
	ApiService *PackageNaturesAPIService
	packageNatureId int32
	fields *string
}

// Projection fields separated with a comma
func (r PackageNaturesAPIGetPackageNatureByIdRequest) Fields(fields string) PackageNaturesAPIGetPackageNatureByIdRequest {
	r.fields = &fields
	return r
}

func (r PackageNaturesAPIGetPackageNatureByIdRequest) Execute() (*PackageNatureDto, *http.Response, error) {
	return r.ApiService.GetPackageNatureByIdExecute(r)
}

/*
GetPackageNatureById Get package nature by id

Get the package nature by its identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param packageNatureId Package nature's identifier.
 @return PackageNaturesAPIGetPackageNatureByIdRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatureById(ctx context.Context, packageNatureId int32) PackageNaturesAPIGetPackageNatureByIdRequest {
	return PackageNaturesAPIGetPackageNatureByIdRequest{
		ApiService: a,
		ctx: ctx,
		packageNatureId: packageNatureId,
	}
}

// Execute executes the request
//  @return PackageNatureDto
func (a *PackageNaturesAPIService) GetPackageNatureByIdExecute(r PackageNaturesAPIGetPackageNatureByIdRequest) (*PackageNatureDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PackageNatureDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackageNaturesAPIService.GetPackageNatureById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/package-natures/{packageNatureId}"
	localVarPath = strings.Replace(localVarPath, "{"+"packageNatureId"+"}", url.PathEscape(parameterValueToString(r.packageNatureId, "packageNatureId")), -1)
...
type PackageNaturesAPIGetPackageNatureReferenceValuesRequest struct {
	ctx context.Context
	ApiService *PackageNaturesAPIService
	packageNatureId int32
...
func (r PackageNaturesAPIGetPackageNatureReferenceValuesRequest) StartIndex(startIndex int32) PackageNaturesAPIGetPackageNatureReferenceValuesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PackageNaturesAPIGetPackageNatureReferenceValuesRequest) Count(count int32) PackageNaturesAPIGetPackageNatureReferenceValuesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PackageNaturesAPIGetPackageNatureReferenceValuesRequest) Sort(sort []string) PackageNaturesAPIGetPackageNatureReferenceValuesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PackageNaturesAPIGetPackageNatureReferenceValuesRequest) Desc(desc []string) PackageNaturesAPIGetPackageNatureReferenceValuesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PackageNaturesAPIGetPackageNatureReferenceValuesRequest) Fields(fields string) PackageNaturesAPIGetPackageNatureReferenceValuesRequest {
	r.fields = &fields
	return r
}

func (r PackageNaturesAPIGetPackageNatureReferenceValuesRequest) Execute() (*IPagedResourceListPackageNatureReferenceValueDto, *http.Response, error) {
	return r.ApiService.GetPackageNatureReferenceValuesExecute(r)
}

/*
GetPackageNatureReferenceValues Get package nature reference values

Get a paginated list of package natures reference values for a package nature and reference index.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param packageNatureId Package nature's identifier.
 @param referenceIndex Index of the reference in the package nature.
 @return PackageNaturesAPIGetPackageNatureReferenceValuesRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatureReferenceValues(ctx context.Context, packageNatureId int32, referenceIndex int32) PackageNaturesAPIGetPackageNatureReferenceValuesRequest {
	return PackageNaturesAPIGetPackageNatureReferenceValuesRequest{
		ApiService: a,
		ctx: ctx,
		packageNatureId: packageNatureId,
...
// Execute executes the request
//  @return IPagedResourceListPackageNatureReferenceValueDto
func (a *PackageNaturesAPIService) GetPackageNatureReferenceValuesExecute(r PackageNaturesAPIGetPackageNatureReferenceValuesRequest) (*IPagedResourceListPackageNatureReferenceValueDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPackageNatureReferenceValueDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackageNaturesAPIService.GetPackageNatureReferenceValues")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/package-natures/{packageNatureId}/references/{referenceIndex}/values"
	localVarPath = strings.Replace(localVarPath, "{"+"packageNatureId"+"}", url.PathEscape(parameterValueToString(r.packageNatureId, "packageNatureId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"referenceIndex"+"}", url.PathEscape(parameterValueToString(r.referenceIndex, "referenceIndex")), -1)
...
type PackageNaturesAPIGetPackageNatureReferencesRequest struct {
	ctx context.Context
	ApiService *PackageNaturesAPIService
	packageNatureId int32
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r PackageNaturesAPIGetPackageNatureReferencesRequest) StartIndex(startIndex int32) PackageNaturesAPIGetPackageNatureReferencesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PackageNaturesAPIGetPackageNatureReferencesRequest) Count(count int32) PackageNaturesAPIGetPackageNatureReferencesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PackageNaturesAPIGetPackageNatureReferencesRequest) Sort(sort []string) PackageNaturesAPIGetPackageNatureReferencesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PackageNaturesAPIGetPackageNatureReferencesRequest) Desc(desc []string) PackageNaturesAPIGetPackageNatureReferencesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PackageNaturesAPIGetPackageNatureReferencesRequest) Fields(fields string) PackageNaturesAPIGetPackageNatureReferencesRequest {
	r.fields = &fields
	return r
}

func (r PackageNaturesAPIGetPackageNatureReferencesRequest) Execute() (*IPagedResourceListPackageNatureReferenceDto, *http.Response, error) {
	return r.ApiService.GetPackageNatureReferencesExecute(r)
}

/*
GetPackageNatureReferences Get package nature references

Get a paginated list of package natures references for a package nature.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param packageNatureId Package nature's identifier.
 @return PackageNaturesAPIGetPackageNatureReferencesRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatureReferences(ctx context.Context, packageNatureId int32) PackageNaturesAPIGetPackageNatureReferencesRequest {
	return PackageNaturesAPIGetPackageNatureReferencesRequest{
		ApiService: a,
		ctx: ctx,
		packageNatureId: packageNatureId,
...
// Execute executes the request
//  @return IPagedResourceListPackageNatureReferenceDto
func (a *PackageNaturesAPIService) GetPackageNatureReferencesExecute(r PackageNaturesAPIGetPackageNatureReferencesRequest) (*IPagedResourceListPackageNatureReferenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPackageNatureReferenceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackageNaturesAPIService.GetPackageNatureReferences")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/package-natures/{packageNatureId}/references"
	localVarPath = strings.Replace(localVarPath, "{"+"packageNatureId"+"}", url.PathEscape(parameterValueToString(r.packageNatureId, "packageNatureId")), -1)
...
type PackageNaturesAPIGetPackageNaturesRequest struct {
	ctx context.Context
	ApiService *PackageNaturesAPIService
	code *string
	label *string
	isEnabled *bool
	packageFamilyCode *string
	customerUids *[]string
	parentPackageNatureIds *[]int32
	labels *[]string
	pattern *string
...
// Package nature code pattern
func (r PackageNaturesAPIGetPackageNaturesRequest) Code(code string) PackageNaturesAPIGetPackageNaturesRequest {
	r.code = &code
	return r
}

// Package nature label pattern
func (r PackageNaturesAPIGetPackageNaturesRequest) Label(label string) PackageNaturesAPIGetPackageNaturesRequest {
	r.label = &label
	return r
}

func (r PackageNaturesAPIGetPackageNaturesRequest) IsEnabled(isEnabled bool) PackageNaturesAPIGetPackageNaturesRequest {
	r.isEnabled = &isEnabled
	return r
}

// Package nature family code pattern
func (r PackageNaturesAPIGetPackageNaturesRequest) PackageFamilyCode(packageFamilyCode string) PackageNaturesAPIGetPackageNaturesRequest {
	r.packageFamilyCode = &packageFamilyCode
	return r
}

// Collection of customer unique identifiers
func (r PackageNaturesAPIGetPackageNaturesRequest) CustomerUids(customerUids []string) PackageNaturesAPIGetPackageNaturesRequest {
	r.customerUids = &customerUids
	return r
}

// Collection of parent package nature identifiers
func (r PackageNaturesAPIGetPackageNaturesRequest) ParentPackageNatureIds(parentPackageNatureIds []int32) PackageNaturesAPIGetPackageNaturesRequest {
	r.parentPackageNatureIds = &parentPackageNatureIds
	return r
}

// Collection of package nature labels
func (r PackageNaturesAPIGetPackageNaturesRequest) Labels(labels []string) PackageNaturesAPIGetPackageNaturesRequest {
	r.labels = &labels
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r PackageNaturesAPIGetPackageNaturesRequest) Pattern(pattern string) PackageNaturesAPIGetPackageNaturesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r PackageNaturesAPIGetPackageNaturesRequest) PatternFields(patternFields []string) PackageNaturesAPIGetPackageNaturesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r PackageNaturesAPIGetPackageNaturesRequest) StartIndex(startIndex int32) PackageNaturesAPIGetPackageNaturesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PackageNaturesAPIGetPackageNaturesRequest) Count(count int32) PackageNaturesAPIGetPackageNaturesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PackageNaturesAPIGetPackageNaturesRequest) Sort(sort []string) PackageNaturesAPIGetPackageNaturesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PackageNaturesAPIGetPackageNaturesRequest) Desc(desc []string) PackageNaturesAPIGetPackageNaturesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PackageNaturesAPIGetPackageNaturesRequest) Fields(fields string) PackageNaturesAPIGetPackageNaturesRequest {
	r.fields = &fields
	return r
}

func (r PackageNaturesAPIGetPackageNaturesRequest) Execute() (*IPagedResourceListPackageNatureDto, *http.Response, error) {
	return r.ApiService.GetPackageNaturesExecute(r)
}

/*
GetPackageNatures Get package natures

Get a paginated list of package natures corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PackageNaturesAPIGetPackageNaturesRequest
*/
func (a *PackageNaturesAPIService) GetPackageNatures(ctx context.Context) PackageNaturesAPIGetPackageNaturesRequest {
	return PackageNaturesAPIGetPackageNaturesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListPackageNatureDto
func (a *PackageNaturesAPIService) GetPackageNaturesExecute(r PackageNaturesAPIGetPackageNaturesRequest) (*IPagedResourceListPackageNatureDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPackageNatureDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackageNaturesAPIService.GetPackageNatures")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/package-natures"
	...
	if r.packageFamilyCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "packageFamilyCode", r.packageFamilyCode, "", "")
	}
	...
	if r.parentPackageNatureIds != nil {
		t := *r.parentPackageNatureIds
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "parentPackageNatureIds", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "parentPackageNatureIds", t, "form", "multi")
		}
	}
	if r.labels != nil {
		t := *r.labels
