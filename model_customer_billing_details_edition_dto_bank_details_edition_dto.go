...
// checks if the CustomerBillingDetailsEditionDtoBankDetailsEditionDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerBillingDetailsEditionDtoBankDetailsEditionDto{}

// CustomerBillingDetailsEditionDtoBankDetailsEditionDto struct for CustomerBillingDetailsEditionDtoBankDetailsEditionDto
type CustomerBillingDetailsEditionDtoBankDetailsEditionDto struct {
	BankCode *string `json:"bankCode,omitempty"`
	// Branch code (French: Guichet)
	BranchCode *string `json:"branchCode,omitempty"`
	AccountNumber *string `json:"accountNumber,omitempty"`
	BankKey *string `json:"bankKey,omitempty"`
	BankDomiciliation *string `json:"bankDomiciliation,omitempty"`
	Iban *string `json:"iban,omitempty"`
	BicCode *string `json:"bicCode,omitempty"`
	// SEPA creditor identifier (French: ICS)
	SepaCreditorIdentifier *string `json:"sepaCreditorIdentifier,omitempty"`
	// SEPA Unique Mandate Reference (French: RUM)
	SepaMandateReference *string `json:"sepaMandateReference,omitempty"`
}

// NewCustomerBillingDetailsEditionDtoBankDetailsEditionDto instantiates a new CustomerBillingDetailsEditionDtoBankDetailsEditionDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCustomerBillingDetailsEditionDtoBankDetailsEditionDto() *CustomerBillingDetailsEditionDtoBankDetailsEditionDto {
	this := CustomerBillingDetailsEditionDtoBankDetailsEditionDto{}
	return &this
}

// NewCustomerBillingDetailsEditionDtoBankDetailsEditionDtoWithDefaults instantiates a new CustomerBillingDetailsEditionDtoBankDetailsEditionDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCustomerBillingDetailsEditionDtoBankDetailsEditionDtoWithDefaults() *CustomerBillingDetailsEditionDtoBankDetailsEditionDto {
	this := CustomerBillingDetailsEditionDtoBankDetailsEditionDto{}
	return &this
}

// GetBankCode returns the BankCode field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBankCode() string {
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBankCodeOk() (*string, bool) {
	if o == nil || IsNil(o.BankCode) {
		return nil, false
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasBankCode() bool {
	if o != nil && !IsNil(o.BankCode) {
		return true
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetBankCode(v string) {
	o.BankCode = &v
}

// GetBranchCode returns the BranchCode field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBranchCode() string {
...
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBranchCodeOk() (*string, bool) {
	if o == nil || IsNil(o.BranchCode) {
		return nil, false
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasBranchCode() bool {
	if o != nil && !IsNil(o.BranchCode) {
		return true
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetBranchCode(v string) {
	o.BranchCode = &v
}

// GetAccountNumber returns the AccountNumber field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetAccountNumber() string {
...
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetAccountNumberOk() (*string, bool) {
	if o == nil || IsNil(o.AccountNumber) {
		return nil, false
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasAccountNumber() bool {
	if o != nil && !IsNil(o.AccountNumber) {
		return true
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetAccountNumber(v string) {
	o.AccountNumber = &v
}

// GetBankKey returns the BankKey field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBankKey() string {
	if o == nil || IsNil(o.BankKey) {
		var ret string
		return ret
	}
	return *o.BankKey
...
// GetBankKeyOk returns a tuple with the BankKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBankKeyOk() (*string, bool) {
	if o == nil || IsNil(o.BankKey) {
		return nil, false
	}
	return o.BankKey, true
}

// HasBankKey returns a boolean if a field has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasBankKey() bool {
	if o != nil && !IsNil(o.BankKey) {
		return true
	}
...
// SetBankKey gets a reference to the given string and assigns it to the BankKey field.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetBankKey(v string) {
	o.BankKey = &v
}

// GetBankDomiciliation returns the BankDomiciliation field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBankDomiciliation() string {
	if o == nil || IsNil(o.BankDomiciliation) {
		var ret string
		return ret
	}
	return *o.BankDomiciliation
}

// GetBankDomiciliationOk returns a tuple with the BankDomiciliation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBankDomiciliationOk() (*string, bool) {
	if o == nil || IsNil(o.BankDomiciliation) {
		return nil, false
	}
	return o.BankDomiciliation, true
}

// HasBankDomiciliation returns a boolean if a field has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasBankDomiciliation() bool {
	if o != nil && !IsNil(o.BankDomiciliation) {
		return true
	}
...
// SetBankDomiciliation gets a reference to the given string and assigns it to the BankDomiciliation field.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetBankDomiciliation(v string) {
	o.BankDomiciliation = &v
}

// GetIban returns the Iban field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetIban() string {
...
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetIbanOk() (*string, bool) {
	if o == nil || IsNil(o.Iban) {
		return nil, false
	}
	return o.Iban, true
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasIban() bool {
	if o != nil && !IsNil(o.Iban) {
		return true
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetIban(v string) {
	o.Iban = &v
}

// GetBicCode returns the BicCode field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBicCode() string {
	if o == nil || IsNil(o.BicCode) {
		var ret string
		return ret
	}
	return *o.BicCode
...
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetBicCodeOk() (*string, bool) {
	if o == nil || IsNil(o.BicCode) {
		return nil, false
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasBicCode() bool {
	if o != nil && !IsNil(o.BicCode) {
		return true
	}
...
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetBicCode(v string) {
	o.BicCode = &v
}

// GetSepaCreditorIdentifier returns the SepaCreditorIdentifier field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetSepaCreditorIdentifier() string {
	if o == nil || IsNil(o.SepaCreditorIdentifier) {
		var ret string
		return ret
	}
	return *o.SepaCreditorIdentifier
}

// GetSepaCreditorIdentifierOk returns a tuple with the SepaCreditorIdentifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetSepaCreditorIdentifierOk() (*string, bool) {
	if o == nil || IsNil(o.SepaCreditorIdentifier) {
		return nil, false
	}
	return o.SepaCreditorIdentifier, true
}

// HasSepaCreditorIdentifier returns a boolean if a field has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasSepaCreditorIdentifier() bool {
	if o != nil && !IsNil(o.SepaCreditorIdentifier) {
		return true
	}
...
// SetSepaCreditorIdentifier gets a reference to the given string and assigns it to the SepaCreditorIdentifier field.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetSepaCreditorIdentifier(v string) {
	o.SepaCreditorIdentifier = &v
}

// GetSepaMandateReference returns the SepaMandateReference field value if set, zero value otherwise.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetSepaMandateReference() string {
	if o == nil || IsNil(o.SepaMandateReference) {
		var ret string
		return ret
	}
	return *o.SepaMandateReference
}

// GetSepaMandateReferenceOk returns a tuple with the SepaMandateReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) GetSepaMandateReferenceOk() (*string, bool) {
	if o == nil || IsNil(o.SepaMandateReference) {
		return nil, false
	}
	return o.SepaMandateReference, true
}

// HasSepaMandateReference returns a boolean if a field has been set.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) HasSepaMandateReference() bool {
	if o != nil && !IsNil(o.SepaMandateReference) {
		return true
	}
...
// SetSepaMandateReference gets a reference to the given string and assigns it to the SepaMandateReference field.
func (o *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) SetSepaMandateReference(v string) {
	o.SepaMandateReference = &v
}

func (o CustomerBillingDetailsEditionDtoBankDetailsEditionDto) MarshalJSON() ([]byte, error) {
...
func (o CustomerBillingDetailsEditionDtoBankDetailsEditionDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BankKey) {
		toSerialize["bankKey"] = o.BankKey
	}
	if !IsNil(o.BankDomiciliation) {
		toSerialize["bankDomiciliation"] = o.BankDomiciliation
	}
	if !IsNil(o.Iban) {
	...
	if !IsNil(o.SepaCreditorIdentifier) {
		toSerialize["sepaCreditorIdentifier"] = o.SepaCreditorIdentifier
	}
	if !IsNil(o.SepaMandateReference) {
		toSerialize["sepaMandateReference"] = o.SepaMandateReference
	}
	return toSerialize, nil
}

type NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto struct {
	value *CustomerBillingDetailsEditionDtoBankDetailsEditionDto
	isSet bool
}

func (v NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto) Get() *CustomerBillingDetailsEditionDtoBankDetailsEditionDto {
	return v.value
}

func (v *NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto) Set(val *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto(val *CustomerBillingDetailsEditionDtoBankDetailsEditionDto) *NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto {
	return &NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto{value: val, isSet: true}
}

func (v NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerBillingDetailsEditionDtoBankDetailsEditionDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
