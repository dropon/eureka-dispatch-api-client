...
// DriversAPIService DriversAPI service
type DriversAPIService service

type DriversAPIGetDriverByCodeRequest struct {
	ctx context.Context
...
// Driver&#39;s code
func (r DriversAPIGetDriverByCodeRequest) Code(code string) DriversAPIGetDriverByCodeRequest {
	r.code = &code
	return r
}

// Projection fields separated with a comma
func (r DriversAPIGetDriverByCodeRequest) Fields(fields string) DriversAPIGetDriverByCodeRequest {
	r.fields = &fields
	return r
}

func (r DriversAPIGetDriverByCodeRequest) Execute() (*DriverDto, *http.Response, error) {
	return r.ApiService.GetDriverByCodeExecute(r)
}

/*
GetDriverByCode Get a driver by its code

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return DriversAPIGetDriverByCodeRequest
*/
func (a *DriversAPIService) GetDriverByCode(ctx context.Context) DriversAPIGetDriverByCodeRequest {
	return DriversAPIGetDriverByCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return DriverDto
func (a *DriversAPIService) GetDriverByCodeExecute(r DriversAPIGetDriverByCodeRequest) (*DriverDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DriverDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DriversAPIService.GetDriverByCode")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/drivers/by-code"
...
type DriversAPIGetDriverByIdRequest struct {
	ctx context.Context
	ApiService *DriversAPIService
	driverId int32
	fields *string
...
// Projection fields separated with a comma
func (r DriversAPIGetDriverByIdRequest) Fields(fields string) DriversAPIGetDriverByIdRequest {
	r.fields = &fields
	return r
}

func (r DriversAPIGetDriverByIdRequest) Execute() (*DriverDto, *http.Response, error) {
	return r.ApiService.GetDriverByIdExecute(r)
}

/*
GetDriverById Get a driver by its identifier

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param driverId Identifier of the driver
 @return DriversAPIGetDriverByIdRequest
*/
func (a *DriversAPIService) GetDriverById(ctx context.Context, driverId int32) DriversAPIGetDriverByIdRequest {
	return DriversAPIGetDriverByIdRequest{
		ApiService: a,
		ctx: ctx,
		driverId: driverId,
...
// Execute executes the request
//  @return DriverDto
func (a *DriversAPIService) GetDriverByIdExecute(r DriversAPIGetDriverByIdRequest) (*DriverDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DriversAPIService.GetDriverById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/drivers/{driverId}"
...
type DriversAPIGetDriversRequest struct {
	ctx context.Context
	ApiService *DriversAPIService
	driverIds *[]int32
	code *string
	...
	defaultVehicleLicensePlate *string
	defaultVehicleCodes *[]string
	currentVehicleCode *string
	currentVehicleLicensePlate *string
	driverTypes *[]string
	driverLicenseTypes *[]string
	minimumGlobalMark *int32
	minimumSubcontractorEmployeesCount *int64
	workingTimeServiceStarted *bool
	isDispatchMobileEnabled *bool
	pattern *string
	patternFields *[]string
	dangerousGoodsCertificationClasses *[]string
	startIndex *int32
	count *int32
	sort *[]string
	desc *[]string
...
// List of driver Ids
func (r DriversAPIGetDriversRequest) DriverIds(driverIds []int32) DriversAPIGetDriversRequest {
	r.driverIds = &driverIds
	return r
}

// Driver code pattern
func (r DriversAPIGetDriversRequest) Code(code string) DriversAPIGetDriversRequest {
	r.code = &code
	return r
}

// Driver name pattern
func (r DriversAPIGetDriversRequest) Name(name string) DriversAPIGetDriversRequest {
	r.name = &name
	return r
}

// Driver country code
func (r DriversAPIGetDriversRequest) CountryCode(countryCode string) DriversAPIGetDriversRequest {
	r.countryCode = &countryCode
	return r
}

// Driver post code
func (r DriversAPIGetDriversRequest) PostCode(postCode string) DriversAPIGetDriversRequest {
	r.postCode = &postCode
	return r
}

// Driver city name
func (r DriversAPIGetDriversRequest) CityName(cityName string) DriversAPIGetDriversRequest {
	r.cityName = &cityName
	return r
}

// Driver agency code
func (r DriversAPIGetDriversRequest) AgencyCode(agencyCode string) DriversAPIGetDriversRequest {
	r.agencyCode = &agencyCode
	return r
}

// Driver agency codes
func (r DriversAPIGetDriversRequest) AgencyCodes(agencyCodes []string) DriversAPIGetDriversRequest {
	r.agencyCodes = &agencyCodes
	return r
}

// Driver team code
func (r DriversAPIGetDriversRequest) TeamCode(teamCode string) DriversAPIGetDriversRequest {
	r.teamCode = &teamCode
	return r
}

// Driver team codes
func (r DriversAPIGetDriversRequest) TeamCodes(teamCodes []string) DriversAPIGetDriversRequest {
	r.teamCodes = &teamCodes
	return r
}

func (r DriversAPIGetDriversRequest) IsEnabled(isEnabled bool) DriversAPIGetDriversRequest {
	r.isEnabled = &isEnabled
	return r
}

// Default vehicle code
func (r DriversAPIGetDriversRequest) DefaultVehicleCode(defaultVehicleCode string) DriversAPIGetDriversRequest {
	r.defaultVehicleCode = &defaultVehicleCode
	return r
}

// Default vehicle license plate
func (r DriversAPIGetDriversRequest) DefaultVehicleLicensePlate(defaultVehicleLicensePlate string) DriversAPIGetDriversRequest {
	r.defaultVehicleLicensePlate = &defaultVehicleLicensePlate
	return r
}

// Default vehicle codes
func (r DriversAPIGetDriversRequest) DefaultVehicleCodes(defaultVehicleCodes []string) DriversAPIGetDriversRequest {
	r.defaultVehicleCodes = &defaultVehicleCodes
	return r
}

// Current vehicle code
func (r DriversAPIGetDriversRequest) CurrentVehicleCode(currentVehicleCode string) DriversAPIGetDriversRequest {
	r.currentVehicleCode = &currentVehicleCode
	return r
}

// Current vehicle license plate
func (r DriversAPIGetDriversRequest) CurrentVehicleLicensePlate(currentVehicleLicensePlate string) DriversAPIGetDriversRequest {
	r.currentVehicleLicensePlate = &currentVehicleLicensePlate
	return r
}

// List of driver types
func (r DriversAPIGetDriversRequest) DriverTypes(driverTypes []string) DriversAPIGetDriversRequest {
	r.driverTypes = &driverTypes
	return r
}

// List of driver license type
func (r DriversAPIGetDriversRequest) DriverLicenseTypes(driverLicenseTypes []string) DriversAPIGetDriversRequest {
	r.driverLicenseTypes = &driverLicenseTypes
	return r
}

// Driver included minimum global mark
func (r DriversAPIGetDriversRequest) MinimumGlobalMark(minimumGlobalMark int32) DriversAPIGetDriversRequest {
	r.minimumGlobalMark = &minimumGlobalMark
	return r
}

// Minimum number of employee the subcontractor have, if specified only subcontractor are returned
func (r DriversAPIGetDriversRequest) MinimumSubcontractorEmployeesCount(minimumSubcontractorEmployeesCount int64) DriversAPIGetDriversRequest {
	r.minimumSubcontractorEmployeesCount = &minimumSubcontractorEmployeesCount
	return r
}

func (r DriversAPIGetDriversRequest) WorkingTimeServiceStarted(workingTimeServiceStarted bool) DriversAPIGetDriversRequest {
	r.workingTimeServiceStarted = &workingTimeServiceStarted
	return r
}

func (r DriversAPIGetDriversRequest) IsDispatchMobileEnabled(isDispatchMobileEnabled bool) DriversAPIGetDriversRequest {
	r.isDispatchMobileEnabled = &isDispatchMobileEnabled
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r DriversAPIGetDriversRequest) Pattern(pattern string) DriversAPIGetDriversRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r DriversAPIGetDriversRequest) PatternFields(patternFields []string) DriversAPIGetDriversRequest {
	r.patternFields = &patternFields
	return r
}

// List of dangerous good certification class
func (r DriversAPIGetDriversRequest) DangerousGoodsCertificationClasses(dangerousGoodsCertificationClasses []string) DriversAPIGetDriversRequest {
	r.dangerousGoodsCertificationClasses = &dangerousGoodsCertificationClasses
	return r
}

// Pagination start index (offset). Default is 0.
func (r DriversAPIGetDriversRequest) StartIndex(startIndex int32) DriversAPIGetDriversRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r DriversAPIGetDriversRequest) Count(count int32) DriversAPIGetDriversRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r DriversAPIGetDriversRequest) Sort(sort []string) DriversAPIGetDriversRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r DriversAPIGetDriversRequest) Desc(desc []string) DriversAPIGetDriversRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r DriversAPIGetDriversRequest) Fields(fields string) DriversAPIGetDriversRequest {
	r.fields = &fields
	return r
}

func (r DriversAPIGetDriversRequest) Execute() (*IPagedResourceListDriverDto, *http.Response, error) {
	return r.ApiService.GetDriversExecute(r)
}

/*
GetDrivers Get drivers

Get a paginated list of drivers corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return DriversAPIGetDriversRequest
*/
func (a *DriversAPIService) GetDrivers(ctx context.Context) DriversAPIGetDriversRequest {
	return DriversAPIGetDriversRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListDriverDto
func (a *DriversAPIService) GetDriversExecute(r DriversAPIGetDriversRequest) (*IPagedResourceListDriverDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListDriverDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DriversAPIService.GetDrivers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/drivers"
	...
	if r.teamCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "teamCode", r.teamCode, "", "")
	}
	if r.teamCodes != nil {
		t := *r.teamCodes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "teamCodes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "teamCodes", t, "form", "multi")
		}
	}
	if r.isEnabled != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isEnabled", r.isEnabled, "", "")
	}
	if r.defaultVehicleCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "defaultVehicleCode", r.defaultVehicleCode, "", "")
	}
	if r.defaultVehicleLicensePlate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "defaultVehicleLicensePlate", r.defaultVehicleLicensePlate, "", "")
	}
	if r.defaultVehicleCodes != nil {
		t := *r.defaultVehicleCodes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "defaultVehicleCodes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "defaultVehicleCodes", t, "form", "multi")
		}
	}
	if r.currentVehicleCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "currentVehicleCode", r.currentVehicleCode, "", "")
	}
	if r.currentVehicleLicensePlate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "currentVehicleLicensePlate", r.currentVehicleLicensePlate, "", "")
	}
	if r.driverTypes != nil {
		t := *r.driverTypes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "driverTypes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "driverTypes", t, "form", "multi")
		}
	}
	if r.driverLicenseTypes != nil {
		t := *r.driverLicenseTypes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "driverLicenseTypes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "driverLicenseTypes", t, "form", "multi")
		}
	}
	if r.minimumGlobalMark != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "minimumGlobalMark", r.minimumGlobalMark, "", "")
	}
	if r.minimumSubcontractorEmployeesCount != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "minimumSubcontractorEmployeesCount", r.minimumSubcontractorEmployeesCount, "", "")
	}
	if r.workingTimeServiceStarted != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "workingTimeServiceStarted", r.workingTimeServiceStarted, "", "")
	}
	if r.isDispatchMobileEnabled != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isDispatchMobileEnabled", r.isDispatchMobileEnabled, "", "")
	}
	if r.pattern != nil {
	...
	if r.dangerousGoodsCertificationClasses != nil {
		t := *r.dangerousGoodsCertificationClasses
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "dangerousGoodsCertificationClasses", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "dangerousGoodsCertificationClasses", t, "form", "multi")
		}
	}
	if r.startIndex != nil {
