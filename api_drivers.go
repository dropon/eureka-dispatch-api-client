...
type ApiGetDriverByCodeRequest struct {
	ctx context.Context
...
// Driver&#39;s code
func (r ApiGetDriverByCodeRequest) Code(code string) ApiGetDriverByCodeRequest {
	r.code = &code
	return r
}

// Projection fields separated with a comma
func (r ApiGetDriverByCodeRequest) Fields(fields string) ApiGetDriverByCodeRequest {
	r.fields = &fields
	return r
}

func (r ApiGetDriverByCodeRequest) Execute() (*DriverDto, *http.Response, error) {
	return r.ApiService.GetDriverByCodeExecute(r)
}

/*
GetDriverByCode Get driver by code

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetDriverByCodeRequest
*/
func (a *DriversAPIService) GetDriverByCode(ctx context.Context) ApiGetDriverByCodeRequest {
	return ApiGetDriverByCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return DriverDto
func (a *DriversAPIService) GetDriverByCodeExecute(r ApiGetDriverByCodeRequest) (*DriverDto, *http.Response, error) {
	var (
...
// Projection fields separated with a comma
func (r ApiGetDriverByIdRequest) Fields(fields string) ApiGetDriverByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetDriverByIdRequest) Execute() (*DriverDto, *http.Response, error) {
...
*/
func (a *DriversAPIService) GetDriverById(ctx context.Context, driverId int32) ApiGetDriverByIdRequest {
	return ApiGetDriverByIdRequest{
		ApiService: a,
		ctx: ctx,
		driverId: driverId,
...
// Execute executes the request
//  @return DriverDto
func (a *DriversAPIService) GetDriverByIdExecute(r ApiGetDriverByIdRequest) (*DriverDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// List of driver Ids
func (r ApiGetDriversRequest) DriverIds(driverIds []int32) ApiGetDriversRequest {
	r.driverIds = &driverIds
	return r
}

// Driver code pattern
func (r ApiGetDriversRequest) Code(code string) ApiGetDriversRequest {
	r.code = &code
	return r
}

// Driver name pattern
func (r ApiGetDriversRequest) Name(name string) ApiGetDriversRequest {
	r.name = &name
	return r
}

// Driver country code
func (r ApiGetDriversRequest) CountryCode(countryCode string) ApiGetDriversRequest {
	r.countryCode = &countryCode
	return r
}

// Driver post code
func (r ApiGetDriversRequest) PostCode(postCode string) ApiGetDriversRequest {
	r.postCode = &postCode
	return r
}

// Driver city name
func (r ApiGetDriversRequest) CityName(cityName string) ApiGetDriversRequest {
	r.cityName = &cityName
	return r
}

// Driver agency code
func (r ApiGetDriversRequest) AgencyCode(agencyCode string) ApiGetDriversRequest {
	r.agencyCode = &agencyCode
	return r
}

// Driver agency codes
func (r ApiGetDriversRequest) AgencyCodes(agencyCodes []string) ApiGetDriversRequest {
	r.agencyCodes = &agencyCodes
	return r
}

// Driver team code
func (r ApiGetDriversRequest) TeamCode(teamCode string) ApiGetDriversRequest {
	r.teamCode = &teamCode
	return r
}

// Driver team codes
func (r ApiGetDriversRequest) TeamCodes(teamCodes []string) ApiGetDriversRequest {
	r.teamCodes = &teamCodes
	return r
}

func (r ApiGetDriversRequest) IsEnabled(isEnabled bool) ApiGetDriversRequest {
	r.isEnabled = &isEnabled
	return r
}

// Default vehicle code
func (r ApiGetDriversRequest) DefaultVehicleCode(defaultVehicleCode string) ApiGetDriversRequest {
	r.defaultVehicleCode = &defaultVehicleCode
	return r
}

// Default vehicle license plate
func (r ApiGetDriversRequest) DefaultVehicleLicensePlate(defaultVehicleLicensePlate string) ApiGetDriversRequest {
	r.defaultVehicleLicensePlate = &defaultVehicleLicensePlate
	return r
}

// Default vehicle codes
func (r ApiGetDriversRequest) DefaultVehicleCodes(defaultVehicleCodes []string) ApiGetDriversRequest {
	r.defaultVehicleCodes = &defaultVehicleCodes
	return r
}

// Current vehicle code
func (r ApiGetDriversRequest) CurrentVehicleCode(currentVehicleCode string) ApiGetDriversRequest {
	r.currentVehicleCode = &currentVehicleCode
	return r
}

// Current vehicle license plate
func (r ApiGetDriversRequest) CurrentVehicleLicensePlate(currentVehicleLicensePlate string) ApiGetDriversRequest {
	r.currentVehicleLicensePlate = &currentVehicleLicensePlate
	return r
}

// List of driver types
func (r ApiGetDriversRequest) DriverTypes(driverTypes []string) ApiGetDriversRequest {
	r.driverTypes = &driverTypes
	return r
}

// List of driver license type
func (r ApiGetDriversRequest) DriverLicenseTypes(driverLicenseTypes []string) ApiGetDriversRequest {
	r.driverLicenseTypes = &driverLicenseTypes
	return r
}

// Driver included minimum global mark
func (r ApiGetDriversRequest) MinimumGlobalMark(minimumGlobalMark int32) ApiGetDriversRequest {
...
func (r ApiGetDriversRequest) MinimumSubcontractorEmployeesCount(minimumSubcontractorEmployeesCount int64) ApiGetDriversRequest {
	r.minimumSubcontractorEmployeesCount = &minimumSubcontractorEmployeesCount
	return r
}

func (r ApiGetDriversRequest) WorkingTimeServiceStarted(workingTimeServiceStarted bool) ApiGetDriversRequest {
	r.workingTimeServiceStarted = &workingTimeServiceStarted
	return r
}

func (r ApiGetDriversRequest) IsDispatchMobileEnabled(isDispatchMobileEnabled bool) ApiGetDriversRequest {
	r.isDispatchMobileEnabled = &isDispatchMobileEnabled
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetDriversRequest) Pattern(pattern string) ApiGetDriversRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetDriversRequest) PatternFields(patternFields []string) ApiGetDriversRequest {
	r.patternFields = &patternFields
	return r
}

// List of dangerous good certification class
func (r ApiGetDriversRequest) DangerousGoodsCertificationClasses(dangerousGoodsCertificationClasses []string) ApiGetDriversRequest {
	r.dangerousGoodsCertificationClasses = &dangerousGoodsCertificationClasses
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetDriversRequest) StartIndex(startIndex int32) ApiGetDriversRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetDriversRequest) Count(count int32) ApiGetDriversRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetDriversRequest) Sort(sort []string) ApiGetDriversRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetDriversRequest) Desc(desc []string) ApiGetDriversRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetDriversRequest) Fields(fields string) ApiGetDriversRequest {
	r.fields = &fields
	return r
}

func (r ApiGetDriversRequest) Execute() (*IPagedResourceListDriverDto, *http.Response, error) {
...
*/
func (a *DriversAPIService) GetDrivers(ctx context.Context) ApiGetDriversRequest {
	return ApiGetDriversRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DriversAPIService) GetDriversExecute(r ApiGetDriversRequest) (*IPagedResourceListDriverDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
