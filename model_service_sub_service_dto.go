...
// checks if the ServiceSubServiceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceSubServiceDto{}

// ServiceSubServiceDto struct for ServiceSubServiceDto
type ServiceSubServiceDto struct {
	SubServiceCode *string `json:"subServiceCode,omitempty"`
	SubServiceLabel *string `json:"subServiceLabel,omitempty"`
	VatCode *string `json:"vatCode,omitempty"`
	DefaultQuantity *float64 `json:"defaultQuantity,omitempty"`
	UnitCode *string `json:"unitCode,omitempty"`
	IsVisibleForOrderer *bool `json:"isVisibleForOrderer,omitempty"`
}

// NewServiceSubServiceDto instantiates a new ServiceSubServiceDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewServiceSubServiceDto() *ServiceSubServiceDto {
	this := ServiceSubServiceDto{}
	return &this
}

// NewServiceSubServiceDtoWithDefaults instantiates a new ServiceSubServiceDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewServiceSubServiceDtoWithDefaults() *ServiceSubServiceDto {
	this := ServiceSubServiceDto{}
	return &this
}

// GetSubServiceCode returns the SubServiceCode field value if set, zero value otherwise.
func (o *ServiceSubServiceDto) GetSubServiceCode() string {
...
func (o *ServiceSubServiceDto) GetSubServiceCodeOk() (*string, bool) {
	if o == nil || IsNil(o.SubServiceCode) {
		return nil, false
	}
...
func (o *ServiceSubServiceDto) HasSubServiceCode() bool {
	if o != nil && !IsNil(o.SubServiceCode) {
		return true
	}
...
func (o *ServiceSubServiceDto) SetSubServiceCode(v string) {
	o.SubServiceCode = &v
}

// GetSubServiceLabel returns the SubServiceLabel field value if set, zero value otherwise.
func (o *ServiceSubServiceDto) GetSubServiceLabel() string {
	if o == nil || IsNil(o.SubServiceLabel) {
		var ret string
		return ret
	}
	return *o.SubServiceLabel
}

// GetSubServiceLabelOk returns a tuple with the SubServiceLabel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceSubServiceDto) GetSubServiceLabelOk() (*string, bool) {
	if o == nil || IsNil(o.SubServiceLabel) {
		return nil, false
	}
	return o.SubServiceLabel, true
}

// HasSubServiceLabel returns a boolean if a field has been set.
func (o *ServiceSubServiceDto) HasSubServiceLabel() bool {
	if o != nil && !IsNil(o.SubServiceLabel) {
		return true
	}
...
// SetSubServiceLabel gets a reference to the given string and assigns it to the SubServiceLabel field.
func (o *ServiceSubServiceDto) SetSubServiceLabel(v string) {
	o.SubServiceLabel = &v
}

// GetVatCode returns the VatCode field value if set, zero value otherwise.
func (o *ServiceSubServiceDto) GetVatCode() string {
...
// and a boolean to check if the value has been set.
func (o *ServiceSubServiceDto) GetVatCodeOk() (*string, bool) {
	if o == nil || IsNil(o.VatCode) {
		return nil, false
	}
...
func (o *ServiceSubServiceDto) HasVatCode() bool {
	if o != nil && !IsNil(o.VatCode) {
		return true
	}
...
func (o *ServiceSubServiceDto) SetVatCode(v string) {
	o.VatCode = &v
}

// GetDefaultQuantity returns the DefaultQuantity field value if set, zero value otherwise.
func (o *ServiceSubServiceDto) GetDefaultQuantity() float64 {
...
// and a boolean to check if the value has been set.
func (o *ServiceSubServiceDto) GetDefaultQuantityOk() (*float64, bool) {
	if o == nil || IsNil(o.DefaultQuantity) {
		return nil, false
	}
...
func (o *ServiceSubServiceDto) HasDefaultQuantity() bool {
	if o != nil && !IsNil(o.DefaultQuantity) {
		return true
	}
...
func (o *ServiceSubServiceDto) SetDefaultQuantity(v float64) {
	o.DefaultQuantity = &v
}

// GetUnitCode returns the UnitCode field value if set, zero value otherwise.
func (o *ServiceSubServiceDto) GetUnitCode() string {
...
// and a boolean to check if the value has been set.
func (o *ServiceSubServiceDto) GetUnitCodeOk() (*string, bool) {
	if o == nil || IsNil(o.UnitCode) {
		return nil, false
	}
...
func (o *ServiceSubServiceDto) HasUnitCode() bool {
	if o != nil && !IsNil(o.UnitCode) {
		return true
	}
...
func (o *ServiceSubServiceDto) SetUnitCode(v string) {
	o.UnitCode = &v
}

// GetIsVisibleForOrderer returns the IsVisibleForOrderer field value if set, zero value otherwise.
func (o *ServiceSubServiceDto) GetIsVisibleForOrderer() bool {
	if o == nil || IsNil(o.IsVisibleForOrderer) {
		var ret bool
		return ret
	}
	return *o.IsVisibleForOrderer
}

// GetIsVisibleForOrdererOk returns a tuple with the IsVisibleForOrderer field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceSubServiceDto) GetIsVisibleForOrdererOk() (*bool, bool) {
	if o == nil || IsNil(o.IsVisibleForOrderer) {
		return nil, false
	}
	return o.IsVisibleForOrderer, true
}

// HasIsVisibleForOrderer returns a boolean if a field has been set.
func (o *ServiceSubServiceDto) HasIsVisibleForOrderer() bool {
	if o != nil && !IsNil(o.IsVisibleForOrderer) {
		return true
	}
...
// SetIsVisibleForOrderer gets a reference to the given bool and assigns it to the IsVisibleForOrderer field.
func (o *ServiceSubServiceDto) SetIsVisibleForOrderer(v bool) {
	o.IsVisibleForOrderer = &v
}

func (o ServiceSubServiceDto) MarshalJSON() ([]byte, error) {
...
func (o ServiceSubServiceDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SubServiceCode) {
		toSerialize["subServiceCode"] = o.SubServiceCode
	}
	if !IsNil(o.SubServiceLabel) {
		toSerialize["subServiceLabel"] = o.SubServiceLabel
	}
	if !IsNil(o.VatCode) {
	...
	if !IsNil(o.IsVisibleForOrderer) {
		toSerialize["isVisibleForOrderer"] = o.IsVisibleForOrderer
	}
	return toSerialize, nil
}

type NullableServiceSubServiceDto struct {
	value *ServiceSubServiceDto
	isSet bool
}

func (v NullableServiceSubServiceDto) Get() *ServiceSubServiceDto {
	return v.value
}

func (v *NullableServiceSubServiceDto) Set(val *ServiceSubServiceDto) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceSubServiceDto) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceSubServiceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceSubServiceDto(val *ServiceSubServiceDto) *NullableServiceSubServiceDto {
	return &NullableServiceSubServiceDto{value: val, isSet: true}
}

func (v NullableServiceSubServiceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceSubServiceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
