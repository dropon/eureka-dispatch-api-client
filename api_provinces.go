...
// ProvincesAPIService ProvincesAPI service
type ProvincesAPIService service

type ApiGetProvinceSubdivisionsRequest struct {
	ctx context.Context
	ApiService *ProvincesAPIService
	uid string
	code *string
	startIndex *int32
	count *int32
...
// Province subdivision code pattern
func (r ApiGetProvinceSubdivisionsRequest) Code(code string) ApiGetProvinceSubdivisionsRequest {
	r.code = &code
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetProvinceSubdivisionsRequest) StartIndex(startIndex int32) ApiGetProvinceSubdivisionsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetProvinceSubdivisionsRequest) Count(count int32) ApiGetProvinceSubdivisionsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetProvinceSubdivisionsRequest) Sort(sort []string) ApiGetProvinceSubdivisionsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetProvinceSubdivisionsRequest) Desc(desc []string) ApiGetProvinceSubdivisionsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetProvinceSubdivisionsRequest) Fields(fields string) ApiGetProvinceSubdivisionsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetProvinceSubdivisionsRequest) Execute() (*IPagedResourceListProvinceSubdivisionDto, *http.Response, error) {
	return r.ApiService.GetProvinceSubdivisionsExecute(r)
}

/*
GetProvinceSubdivisions Get province subdivisions

Get a paginated list of subdivisions corresponding to the specified province

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uid
 @return ApiGetProvinceSubdivisionsRequest
*/
func (a *ProvincesAPIService) GetProvinceSubdivisions(ctx context.Context, uid string) ApiGetProvinceSubdivisionsRequest {
	return ApiGetProvinceSubdivisionsRequest{
		ApiService: a,
		ctx: ctx,
		uid: uid,
...
//  @return IPagedResourceListProvinceSubdivisionDto
func (a *ProvincesAPIService) GetProvinceSubdivisionsExecute(r ApiGetProvinceSubdivisionsRequest) (*IPagedResourceListProvinceSubdivisionDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListProvinceSubdivisionDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvincesAPIService.GetProvinceSubdivisions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/provinces/{uid}/subdivisions"
...
type ApiGetProvincesRequest struct {
	ctx context.Context
	ApiService *ProvincesAPIService
	code *string
	label *string
...
func (r ApiGetProvincesRequest) Code(code string) ApiGetProvincesRequest {
	r.code = &code
	return r
}

// Province label pattern
func (r ApiGetProvincesRequest) Label(label string) ApiGetProvincesRequest {
	r.label = &label
	return r
}

// Exact country code used to return only provinces associated with this country
func (r ApiGetProvincesRequest) CountryCode(countryCode string) ApiGetProvincesRequest {
	r.countryCode = &countryCode
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetProvincesRequest) Pattern(pattern string) ApiGetProvincesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetProvincesRequest) PatternFields(patternFields []string) ApiGetProvincesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetProvincesRequest) StartIndex(startIndex int32) ApiGetProvincesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetProvincesRequest) Count(count int32) ApiGetProvincesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetProvincesRequest) Sort(sort []string) ApiGetProvincesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetProvincesRequest) Desc(desc []string) ApiGetProvincesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetProvincesRequest) Fields(fields string) ApiGetProvincesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetProvincesRequest) Execute() (*IPagedResourceListProvinceDto, *http.Response, error) {
	return r.ApiService.GetProvincesExecute(r)
}

/*
GetProvinces Get provinces

Get a paginated list of provinces corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetProvincesRequest
*/
func (a *ProvincesAPIService) GetProvinces(ctx context.Context) ApiGetProvincesRequest {
	return ApiGetProvincesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListProvinceDto
func (a *ProvincesAPIService) GetProvincesExecute(r ApiGetProvincesRequest) (*IPagedResourceListProvinceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListProvinceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvincesAPIService.GetProvinces")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/provinces"
