...
// checks if the CreateCityCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCityCommand{}

// CreateCityCommand struct for CreateCityCommand
type CreateCityCommand struct {
	// Mandatory.
	Name string `json:"name"`
	PostCode *string `json:"postCode,omitempty"`
	SectorCode *string `json:"sectorCode,omitempty"`
	OperationZoneCode *string `json:"operationZoneCode,omitempty"`
	Geocoding *CreateCityCommandCreateCityGeocodingDto `json:"geocoding,omitempty"`
	// The province is mandatory when the specified country has provinces, and must be null otherwise.    It is also mandatory if the subdivision is specified.
	ProvinceUid *string `json:"provinceUid,omitempty"`
	ProvinceSubdivisionUid *string `json:"provinceSubdivisionUid,omitempty"`
	// Mandatory.
	CountryCode string `json:"countryCode"`
	AgencyCode *string `json:"agencyCode,omitempty"`
	// Indicates whether the entity is available for mission entry.    When not set, the city will be available for mission entry.
	IsAvailableForMissionEntry *bool `json:"isAvailableForMissionEntry,omitempty"`
}

type _CreateCityCommand CreateCityCommand
...
func (o *CreateCityCommand) GetGeocoding() CreateCityCommandCreateCityGeocodingDto {
	if o == nil || IsNil(o.Geocoding) {
		var ret CreateCityCommandCreateCityGeocodingDto
		return ret
	}
	return *o.Geocoding
}
...
// SetGeocoding gets a reference to the given CreateCityCommandCreateCityGeocodingDto and assigns it to the Geocoding field.
func (o *CreateCityCommand) SetGeocoding(v CreateCityCommandCreateCityGeocodingDto) {
	o.Geocoding = &v
}

// GetProvinceUid returns the ProvinceUid field value if set, zero value otherwise.
func (o *CreateCityCommand) GetProvinceUid() string {
	if o == nil || IsNil(o.ProvinceUid) {
		var ret string
		return ret
	}
	return *o.ProvinceUid
}

// GetProvinceUidOk returns a tuple with the ProvinceUid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCityCommand) GetProvinceUidOk() (*string, bool) {
	if o == nil || IsNil(o.ProvinceUid) {
		return nil, false
	}
	return o.ProvinceUid, true
}
...
// SetProvinceUid gets a reference to the given string and assigns it to the ProvinceUid field.
func (o *CreateCityCommand) SetProvinceUid(v string) {
	o.ProvinceUid = &v
}

// GetProvinceSubdivisionUid returns the ProvinceSubdivisionUid field value if set, zero value otherwise.
func (o *CreateCityCommand) GetProvinceSubdivisionUid() string {
	if o == nil || IsNil(o.ProvinceSubdivisionUid) {
		var ret string
		return ret
	}
	return *o.ProvinceSubdivisionUid
}

// GetProvinceSubdivisionUidOk returns a tuple with the ProvinceSubdivisionUid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCityCommand) GetProvinceSubdivisionUidOk() (*string, bool) {
	if o == nil || IsNil(o.ProvinceSubdivisionUid) {
		return nil, false
	}
	return o.ProvinceSubdivisionUid, true
}
...
// SetProvinceSubdivisionUid gets a reference to the given string and assigns it to the ProvinceSubdivisionUid field.
func (o *CreateCityCommand) SetProvinceSubdivisionUid(v string) {
	o.ProvinceSubdivisionUid = &v
}
...
// GetIsAvailableForMissionEntry returns the IsAvailableForMissionEntry field value if set, zero value otherwise.
func (o *CreateCityCommand) GetIsAvailableForMissionEntry() bool {
	if o == nil || IsNil(o.IsAvailableForMissionEntry) {
		var ret bool
		return ret
	}
	return *o.IsAvailableForMissionEntry
}

// GetIsAvailableForMissionEntryOk returns a tuple with the IsAvailableForMissionEntry field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCityCommand) GetIsAvailableForMissionEntryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsAvailableForMissionEntry) {
		return nil, false
	}
	return o.IsAvailableForMissionEntry, true
}
...
// SetIsAvailableForMissionEntry gets a reference to the given bool and assigns it to the IsAvailableForMissionEntry field.
func (o *CreateCityCommand) SetIsAvailableForMissionEntry(v bool) {
	o.IsAvailableForMissionEntry = &v
}

func (o CreateCityCommand) MarshalJSON() ([]byte, error) {
...
func (o CreateCityCommand) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProvinceUid) {
		toSerialize["provinceUid"] = o.ProvinceUid
	}
	if !IsNil(o.ProvinceSubdivisionUid) {
		toSerialize["provinceSubdivisionUid"] = o.ProvinceSubdivisionUid
	}
	toSerialize["countryCode"] = o.CountryCode
	if !IsNil(o.AgencyCode) {
		toSerialize["agencyCode"] = o.AgencyCode
	}
	if !IsNil(o.IsAvailableForMissionEntry) {
		toSerialize["isAvailableForMissionEntry"] = o.IsAvailableForMissionEntry
	}
	return toSerialize, nil
}

func (o *CreateCityCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCityCommand := _CreateCityCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCityCommand)

	if err != nil {
		return err
	}

	*o = CreateCityCommand(varCreateCityCommand)

	return err
}

type NullableCreateCityCommand struct {
	value *CreateCityCommand
	isSet bool
}

func (v NullableCreateCityCommand) Get() *CreateCityCommand {
	return v.value
}

func (v *NullableCreateCityCommand) Set(val *CreateCityCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCityCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCityCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCityCommand(val *CreateCityCommand) *NullableCreateCityCommand {
	return &NullableCreateCityCommand{value: val, isSet: true}
}

func (v NullableCreateCityCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCityCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
