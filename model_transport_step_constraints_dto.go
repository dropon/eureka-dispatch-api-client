...
// checks if the TransportStepConstraintsDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportStepConstraintsDto{}

// TransportStepConstraintsDto struct for TransportStepConstraintsDto
type TransportStepConstraintsDto struct {
...
// NewTransportStepConstraintsDto instantiates a new TransportStepConstraintsDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTransportStepConstraintsDto() *TransportStepConstraintsDto {
	this := TransportStepConstraintsDto{}
	return &this
}

// NewTransportStepConstraintsDtoWithDefaults instantiates a new TransportStepConstraintsDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTransportStepConstraintsDtoWithDefaults() *TransportStepConstraintsDto {
	this := TransportStepConstraintsDto{}
	return &this
}

// GetIsHeightRestrictedAccess returns the IsHeightRestrictedAccess field value if set, zero value otherwise.
func (o *TransportStepConstraintsDto) GetIsHeightRestrictedAccess() bool {
...
func (o *TransportStepConstraintsDto) GetIsHeightRestrictedAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.IsHeightRestrictedAccess) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasIsHeightRestrictedAccess() bool {
	if o != nil && !IsNil(o.IsHeightRestrictedAccess) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetIsHeightRestrictedAccess(v bool) {
	o.IsHeightRestrictedAccess = &v
}

// GetHeightLimitation returns the HeightLimitation field value if set, zero value otherwise.
func (o *TransportStepConstraintsDto) GetHeightLimitation() int32 {
...
// and a boolean to check if the value has been set.
func (o *TransportStepConstraintsDto) GetHeightLimitationOk() (*int32, bool) {
	if o == nil || IsNil(o.HeightLimitation) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasHeightLimitation() bool {
	if o != nil && !IsNil(o.HeightLimitation) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetHeightLimitation(v int32) {
	o.HeightLimitation = &v
}

// GetIsHatchBackMandatory returns the IsHatchBackMandatory field value if set, zero value otherwise.
func (o *TransportStepConstraintsDto) GetIsHatchBackMandatory() bool {
...
// and a boolean to check if the value has been set.
func (o *TransportStepConstraintsDto) GetIsHatchBackMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsHatchBackMandatory) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasIsHatchBackMandatory() bool {
	if o != nil && !IsNil(o.IsHatchBackMandatory) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetIsHatchBackMandatory(v bool) {
...
func (o *TransportStepConstraintsDto) GetIsWarehousemanMandatory() bool {
...
// and a boolean to check if the value has been set.
func (o *TransportStepConstraintsDto) GetIsWarehousemanMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsWarehousemanMandatory) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasIsWarehousemanMandatory() bool {
	if o != nil && !IsNil(o.IsWarehousemanMandatory) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetIsWarehousemanMandatory(v bool) {
...
func (o *TransportStepConstraintsDto) GetIsHandlingEquipmentMandatory() bool {
...
// and a boolean to check if the value has been set.
func (o *TransportStepConstraintsDto) GetIsHandlingEquipmentMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsHandlingEquipmentMandatory) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasIsHandlingEquipmentMandatory() bool {
	if o != nil && !IsNil(o.IsHandlingEquipmentMandatory) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetIsHandlingEquipmentMandatory(v bool) {
...
func (o *TransportStepConstraintsDto) GetIsSecuritySuitcaseMandatory() bool {
...
// and a boolean to check if the value has been set.
func (o *TransportStepConstraintsDto) GetIsSecuritySuitcaseMandatoryOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSecuritySuitcaseMandatory) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasIsSecuritySuitcaseMandatory() bool {
	if o != nil && !IsNil(o.IsSecuritySuitcaseMandatory) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetIsSecuritySuitcaseMandatory(v bool) {
	o.IsSecuritySuitcaseMandatory = &v
}

// GetIsSideUnloading returns the IsSideUnloading field value if set, zero value otherwise.
func (o *TransportStepConstraintsDto) GetIsSideUnloading() bool {
...
// and a boolean to check if the value has been set.
func (o *TransportStepConstraintsDto) GetIsSideUnloadingOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSideUnloading) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasIsSideUnloading() bool {
	if o != nil && !IsNil(o.IsSideUnloading) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetIsSideUnloading(v bool) {
	o.IsSideUnloading = &v
}

// GetIsCraneUnloading returns the IsCraneUnloading field value if set, zero value otherwise.
func (o *TransportStepConstraintsDto) GetIsCraneUnloading() bool {
...
// and a boolean to check if the value has been set.
func (o *TransportStepConstraintsDto) GetIsCraneUnloadingOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCraneUnloading) {
		return nil, false
	}
...
func (o *TransportStepConstraintsDto) HasIsCraneUnloading() bool {
	if o != nil && !IsNil(o.IsCraneUnloading) {
		return true
	}
...
func (o *TransportStepConstraintsDto) SetIsCraneUnloading(v bool) {
	o.IsCraneUnloading = &v
}

func (o TransportStepConstraintsDto) MarshalJSON() ([]byte, error) {
...
func (o TransportStepConstraintsDto) ToMap() (map[string]interface{}, error) {
...
type NullableTransportStepConstraintsDto struct {
	value *TransportStepConstraintsDto
	isSet bool
}

func (v NullableTransportStepConstraintsDto) Get() *TransportStepConstraintsDto {
	return v.value
}

func (v *NullableTransportStepConstraintsDto) Set(val *TransportStepConstraintsDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportStepConstraintsDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportStepConstraintsDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportStepConstraintsDto(val *TransportStepConstraintsDto) *NullableTransportStepConstraintsDto {
	return &NullableTransportStepConstraintsDto{value: val, isSet: true}
}

func (v NullableTransportStepConstraintsDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportStepConstraintsDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
