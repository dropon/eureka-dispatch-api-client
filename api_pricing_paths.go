...
type ApiGetPricingPathAdditionalUnitsRequest struct {
	ctx context.Context
...
// Sub service code
func (r ApiGetPricingPathAdditionalUnitsRequest) SubServiceCode(subServiceCode string) ApiGetPricingPathAdditionalUnitsRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetPricingPathAdditionalUnitsRequest) StartIndex(startIndex int32) ApiGetPricingPathAdditionalUnitsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPricingPathAdditionalUnitsRequest) Count(count int32) ApiGetPricingPathAdditionalUnitsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPricingPathAdditionalUnitsRequest) Sort(sort []string) ApiGetPricingPathAdditionalUnitsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPricingPathAdditionalUnitsRequest) Desc(desc []string) ApiGetPricingPathAdditionalUnitsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPricingPathAdditionalUnitsRequest) Fields(fields string) ApiGetPricingPathAdditionalUnitsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPricingPathAdditionalUnitsRequest) Execute() (*IPagedResourceListPricingPathSubServiceAdditionalUnitDto, *http.Response, error) {
...
Get a paginated list of pricing paths additional units corresponding to the specified filters
 ...
 @return ApiGetPricingPathAdditionalUnitsRequest
*/
func (a *PricingPathsAPIService) GetPricingPathAdditionalUnits(ctx context.Context, pricingPathId int32) ApiGetPricingPathAdditionalUnitsRequest {
	return ApiGetPricingPathAdditionalUnitsRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *PricingPathsAPIService) GetPricingPathAdditionalUnitsExecute(r ApiGetPricingPathAdditionalUnitsRequest) (*IPagedResourceListPricingPathSubServiceAdditionalUnitDto, *http.Response, error) {
	var (
...
type ApiGetPricingPathByIdRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	fields *string
...
// Projection fields separated with a comma
func (r ApiGetPricingPathByIdRequest) Fields(fields string) ApiGetPricingPathByIdRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPricingPathByIdRequest) Execute() (*PricingPathDto, *http.Response, error) {
...
GetPricingPathById Get pricing path by id
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId
 @return ApiGetPricingPathByIdRequest
*/
func (a *PricingPathsAPIService) GetPricingPathById(ctx context.Context, pricingPathId int32) ApiGetPricingPathByIdRequest {
	return ApiGetPricingPathByIdRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
func (a *PricingPathsAPIService) GetPricingPathByIdExecute(r ApiGetPricingPathByIdRequest) (*PricingPathDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetPricingPathSubServiceUnitPricingSlotsRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	subServiceCode *string
...
// Sub service code
func (r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) SubServiceCode(subServiceCode string) ApiGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) StartIndex(startIndex int32) ApiGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) Count(count int32) ApiGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) Sort(sort []string) ApiGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) Desc(desc []string) ApiGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) Fields(fields string) ApiGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) Execute() (*IPagedResourceListPricingPathSubServiceUnitPricingSlotDto, *http.Response, error) {
...
Get a paginated list of pricing paths sub service unit pricing slots corresponding to the specified filters
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId Identifier of the pricing path
 @return ApiGetPricingPathSubServiceUnitPricingSlotsRequest
*/
func (a *PricingPathsAPIService) GetPricingPathSubServiceUnitPricingSlots(ctx context.Context, pricingPathId int32) ApiGetPricingPathSubServiceUnitPricingSlotsRequest {
	return ApiGetPricingPathSubServiceUnitPricingSlotsRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
func (a *PricingPathsAPIService) GetPricingPathSubServiceUnitPricingSlotsExecute(r ApiGetPricingPathSubServiceUnitPricingSlotsRequest) (*IPagedResourceListPricingPathSubServiceUnitPricingSlotDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetPricingPathSubServicesRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r ApiGetPricingPathSubServicesRequest) StartIndex(startIndex int32) ApiGetPricingPathSubServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPricingPathSubServicesRequest) Count(count int32) ApiGetPricingPathSubServicesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPricingPathSubServicesRequest) Sort(sort []string) ApiGetPricingPathSubServicesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPricingPathSubServicesRequest) Desc(desc []string) ApiGetPricingPathSubServicesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPricingPathSubServicesRequest) Fields(fields string) ApiGetPricingPathSubServicesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPricingPathSubServicesRequest) Execute() (*IPagedResourceListPricingPathSubServiceDto, *http.Response, error) {
...
Get a paginated list of pricing paths sub services
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId Identifier of the pricing path
 @return ApiGetPricingPathSubServicesRequest
*/
func (a *PricingPathsAPIService) GetPricingPathSubServices(ctx context.Context, pricingPathId int32) ApiGetPricingPathSubServicesRequest {
	return ApiGetPricingPathSubServicesRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
func (a *PricingPathsAPIService) GetPricingPathSubServicesExecute(r ApiGetPricingPathSubServicesRequest) (*IPagedResourceListPricingPathSubServiceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetPricingPathUnitPricingSlotEquivalencesRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	subServiceCode *string
...
// Sub service code
func (r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) SubServiceCode(subServiceCode string) ApiGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) StartIndex(startIndex int32) ApiGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) Count(count int32) ApiGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) Sort(sort []string) ApiGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) Desc(desc []string) ApiGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) Fields(fields string) ApiGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) Execute() (*IPagedResourceListPricingPathUnitPricingSlotEquivalenceDto, *http.Response, error) {
...
Get a paginated list of pricing paths unit pricing slot equivalences corresponding to the specified filters
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId Identifier of the pricing path
 @return ApiGetPricingPathUnitPricingSlotEquivalencesRequest
*/
func (a *PricingPathsAPIService) GetPricingPathUnitPricingSlotEquivalences(ctx context.Context, pricingPathId int32) ApiGetPricingPathUnitPricingSlotEquivalencesRequest {
	return ApiGetPricingPathUnitPricingSlotEquivalencesRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
func (a *PricingPathsAPIService) GetPricingPathUnitPricingSlotEquivalencesExecute(r ApiGetPricingPathUnitPricingSlotEquivalencesRequest) (*IPagedResourceListPricingPathUnitPricingSlotEquivalenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetPricingPathsRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
...
func (r ApiGetPricingPathsRequest) PriceCatalogCode(priceCatalogCode string) ApiGetPricingPathsRequest {
	r.priceCatalogCode = &priceCatalogCode
	return r
}

// Service code pattern
func (r ApiGetPricingPathsRequest) ServiceCode(serviceCode string) ApiGetPricingPathsRequest {
	r.serviceCode = &serviceCode
	return r
}

// Customer code pattern
func (r ApiGetPricingPathsRequest) CustomerCode(customerCode string) ApiGetPricingPathsRequest {
	r.customerCode = &customerCode
	return r
}

// Sub contractor code pattern
func (r ApiGetPricingPathsRequest) SubcontractorCode(subcontractorCode string) ApiGetPricingPathsRequest {
	r.subcontractorCode = &subcontractorCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetPricingPathsRequest) StartIndex(startIndex int32) ApiGetPricingPathsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetPricingPathsRequest) Count(count int32) ApiGetPricingPathsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetPricingPathsRequest) Sort(sort []string) ApiGetPricingPathsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetPricingPathsRequest) Desc(desc []string) ApiGetPricingPathsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetPricingPathsRequest) Fields(fields string) ApiGetPricingPathsRequest {
	r.fields = &fields
	return r
}

func (r ApiGetPricingPathsRequest) Execute() (*IPagedResourceListPricingPathDto, *http.Response, error) {
...
Get a paginated list of pricing paths corresponding to the specified filters
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPricingPathsRequest
*/
func (a *PricingPathsAPIService) GetPricingPaths(ctx context.Context) ApiGetPricingPathsRequest {
	return ApiGetPricingPathsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PricingPathsAPIService) GetPricingPathsExecute(r ApiGetPricingPathsRequest) (*IPagedResourceListPricingPathDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
