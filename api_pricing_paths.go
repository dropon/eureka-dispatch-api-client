...
// PricingPathsAPIService PricingPathsAPI service
type PricingPathsAPIService service

type PricingPathsAPIGetPricingPathAdditionalUnitsRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
...
// Sub service code
func (r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) SubServiceCode(subServiceCode string) PricingPathsAPIGetPricingPathAdditionalUnitsRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) StartIndex(startIndex int32) PricingPathsAPIGetPricingPathAdditionalUnitsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) Count(count int32) PricingPathsAPIGetPricingPathAdditionalUnitsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) Sort(sort []string) PricingPathsAPIGetPricingPathAdditionalUnitsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) Desc(desc []string) PricingPathsAPIGetPricingPathAdditionalUnitsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) Fields(fields string) PricingPathsAPIGetPricingPathAdditionalUnitsRequest {
	r.fields = &fields
	return r
}

func (r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) Execute() (*IPagedResourceListPricingPathSubServiceAdditionalUnitDto, *http.Response, error) {
	return r.ApiService.GetPricingPathAdditionalUnitsExecute(r)
}

/*
GetPricingPathAdditionalUnits Get pricing path additional units

Get a paginated list of pricing paths additional units corresponding to the specified filters

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId Identifier of the pricing path
 @return PricingPathsAPIGetPricingPathAdditionalUnitsRequest
*/
func (a *PricingPathsAPIService) GetPricingPathAdditionalUnits(ctx context.Context, pricingPathId int32) PricingPathsAPIGetPricingPathAdditionalUnitsRequest {
	return PricingPathsAPIGetPricingPathAdditionalUnitsRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
	}
}

// Execute executes the request
//  @return IPagedResourceListPricingPathSubServiceAdditionalUnitDto
func (a *PricingPathsAPIService) GetPricingPathAdditionalUnitsExecute(r PricingPathsAPIGetPricingPathAdditionalUnitsRequest) (*IPagedResourceListPricingPathSubServiceAdditionalUnitDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPricingPathSubServiceAdditionalUnitDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricingPathsAPIService.GetPricingPathAdditionalUnits")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/pricing-paths/{pricingPathId}/sub-service-additional-units"
	localVarPath = strings.Replace(localVarPath, "{"+"pricingPathId"+"}", url.PathEscape(parameterValueToString(r.pricingPathId, "pricingPathId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if r.subServiceCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "subServiceCode", r.subServiceCode, "", "")
	}
	if r.startIndex != nil {
...
type PricingPathsAPIGetPricingPathByIdRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	fields *string
...
// Projection fields separated with a comma
func (r PricingPathsAPIGetPricingPathByIdRequest) Fields(fields string) PricingPathsAPIGetPricingPathByIdRequest {
	r.fields = &fields
	return r
}

func (r PricingPathsAPIGetPricingPathByIdRequest) Execute() (*PricingPathDto, *http.Response, error) {
	return r.ApiService.GetPricingPathByIdExecute(r)
}

/*
GetPricingPathById Get pricing path by id

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId
 @return PricingPathsAPIGetPricingPathByIdRequest
*/
func (a *PricingPathsAPIService) GetPricingPathById(ctx context.Context, pricingPathId int32) PricingPathsAPIGetPricingPathByIdRequest {
	return PricingPathsAPIGetPricingPathByIdRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
// Execute executes the request
//  @return PricingPathDto
func (a *PricingPathsAPIService) GetPricingPathByIdExecute(r PricingPathsAPIGetPricingPathByIdRequest) (*PricingPathDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PricingPathDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricingPathsAPIService.GetPricingPathById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/pricing-paths/{pricingPathId}"
	localVarPath = strings.Replace(localVarPath, "{"+"pricingPathId"+"}", url.PathEscape(parameterValueToString(r.pricingPathId, "pricingPathId")), -1)
...
type PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	subServiceCode *string
...
// Sub service code
func (r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) SubServiceCode(subServiceCode string) PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) StartIndex(startIndex int32) PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) Count(count int32) PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) Sort(sort []string) PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) Desc(desc []string) PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) Fields(fields string) PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest {
	r.fields = &fields
	return r
}

func (r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) Execute() (*IPagedResourceListPricingPathSubServiceUnitPricingSlotDto, *http.Response, error) {
	return r.ApiService.GetPricingPathSubServiceUnitPricingSlotsExecute(r)
}

/*
GetPricingPathSubServiceUnitPricingSlots Get pricing path sub service unit pricing slots

Get a paginated list of pricing paths sub service unit pricing slots corresponding to the specified filters

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId Identifier of the pricing path
 @return PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest
*/
func (a *PricingPathsAPIService) GetPricingPathSubServiceUnitPricingSlots(ctx context.Context, pricingPathId int32) PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest {
	return PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
// Execute executes the request
//  @return IPagedResourceListPricingPathSubServiceUnitPricingSlotDto
func (a *PricingPathsAPIService) GetPricingPathSubServiceUnitPricingSlotsExecute(r PricingPathsAPIGetPricingPathSubServiceUnitPricingSlotsRequest) (*IPagedResourceListPricingPathSubServiceUnitPricingSlotDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPricingPathSubServiceUnitPricingSlotDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricingPathsAPIService.GetPricingPathSubServiceUnitPricingSlots")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/pricing-paths/{pricingPathId}/sub-service-unit-pricing-slots"
	localVarPath = strings.Replace(localVarPath, "{"+"pricingPathId"+"}", url.PathEscape(parameterValueToString(r.pricingPathId, "pricingPathId")), -1)
...
type PricingPathsAPIGetPricingPathSubServicesRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	startIndex *int32
...
// Pagination start index (offset). Default is 0.
func (r PricingPathsAPIGetPricingPathSubServicesRequest) StartIndex(startIndex int32) PricingPathsAPIGetPricingPathSubServicesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PricingPathsAPIGetPricingPathSubServicesRequest) Count(count int32) PricingPathsAPIGetPricingPathSubServicesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PricingPathsAPIGetPricingPathSubServicesRequest) Sort(sort []string) PricingPathsAPIGetPricingPathSubServicesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PricingPathsAPIGetPricingPathSubServicesRequest) Desc(desc []string) PricingPathsAPIGetPricingPathSubServicesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PricingPathsAPIGetPricingPathSubServicesRequest) Fields(fields string) PricingPathsAPIGetPricingPathSubServicesRequest {
	r.fields = &fields
	return r
}

func (r PricingPathsAPIGetPricingPathSubServicesRequest) Execute() (*IPagedResourceListPricingPathSubServiceDto, *http.Response, error) {
	return r.ApiService.GetPricingPathSubServicesExecute(r)
}

/*
GetPricingPathSubServices Get pricing path sub services

Get a paginated list of pricing paths sub services

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId Identifier of the pricing path
 @return PricingPathsAPIGetPricingPathSubServicesRequest
*/
func (a *PricingPathsAPIService) GetPricingPathSubServices(ctx context.Context, pricingPathId int32) PricingPathsAPIGetPricingPathSubServicesRequest {
	return PricingPathsAPIGetPricingPathSubServicesRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
// Execute executes the request
//  @return IPagedResourceListPricingPathSubServiceDto
func (a *PricingPathsAPIService) GetPricingPathSubServicesExecute(r PricingPathsAPIGetPricingPathSubServicesRequest) (*IPagedResourceListPricingPathSubServiceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPricingPathSubServiceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricingPathsAPIService.GetPricingPathSubServices")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/pricing-paths/{pricingPathId}/sub-services"
	localVarPath = strings.Replace(localVarPath, "{"+"pricingPathId"+"}", url.PathEscape(parameterValueToString(r.pricingPathId, "pricingPathId")), -1)
...
type PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	pricingPathId int32
	subServiceCode *string
...
// Sub service code
func (r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) SubServiceCode(subServiceCode string) PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.subServiceCode = &subServiceCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) StartIndex(startIndex int32) PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) Count(count int32) PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) Sort(sort []string) PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) Desc(desc []string) PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) Fields(fields string) PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest {
	r.fields = &fields
	return r
}

func (r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) Execute() (*IPagedResourceListPricingPathUnitPricingSlotEquivalenceDto, *http.Response, error) {
	return r.ApiService.GetPricingPathUnitPricingSlotEquivalencesExecute(r)
}

/*
GetPricingPathUnitPricingSlotEquivalences Get pricing path unit pricing slot equivalences

Get a paginated list of pricing paths unit pricing slot equivalences corresponding to the specified filters

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pricingPathId Identifier of the pricing path
 @return PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest
*/
func (a *PricingPathsAPIService) GetPricingPathUnitPricingSlotEquivalences(ctx context.Context, pricingPathId int32) PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest {
	return PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest{
		ApiService: a,
		ctx: ctx,
		pricingPathId: pricingPathId,
...
// Execute executes the request
//  @return IPagedResourceListPricingPathUnitPricingSlotEquivalenceDto
func (a *PricingPathsAPIService) GetPricingPathUnitPricingSlotEquivalencesExecute(r PricingPathsAPIGetPricingPathUnitPricingSlotEquivalencesRequest) (*IPagedResourceListPricingPathUnitPricingSlotEquivalenceDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPricingPathUnitPricingSlotEquivalenceDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricingPathsAPIService.GetPricingPathUnitPricingSlotEquivalences")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/pricing-paths/{pricingPathId}/unit-pricing-slot-equivalences"
	localVarPath = strings.Replace(localVarPath, "{"+"pricingPathId"+"}", url.PathEscape(parameterValueToString(r.pricingPathId, "pricingPathId")), -1)
...
type PricingPathsAPIGetPricingPathsRequest struct {
	ctx context.Context
	ApiService *PricingPathsAPIService
	priceCatalogCode *string
	serviceCode *string
	customerCode *string
...
// Prices catalog code pattern
func (r PricingPathsAPIGetPricingPathsRequest) PriceCatalogCode(priceCatalogCode string) PricingPathsAPIGetPricingPathsRequest {
	r.priceCatalogCode = &priceCatalogCode
	return r
}

// Service code pattern
func (r PricingPathsAPIGetPricingPathsRequest) ServiceCode(serviceCode string) PricingPathsAPIGetPricingPathsRequest {
	r.serviceCode = &serviceCode
	return r
}

// Customer code pattern
func (r PricingPathsAPIGetPricingPathsRequest) CustomerCode(customerCode string) PricingPathsAPIGetPricingPathsRequest {
	r.customerCode = &customerCode
	return r
}

// Sub contractor code pattern
func (r PricingPathsAPIGetPricingPathsRequest) SubcontractorCode(subcontractorCode string) PricingPathsAPIGetPricingPathsRequest {
	r.subcontractorCode = &subcontractorCode
	return r
}

// Pagination start index (offset). Default is 0.
func (r PricingPathsAPIGetPricingPathsRequest) StartIndex(startIndex int32) PricingPathsAPIGetPricingPathsRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r PricingPathsAPIGetPricingPathsRequest) Count(count int32) PricingPathsAPIGetPricingPathsRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r PricingPathsAPIGetPricingPathsRequest) Sort(sort []string) PricingPathsAPIGetPricingPathsRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r PricingPathsAPIGetPricingPathsRequest) Desc(desc []string) PricingPathsAPIGetPricingPathsRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r PricingPathsAPIGetPricingPathsRequest) Fields(fields string) PricingPathsAPIGetPricingPathsRequest {
	r.fields = &fields
	return r
}

func (r PricingPathsAPIGetPricingPathsRequest) Execute() (*IPagedResourceListPricingPathDto, *http.Response, error) {
	return r.ApiService.GetPricingPathsExecute(r)
}

/*
GetPricingPaths Get pricing paths

Get a paginated list of pricing paths corresponding to the specified filters

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PricingPathsAPIGetPricingPathsRequest
*/
func (a *PricingPathsAPIService) GetPricingPaths(ctx context.Context) PricingPathsAPIGetPricingPathsRequest {
	return PricingPathsAPIGetPricingPathsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListPricingPathDto
func (a *PricingPathsAPIService) GetPricingPathsExecute(r PricingPathsAPIGetPricingPathsRequest) (*IPagedResourceListPricingPathDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListPricingPathDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricingPathsAPIService.GetPricingPaths")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/pricing-paths"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if r.priceCatalogCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "priceCatalogCode", r.priceCatalogCode, "", "")
	}
	if r.serviceCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "serviceCode", r.serviceCode, "", "")
	}
	if r.customerCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "customerCode", r.customerCode, "", "")
	}
	if r.subcontractorCode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "subcontractorCode", r.subcontractorCode, "", "")
	}
	if r.startIndex != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "startIndex", r.startIndex, "", "")
	}
