...
// checks if the ReportPaperOptionsDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportPaperOptionsDto{}

// ReportPaperOptionsDto Paper options for report generation.  Paper options are not taken into account for ZPL sticker generation ; the report must be already customized to match specific characteristics.
type ReportPaperOptionsDto struct {
	// Optional paper size type.  Please note that some sizes may not be supported for the requested report.
	SizeType *string `json:"sizeType,omitempty"`
	Orientation *string `json:"orientation,omitempty"`
	BottomMargin *int32 `json:"bottomMargin,omitempty"`
	LeftMargin *int32 `json:"leftMargin,omitempty"`
	TopMargin *int32 `json:"topMargin,omitempty"`
	RightMargin *int32 `json:"rightMargin,omitempty"`
}

// NewReportPaperOptionsDto instantiates a new ReportPaperOptionsDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReportPaperOptionsDto() *ReportPaperOptionsDto {
	this := ReportPaperOptionsDto{}
	return &this
}

// NewReportPaperOptionsDtoWithDefaults instantiates a new ReportPaperOptionsDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewReportPaperOptionsDtoWithDefaults() *ReportPaperOptionsDto {
	this := ReportPaperOptionsDto{}
	return &this
}

// GetSizeType returns the SizeType field value if set, zero value otherwise.
func (o *ReportPaperOptionsDto) GetSizeType() string {
...
func (o *ReportPaperOptionsDto) GetSizeTypeOk() (*string, bool) {
	if o == nil || IsNil(o.SizeType) {
		return nil, false
	}
...
func (o *ReportPaperOptionsDto) HasSizeType() bool {
	if o != nil && !IsNil(o.SizeType) {
		return true
	}
...
func (o *ReportPaperOptionsDto) SetSizeType(v string) {
	o.SizeType = &v
}

// GetOrientation returns the Orientation field value if set, zero value otherwise.
func (o *ReportPaperOptionsDto) GetOrientation() string {
...
// and a boolean to check if the value has been set.
func (o *ReportPaperOptionsDto) GetOrientationOk() (*string, bool) {
	if o == nil || IsNil(o.Orientation) {
		return nil, false
	}
...
func (o *ReportPaperOptionsDto) HasOrientation() bool {
	if o != nil && !IsNil(o.Orientation) {
		return true
	}
...
func (o *ReportPaperOptionsDto) SetOrientation(v string) {
	o.Orientation = &v
}

// GetBottomMargin returns the BottomMargin field value if set, zero value otherwise.
func (o *ReportPaperOptionsDto) GetBottomMargin() int32 {
	if o == nil || IsNil(o.BottomMargin) {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ReportPaperOptionsDto) GetBottomMarginOk() (*int32, bool) {
	if o == nil || IsNil(o.BottomMargin) {
		return nil, false
	}
...
func (o *ReportPaperOptionsDto) HasBottomMargin() bool {
	if o != nil && !IsNil(o.BottomMargin) {
		return true
	}
...
// SetBottomMargin gets a reference to the given int32 and assigns it to the BottomMargin field.
func (o *ReportPaperOptionsDto) SetBottomMargin(v int32) {
	o.BottomMargin = &v
}

// GetLeftMargin returns the LeftMargin field value if set, zero value otherwise.
func (o *ReportPaperOptionsDto) GetLeftMargin() int32 {
	if o == nil || IsNil(o.LeftMargin) {
		var ret int32
		return ret
	}
	return *o.LeftMargin
...
// and a boolean to check if the value has been set.
func (o *ReportPaperOptionsDto) GetLeftMarginOk() (*int32, bool) {
	if o == nil || IsNil(o.LeftMargin) {
		return nil, false
	}
...
func (o *ReportPaperOptionsDto) HasLeftMargin() bool {
	if o != nil && !IsNil(o.LeftMargin) {
		return true
	}
...
// SetLeftMargin gets a reference to the given int32 and assigns it to the LeftMargin field.
func (o *ReportPaperOptionsDto) SetLeftMargin(v int32) {
	o.LeftMargin = &v
}

// GetTopMargin returns the TopMargin field value if set, zero value otherwise.
func (o *ReportPaperOptionsDto) GetTopMargin() int32 {
	if o == nil || IsNil(o.TopMargin) {
		var ret int32
		return ret
	}
	return *o.TopMargin
...
// and a boolean to check if the value has been set.
func (o *ReportPaperOptionsDto) GetTopMarginOk() (*int32, bool) {
	if o == nil || IsNil(o.TopMargin) {
		return nil, false
	}
...
func (o *ReportPaperOptionsDto) HasTopMargin() bool {
	if o != nil && !IsNil(o.TopMargin) {
		return true
	}
...
// SetTopMargin gets a reference to the given int32 and assigns it to the TopMargin field.
func (o *ReportPaperOptionsDto) SetTopMargin(v int32) {
	o.TopMargin = &v
}

// GetRightMargin returns the RightMargin field value if set, zero value otherwise.
func (o *ReportPaperOptionsDto) GetRightMargin() int32 {
	if o == nil || IsNil(o.RightMargin) {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ReportPaperOptionsDto) GetRightMarginOk() (*int32, bool) {
	if o == nil || IsNil(o.RightMargin) {
		return nil, false
	}
...
func (o *ReportPaperOptionsDto) HasRightMargin() bool {
	if o != nil && !IsNil(o.RightMargin) {
		return true
	}
...
// SetRightMargin gets a reference to the given int32 and assigns it to the RightMargin field.
func (o *ReportPaperOptionsDto) SetRightMargin(v int32) {
	o.RightMargin = &v
}

func (o ReportPaperOptionsDto) MarshalJSON() ([]byte, error) {
...
func (o ReportPaperOptionsDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BottomMargin) {
		toSerialize["bottomMargin"] = o.BottomMargin
	}
	if !IsNil(o.LeftMargin) {
		toSerialize["leftMargin"] = o.LeftMargin
	}
	if !IsNil(o.TopMargin) {
		toSerialize["topMargin"] = o.TopMargin
	}
	if !IsNil(o.RightMargin) {
		toSerialize["rightMargin"] = o.RightMargin
	}
	return toSerialize, nil
}

type NullableReportPaperOptionsDto struct {
	value *ReportPaperOptionsDto
	isSet bool
}

func (v NullableReportPaperOptionsDto) Get() *ReportPaperOptionsDto {
	return v.value
}

func (v *NullableReportPaperOptionsDto) Set(val *ReportPaperOptionsDto) {
	v.value = val
	v.isSet = true
}

func (v NullableReportPaperOptionsDto) IsSet() bool {
	return v.isSet
}

func (v *NullableReportPaperOptionsDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportPaperOptionsDto(val *ReportPaperOptionsDto) *NullableReportPaperOptionsDto {
	return &NullableReportPaperOptionsDto{value: val, isSet: true}
}

func (v NullableReportPaperOptionsDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportPaperOptionsDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
