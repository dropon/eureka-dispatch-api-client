...
var _ MappedNullable = &DriverDto{}

// DriverDto struct for DriverDto
type DriverDto struct {
	...
	IsDispatchMobileEnabled *bool `json:"isDispatchMobileEnabled,omitempty"`
	...
	CurrentVehicleCode *string `json:"currentVehicleCode,omitempty"`
	DefaultVehicleCode *string `json:"defaultVehicleCode,omitempty"`
	DrivingLicenceType *string `json:"drivingLicenceType,omitempty"`
	HasDangerousGoodsCertification *bool `json:"hasDangerousGoodsCertification,omitempty"`
	GlobalMark *int32 `json:"globalMark,omitempty"`
	Included *DriverIncludedDto `json:"included,omitempty"`
...
// GetTeamLabel returns the TeamLabel field value if set, zero value otherwise.
func (o *DriverDto) GetTeamLabel() string {
	if o == nil || IsNil(o.TeamLabel) {
		var ret string
		return ret
	}
	return *o.TeamLabel
...
// GetTeamLabelOk returns a tuple with the TeamLabel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetTeamLabelOk() (*string, bool) {
	if o == nil || IsNil(o.TeamLabel) {
		return nil, false
	}
	return o.TeamLabel, true
}
...
// SetTeamLabel gets a reference to the given string and assigns it to the TeamLabel field.
func (o *DriverDto) SetTeamLabel(v string) {
	o.TeamLabel = &v
}

// GetProfileCode returns the ProfileCode field value if set, zero value otherwise.
func (o *DriverDto) GetProfileCode() string {
	if o == nil || IsNil(o.ProfileCode) {
		var ret string
		return ret
	}
	return *o.ProfileCode
}

// GetProfileCodeOk returns a tuple with the ProfileCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetProfileCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ProfileCode) {
		return nil, false
	}
	return o.ProfileCode, true
}
...
// SetProfileCode gets a reference to the given string and assigns it to the ProfileCode field.
...
// GetIsDispatchMobileEnabled returns the IsDispatchMobileEnabled field value if set, zero value otherwise.
func (o *DriverDto) GetIsDispatchMobileEnabled() bool {
	if o == nil || IsNil(o.IsDispatchMobileEnabled) {
		var ret bool
		return ret
	}
	return *o.IsDispatchMobileEnabled
}

// GetIsDispatchMobileEnabledOk returns a tuple with the IsDispatchMobileEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetIsDispatchMobileEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.IsDispatchMobileEnabled) {
		return nil, false
	}
	return o.IsDispatchMobileEnabled, true
}
...
// SetIsDispatchMobileEnabled gets a reference to the given bool and assigns it to the IsDispatchMobileEnabled field.
func (o *DriverDto) SetIsDispatchMobileEnabled(v bool) {
	o.IsDispatchMobileEnabled = &v
}
...
// GetCurrentVehicleCode returns the CurrentVehicleCode field value if set, zero value otherwise.
func (o *DriverDto) GetCurrentVehicleCode() string {
	if o == nil || IsNil(o.CurrentVehicleCode) {
		var ret string
		return ret
	}
	return *o.CurrentVehicleCode
}

// GetCurrentVehicleCodeOk returns a tuple with the CurrentVehicleCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetCurrentVehicleCodeOk() (*string, bool) {
	if o == nil || IsNil(o.CurrentVehicleCode) {
		return nil, false
	}
	return o.CurrentVehicleCode, true
}
...
// SetCurrentVehicleCode gets a reference to the given string and assigns it to the CurrentVehicleCode field.
func (o *DriverDto) SetCurrentVehicleCode(v string) {
	o.CurrentVehicleCode = &v
}

// GetDefaultVehicleCode returns the DefaultVehicleCode field value if set, zero value otherwise.
func (o *DriverDto) GetDefaultVehicleCode() string {
	if o == nil || IsNil(o.DefaultVehicleCode) {
		var ret string
		return ret
	}
	return *o.DefaultVehicleCode
}

// GetDefaultVehicleCodeOk returns a tuple with the DefaultVehicleCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetDefaultVehicleCodeOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultVehicleCode) {
		return nil, false
	}
	return o.DefaultVehicleCode, true
}
...
// SetDefaultVehicleCode gets a reference to the given string and assigns it to the DefaultVehicleCode field.
func (o *DriverDto) SetDefaultVehicleCode(v string) {
	o.DefaultVehicleCode = &v
}

// GetDrivingLicenceType returns the DrivingLicenceType field value if set, zero value otherwise.
func (o *DriverDto) GetDrivingLicenceType() string {
	if o == nil || IsNil(o.DrivingLicenceType) {
		var ret string
		return ret
	}
	return *o.DrivingLicenceType
}

// GetDrivingLicenceTypeOk returns a tuple with the DrivingLicenceType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetDrivingLicenceTypeOk() (*string, bool) {
	if o == nil || IsNil(o.DrivingLicenceType) {
		return nil, false
	}
	return o.DrivingLicenceType, true
}
...
// SetDrivingLicenceType gets a reference to the given string and assigns it to the DrivingLicenceType field.
func (o *DriverDto) SetDrivingLicenceType(v string) {
	o.DrivingLicenceType = &v
}

// GetHasDangerousGoodsCertification returns the HasDangerousGoodsCertification field value if set, zero value otherwise.
func (o *DriverDto) GetHasDangerousGoodsCertification() bool {
	if o == nil || IsNil(o.HasDangerousGoodsCertification) {
		var ret bool
		return ret
	}
	return *o.HasDangerousGoodsCertification
}

// GetHasDangerousGoodsCertificationOk returns a tuple with the HasDangerousGoodsCertification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetHasDangerousGoodsCertificationOk() (*bool, bool) {
	if o == nil || IsNil(o.HasDangerousGoodsCertification) {
		return nil, false
	}
	return o.HasDangerousGoodsCertification, true
}
...
// SetHasDangerousGoodsCertification gets a reference to the given bool and assigns it to the HasDangerousGoodsCertification field.
func (o *DriverDto) SetHasDangerousGoodsCertification(v bool) {
	o.HasDangerousGoodsCertification = &v
}

// GetGlobalMark returns the GlobalMark field value if set, zero value otherwise.
func (o *DriverDto) GetGlobalMark() int32 {
	if o == nil || IsNil(o.GlobalMark) {
		var ret int32
		return ret
	}
	return *o.GlobalMark
...
// GetGlobalMarkOk returns a tuple with the GlobalMark field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetGlobalMarkOk() (*int32, bool) {
	if o == nil || IsNil(o.GlobalMark) {
		return nil, false
	}
	return o.GlobalMark, true
}
...
// SetGlobalMark gets a reference to the given int32 and assigns it to the GlobalMark field.
...
// SetIncluded gets a reference to the given DriverIncludedDto and assigns it to the Included field.
...
// GetRemoteAgencyCode returns the RemoteAgencyCode field value if set, zero value otherwise.
func (o *DriverDto) GetRemoteAgencyCode() string {
	if o == nil || IsNil(o.RemoteAgencyCode) {
		var ret string
		return ret
	}
	return *o.RemoteAgencyCode
}

// GetRemoteAgencyCodeOk returns a tuple with the RemoteAgencyCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetRemoteAgencyCodeOk() (*string, bool) {
	if o == nil || IsNil(o.RemoteAgencyCode) {
		return nil, false
	}
	return o.RemoteAgencyCode, true
}
...
// SetRemoteAgencyCode gets a reference to the given string and assigns it to the RemoteAgencyCode field.
func (o *DriverDto) SetRemoteAgencyCode(v string) {
	o.RemoteAgencyCode = &v
}

// GetRemoteLicenseCode returns the RemoteLicenseCode field value if set, zero value otherwise.
func (o *DriverDto) GetRemoteLicenseCode() string {
	if o == nil || IsNil(o.RemoteLicenseCode) {
		var ret string
		return ret
	}
	return *o.RemoteLicenseCode
}

// GetRemoteLicenseCodeOk returns a tuple with the RemoteLicenseCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetRemoteLicenseCodeOk() (*string, bool) {
	if o == nil || IsNil(o.RemoteLicenseCode) {
		return nil, false
	}
	return o.RemoteLicenseCode, true
}
...
// SetRemoteLicenseCode gets a reference to the given string and assigns it to the RemoteLicenseCode field.
func (o *DriverDto) SetRemoteLicenseCode(v string) {
	o.RemoteLicenseCode = &v
}

// GetSubcontractorEmployeesCount returns the SubcontractorEmployeesCount field value if set, zero value otherwise.
func (o *DriverDto) GetSubcontractorEmployeesCount() int64 {
	if o == nil || IsNil(o.SubcontractorEmployeesCount) {
		var ret int64
		return ret
	}
	return *o.SubcontractorEmployeesCount
}

// GetSubcontractorEmployeesCountOk returns a tuple with the SubcontractorEmployeesCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DriverDto) GetSubcontractorEmployeesCountOk() (*int64, bool) {
	if o == nil || IsNil(o.SubcontractorEmployeesCount) {
		return nil, false
	}
	return o.SubcontractorEmployeesCount, true
}
...
// SetSubcontractorEmployeesCount gets a reference to the given int64 and assigns it to the SubcontractorEmployeesCount field.
func (o *DriverDto) SetSubcontractorEmployeesCount(v int64) {
	o.SubcontractorEmployeesCount = &v
}
...
func (o *DriverDto) GetDepartureDateTimeOk() (*time.Time, bool) {
	...
	return o.DepartureDateTime, true
}
...
func (o DriverDto) MarshalJSON() ([]byte, error) {
...
func (o DriverDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DriverType) {
		toSerialize["driverType"] = o.DriverType
	}
	...
	if !IsNil(o.TeamLabel) {
		toSerialize["teamLabel"] = o.TeamLabel
	}
	if !IsNil(o.ProfileCode) {
		toSerialize["profileCode"] = o.ProfileCode
	}
	if !IsNil(o.IsEnabled) {
		toSerialize["isEnabled"] = o.IsEnabled
	}
	if !IsNil(o.IsDispatchMobileEnabled) {
		toSerialize["isDispatchMobileEnabled"] = o.IsDispatchMobileEnabled
	}
	if !IsNil(o.Phone) {
	...
	if !IsNil(o.CurrentVehicleCode) {
		toSerialize["currentVehicleCode"] = o.CurrentVehicleCode
	}
	if !IsNil(o.DefaultVehicleCode) {
		toSerialize["defaultVehicleCode"] = o.DefaultVehicleCode
	}
	if !IsNil(o.DrivingLicenceType) {
		toSerialize["drivingLicenceType"] = o.DrivingLicenceType
	}
	if !IsNil(o.HasDangerousGoodsCertification) {
		toSerialize["hasDangerousGoodsCertification"] = o.HasDangerousGoodsCertification
	}
	if !IsNil(o.GlobalMark) {
		toSerialize["globalMark"] = o.GlobalMark
	}
	if !IsNil(o.Included) {
	...
	if !IsNil(o.RemoteAgencyCode) {
		toSerialize["remoteAgencyCode"] = o.RemoteAgencyCode
	}
	if !IsNil(o.RemoteLicenseCode) {
		toSerialize["remoteLicenseCode"] = o.RemoteLicenseCode
	}
	if !IsNil(o.SubcontractorEmployeesCount) {
		toSerialize["subcontractorEmployeesCount"] = o.SubcontractorEmployeesCount
	}
	if !IsNil(o.ArrivalDateTime) {
		toSerialize["arrivalDateTime"] = o.ArrivalDateTime
	}
	if !IsNil(o.DepartureDateTime) {
		toSerialize["departureDateTime"] = o.DepartureDateTime
	}
	return toSerialize, nil
}

type NullableDriverDto struct {
	value *DriverDto
	isSet bool
}

func (v NullableDriverDto) Get() *DriverDto {
	return v.value
}

func (v *NullableDriverDto) Set(val *DriverDto) {
	v.value = val
	v.isSet = true
}

func (v NullableDriverDto) IsSet() bool {
	return v.isSet
}

func (v *NullableDriverDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDriverDto(val *DriverDto) *NullableDriverDto {
	return &NullableDriverDto{value: val, isSet: true}
}

func (v NullableDriverDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDriverDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
