...
// SubstatesAPIService SubstatesAPI service
type SubstatesAPIService service

type SubstatesAPIGetSubstateByCodeRequest struct {
	ctx context.Context
	ApiService *SubstatesAPIService
	code *string
	fields *string
}

// Substate&#39;s code
func (r SubstatesAPIGetSubstateByCodeRequest) Code(code string) SubstatesAPIGetSubstateByCodeRequest {
	r.code = &code
	return r
}

// Projection fields separated with a comma
func (r SubstatesAPIGetSubstateByCodeRequest) Fields(fields string) SubstatesAPIGetSubstateByCodeRequest {
	r.fields = &fields
	return r
}

func (r SubstatesAPIGetSubstateByCodeRequest) Execute() (*SubStateDto, *http.Response, error) {
	return r.ApiService.GetSubstateByCodeExecute(r)
}

/*
GetSubstateByCode Get a substate by its code

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubstatesAPIGetSubstateByCodeRequest
*/
func (a *SubstatesAPIService) GetSubstateByCode(ctx context.Context) SubstatesAPIGetSubstateByCodeRequest {
	return SubstatesAPIGetSubstateByCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return SubStateDto
func (a *SubstatesAPIService) GetSubstateByCodeExecute(r SubstatesAPIGetSubstateByCodeRequest) (*SubStateDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SubStateDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubstatesAPIService.GetSubstateByCode")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/substates/by-code"
...
type SubstatesAPIGetSubstatesRequest struct {
	ctx context.Context
	ApiService *SubstatesAPIService
	subStateCodes *[]string
	subStateFamilyCodes *[]string
	pattern *string
...
// Substate unique codes
func (r SubstatesAPIGetSubstatesRequest) SubStateCodes(subStateCodes []string) SubstatesAPIGetSubstatesRequest {
	r.subStateCodes = &subStateCodes
	return r
}

// Substate family unique codes
func (r SubstatesAPIGetSubstatesRequest) SubStateFamilyCodes(subStateFamilyCodes []string) SubstatesAPIGetSubstatesRequest {
	r.subStateFamilyCodes = &subStateFamilyCodes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r SubstatesAPIGetSubstatesRequest) Pattern(pattern string) SubstatesAPIGetSubstatesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r SubstatesAPIGetSubstatesRequest) PatternFields(patternFields []string) SubstatesAPIGetSubstatesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r SubstatesAPIGetSubstatesRequest) StartIndex(startIndex int32) SubstatesAPIGetSubstatesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r SubstatesAPIGetSubstatesRequest) Count(count int32) SubstatesAPIGetSubstatesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r SubstatesAPIGetSubstatesRequest) Sort(sort []string) SubstatesAPIGetSubstatesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r SubstatesAPIGetSubstatesRequest) Desc(desc []string) SubstatesAPIGetSubstatesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r SubstatesAPIGetSubstatesRequest) Fields(fields string) SubstatesAPIGetSubstatesRequest {
	r.fields = &fields
	return r
}

func (r SubstatesAPIGetSubstatesRequest) Execute() (*IPagedResourceListSubStateDto, *http.Response, error) {
	return r.ApiService.GetSubstatesExecute(r)
}

/*
GetSubstates Get substates

Get a paginated list of substates corresponding to the specified filters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubstatesAPIGetSubstatesRequest
*/
func (a *SubstatesAPIService) GetSubstates(ctx context.Context) SubstatesAPIGetSubstatesRequest {
	return SubstatesAPIGetSubstatesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IPagedResourceListSubStateDto
func (a *SubstatesAPIService) GetSubstatesExecute(r SubstatesAPIGetSubstatesRequest) (*IPagedResourceListSubStateDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IPagedResourceListSubStateDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubstatesAPIService.GetSubstates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/substates"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if r.subStateCodes != nil {
		t := *r.subStateCodes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "subStateCodes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "subStateCodes", t, "form", "multi")
		}
	}
	if r.subStateFamilyCodes != nil {
		t := *r.subStateFamilyCodes
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "subStateFamilyCodes", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "subStateFamilyCodes", t, "form", "multi")
		}
	}
	if r.pattern != nil {
