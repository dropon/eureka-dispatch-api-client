...
type ApiGetSubstateByCodeRequest struct {
	ctx context.Context
...
// Substate&#39;s code
func (r ApiGetSubstateByCodeRequest) Code(code string) ApiGetSubstateByCodeRequest {
	r.code = &code
	return r
}

// Projection fields separated with a comma
func (r ApiGetSubstateByCodeRequest) Fields(fields string) ApiGetSubstateByCodeRequest {
	r.fields = &fields
	return r
}

func (r ApiGetSubstateByCodeRequest) Execute() (*SubStateDto, *http.Response, error) {
	return r.ApiService.GetSubstateByCodeExecute(r)
}

/*
GetSubstateByCode Get substate by code

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSubstateByCodeRequest
*/
func (a *SubstatesAPIService) GetSubstateByCode(ctx context.Context) ApiGetSubstateByCodeRequest {
	return ApiGetSubstateByCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return SubStateDto
func (a *SubstatesAPIService) GetSubstateByCodeExecute(r ApiGetSubstateByCodeRequest) (*SubStateDto, *http.Response, error) {
	var (
...
type ApiGetSubstatesRequest struct {
	ctx context.Context
	ApiService *SubstatesAPIService
...
func (r ApiGetSubstatesRequest) SubStateCodes(subStateCodes []string) ApiGetSubstatesRequest {
	r.subStateCodes = &subStateCodes
	return r
}

// Substate family unique codes
func (r ApiGetSubstatesRequest) SubStateFamilyCodes(subStateFamilyCodes []string) ApiGetSubstatesRequest {
	r.subStateFamilyCodes = &subStateFamilyCodes
	return r
}

// A pattern to look for in fields specified  by PatternFields.
func (r ApiGetSubstatesRequest) Pattern(pattern string) ApiGetSubstatesRequest {
	r.pattern = &pattern
	return r
}

// Fields in which to search for Pattern
func (r ApiGetSubstatesRequest) PatternFields(patternFields []string) ApiGetSubstatesRequest {
	r.patternFields = &patternFields
	return r
}

// Pagination start index (offset). Default is 0.
func (r ApiGetSubstatesRequest) StartIndex(startIndex int32) ApiGetSubstatesRequest {
	r.startIndex = &startIndex
	return r
}

// Pagination count (page size). Default is 10, maximum is 200.
func (r ApiGetSubstatesRequest) Count(count int32) ApiGetSubstatesRequest {
	r.count = &count
	return r
}

// Pagination sorting fields separated with a comma
func (r ApiGetSubstatesRequest) Sort(sort []string) ApiGetSubstatesRequest {
	r.sort = &sort
	return r
}

// Pagination sorting fields with descending order separated with a comma. They must also be provided in sort fields.
func (r ApiGetSubstatesRequest) Desc(desc []string) ApiGetSubstatesRequest {
	r.desc = &desc
	return r
}

// Projection fields separated with a comma
func (r ApiGetSubstatesRequest) Fields(fields string) ApiGetSubstatesRequest {
	r.fields = &fields
	return r
}

func (r ApiGetSubstatesRequest) Execute() (*IPagedResourceListSubStateDto, *http.Response, error) {
...
Get a paginated list of substates corresponding to the specified filters.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSubstatesRequest
*/
func (a *SubstatesAPIService) GetSubstates(ctx context.Context) ApiGetSubstatesRequest {
	return ApiGetSubstatesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubstatesAPIService) GetSubstatesExecute(r ApiGetSubstatesRequest) (*IPagedResourceListSubStateDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
