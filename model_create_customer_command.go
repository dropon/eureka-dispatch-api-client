...
// checks if the CreateCustomerCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCustomerCommand{}

// CreateCustomerCommand struct for CreateCustomerCommand
type CreateCustomerCommand struct {
	// Must contain only ASCII letters (A-Z, a-z), digits (0-9), underscores (_), or hyphens (-).
	Code *string `json:"code,omitempty"`
	// Mandatory.
	AgencyCode string `json:"agencyCode"`
	CustomerFamilyCode *string `json:"customerFamilyCode,omitempty"`
	// Indicates whether the agency address should be used instead of the operation address.    If true, the provided operation address will be ignored and the agency address will be used instead.
	UseAgencyAddressInsteadOfOperationAddress *bool `json:"useAgencyAddressInsteadOfOperationAddress,omitempty"`
	OperationAddress *OperationAddressEditionDto `json:"operationAddress,omitempty"`
	OperationalConfiguration *CustomerOperationalConfigurationEditionDto `json:"operationalConfiguration,omitempty"`
	BillingAddress *CustomerBillingAddressEditionDto `json:"billingAddress,omitempty"`
	BillingConfiguration *CustomerBillingConfigurationEditionDto `json:"billingConfiguration,omitempty"`
	BillingDetails *CustomerBillingDetailsEditionDto `json:"billingDetails,omitempty"`
}

type _CreateCustomerCommand CreateCustomerCommand
...
// GetAgencyCode returns the AgencyCode field value
...
// GetAgencyCodeOk returns a tuple with the AgencyCode field value
// and a boolean to check if the value has been set.
...
// SetAgencyCode sets field value
func (o *CreateCustomerCommand) SetAgencyCode(v string) {
	o.AgencyCode = v
}

// GetCustomerFamilyCode returns the CustomerFamilyCode field value if set, zero value otherwise.
func (o *CreateCustomerCommand) GetCustomerFamilyCode() string {
	if o == nil || IsNil(o.CustomerFamilyCode) {
		var ret string
		return ret
	}
	return *o.CustomerFamilyCode
}

// GetCustomerFamilyCodeOk returns a tuple with the CustomerFamilyCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCustomerCommand) GetCustomerFamilyCodeOk() (*string, bool) {
	if o == nil || IsNil(o.CustomerFamilyCode) {
		return nil, false
	}
	return o.CustomerFamilyCode, true
}
...
// SetCustomerFamilyCode gets a reference to the given string and assigns it to the CustomerFamilyCode field.
func (o *CreateCustomerCommand) SetCustomerFamilyCode(v string) {
	o.CustomerFamilyCode = &v
}

// GetUseAgencyAddressInsteadOfOperationAddress returns the UseAgencyAddressInsteadOfOperationAddress field value if set, zero value otherwise.
func (o *CreateCustomerCommand) GetUseAgencyAddressInsteadOfOperationAddress() bool {
	if o == nil || IsNil(o.UseAgencyAddressInsteadOfOperationAddress) {
		var ret bool
		return ret
	}
	return *o.UseAgencyAddressInsteadOfOperationAddress
}

// GetUseAgencyAddressInsteadOfOperationAddressOk returns a tuple with the UseAgencyAddressInsteadOfOperationAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCustomerCommand) GetUseAgencyAddressInsteadOfOperationAddressOk() (*bool, bool) {
	if o == nil || IsNil(o.UseAgencyAddressInsteadOfOperationAddress) {
		return nil, false
	}
	return o.UseAgencyAddressInsteadOfOperationAddress, true
}
...
// SetUseAgencyAddressInsteadOfOperationAddress gets a reference to the given bool and assigns it to the UseAgencyAddressInsteadOfOperationAddress field.
func (o *CreateCustomerCommand) SetUseAgencyAddressInsteadOfOperationAddress(v bool) {
	o.UseAgencyAddressInsteadOfOperationAddress = &v
}

// GetOperationAddress returns the OperationAddress field value if set, zero value otherwise.
func (o *CreateCustomerCommand) GetOperationAddress() OperationAddressEditionDto {
	if o == nil || IsNil(o.OperationAddress) {
		var ret OperationAddressEditionDto
		return ret
	}
	return *o.OperationAddress
}

// GetOperationAddressOk returns a tuple with the OperationAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetOperationAddress gets a reference to the given OperationAddressEditionDto and assigns it to the OperationAddress field.
...
func (o *CreateCustomerCommand) GetOperationalConfiguration() CustomerOperationalConfigurationEditionDto {
	if o == nil || IsNil(o.OperationalConfiguration) {
		var ret CustomerOperationalConfigurationEditionDto
		return ret
	}
...
// SetOperationalConfiguration gets a reference to the given CustomerOperationalConfigurationEditionDto and assigns it to the OperationalConfiguration field.
...
func (o *CreateCustomerCommand) GetBillingAddress() CustomerBillingAddressEditionDto {
	if o == nil || IsNil(o.BillingAddress) {
		var ret CustomerBillingAddressEditionDto
		return ret
	}
...
// SetBillingAddress gets a reference to the given CustomerBillingAddressEditionDto and assigns it to the BillingAddress field.
...
func (o *CreateCustomerCommand) GetBillingConfiguration() CustomerBillingConfigurationEditionDto {
	if o == nil || IsNil(o.BillingConfiguration) {
		var ret CustomerBillingConfigurationEditionDto
		return ret
	}
...
// SetBillingConfiguration gets a reference to the given CustomerBillingConfigurationEditionDto and assigns it to the BillingConfiguration field.
...
func (o *CreateCustomerCommand) GetBillingDetails() CustomerBillingDetailsEditionDto {
	if o == nil || IsNil(o.BillingDetails) {
		var ret CustomerBillingDetailsEditionDto
		return ret
	}
...
// SetBillingDetails gets a reference to the given CustomerBillingDetailsEditionDto and assigns it to the BillingDetails field.
func (o *CreateCustomerCommand) SetBillingDetails(v CustomerBillingDetailsEditionDto) {
	o.BillingDetails = &v
}

func (o CreateCustomerCommand) MarshalJSON() ([]byte, error) {
...
func (o CreateCustomerCommand) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Code) {
		toSerialize["code"] = o.Code
	}
	toSerialize["agencyCode"] = o.AgencyCode
	if !IsNil(o.CustomerFamilyCode) {
		toSerialize["customerFamilyCode"] = o.CustomerFamilyCode
	}
	if !IsNil(o.UseAgencyAddressInsteadOfOperationAddress) {
		toSerialize["useAgencyAddressInsteadOfOperationAddress"] = o.UseAgencyAddressInsteadOfOperationAddress
	}
	if !IsNil(o.OperationAddress) {
		toSerialize["operationAddress"] = o.OperationAddress
	}
	...
	if !IsNil(o.BillingConfiguration) {
		toSerialize["billingConfiguration"] = o.BillingConfiguration
	}
...
func (o *CreateCustomerCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCustomerCommand := _CreateCustomerCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCustomerCommand)

	if err != nil {
		return err
	}

	*o = CreateCustomerCommand(varCreateCustomerCommand)

	return err
}

type NullableCreateCustomerCommand struct {
	value *CreateCustomerCommand
	isSet bool
}

func (v NullableCreateCustomerCommand) Get() *CreateCustomerCommand {
	return v.value
}

func (v *NullableCreateCustomerCommand) Set(val *CreateCustomerCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCustomerCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCustomerCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCustomerCommand(val *CreateCustomerCommand) *NullableCreateCustomerCommand {
	return &NullableCreateCustomerCommand{value: val, isSet: true}
}

func (v NullableCreateCustomerCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCustomerCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
