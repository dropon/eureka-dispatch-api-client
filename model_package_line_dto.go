...
// checks if the PackageLineDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackageLineDto{}

// PackageLineDto struct for PackageLineDto
type PackageLineDto struct {
	...
	PackageHistoryCode *string `json:"packageHistoryCode,omitempty"`
	PackageSizes *CappedCollectionDtoPackageLineSizeDto `json:"packageSizes,omitempty"`
	References *CappedCollectionDtoPackageLineReferenceValueDto `json:"references,omitempty"`
}
...
// GetPackageHistoryCode returns the PackageHistoryCode field value if set, zero value otherwise.
func (o *PackageLineDto) GetPackageHistoryCode() string {
	if o == nil || IsNil(o.PackageHistoryCode) {
		var ret string
		return ret
	}
	return *o.PackageHistoryCode
}

// GetPackageHistoryCodeOk returns a tuple with the PackageHistoryCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PackageLineDto) GetPackageHistoryCodeOk() (*string, bool) {
	if o == nil || IsNil(o.PackageHistoryCode) {
		return nil, false
	}
	return o.PackageHistoryCode, true
}
...
// SetPackageHistoryCode gets a reference to the given string and assigns it to the PackageHistoryCode field.
func (o *PackageLineDto) SetPackageHistoryCode(v string) {
	o.PackageHistoryCode = &v
}
...
func (o *PackageLineDto) GetPackageSizes() CappedCollectionDtoPackageLineSizeDto {
	if o == nil || IsNil(o.PackageSizes) {
		var ret CappedCollectionDtoPackageLineSizeDto
		return ret
	}
...
// SetPackageSizes gets a reference to the given CappedCollectionDtoPackageLineSizeDto and assigns it to the PackageSizes field.
...
func (o *PackageLineDto) GetReferences() CappedCollectionDtoPackageLineReferenceValueDto {
	if o == nil || IsNil(o.References) {
		var ret CappedCollectionDtoPackageLineReferenceValueDto
		return ret
	}
	return *o.References
}
...
// SetReferences gets a reference to the given CappedCollectionDtoPackageLineReferenceValueDto and assigns it to the References field.
func (o *PackageLineDto) SetReferences(v CappedCollectionDtoPackageLineReferenceValueDto) {
	o.References = &v
}

func (o PackageLineDto) MarshalJSON() ([]byte, error) {
...
func (o PackageLineDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PackageHistoryCode) {
		toSerialize["packageHistoryCode"] = o.PackageHistoryCode
	}
...
type NullablePackageLineDto struct {
	value *PackageLineDto
	isSet bool
}

func (v NullablePackageLineDto) Get() *PackageLineDto {
	return v.value
}

func (v *NullablePackageLineDto) Set(val *PackageLineDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageLineDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageLineDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageLineDto(val *PackageLineDto) *NullablePackageLineDto {
	return &NullablePackageLineDto{value: val, isSet: true}
}

func (v NullablePackageLineDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageLineDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
